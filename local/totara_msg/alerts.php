 ...
 */
    ...
    $strheading = get_string('alerts', 'local_totara_msg');
    ...
    if (strstr($referer, 'my/team.php')) {
        ...
        $navlinks[] = array('name' => get_string('myteam', 'local').' '.get_string('dashboard', 'local_dashboard'),
            'link' => "{$CFG->wwwroot}/my/team.php", 'type' => 'title');
    }
    if (strstr($referer, 'my/learning.php')) {
        ...
        $navlinks[] = array('name' => get_string('mylearning', 'local').' '.get_string('dashboard', 'local_dashboard'),
            'link' => "{$CFG->wwwroot}/my/learning.php", 'type' => 'title');
    }
    ...
    if (empty($report->description)) {
        $report->description = get_string('alert_description', 'local_totara_msg');
    }
...
//        print $report->edit_button();
        ...
        $out .= '</td>';
        $out .= '<td>';
        $out .= '<input type="submit" name="dismiss" disabled="true" id="totara-dismiss" value="'. get_string('dismiss','local_totara_msg') .'" style="display:none;"/>';
        $out .= '<noscript>';
