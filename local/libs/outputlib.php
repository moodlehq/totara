...
require_once($CFG->dirroot.'/local/libs/outputcomponents.php');
require_once($CFG->dirroot.'/local/libs/outputactions.php');
require_once($CFG->dirroot.'/local/libs/outputfactories.php');
require_once($CFG->dirroot.'/local/libs/outputrenderers.php');
require_once($CFG->dirroot.'/local/libs/outputrequirementslib.php');
