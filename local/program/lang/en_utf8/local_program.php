...
$string['beforecourseends'] = 'before course ends';
...
$string['endnote'] = 'Program end note';
...
$string['memberofcohort'] = 'Member of cohort \'{$a}\'.';
...
$string['error:coursecreation_nonzero'] = 'Course creation must be more than zero days before course ends';
...
$string['tosavemessages'] = 'To save all message changes, click \''.$string['saveallchanges'].'\'. To edit message changes click \''.$string['editmessages'].'\'. Saving message changes cannot be undone.';
...
$string['allcurrentlyassignedissues'] = 'All currently assigned issues';
