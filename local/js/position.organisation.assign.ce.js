...
YAHOO.util.Event.onDOMReady(function () {
    YAHOO.dialog.organisation = new yuiDialog(
        ...
        {},
        '../../../type/organisation/assign/find.php?user='+user_id
    );
});
...
function organisationassignment_load(parentid) {
    ...
    YAHOO.util.Connect.asyncRequest(
        'GET',
        '../../../type/organisation/assign/find.php?user='+user_id+'&parentid='+parentid,
        callback
    );
}
...
function organisationassignment_set_framework() {
    ...
    // Update URL
    var url = '../../../type/organisation/assign/find.php'+
              '?user='+user_id+
