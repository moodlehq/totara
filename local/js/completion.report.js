...
YAHOO.util.Event.onDOMReady(function () {
    ...
    var fnc_edit = function(event) {
        ...
        if (inputgroup.length)
        {
            ...
            if (inputvalue) {
                // Change icon
                $('a.rpledit img', cell).attr('src', '/theme/mitms/pix/i/completion-rpl-y.gif');
            ...
            // If no RPL was entered
                ...
                // Change icon
                $('a.rpledit img', cell).attr('src', '/theme/mitms/pix/i/completion-rpl-n.gif');
            }
            ...
            var cancel = $('<a href="#" class="icon rpldelete" title="Delete this RPL"><img src="/theme/mitms/pix/i/cross_red_big.gif" alt="Delete" /></a>');
    ...
    var fnc_saverpl = function(cell, user, rpl) {
        ...
        // Show loading icon
        cell.append($('<img class="rplloading" src="/theme/mitms/pix/i/loading_small.gif" />'));
