<?php
//
// Capability definitions for the cohort module.
//
...
$capabilities = array(
    ...
    // create, delete, move cohorts in system,
    'local/cohort:manage' => array(
        'captype' => 'write',
...
$local_cohort_capabilities = $capabilities;
?>
