...
$columnoptions = array(
    ...
    'sco' => array(
        ...
        'status' => array(
            'name'  => 'SCO Status',
            'field' => 'status.value',
            'joins' => array('sco_status'),
            'displayfunc' => 'reportbuilder_ucfirst',
        ),
        'totaltime' => array(
            'name'  => 'SCO Total Time',
            'field' => 'totaltime.value',
            'joins' => array('sco_totaltime'),
        ),
        'scoreraw' => array(
            'name'  => 'SCO Score',
            'field' => 'scoreraw.value',
            'joins' => array('sco_scoreraw'),
        ),
        'scoremin' => array(
            'name'  => 'SCO Min Score',
            'field' => 'scoremin.value',
            'joins' => array('sco_scoremin'),
        ),
        'scoremax' => array(
            'name'  => 'SCO Max Score',
            'field' => 'scoremax.value',
            'joins' => array('sco_scoremax'),
        ),
        'attempt' => array(
            'name' => 'SCO Attempt Number',
            'field' => 'base.attempt',
            'joins' => array(),
        ),
    ),
