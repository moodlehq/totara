...
class columns_test extends prefix_changing_test_case {
    ...
    function tearDown() {
        ...
        remove_test_table('mdl_unittest_feedback_value', $db);
        remove_test_table('mdl_unittest_feedback_completed', $db);
        remove_test_table('mdl_unittest_feedback_item', $db);
        remove_test_table('mdl_unittest_feedback', $db);
        remove_test_table('mdl_unittest_scorm_scoes_track', $db);
        remove_test_table('mdl_unittest_scorm_scoes', $db);
        remove_test_table('mdl_unittest_scorm', $db);
        remove_test_table('mdl_unittest_facetoface', $db);
        remove_test_table('mdl_unittest_facetoface_sessions', $db);
        remove_test_table('mdl_unittest_facetoface_sessions_dates', $db);
        remove_test_table('mdl_unittest_facetoface_signups', $db);
        remove_test_table('mdl_unittest_facetoface_signups_status', $db);
        remove_test_table('mdl_unittest_facetoface_session_roles', $db);
