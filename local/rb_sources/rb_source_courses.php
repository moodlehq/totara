    ...
    function define_columnoptions() {
        $columnoptions = array(
            new rb_column_option(
                'course',
                'mods',
                get_string('content', 'rb_source_completion_by_org'),
                "mods.list",
    ...
    function define_filteroptions() {
        $filteroptions = array(
            new rb_filter_option(
                'course',         // type
                'mods',           // value
                get_string('coursecontent', 'rb_source_completion_by_org'), // label
    ...
    function define_contentoptions() {
        $contentoptions = array(
            ...
            new rb_content_option(
                'date',
                get_string('startdate', 'rb_source_completion_by_org'),
                'base.startdate'
            ),
        );
