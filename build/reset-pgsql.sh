...
touch /var/log/sitelogs/totara-pgsql/access.log
touch /var/log/sitelogs/totara-pgsql/error.log
chmod 666 /var/log/sitelogs/totara-pgsql/access.log
chmod 666 /var/log/sitelogs/totara-pgsql/error.log
