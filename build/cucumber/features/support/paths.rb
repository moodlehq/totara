  ...
  def paths
    {
      ...
      'a learners my records' => '/local/plan/record/courses.php?id=' + get_username_id('learner'),
      'an administrators my records' => '/local/plan/record/courses.php?id=' + get_username_id('admin'),
