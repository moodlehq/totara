...
/// process data if submitted
    ...
    $aggregation = new completion_aggregation($agg_data);
    ...
    $agg_data['criteriatype'] = COMPLETION_CRITERIA_TYPE_ACTIVITY;
    $aggregation = new completion_aggregation($agg_data);
    ...
    $agg_data['criteriatype'] = COMPLETION_CRITERIA_TYPE_COURSE;
    $aggregation = new completion_aggregation($agg_data);
    ...
    $agg_data['criteriatype'] = COMPLETION_CRITERIA_TYPE_ROLE;
    $aggregation = new completion_aggregation($agg_data);
