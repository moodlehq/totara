...
<div>
    ...
    <input type="text" class="extensiontime" name="extensiontime" id="extensiontime" size="20" maxlength="10" placeholder="<?php echo get_string('datepickerplaceholder', 'totara_core'); ?>" />
</div>
<br />
<div>
