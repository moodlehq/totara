...
La note au gestionnaire peut contenir des variables qui seront remplacées dans le message envoyé. Pour plus de détails sur les variables pouvant être susbstituées, voir [ substitution de variables ][1].
...
Le sujet peut contenir des variables qui seront remplacées dans le message envoyé. Pour plus de détails sur les variables pouvant être susbstituées, voir [ substitution de variables ][1].
...
Le corps du message peut contenir des variables qui seront remplacées lors de l\'envoi du message. Pour plus de détails sur les variables qui peuvent être substituées, voir [ substitution de variables ][1].
