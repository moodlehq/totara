...
if ($d and $confirm ) {
    ...
    if(isset($fid)) {
        if($report->delete_filter($fid)) {
            ...
            totara_set_notification(get_string('filter_deleted','local_reportbuilder'), $returnurl, array('class' => 'notifysuccess'));
        } else {
...
if($m && isset($fid)) {
    if($report->move_filter($fid, $m)) {
        ...
        totara_set_notification(get_string('filter_moved','local_reportbuilder'), $returnurl, array('class' => 'notifysuccess'));
    } else {
...
if ($fromform = $mform->get_data()) {
    ...
    if(build_filters($id, $fromform)) {
        ...
        totara_set_notification(get_string('filters_updated','local_reportbuilder'), $returnurl, array('class' => 'notifysuccess'));
    } else {
