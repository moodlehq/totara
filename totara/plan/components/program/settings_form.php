...
require_once($CFG->dirroot.'/totara/plan/components/program/program.class.php');
...
function dp_program_component_build_settings_form(&$mform, $customdata) {
    ...
    $mform->addElement('header', 'programsettings', get_string('programsettings', 'totara_plan'));
    $mform->addHelpButton('programsettings', 'advancedsettingsprogramsettings', 'totara_plan', '', true);
    ...
    $mform->addElement('header', 'programpermissions', get_string('programpermissions', 'totara_plan'));
    $mform->addHelpButton('programpermissions', 'advancedsettingsprogrampermissions', 'totara_plan', '', true);
...
function dp_program_component_process_settings_form($fromform, $id) {
    ...
    $currenturl = new moodle_url('/totara/plan/template/advancedworkflow.php', array('id' => $id, 'component' => 'program'));
