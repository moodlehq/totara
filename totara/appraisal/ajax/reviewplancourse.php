...
$new_items = $DB->get_records_select('dp_plan_course_assign', 'id ' . $itemssql, $params);
...
$sql = 'SELECT questdata.*, c.fullname FROM {appraisal_review_data} questdata
...
foreach ($items as $item) {
    // We need to add extra information in here so we have enough
    // information to render the table
}
