...
if (!$nojs) {
    ...
    $dialog = new totara_dialog_content_plan('program', $planid, $showhidden, $subjectid);
    ...
    $dialog->string_nothingtodisplay = 'error:dialognotreeitemsplanprograms';
