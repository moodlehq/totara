...
if (!$nojs) {
    ...
    $dialog = new totara_dialog_content_plan('objective', $planid, $showhidden, $subjectid);
    ...
    $dialog->string_nothingtodisplay = 'error:dialognotreeitemsplanobjectives';
