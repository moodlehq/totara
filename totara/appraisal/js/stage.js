  ...
  init : function(Y, args) {
    ...
    function updateRoles(sID) {
      $.get(M.cfg.wwwroot + '/totara/appraisal/ajax/stage.php', {
        ...
        $('table.appraisal-stages tr.selected span.appraisal-rolescananswer').html($(data).get(0));
        $('table.appraisal-stages tr.selected span.appraisal-rolescanview').html($(data).get(1));
      });
    }
      ...
      YUI().use('dd', function(Y) {
        ...
        Y.DD.DDM.on('drag:end', function(e) {
          ...
          $.get(url, {
            ...
            action: 'pos',
            id: node.getData('pageid') || node.getData('questid'), // @TODO Find a better way of doing this
            pos: newPos
          });
          //Put our styles back
          node.setStyles({
