...
if ($view_type) {
    ...
    $returnurl = new moodle_url('/totara/hierarchy/prefix/goal/mygoals.php', array('id' => $modid));
}
...
if ($delete) {
    ...
    echo $OUTPUT->confirm($strdelete . html_writer::empty_tag('br') . html_writer::empty_tag('br') . $strassig, $deleteurl, $returnurl);
