...
foreach ($assignments as $assignment) {
    ...
    if($nojs) {
        ...
        if ($editingon) {
            ...
            echo "<a href=\"{$CFG->wwwroot}/hierarchy/prefix/{$hierarchy->prefix}/template/remove_assignment.php?templateid={$template->id}&assignment={$competency->id}\" title=\"$str_remove\">".
