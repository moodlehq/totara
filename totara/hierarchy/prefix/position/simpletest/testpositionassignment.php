...
class positionassignment_test extends UnitTestCaseUsingDatabase {
    ...
    function setup() {
        ...
        $this->load_test_table('role_assignments', 'lib', $this->role_assignments_data);
        $this->load_test_table('pos_framework', 'totara/hierarchy', $this->pos_framework_data);
        $this->load_test_table('pos', 'totara/hierarchy', $this->pos_data);
        $this->load_test_table('prog_pos_assignment', 'totara/program', $this->prog_pos_assignment_data);
        $this->load_test_table('user', 'lib', $this->user_data);
        $this->load_test_table('pos_assignment', 'totara/hierarchy', $this->pos_assignment_data);
    ...
    function tearDown() {
        ...
        $this->drop_test_table('pos');
        $this->drop_test_table('pos_framework');
        $this->drop_test_table('prog_pos_assignment');
    ...
    function test_assign_top_level_user() {
        ...
        if (!$field = $this->testdb->get_field('pos_assignment', 'managerpath', array('userid' => 2))) {
            $this->fail();
        }
        //Check correct path
    ...
    function test_assign_lower_level_user() {
        ...
        if (!$field = $this->testdb->get_field('pos_assignment', 'managerpath', array('userid' => 5))) {
            $this->fail();
        }
    ...
    function test_assign_to_user_wo_assignment() {
        ...
        $assignment2 = new position_assignment((array)$this->pos_assignment[0]);
        $assignment2->managerid = 3;
        assign_user_position($assignment2, true);
