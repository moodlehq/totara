...
class bulkaddhierarchyitems_test extends UnitTestCaseUsingDatabase {
    ...
    function setUp() {
        ...
        $ret = $this->load_test_data('org', $this->org_cols, $this->org_data);
        $this->switch_to_test_db();
//        $this->create_test_table('timezone', 'lib');
    }
    ...
    function test_add_multiple_hierarchy_items_to_root() {
        ...
        $before = $this->testdb->get_records_menu('org', null, 'sortthread', 'id,sortthread');
        $this->assertTrue($org->add_multiple_hierarchy_items($parent, $items, 1, false));
        $after = $this->testdb->get_records_menu('org', null, 'sortthread', 'id,sortthread');
        ...
        // get the items
        $this->assertTrue($item1 = $this->testdb->get_record('org', array('id' => 11)));
        $this->assertTrue($item2 = $this->testdb->get_record('org', array('id' => 12)));
