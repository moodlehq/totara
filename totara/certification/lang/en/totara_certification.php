...
$string['certification:handleexceptions'] = 'Handle certification exceptions';
$string['certification:viewcertification'] = 'View certification';
...
$string['certificationdeletesuccess'] = 'Certification deleted sucessfully';
...
$string['error:histalreadyexists'] = 'Certif history already exists certifid={$a->certifid}, timeexpires={$a->timeexpires}';
...
$string['error:missingprogcompletion'] = 'Missing prog completion record for certifid={$a->certifid} userid={$a->userid}';
...
$string['recertfailrecertmessage_help'] = 'This message will be sent when a recertification period has expired and the learner will need to
 repeat the original certification.';
