...
switch ($action) {
    ...
    case 'copy':
        ...
        $cloned_feedback360_id = feedback360::duplicate_feedback360($id);

        $returnurl = new moodle_url('/totara/feedback360/general.php', array('id' => $cloned_feedback360_id));

        totara_set_notification(get_string('feedback360cloned', 'totara_feedback360'), $returnurl, array('class' => 'notifysuccess'));
