...
echo html_writer::tag('p', 'This will set the title to be the same as the alt text, and by default assign the "smallicon" class unless you set any other class via the attributes. Note that currently in moodle, no size is set on "smallicon" (but iconsmall is set to 11x11px). <strong>Moodle bug?</strong>');
