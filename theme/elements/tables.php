...
$url = new moodle_url('/theme/elements/tables.php');
...
$head1->attributes = array('class' => 'left-head-class');
$head2 = new html_table_cell();
$head2->text = 'Right Head';
$head2->header = true;
$head1->id = 'right-head-id';
$head1->attributes = array('class' => 'right-head-class');
$head = new html_table_row();
$head->cells = array($head1, $head2);
$head->id = 'header-id';
$head->attributes = array('class' => 'header-class');
$cell1 = new html_table_cell();
$cell1->id = 'top-left-cell-id';
$cell1->attributes = array('class' => 'top-left-cell-class');
$cell1->text = 'Top Left';
$cell2 = new html_table_cell();
$cell2->id = 'top-right-cell-id';
$cell2->attributes = array('class' => 'top-right-cell-class');
$cell2->text = 'Top Right';
$row1 = new html_table_row();
$row1->cells = array($cell1, $cell2);
$row1->id = 'row1-id';
$row1->attributes = array('class' => 'row1-class');
$cell3 = new html_table_cell();
$cell3->id = 'bottom-left-cell-id';
$cell3->attributes = array('class' => 'bottom-left-cell-class');
$cell3->text = 'Bottom Left';
$cell4 = new html_table_cell();
$cell4->id = 'bottom-right-cell-id';
$cell4->attributes = array('class' => 'bottom-right-cell-class');
$cell4->text = 'Bottom Right';
$row2 = new html_table_row();
$row2->cells = array($cell3, $cell4);
$row2->id = 'row2-id';
$row2->attributes = array('class' => 'row2-class');
