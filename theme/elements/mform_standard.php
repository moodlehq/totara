...
class standard_form_elements extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('selectwithlink', 'selectwithlinkfield', 'Select with link', array(1 => 'One', 2 => 'Two', 3 => 'Three'), null, array('link' => $CFG->wwwroot.'/path/of/url.php', 'label' => 'A label'));
