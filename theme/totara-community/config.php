...
$THEME->sheets = array('jquery-ui-1.7.2.custom','styles_totara_community');
...
$THEME->parentsheets = array('jquery-ui-1.7.2.custom','jquery.treeview','styles_menu','styles_page','styles_buttons','styles_totara','styles_totara_common');
