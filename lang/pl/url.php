...
/**
 * Strings for component 'url', language 'pl', branch 'MOODLE_22_STABLE'
 *
 * @package   url
...
$string['popupheightexplain'] = 'Określ domyślną wysokość wyskakującego okna.';
$string['popupwidth'] = 'Szerokość okna popup (w pikselach)';
$string['popupwidthexplain'] = 'Określ domyślną szerokość wyskakującego okna.';
$string['printheading'] = 'Wyświetl nazwę adresu URL';
$string['printheadingexplain'] = 'Wyświetl adres URL powyżej treści? Niektóre typy mogą nie wyświetlać adresu URL, pomimo włączenia.';
$string['printintro'] = 'Wyświetl opis adres URL';
$string['printintroexplain'] = 'Wyświetl adres URL poniżej treści? Niektóre typy mogą nie wyświetlać adresu URL, pomimo włączenia.';
