...
/**
 * Strings for component 'block', language 'pl', branch 'MOODLE_22_STABLE'
 *
 * @package   block
...
$string['defaultregion'] = 'Domyślny region';
$string['defaultweight'] = 'Domyślna waga';
$string['moveblockhere'] = 'Przesuń blok tutaj';
...
$string['region'] = 'Obszar';
$string['restrictpagetypes'] = 'Ogranicz do tych typów stron';
...
$string['subpages'] = 'Specyficzna podstrona';
$string['thisspecificpage'] = 'Ta specyficzna strona';
$string['undockall'] = 'Odłącz wszystkie';
$string['undockitem'] = 'Odłącz tą pozycję';
