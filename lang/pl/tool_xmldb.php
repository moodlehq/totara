...
/**
 * Strings for component 'tool_xmldb', language 'pl', branch 'MOODLE_22_STABLE'
 *
 * @package   tool_xmldb
...
$string['checkoraclesemantics'] = 'Sprawdź semantykę';
...
$string['filenotwriteable'] = 'Plik nie zapisywalny';
$string['generate_all_documentation'] = 'Cała dokumentacja';
...
$string['textincorrectlength'] = 'Nieprawidłowa długość pola tekstowego';
$string['up'] = 'Do góry';
$string['view'] = 'Zobacz';
