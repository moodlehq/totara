...
/**
 * Strings for component 'enrol_paypal', language 'pl', branch 'MOODLE_22_STABLE'
 *
...
$string['cost'] = 'Koszt rejestracji';
$string['costerror'] = 'Koszt rejestracji nie jest numeryczny';
