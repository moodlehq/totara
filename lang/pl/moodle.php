...
/**
 * Strings for component 'moodle', language 'pl', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['availability_help'] = 'Ta opcja określa, czy kurs będzie widoczny na liście kursów. Poza nauczycielami i administratorami, użytkownicy nie są uprawnieni do wejścia na kurs';
...
$string['backupmissinguserinfoperms'] = '';
...
$string['courseapprovedemail2'] = 'Twoje żądanie utworzenia kursu {$a->name} zostało zatwierdzone. Aby uzyskać dostęp do nowego kursu kliknij na link: {a->url}';
...
$string['coursecompletions'] = 'Ukończenia kursów';
...
$string['coursehelpcategory'] = 'Umieszcza kurs na liście kursów i może ułatwić uczestnikom znalezienie go.';
...
$string['coursehelpnewsitemsnumber'] = 'Liczba ostatnich elementów wyświetlanych na stronie głównej kursu w polu wiadomości u dołu z prawej strony <br/>(0 oznacza, że wiadomości nie będą wyświetlane).';
$string['coursehelpnumberweeks'] = 'Liczba tematów/tygodni wyświetlana na głównej stronie kursu.';
$string['coursehelpshowgrades'] = 'Włącz wyświetlanie dziennika ocen. Nie zapobiegnie to wyświetlaniu ocen w ramach poszczególnych czynności.';
$string['coursehidden'] = 'Ten kurs jest obecnie niedostępny dla studentów';
$string['courseinfo'] = 'Informacje o kursie';
$string['courselegacyfiles'] = 'Pliki kursu';
...
$string['courserequestdetails'] = 'Szczegóły kursu, który chcesz zamówić';
...
$string['editsettings'] = 'Ustawienia';
...
$string['expirynotify'] = 'Powiadomienie o wygaśnięciu uczestnictwa w kursie';
...
$string['forcedmodeinbrackets'] = '{$a} (tryb wymuszony)';
...
$string['gd1'] = 'Biblioteka GD 1.x jest zainstalowana';
$string['gd2'] = 'Biblioteka GD 2.x jest zainstalowana';
$string['gdneed'] = 'Biblioteka GD musi być zainstalowana oby można było oglądać wykresy.';
$string['gdnot'] = 'Biblioteka GD nie jest zainstalowana';
...
$string['groupextendenrol'] = 'Rozszerz rejestrację (wspólną)';
...
$string['hidetopicfromothers'] = 'Ukryj temat';
$string['hideweekfromothers'] = 'Ukryj tydzień';
...
$string['layouttable'] = 'Tabela układu';
...
$string['localplugindeleteconfirm'] = 'Zamierzasz całkowicie usunąć lokalną wtyczkę \'{$a}\'. To działanie całkowicie usunie z bazy danych wszystko co było z nią powiązane. Czy na pewno chcesz kontynuować?';
...
$string['managecategories'] = 'Zarządzaj kategoriami';
...
$string['messageprovider:backup'] = 'Kopia zapasowa powiadomień';
...
$string['noteusercannotrolldatesoncontext'] = '<strong>Uwaga:</strong> Możliwość rzutowania dat podczas odtwarzania tej kopii zapasowej została wyłączona, ponieważ nie masz wymaganych uprawnień.';
...
$string['orphanedactivities'] = 'Porzucone aktywności';
$string['other'] = 'Inne';
...
$string['publicsitefileswarning2'] = 'Uwaga: Umieszczone tu pliki są dostępne dla każdego, kto zna (lub może zgadnąć) adres URL. Ze względów bezpieczeństwa zaleca się usuwanie wszystkich plików kopii zapasowej natychmiast po ich przywróceniu.';
$string['publicsitefileswarning3'] = 'Uwaga: Umieszczone tu pliki są dostępne dla każdego, kto zna (lub może zgadnąć) adres URL. <br />Ze względów bezpieczeństwa pliki kopii zapasowej należy zapisywać tylko w bezpiecznym folderze backupdata.';
...
$string['restorecannotassignroles'] = 'Przywracanie wymaga przypisania ról, a nie masz do tego uprawnień';
$string['restorecannotcreateorassignroles'] = 'Przywracanie wymaga utworzenia lub przypisania ról, a nie masz do tego uprawnień';
...
$string['restorecannotoverrideperms'] = 'Przywracanie wymaga zastąpienia uprawnień, a nie masz do tego uprawnień';
...
$string['restoretositeadding'] = 'Ostrzeżenie: Zamierzasz przywrócić na pierwszą stronę witryny, dodając do niej dane!';
$string['restoretositedeleting'] = 'Ostrzeżenie: Zamierzasz przywrócić na pierwszą stronę witryny, najpierw usuwając z niej dane!';
...
$string['restoreuserinfofailed'] = 'Proces przywracania zatrzymał się, ponieważ nie masz uprawnień do przywracania danych użytkownika.';
...
$string['screenreaderuse'] = 'Czytnik ekranu';
...
$string['showtopicfromothers'] = 'Pokaż temat';
$string['showweekfromothers'] = 'Pokaż tydzień';
$string['since'] = 'Od';
