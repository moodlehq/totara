...
/**
 * Strings for component 'book', language 'pl', branch 'MOODLE_22_STABLE'
 *
 * @package   book
...
$string['book:edit'] = 'Edytuj rozdziały książki';
$string['book:read'] = 'Czytaj książkę';
$string['book:viewhiddenchapters'] = 'Zobacz ukryte rozdziały książki';
...
$string['customtitles_help'] = 'Tytuły rozdziałów są automatycznie wyświetlane tylko w spisie treści.';
...
$string['numberingoptions'] = 'Dostępne opcje numeracji';
$string['numberingoptions_help'] = 'Wybierz opcje numeracji, które powinny być dostępne przy tworzeniu nowych książek.';
$string['pluginadministration'] = 'Administracja książką';
