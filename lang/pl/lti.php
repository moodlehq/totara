...
/**
 * Strings for component 'lti', language 'pl', branch 'MOODLE_22_STABLE'
 *
 * @package   lti
...
$string['accept_grades'] = 'Zaakceptuj oceny z przybornika';
$string['accept_grades_admin'] = 'Zaakceptuj oceny z przybornika';
$string['action'] = 'Akcja';
...
$string['allow'] = 'Zezwól';
$string['allowinstructorcustom'] = 'Zezwól instruktorom dodawać własne parametry';
...
$string['curllibrarymissing'] = 'Biblioteka PHP Curl musi być zainstalowany, aby używać LTI';
...
$string['imsroleadmin'] = 'Instruktor, Administrator';
$string['imsroleinstructor'] = 'Instruktor';
$string['imsrolelearner'] = 'Uczeń';
