...
$string['allowuserswitchrolestheycantassign'] = '允许无分配角色能力用户切换角色';
...
$string['calendarexportsalt'] = '日历导出 salt';
...
$string['computedfromlogs'] = '$a开始从日志中计算';
...
$string['configallowoverride2'] = '选择哪些角色可被左列中的各角色覆盖。<br />请注意，这些设置仅适用于允许 moodle/role:override 能力或 moodle/role:safeoverride 能力的用户。';
...
$string['configallowuserswitchrolestheycantassign'] = '默认情况下，需要为切换角色的用户提供 moodle/role:assign。启用此设置将消除此要求，得到仅由 \"允许角色分配\"表中的设置确定的 \"角色切换到\"下拉菜单中的角色。
建议 \"允许角色分配\"表不允许用户切换到具有超出其现有角色能力的角色。';
...
$string['configcalendarexportsalt'] = '这些随机文本用于提高日历导出所用的身份验证令牌的安全性。请注意，如果您更改了此散列 salt，则所有当前令牌都将无效。';
...
$string['configconvertformat'] = '如果 <i>latex</i>、<i>dvips</i> 和 <i>convert</i> 可用，则图像使用特定格式创建。若非如此，则将使用 mimeTeX，它将创建 GIF 图像。';
...
$string['configcourserequestnotify'] = '键入申请新课程时要通知的用户的用户名。';
$string['configcourserequestnotify2'] = '在申请课程时要通知的用户。此处仅列出可以审批课程申请的用户。';
...
$string['configdeleteincompleteusers'] = '在此阶段之后，陈旧但未完全设置的帐号将被删除。';
...
$string['configemailchangeconfirmation'] = '在用户更改其个人资料中的电子邮件地址时，需要电子邮件确认步骤。';
...
$string['configenablecalendarexport'] = '支持导出或订阅日历。';
...
$string['configenablesafebrowserintegration'] = '这将为测验设置表单的 \'浏览器安全\'字段添加\'需要安全测验浏览器\'选项。有关详细信息，请参见 http://www.safeexambrowser.org/。';
...
$string['configerrorlevel'] = '选择显示的PHP警告数目。正常通常是最佳选择。';
$string['configexcludeoldflashclients'] = '某些版本的 Adobe Flash 插件已知易受恶意 Flash 内容的攻击。您可以在此处指定支持的最低版本，Moodle 不会为使用更低版本的用户显示 Flash 文件。这些用户将看到一个替代性的 Flash 文件，告知他们如何升级。将此留空将禁用所有检查。';
$string['configexperimentalsplitrestore'] = '若启用，将检查课程备份文件中的 XML 错误，并将其分割成较小的部分，以便在恢复过程中使用。这将改进恢复的健壮性和执行时间，尤其对于中型到大型课程备份来说更是如此。';
$string['configextendedusernamechars'] = '激活这个选项将允许学生在用户名中使用任何字符(这并不会影响它们的实际名字)。缺省的情况是 \"否\"，它限制用户名只能使用英文字母和数字。';
$string['configextramemorylimit'] = '搜索、备份/恢复或 cron 等脚本需要较多的内存。请为较大的网站设置较高的值。';
...
$string['configforceloginforprofiles'] = '此设置将强制人们用实际（非访客）帐号登录，之后才能查看任何用户的个人资料。如果您禁用了此设置，则可能会发现有些用户在其个人资料中发布广告（垃圾信息）或其他不当内容，而这些垃圾信息是对所有人可见的。';
...
$string['configgetremoteaddrconf'] = '如果您的服务器处于反向代理之后，则可使用此设置指定可信任哪些 HTTP 标头包含远程 IT 地址。标头将被依次读取，使用可用的第一个标头。';
...
$string['configloglifetime'] = '这可指定保存用户活动日志的时间长短。超出此时间段的日志将被自动删除。最好是将日志保留尽量长的时间，以防您需要这些日志，但如果您的服务器非常繁忙且有性能方面的问题，您也许会希望减少保留日志的时间。建议不要使用 30 以下的值，因为统计可能无法正常工作。';
...
$string['configmycoursesperpage'] = '在任意用户自己的课程列表中显示的最大课程深度';
$string['configmymoodleredirect'] = '如果开启，则当非管理员用户登录时，直接跳转到/我的Moodle，并用/我的Moodle替换掉站点首页。';
$string['confignodefaultuserrolelists'] = '该设置阻止所有从数据库返回的用户调用get_course_user表，例如，如果默认角色可以访问站点课程。如果服务器性能不行，选中该选项即可。';
$string['confignonmetacoursesyncroleids'] = '默认所有子课程中的角色分配和元课程中同步。这里选择的角色不会包括在同步过程中。';
...
$string['configprofilesforenrolledusersonly'] = '为了避免被垃圾信息发送者滥用，尚未选修任何课程的用户的个人资料描述将被隐藏。新用户必须至少选修一门课程，之后才能添加个人资料描述。';
...
$string['configrecaptchaprivatekey'] = '您的 Moodle 服务器和 recaptcha.net 服务器之间使用字符串来通信。请访问 http://recaptcha.net，为此站点获取一个';
$string['configrecaptchapublickey'] = '字符串用于显示登录表单中的 reCAPTCHA 元素。由 http://recaptcha.net 生成';
$string['configregenloginsession'] = '出于安全方面的原因，强烈建议在每个登录请求中重新生成会话 id。此设置可能与某些身份验证插件不兼容。';
...
$string['configsendcoursewelcomemessage'] = '如果启用，用户在自行选修课程时，将通过电子邮件收到一条欢迎消息。';
$string['configsessioncookie'] = '此选项用来设定 Moodle 会话所使用的 cookie 的名称。这个选项是可选的，仅仅在一种情况下比较有用：一个站点上运行了多个 Moodle 的拷贝，要避免 cookie 发生混乱。';
$string['configsessioncookiedomain'] = '这允许您更改 Moodle cookie 可用的域名。这对于需要与其他子域中的 web 应用程序共享 Moodle 会话信息的 Moodle 自定义（例如，身份验证或选课插件）来说非常有用。<strong>警告：强烈建议将此设置保留为默认设置（空） - 不正确的值将阻止对网站的所有登录。</strong>';
...
$string['configsitemaxcategorydepth'] = '最大类别深度';
$string['configsitemaxcategorydepthhelp'] = '这指定了所示子类别的最大深度';
...
$string['configsmtphosts'] = '提供 Moodle 应用于发送邮件的一个或多个本地 SMTP 服务器的全名（例如 \'mail.a.com\'或 \'mail.a.com;mail.b.com\'）。要指定非默认端口（也就是说，端口 25 以外的端口），您可以使用 [服务器]:[端口] 语法（例如 \'mail.a.com:587\'）。如果您将其保留为空，Moodle 将使用 PHP 默认方法发送邮件。';
...
$string['configstatsmaxruntime2'] = '统计工作是很耗时的，因此指定一天中统计的最长时间，在一个 cron 中执行的最长天数是 31 天。';
$string['configstatsmaxruntime3'] = '指定允许的一天中计算统计的最长时间，请牢记，统计处理会给服务器造成沉重负载。一个 cron 中执行的最长天数可在下方指定。';
$string['configstatsruntimedays'] = '指定各统计执行中处理的最大天数。在统计数据最新时，仅会处理一天，因此请根据您的服务器负载调整这个值，若需要较短的 cron 执行时间，请减小这个值。';
...
$string['configstripalltitletags'] = '取消选择此设置，允许活动和资源名称中使用 HTML 标签。';
...
$string['configverifychangedemail'] = '支持使用允许的和拒绝的电子邮件域名设置验证更改后的电子邮件地址。如果禁用了此设置，则创建新用户时将强制使用域名。';
...
$string['convertformat'] = '<i>转换</i>输出格式';
...
$string['courserequestnotify'] = '课程申请通知';
$string['courserequestnotifyemail'] = '用户 $a->user 通过 $a->link 申请了一个新课程';
$string['courserequests'] = '课程申请';
$string['courserequestspending'] = '待核准的课程申请';
$string['courses'] = '课程';
...
$string['ctyperecommended'] = '我们强烈建议您安装可选的 ctype PHP 扩展，特别是您的站点支持非拉丁语系的语言时，它可以大大提升系统性能。';
$string['ctyperequired'] = 'Moodle 目前要求使用 ctype PHP 扩展，以便提高网站性能，并实现多语言兼容性。';
$string['curlrecommended'] = '为了使用Moodle网络功能，需要安装Curl库。';
$string['customcheck'] = '其他检查';
$string['datarootsecurityerror'] = '<p><strong>安全警告！</strong></p><p>您的数据根目录位于错误的位置，并对 Web 公开。这意味着世界上的任何人都能看到您的全部私有文件，其中的某些文件可能会被攻击者利用，以获得对您的网站的未经授权的管理访问权限！</p>
<p>您<em>必须</em>将数据根目录 ($a) 移动到一个不在公共 web 目录中的新位置，并相应地在 config.php 中更新 <code>\$CFG->dataroot</code> 设置。</p>';
...
$string['deleteincompleteusers'] = '之后删除不完整的用户';
$string['deleteunconfirmed'] = '之后删除未完全设置的用户';
...
$string['displayerrorswarning'] = '建议不要在生产站点上启用 PHP 设置 <em>display_errors</em>，因为错误消息可能会显示有关您的服务器的敏感信息。';
...
$string['emailchangeconfirmation'] = '电子邮件更改确认';
$string['emoticons'] = '表情';
...
$string['enablesafebrowserintegration'] = '启用安全测验浏览器集成';
...
$string['everyonewhocan'] = '可以 \'$a\'的所有人';
$string['excludeoldflashclients'] = '需要的 Flash 播放器版本';
$string['experimental'] = '试验性功能';
$string['experimentalsplitrestore'] = '试验性分割恢复';
$string['extendedusernamechars'] = '允许在用户名中使用扩展字符';
$string['extramemorylimit'] = '其他 PHP 内存限制';
...
$string['gdrecommended'] = 'GD 扩展用于转换图像，若缺失，则用户个人资料图像等部分功能将无法使用。';
$string['gdversion'] = 'GD版本';
$string['generalsettings'] = '一般设置';
$string['geoipfile'] = 'GeoIP City数据文件';
$string['getremoteaddrconf'] = '登录 IP 地址源';
...
$string['globalswarning'] = '<p><strong>安全警告！</strong></p><p>为保证正常工作，Moodle 需要<br />您对当前的 PHP 设置做出一些修改。</p><p>您<em>必须</em>设置 <code>register_globals=off</code>。</p><p>此设置通过编辑 <code>php.ini</code>、Apache/IIS <br />配置或 <code>.htaccess</code> 文件加以控制。</p>';
...
$string['importtimezonescount'] = '从$a-source中导入$a->count项';
...
$string['intlrecommended'] = 'Intl 扩展用于改善国际化支持，例如支持语言区域的排序。';
...
$string['langimportdisabled'] = '语言导入功能已被禁用。您必须在文件系统级手动更新语言包。';
...
$string['mediapluginogg'] = '过滤 .ogg 文件';
$string['mediapluginogv'] = '过滤 .ogv 文件';
...
$string['mediapluginyoutube'] = '过滤 YouTube 链接';
...
$string['misc'] = '杂项';
$string['missinglangparent'] = '<em>$a->lang</em> 的父语言 <em>$a->parent</em> 缺失。';
$string['mnetrestore_extusers'] = '<strong>注意：</strong> 这个备份文件包含远程Moodle网络的使用者帐号，该帐号将做在处理过程中存储。';
$string['mnetrestore_extusers_admin'] = '<strong>注意：</strong>这个备份文件似乎来自不同的 Moodle 安装，包含远程 Moodle 网络用户帐号。恢复过程将尝试为创建的全部用户匹配 Moodle 网络主机。不匹配的用户将自动切换到内部身份验证（而非 mnet）。恢复日志将为您提供相关信息。';
...
$string['mnetrestore_extusers_noadmin'] = '<strong>注意：</strong>这个备份文件似乎来自不同的 Moodle 安装，包含远程 Moodle 网络用户帐号。不允许执行此类恢复。请联系网站管理员或者恢复无任何用户信息（模块、文件等）的课程';
$string['mnetrestore_extusers_switchuserauth'] = '远程 Moodle 网络用户 $a->username（来自 $a->mnethosturl）已切换到本地 $a->auth 身份验证的用户。';
...
$string['mycoursesperpage'] = '最大课程数';
$string['mymoodle'] = '我的Moodle';
$string['mymoodleredirect'] = '强制用户使用“我的 Moodle”';
...
$string['php533warning'] = '建议使用 PHP 5.3.3 及更高版本';
$string['phpfloatproblem'] = '处理 PHP 浮点数时检测到意外问题 - $a';
...
$string['profileconfirmfielddeletion'] = '$a用户记录字段将会删除<br />您是否希望删除该字段。';
...
$string['profiledefaultchecked'] = '默认选中';
...
$string['profilefieldtypecheckbox'] = '选择框';
...
$string['profilesforenrolledusersonly'] = '仅选课用户的个人资料';
...
$string['regenloginsession'] = '在登录过程中重新生成会话 id';
...
$string['sessioncookiedomain'] = 'Cookie 域';
...
$string['simplexmlrequired'] = 'Moodle 现需要 SimpleXML PHP 扩展。';
...
$string['soaprecommended'] = '安装可选 soap 扩展对于 Web 服务和某些 contrib 模块来说非常有用。';
$string['spamcleaner'] = '垃圾信息清除器';
$string['splrequired'] = 'Moodle 现需要 SPL PHP 扩展。';
$string['stats'] = '统计';
$string['statscatdepth'] = '最大父类别数';
$string['statsfirstrun'] = '最长的处理间隔';
$string['statsmaxruntime'] = '最长运行时间';
$string['statsruntimedays'] = '处理天数';
...
$string['stripalltitletags'] = '从所有活动名称中删除 HTML 标签';
...
$string['upgrade197notice'] = '<p>Moodle 1.9.7 包含对用户密码和备份的多项安全修复，以保护您的网站中的用户数据。因而，您的某些与备份相关的设置和权限可能已更改。<br />
有关详细信息，请参见 <a href=\"http://docs.moodle.org/en/Moodle_1.9.7_release_notes\" target=\"_blank\">Moodle 1.9.7 发行说明</a>。</p>';
$string['upgrade197noticesubject'] = 'Moodle 1.9.7 升级安全通知';
$string['upgrade197salt'] = '为了降低密码被窃的风险，我们强烈建议您设置密码 salt。<br />有关详细信息，请参见<a href=\"$a\" target=\"_blank\">密码 salting 文档</a>。';
...
$string['usersweakpassword'] = '使用弱密码的用户';
...
$string['verifychangedemail'] = '在更改电子邮件时限制域名';
...
$string['xmlrpcrecommended'] = '集线器通信需要 xmlrpc 扩展，这对 Web 服务和 Moodle 网络都非常有用';
$string['xmlstrictheaders'] = 'XML strict headers';
$string['ziprequired'] = 'Moodle 现需要 Zip PHP 扩展，不再使用 info-ZIP 二进制文件或 PclZip 库。';
