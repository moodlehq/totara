...
$string['errversionsave'] = '很抱歉，在您修改这个页面时有人已经对其进行了修改。请将您所做的修改复制到剪贴板上并返回前一页，然后重新载入它并修改。';
$string['ewikiacceptbinary'] = '允许二进制文件';
$string['ewikiprinttitle'] = '是否在每个页面上显示Wiki名称';
$string['export'] = '导出';
...
$string['pagelocked'] = '<p><strong> $a->name 正在编辑此页面。</strong> 他们在 $a->since 开始编辑，而且窗口始终打开着直到 $a->seen 为止。</p><p>您在编辑此页面之前必须等待他们完成。</p>';
...
$string['save'] = '保存';
$string['savenolock'] = '您无法保存页面，因为您没有编辑锁。如果您的浏览器关闭了Javascript，或者其他用户覆盖了您的锁，那么就可能会发生这种事。<br />您可以使用浏览器的\'后退\'按钮返回到前一个页面，并且复制任何您做过修改的文本，然后再重新编译。';
...
$string['uplerror'] = '很抱歉，在上传文件的过程中发生错误。';
