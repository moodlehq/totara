...
$string['createnewcategories'] = '建立一个新的（隐藏的）课程种类如果没有在Moodle中找到';
$string['createnewcourses'] = '建立一个新的（隐藏的）课程如果没有在Moodle中找';
$string['createnewusers'] = '为还没有在Moodle中注册的用户建立用户帐号';
$string['cronfrequency'] = '处理频率';
$string['deleteusers'] = '删除用户帐号当其列入IMS数据';
$string['description'] = '这个方法将重复的检测和处理在本地的您指定的特殊格式的文本文件。文件必须遵守<a href=\'../help.php?module=enrol/imsenterprise&file=formatoverview.html\' target=\'_blank\'>IMS计划规范</a>包括人，组，和团体的XML原理';
