...
$string['adminhelpassigncreators'] = '课程创建者可以创建新的课程';
...
$string['backupfromthissite'] = '已在此站点上进行了备份？';
$string['backupgradebookhistoryhelp'] = '若启用，成绩簿历史记录将包含在自动化备份中。请注意，若要进行此操作，则不得在服务器设置 (disablegradehistory) 中禁用成绩历史记录';
...
$string['backupmissinguserinfoperms'] = '备注：此备份不包含任何用户数据。备份中将不包含作业和互动评价活动，因为这些模块与此类型备份不兼容。';
$string['backupnoneusersinfo'] = '备注：此备份不包含任何用户数据，因此所有活动已切换至\"无用户数据\"模式。备份中将不包含作业和互动评价活动，因为这些模块与此类型备份不兼容。';
...
$string['categorycontents'] = '子类别与课程';
$string['categorydeleted'] = '已经删除类别 \'$a\'';
$string['categoryduplicate'] = '\'$a\'类别已经存在!';
$string['categorymodifiedcancel'] = '类别已修改！请取消并重试。';
...
$string['clamlostandactinglikevirus'] = '此外，Moodle 当前已配置，因此，如果 clam 运行失败，系统将会以对待病毒的方式来处理所有文件。这意味着在错误被修复前，学生们不能成功上传任何文件。';
...
$string['coursecompletiondata'] = '课程完成数据';
$string['coursecompletions'] = '课程完成';
$string['coursecreators'] = '课程创建者';
$string['coursecreatorsdescription'] = '课程创建者可以创建新的课程。';
$string['coursedeleted'] = '已删除的课程 $a';
$string['coursefiles'] = '课程文件';
$string['courseformatdata'] = '课程数据格式';
$string['courseformats'] = '课程格式';
$string['coursegrades'] = '课程成绩';
$string['coursehelpcategory'] = '在课程列表中定位课程，以便于学生查找。';
$string['coursehelpformat'] = '课程主页将以此格式显示。';
$string['coursehelpnumberweeks'] = '课程主页上显示的周/主题数。';
$string['coursehelphiddensections'] = '如何向学生显示课程中的隐藏部分。';
$string['coursehelpnewsitemsnumber'] = '显示在课程主页上的最近项目数，位于右侧下方的新闻框中<br/>（0 表示新闻框不显示）
。';
$string['coursehelpshowgrades'] = '启用成绩簿的显示。不阻止成绩在个人活动中显示。';
$string['coursehelpmaximumupload'] = '定义此课程中可以上传的最大文件大小，受网站级设置限制。';
$string['coursehelpmetacourse'] = '将课程设置为元课程。元课程的选修（及其他角色指定）来自 \"子\"课程或多个课程。';
...
$string['coursereasonforrejectingemail'] = '将通过电子邮件发送给申请人';
...
$string['courserequestdetails'] = '所申请课程的详细信息';
...
$string['courserequestsupport'] = '帮助管理员评估申请的支持信息';
$string['courserestore'] = '课程恢复';
$string['courses'] = '课程';
$string['coursescategory'] = '同一类别的课程';
$string['coursesettings'] = '课程默认设置';
$string['coursesmovedout'] = '课程已从 $a 移出';
...
$string['creatingconditionalavailabilitydata'] = '创建条件可用性数据';
$string['creatingcoursecompletiondata'] = '创建课程完成数据';
...
$string['deleteallcannotundo'] = '全部删除 - 不可恢复';
$string['deleteallcomments'] = '删除所有评论';
$string['deleteallratings'] = '删除所有等级';
$string['deletecategory'] = '删除类别：$a';
$string['deletecategorycheck'] = '您确定要完全删除类别<b> \' $a\'</b>么?<br />此类别中的所有课程将会被移动到父类别或类别 \'五花八门\'中。';
$string['deletecategorycheck2'] = '如果您删除此类别，需要选择对课程及其包含的子类别执行的操作。';
$string['deletecategoryempty'] = '此类别为空。';
...
$string['donotask'] = '不要问';
$string['donotclickcontinue'] = '不要点击以下继续链接 ;-)';
$string['down'] = '向下';
...
$string['editortoggle'] = '切换高级文本编辑模式';
...
刚才您用您的电子邮箱地址在 \'$a->sitename上\'申请了一个新帐号。
...
$string['enrolmentnewuser'] = '$a->user已经选择了 \'$a->course\'课程';
$string['enrolmentnointernal'] = '手工选课目前并未激活';
$string['enrolmentnotyet'] = '很抱歉，在$a之前您不能访问此课程';
...
$string['expirynotifystudentsemail'] = '尊敬的 $a->studentstr：';
$string['expirythreshold'] = '课程到期后期限';
$string['explanation'] = '解释';
$string['extendenrol'] = '延长选课（个别）';
$string['groupextendenrol'] = '延长选课（通用）';
...
$string['flashlinkmessage'] = '请立即升级您的 Flash 播放器：';
$string['flashupgrademessage'] = " 播放此内容需要 Flash 插件，您的版本太旧。\n\n请注销并在升级后再登录。";
$string['folder'] = '文件夹';
...
$string['forcepasswordchangecheckfull'] = '确实要将密码强制修改为 $a 吗？';
$string['forcepasswordchangehelp'] = '在用户下次登录时提示其修改';
$string['forcepasswordchangenot'] = '无法将密码强制修改为 $a';
...
$string['gpl'] = '版权所有 (C) 2010, 2011 Totara Learning Solutions LTD (http://www.totaralms.com)
版权所有 (C) 1999 onwards  Martin Dougiamas  (http://moodle.com)

该程序是免费软件；您可以按照免费软件基金会所公布
的 GNU 通用公共许可证 (GPL) 进行修改
或重新发布该软件；许可证可以是第 2 版，
或更新的版本。

发布该软件是希望它有用有益，
但不提供任何形式的担保，不论是明示的还是隐含的担保，
包括但不限于适销性和特定目的适用性的隐含保证。
有关详细信息，请参见 GNU 通用公共许可证。

您应该已随此程序收到一份 GNU 通用公共许可证
的副本。若没有，请访问 http://www.gnu.org/licenses/
';
$string['grade'] = '成绩';
$string['grades'] = '成绩';
$string['group'] = '小组';
...
$string['hiddenfromstudents'] = '学生隐藏';
...
$string['hitsoncoursetoday'] = '今天用户 $a->username浏览了 $a->coursename';
$string['home'] = '回到首页';
$string['hour'] = '小时';
$string['hours'] = '小时';
...
$string['manageruser'] = '管理者用户';
$string['manageruserdescription'] = '管理者可以管理其他用户。';
...
$string['missingrecaptchachallengefield'] = 'reCAPTCHA 质询字段没填';
...
$string['moreprofileinfoneeded'] = '请告诉我们有关您自己的详细信息';
$string['mostrecently'] = '最近';
$string['move'] = '移动';
$string['movecategoryto'] = '移动类别到:';
$string['movecategorycontentto'] = '移动到';
$string['movecontentstoanothercategory'] = '将内容移动到另一类别';
...
$string['noteusercannotrolldatesoncontext'] = '<strong>注意：</strong>在恢复此备份时滚动日期的能力已禁用，因为您没有必需的权限。';
$string['noteuserschangednonetocourse'] = '<strong>注意：</strong>恢复用户数据（活动、文件或消息中的数据）时课程用户也需要恢复。已为您更改了此设置。';
...
$string['passwordreused'] = '这个密码此前已经使用过，不允许再次使用';
...
$string['pluginchecknotice'] = '下表显示了在当前 Moodle 中检测到的已安装模块、版块和过滤插件；
它们指出了哪些插件是标准的，哪些不是。在继续此 Moodle 升级之前应检查所有非标准插件，并将其升级到
最新的版本。';
...
$string['policyagreementclick'] = '链接到网站策略协议';
$string['popup'] = '弹出';
...
$string['profile'] = '信息概要';
$string['profilenotshown'] = '在此人选修至少一门课程之后，才会显示此信息概要说明。';
...
$string['publicsitefileswarning2'] = '注意：任何知道（或者能猜出）URL 的人都能访问存放于此的文件。出于安全方面的原因，建议在恢复之后立即删除所有备份文件。';
$string['publicsitefileswarning3'] = '注意：任何知道（或者能猜出）URL 的人都能访问存放于此的文件。<br />出于安全方面的原因，只能将备份文件保存在安全的备份数据文件夹中。';
$string['question'] = '试题';
$string['questionsinthequestionbank'] = '试题库中的试题';
...
$string['restorecannotassignroles'] = '恢复需要指定角色，您没有执行此操作的权限';
$string['restorecannotcreateorassignroles'] = '恢复需要创建或指定角色，您没有执行此操作的权限';
$string['restorecannotcreateuser'] = '恢复需要从备份文件创建用户 \'$a\'，您没有执行此操作的权限';
$string['restorecannotoverrideperms'] = '恢复需要覆盖权限，您没有执行此操作的权限';
$string['restorecoursenow'] = '恢复课程';
$string['restoredaccount'] = '已恢复的帐号';
$string['restoredaccountinfo'] = '此帐号是从另一台服务器导入的，密码已经丢失。要通过电子邮件设置一个新密码，请单击 \"继续\"';
$string['restorefinished'] = '恢复成功';
$string['restoreto'] = '恢复到';
$string['restoretositeadding'] = '警告：您将恢复到站点首页，为其添加数据！';
$string['restoretositedeleting'] = '警告：您将恢复到站点首页，请首先删除其中的数据！';
$string['restoreuserconflict'] = '尝试从备份文件恢复用户 \'$a\'将会导致冲突';
$string['restoreuserinfofailed'] = '恢复过程已停止，因为您没有恢复用户数据的权限。';
$string['restoreusersprecheck'] = '检查用户数据';
$string['restoreusersprecheckerror'] = '检查用户数据时检测到一些问题';
...
$string['scalestip2'] = '要创建自定义等级，请单击课程管理菜单中的“成绩”链接，随后依次选择“编辑”、“等级”。';
$string['schedule'] = '时间表';
...
$string['selectednowmove'] = '$a个文件被选定。现在请前往目的地址点击 \'移动文件到这里\'';
...
$string['showthishelpinlanguage'] = '使用以下语言显示此帮助：$a';
$string['since'] = '开始时间';
...
$string['thiscategorycontains'] = '此类别包括';
...
$string['uploadnotempdir'] = '缺少临时文件夹';
...
$string['welcometocoursetext'] = '欢迎进入 $a->coursename！

如果您还没有这样做，请编辑您的个人资料页面，这样，我们能够进一步了解您的情况：

  $a->profileurl';
$string['whattocallzip'] = '如何命名该zip文件?';
$string['whattodo'] = '要做什么';
...
$string['writingblogsinfo'] = '写入博客信息';
$string['writingcategoriesandquestions'] = '写入类别及问题';
$string['writingcompetencyevidenceinfo'] = '写入能力证明信息';
