...
$string['cannotadddiscussionall'] = '您无权限为所有参加者添加新讨论。';
$string['cannotdeletepost'] = '您无法删除此帖！';
$string['cleanreadtime'] = '在旧帖中标记阅读时间';
$string['completiondiscussions'] = '用户必须创建讨论：';
$string['completiondiscussionshelp'] = '需要讨论才能完成';
$string['completiondiscussionsgroup'] = '需要讨论';
$string['completionposts'] = '用户必须发帖讨论或回复：';
$string['completionpostshelp'] = '需要讨论或回复才能完成';
$string['completionpostsgroup'] = '需要发帖';
$string['completionreplies'] = '用户必须发帖回复：';
$string['completionreplieshelp'] = '需要回复才能完成';
$string['completionrepliesgroup'] = '需要回复';
$string['configajaxrating'] = 'AJAX 评分是论坛评分方法的改进。如果启用，用户几乎可以即时评价论坛帖子，而无需滚动到页面底部并点击 \'发送我的最新评级\'按钮。此设置还需要对该网站和用户资料启用 AJAX。';
...
$string['confirmsubscribe'] = '您确实要订阅论坛 \'$a\'吗？';
$string['confirmunsubscribe'] = '您确实要退订论坛 \'$a\'吗？';
...
$string['nameteacher'] = '教师讨论区'; //depreciated after 1.7
...
<p>如果需要，可以在 $a 内修改它。</p>';
$string['postaddedsuccess'] = '您的帖子已经成功添加。';
$string['postaddedtimeleft'] = '如果需要进行任何更改，可以使用 $a 对其进行编辑。';
...
$string['unsubscribeall'] = '退订所有的论坛';
$string['unsubscribeallconfirm'] = '您现已订阅 $a 论坛。确实要退订所有的论坛并禁用论坛自动订阅吗？';
$string['unsubscribealldone'] = '您所有的论坛订阅都已删除，您可能仍会收到来自强制订阅论坛的通知。如果您不希望收到来自此服务器的任何电子邮件，请转到您的资料并禁用电子邮件地址。';
$string['unsubscribeallempty'] = '对不起，您未订阅任何论坛。如果您不希望收到来自此服务器的任何电子邮件，请转到您的资料并禁用电子邮件地址。';
