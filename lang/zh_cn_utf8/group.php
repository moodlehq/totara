...
$string['errorselectone'] = '请在选择此选项之前选择一个组';
$string['errorselectsome'] = '请在选择此选项之前选择一个或多个组';

$string['groupings'] = '班';
$string['grouping'] = '班';
$string['groups'] = '组';
$string['group'] = '组';
$string['groupsinselectedgrouping'] = '班中的组'; //'selected grouping'
...
$string['groupname'] = '组名';
$string['groupnameexists'] = '组名$a在课程中存在，请改为其他名称。';
...
$string['groupingsonly'] = '仅班';
$string['groupsonly'] = '仅组';
