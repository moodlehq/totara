...
$string['correctfeedback'] = '针对任何正确答案';
$string['editingmultichoice'] = '编辑多项选择题';
$string['errfractionsaddwrong'] = '您选择的实际成绩不会达到 100%%<br />取而代之是 {$a}%%';
$string['errfractionsnomax'] = '至少有一个答案应该是 100%%，这样才能在这道问题中得到满分。';
$string['feedback'] = '反馈';
$string['fillouttwochoices'] = '您必须至少填写两个选项。留空的选项不会被使用。';
