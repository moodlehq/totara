...
$string['admincronsetup'] = 'cron.php 维护脚本已至少 24 小时未运行。<br />必须启用 Cron 才能使用预定获取功能。<br /><b>启用</b> \'Authorize.net 插件\'并正确<b>设置 cron</b>，或再次<b>取消选中 an_review</b>。<br />如果禁用预定获取功能，交易将被取消，除非您在 30 天内进行检查。<br />选中 <b>an_review</b>并向 <b>an_capture_day</b> 字段中输入 \'0\'<br />才能在 30 天内<b>手动</b>接受/拒绝支付。';
$string['adminemailexpired'] = '这有助于 \'手动获取\'。管理员会在待定订单过期前 <b>$a</b> 天收到通知。';
