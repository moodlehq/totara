...
$string['displayleftif'] = '仅在成绩高于以下值时显示左侧目录：';
...
$string['essay'] = '问答题';
$string['essayemailmessage'] = '<p>下文提示:<blockquote>$a->question</blockquote></p><p>您的回答:<blockquote><em>$a->response</em></blockquote></p><p>$a->teacher的评论:<blockquote><em>$a->comment</em></blockquote></p><p>您已经收到 $a->outof 个这个短文试题中的 $a->earned .</p><p>您这课的分数已经被修改到 $a->newgrade%%.</p>';
...
$string['leftduringtimed'] = '您在一个计时的课程期间离开了。<br/>请点击继续来重启课程。';
...
$string['ongoingnormal'] = '您在已浏览的 $a->viewed 个问题中回答正确了$a->correct个试题。';
$string['or'] = '或';
$string['ordered'] = '已排序的';
$string['other'] = '其它';
$string['outof'] = '超出 $a';
...
$string['slideshowbgcolor'] = '幻灯片背景色';
$string['slideshowheight'] = '幻灯片高度';
$string['slideshowwidth'] = '幻灯片宽度';
$string['startlesson'] = '开始专题讨论';
$string['studentattemptlesson'] = '$a->firstname $a->lastname的尝试次数 $a->attempt';
