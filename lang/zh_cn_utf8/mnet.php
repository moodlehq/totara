...
$string['trustedhostsexplain']          = '<p>信任主机机制允许具体的主机通过XML-RPC执行到其他Moodle API端口的调用。可以利用脚本控制Moodle行为，激活它也可能事非常危险的，如果有什么疑问，可以将其关闭。</p>
...
$string['allhosts_no_options']          = '在查看多个主机时，没有选项可用';
...
$string['nolocaluser2'] = '无远程用户的本地记录，也无法创建这些记录，因为此主机不会自动创建用户。请与您的管理员联系！';
...
$string['authmnetdisabled'] = 'Moodle 网络<em>身份验证插件</em><strong>已禁用</strong>。';
...
$string['host'] = '主机';
$string['loginlinkmnetuser'] = '<br />如果您是 Moodle 网络远程用户，可以<a href=\"$a\">在此处确认您的电子邮件地址</a>，您可能会重新定向到登录页面。<br />';
$string['mnetidprovider'] = 'MNET ID 提供商';
$string['mnetidprovidermsg'] = '您应能够在 $a 提供商处登录。';
$string['mnetidproviderdesc'] = '只要您能提供与之前尝试登录的用户名匹配的正确电子邮件地址，就可以利用这种机制来检索可登录的链接。';
$string['mnetidprovidernotfound'] = '抱歉，无法找到更多信息。';
