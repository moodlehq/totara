...
$string['course:changefullname'] = '更改课程全名';
$string['course:changeshortname'] = '更改课程简称';
$string['course:changeidnumber'] = '更改课程 ID 号';
$string['course:changecategory'] = '更改课程类别';
$string['course:changesummary'] = '更改课程摘要';
...
$string['course:markcomplete'] = '标记用户完成';
$string['course:request'] = '请求新课程';
...
$string['deleterolesure'] = '您确定要删除角色 \"$a->name ($a->shortname)\"？</p><p>当前此角色已经分配給$a->count个用户了。';
...
$string['legacy:manager'] = '旧版角色：管理者';
...
$string['safeoverridenotice'] = '备注：具有更高风险的功能被锁定，因为您仅获准修改安全功能。';
...
$string['userhashiddenassignments'] = '此用户在本课程中具有一个或多个隐藏角色分配';
$string['userswithrole'] = '所有具有角色的用户';
$string['viewrole'] = '浏览角色详细信息';
$string['xuserswiththerole'] = '具有 \"$a->role\"角色的用户';
$string['ingroup'] = '在 \"$a->group\"组中';
$string['inactiveformorethan'] = '无活动已超过 $a->timeperiod';
