...
$string['assignmentmail'] = '$a->teacher已经在 \'$a->assignment\'中为您提交的作业写了反馈意见。
您可以在您交的作业后面看到反馈意见：
...
$string['emailstudents'] = '用 E-mail 提醒学生';
$string['emailteachermail'] = '$a->username 更新了他为作业 \'$a->assignment\'提交的内容。新内容位于:

$a->url';
$string['emailteachermailhtml'] = '$a->username 更新了其作业<i> \'$a->assignment\'</i>。<br /><br />新的内容位于<a href=\"$a->url\">Web 服务器</a>上。';
$string['emailteachers'] = '是否使用 E-mail 提醒教师';
$string['emptysubmission'] = '您尚未提交任何内容';
$string['enableemailnotification'] = '发送 E-mail 通知';
...
$string['hideintro'] = '在作业开始提交前隐藏作业说明';
$string['itemstocount'] = '数目';
$string['late'] = '$a 之后';
...
$string['usernosubmit'] = '抱歉，不允许您提交作业。';
