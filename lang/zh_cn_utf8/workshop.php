...
$string['assessmentofresubmission'] = '这是一个对修正部分工作的评价。<br />这个表单已经利用您上一个评分和评价填充。 <br />请在查看修改的工作后重新修正这些。';
...
$string['examplesubmissions'] = '提交样例';
$string['excellent'] = '优秀';
...
$string['hidegradesbeforeagreement'] = '评分前隐藏分数';
$string['hidenamesfromstudents'] = '隐藏 $a 姓名';
...
$string['mail1'] = '您的评价 \'$a\'已经被评分';
$string['mail10'] = '您可以在您的专题讨论中评价它';
$string['mail2'] = '评论和成绩能在互动评价作业 $a 中看到。';
$string['mail3'] = '您能在您的互动评价作业中看到';
$string['mail4'] = '评论被添加到作业 $a 由';
$string['mail5'] = '新的评论能在互动评价作业 \'$a\'中看到';
$string['mail6'] = '您对作业 \'$a\'的评价已经被复审';
$string['mail7'] = '给 $a 的评论能在专题讨论作业中看到';
$string['mail8'] = '作业 $a 是一个修改部分的工作。';
$string['mail9'] = '请在互动评价作业 $a 中评定它';
$string['managingassignment'] = '管理互动评价';
$string['maximum'] = '最大的';
...
$string['nosubmissionsavailableforassessment'] = '没有提交的作业可供评价';
$string['notallowed'] = '您现在不允许在这个页面';
$string['notavailable'] = '没有';
$string['notenoughexamplessubmitted'] = '没有足够的样例提交';
...
$string['nowork'] = '提交时期现在已经结束。<br/>您没有提交任何工作。';
...
$string['numberofattachments'] = '提交作业的附件框数目';
...
$string['overallocation'] = '额外分配标准';
$string['overallpeergrade'] = '全部同学评分： $a ';
$string['overallteachergrade'] = '全部教师评分： $a ';
$string['ownwork'] = '特有工作';
$string['passmnts'] = '同伴<br/>评价';
$string['passwordprotectedworkshop'] = '密码保护的互动评价';
...
$string['pleaseassessyoursubmissions'] = '请评价您的提交';
$string['poor'] = '差';
$string['present'] = '当前';
...
$string['saveoverallocation'] = '保存过高的分配';
...
$string['sgrade'] = '提交作业评分';
$string['showdescription'] = '显示互动活动注释';
...
$string['thegradeforthisassessmentis'] = '评价的评分是 $a ';
$string['thegradeis'] = '得分为 $a ';
$string['theseasessmentsaregradedbytheteacher'] = '这些评价由 $a 评分';
$string['thisisadroppedassessment'] = '这是一个废弃的评价';
...
$string['workshop:participate'] = '参与互动活动';
$string['workshopagreedassessments'] = '对互动活动共识的评价';
$string['workshopassessments'] = '对互动活动的评价';
$string['workshopcomments'] = '对互动活动的评论';
$string['workshopfeedback'] = '对互动活动的反馈';
$string['workshopsubmissions'] = '对互动活动的提交';
$string['wrongpassword'] = '用于这个互动活动的密码不正确';
$string['yourassessments'] = '您的评价';
$string['yourassessmentsofexamplesfromtheteacher'] = '您的评价样例来自 $a ';
$string['yourfeedbackgoeshere'] = '您的反馈在这里';
$string['yoursubmissions'] = '您的提交';
