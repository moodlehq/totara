...
$string['aggregatesubcatshelp'] = '成绩汇总通常只与直接相关的子类别相关。除了其他已汇总的成绩外，还可以在所有子类中汇总其中的各项成绩。';
...
$string['aggregationsvisiblehelp'] = '选择所有应可用的汇总类型。请按住 Ctrl 键选择多个项目。';
...
$string['badlyformattedscale'] = '请输入逗号分隔的值列表（至少需要两个值）。';
$string['baduser'] = '提供的用户不可用';
$string['bonuspoints'] = '奖励分数';
$string['combo'] = '标签和下拉菜单';
$string['bulkcheckboxes'] = '大量的checkbox';
$string['calculatedgrade'] = '计算的成绩';
...
$string['cannotaccessgroup'] = '对不起，无法访问选定组的成绩。';
...
$string['categorytotalfull'] = '$a->类别总分';
...
$string['configfixedstudents'] = '通过将成绩设置为静态，可在保持查看学生列的前提下水平滚动成绩。';
...
$string['configshowpercentage'] = '是否显示各成绩项的百分比值。';
...
$string['configunlimitedgrades'] = '默认情况下，成绩由成绩项的最大值和最小值限制。启用此设置将取消此项限制，允许直接在成绩簿中输入超过 100%% 的成绩。建议在非高峰时间启用此设置，因为所有成绩都将重新计算，这可能会导致较高的服务器负载。';
...
$string['coursesettingsexplanation'] = '课程设置确定如何对课程的所有参与者显示成绩簿。';
...
$string['editcalculationverbose'] = '编辑 $a->category $a->itemmodule $a->itemname中的计算方法';
...
$string['errorsavegrade'] = '对不起，无法保存成绩。';
...
$string['hidetotalifhiddenitems'] = '如果包含隐藏成绩项则隐藏总分数';
$string['hidetotalifhiddenitemsdescription'] = '是对学生显示包含隐藏成绩项的总分（通过排除或包括隐藏成绩项计算得出），还是以连字号代替总分。';
$string['hidetotalshowexhiddenitems'] = '显示总分，不包含隐藏成绩项';
$string['hidetotalshowinchiddenitems'] = '显示总分，包含隐藏成绩项';
...
$string['incorrectcustomscale'] = '（不正确的客户等级，请更改。）';
...
$string['nooutcomes'] = '成果项必须链接到课程成果，但此课程无成果。您要添加一个吗？';
$string['nopublish'] = '不发布';
$string['noscales'] = '成果必须链接到课程等级或全局等级，但它们都不存在。您要添加一个吗？';
...
$string['options'] = '选项';
$string['outcome'] = '成果';
$string['outcomeassigntocourse'] = '为此课程分配其他成果';
...
$string['rawpct'] = '原%%';
$string['real'] = '分数';
$string['realletter'] = '实际（分数段）';
$string['realpercentage'] = '实际（百分比）';
...
$string['switchtosimpleview'] = '切换到简单视图';
...
$string['unenrolledusersinimport'] = '此导入包含了目前未选修此课程的以下用户的成绩：$a';
$string['unlimitedgrades'] = '无限制成绩';
$string['unlock'] = '解锁';
...
$string['user'] = '用户';
$string['usergrade'] = '成绩项 $a->gradeidnumber 的用户 $a->fullname ($a->useridnumber)';
$string['userkeyhelp'] = '选择一个已保存的 key，该键值为使用者提供对导出插件的中已发布数据的访问，不必记录在 moodle 中。可以在提交保单的时候选择 `创建一个新用户 key` 来产生一个新的 key。';
$string['userpreferences'] = '使用参数选择';
$string['useweighted'] = '使用权重';
$string['verbosescales'] = '详细等级';
$string['viewbygroup'] = '小组';
$string['viewgrades'] = '查看成绩';
$string['warningexcludedsum'] = '警告：汇总中不得排除成绩。';
$string['weight'] = '权重';
$string['weightuc'] = '权重';
...
$string['weightorextracredit'] = '权重或额外学分';
$string['weights'] = '权重';
$string['weightsedit'] = '编辑权重和额外学分';
