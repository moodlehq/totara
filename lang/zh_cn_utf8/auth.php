...
// nologin plugin
$string['auth_nologindescription'] = '辅助插件阻止用户登录到系统中，并忽略发送给这些用户的电子邮件。可以用来<em>暂停</em>用户帐号。';
...
$string['auth_cas_proxycas'] = "如果在代理模式使用 CAS，将此设置为“是”。";
$string['auth_cas_logoutcas'] = "当与 Moodle 的连接中断时，如果想从 CAS 退出，将此设置为“是”。";
$string['auth_cas_multiauth'] = "如果您想有多种身份验证方式（CAS + 其他验证方式），将此设置为“是”。";
$string['auth_cas_certificate_check'] = "如果您想验证服务器证书，将此设置为“是”";
$string['auth_cas_certificate_path'] = "验证服务器证书的 CA 链文件（PEM 格式）的路径";
$string['auth_cas_certificate_path_empty'] = "如果您启动了服务器验证，则需要指定证书路径";
...
// Email plugin
$string['auth_emailchangecancel'] = '取消电子邮件更改';
$string['auth_emailchangepending'] = '更改待核准。在 $a->preference_newemail 中打开发送给您的链接。';
...
$string['auth_emailnowexists'] = '在您初次申请之后，您尝试为您的个人资料分配的电子邮件地址已经分配给其他用户。您的电子邮件地址更改申请已取消，但您可以使用另一个地址再次尝试。';
...
$string['auth_emailrecaptcha'] = '为电子邮件自助注册用户添加可视/音频确认表单元素。这能保护您的网站免受垃圾信息发送者侵扰，并且提供有价值的内容。请参见 http://recaptcha.net/learnmore.html 获得更多详细信息。<br /><em>需要 PHP cURL 扩展。</em>';
$string['auth_emailrecaptcha_key'] = '启用 reCAPTCHA 元素';
$string['auth_emailsettings'] = '设置';
$string['auth_emailupdatemessage'] = '尊敬的 $a->fullname，

您申请在 $a->site 中为您的用户帐号更改电子邮件地址。请在您的浏览器中打开以下 URL，确认此更改。

$a->url';
$string['auth_emailupdatetitle'] = '在 $a->site 中确认电子邮件更新';
$string['auth_invalidnewemailkey'] = '错误：如果您正在尝试确认电子邮件地址更改，那么可能没有正确地复制我们通过电子邮件发送给您的 URL。请复制该地址并重试。';
$string['auth_emailupdatesuccess'] = '用户 <em>$a->fullname</em> 的电子邮件地址已成功更新为 <em>$a->email</em>。';
$string['auth_outofnewemailupdateattempts'] = '您已经超出了更新电子邮件地址的允许尝试次数。您的更新申请已取消。';
$string['auth_emailupdate'] = '电子邮件地址更新';
$string['auth_changingemailaddress'] = '您申请了更改电子邮件地址，从 $a->oldemail 更改为 $a->newemail。出于安全方面的原因，我们向新地址发送了一封电子邮件，以便确认它确属您的电子邮件地址。只要您打开在该邮件中发送给您的 URL，则您的电子邮件地址将立即更新。';
...
$string['auth_fieldlocks_help'] = '<p>您可以锁定特定的用户数据字段。对于用户数据由管理员来维护或者是通过 \'上传用户\' 机制来创建的站点而言，这个功能是很有用的。如果您锁定了 Moodle 需要的字段，那么请您确信在创建用户帐户时已经提供了其内容，否则这个账号将无法使用。</p><p>如果想要避免这个问题，可以考虑将锁定模式设定为 \'如果空则锁定\'。</p>';
...
$string['auth_ldap_gracelogins_desc'] = '启用LDAP 宽限登录支持。在密码过期后，在宽限登录为 0 前用户仍可以登录。激活这个选项后，当密码过期时将显示宽限登录信息。';
...
$string['auth_ldap_host_url'] = '以 URL 形式指定 LDAP 主机，例如 \'ldap://ldap.myorg.com/\'或 \'ldaps://ldap.myorg.com/\'使用 \';\'分隔服务器以便获得故障转移支持。<br/><br/>注意：如果您未设置此值，Moodle 将不会尝试从 LDAP 获取/更新用户信息，而是遵从您在下方指定的锁定字段。';
...
$string['auth_ldapdescription'] = '该方法利用一个外部的 LDAP 服务器进行身份验证。
                                  ...
                                  如果给出的用户名和密码是有效的，Moodle 将在其数据库中创建一个新用户。

                                  该模块可以从 LDAP 中读取用户属性，并将

                                  指定的字段预先填入 Moodle。此后的登录只需验证用户名和
...
$string['auth_ntlmsso_ie_fastpath'] = '设置为“是”将启用 NTLM SSO 快速路径（绕过某些步骤，仅在客户端的浏览器为 MS Internet Explorer 时有效）。';
$string['auth_ntlmsso_ie_fastpath_key'] = 'MS IE 快速路径？';
...
$string['auth_radiustype'] = '选择 RADIUS 服务器要使用的身份验证规则。';
$string['auth_radiustypepap'] = 'PAP';
$string['auth_radiustypechapmd5'] = 'CHAP MD5';
$string['auth_radiustypemschapv1'] = 'Microsoft CHAP 版本 1';
$string['auth_radiustypemschapv2'] = 'Microsoft CHAP 版本 2';
...
$string['auth_radiustype_key'] = '身份验证';

// Shibboleth plugin
$string['auth_shibbolethdescription'] = '使用这种方法，用户的创建和身份验证是通过 <a href=\"http://shibboleth.internet2.edu/\">Shibboleth</a> 进行的。<br />请务必阅读 Shibboleth 的 <a href=\"../auth/shibboleth/README.txt\">说明</a>，了解如何使用 Shibboleth 设置您的 Moodle';
...
$string['auth_shib_integrated_wayf'] = 'Moodle WAYF 服务';
$string['auth_shib_integrated_wayf_description'] = '如果选中此项，Moodle 将使用自己的 WAYF 服务，而非为 Shibboleth 配置的服务。在用户必须选择其身份提供者时，Moodle 将在这个可选登录页面上显示一个下拉列表。';
$string['auth_shib_idp_list'] = '身份提供者';
$string['auth_shib_idp_list_description'] = '提供身份提供者 entityID 列表，允许用户在登录页面中进行选择。<br />每一行都必须是逗号分隔的 idP entityID 和 idP Name 元组（参见 Shibboleth 元数据文件），它应显示在下拉列表中。<br />作为可选的第三个参数，您可以添加在 Moodle 安装属于多重联合设置的一部分的情况下使用的 Shibboleth 会话发起者的位置。';
$string['auth_shib_logout_url'] = 'Shibboleth 服务提供者退出处理程序 URL';
$string['auth_shib_logout_url_description'] = '提供 Shibboleth 服务提供者退出处理程序的 URL。通常是 <tt>/Shibboleth.sso/Logout</tt>';
$string['auth_shib_auth_method'] = '身份验证方法名称';
$string['auth_shib_auth_method_description'] = '为您的用户熟悉的 Shibboleth 身份验证方法提供一个名称。这应该是您的 Shibboleth 联合的名称，例如 <tt>SWITCHaai Login</tt> 或 <tt>InCommon Login</tt> 或者类似的名称。';
$string['auth_shib_logout_return_url'] = '可选退出返回 URL';
$string['auth_shib_logout_return_url_description'] = '提供 Shibboleth 用户在退出之后应重定向到的 URL。<br />若留空，用户将被重定向到 moodle 重定向用户的位置';
...
$string['changepasswordhelp'] = '在这里您可以指定一个位置，使用户可以在遗忘用户名/密码的情况下重新获得或更改他们的用户名/密码。这将在登录页面显示为一个按钮。如果留空不填，就不会有按钮出现。';
...
$string['selfregistration_help'] = '如果选择了一个身份验证插件，例如基于电子邮件的自己注册，则使潜在用户能够自己注册并创建账户。这使垃圾信息发送者有可能创建帐号，来利用论坛发帖、博客等方式发送垃圾信息。为了避免这样的风险，应通过<em>允许的电子邮件域名</em>设置禁用或限制自己注册。';
...
$string['locked'] = '已锁定';
$string['incorrectpleasetryagain'] = '不正确。请重试。';
$string['enterthewordsabove'] = '输入以上词语';
$string['enterthenumbersyouhear'] = '输入您听到的数字';
$string['getanothercaptcha'] = '获得另一个 CAPTCHA';
$string['getanaudiocaptcha'] = '获得一个音频 CAPTCHA';
$string['getanimagecaptcha'] = '获得一个图像 CAPTCHA';
$string['recaptcha'] = 'reCAPTCHA';
$string['informminpasswordlength'] = '至少 $a 个字符';
$string['informminpassworddigits'] = '至少 $a 位数字';
$string['informminpasswordlower'] = '至少 $a 个小写字母';
$string['informminpasswordnonalphanum'] = '至少 $a 个非字母数字字符';
$string['informminpasswordupper'] = '至少 $a 个大写字母';
$string['informpasswordpolicy'] = '密码必须包括 $a';

// Password rotation
$string['auth_passchangedays'] = '密码过期期限（天数）';
$string['auth_passchangedayshelp'] = '允许用户保留相同密码的最大天数';
$string['auth_passexpiration'] = '密码过期';
$string['auth_passexpirationhelp'] = '指定是否应在特定的密码过期期限之后强制执行密码更改';
$string['auth_passexpirationwarning'] = '密码更改警告（天数）';
$string['auth_passexpirationwarninghelp'] = '用户获得警告，即将强制更改的密码强制更改之前的天数。';
$string['authforcedchangeinstructions'] = '告知您的用户在其密码过期时应采取哪些措施及其将被强制选择一个新密码的说明。';
$string['errorminpasswordthreeoffour'] = '您的密码满足以下四条标准中的三条：';
$string['forcedchangeinstructions'] = '强制更改说明';
?>
