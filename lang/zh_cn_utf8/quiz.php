...
$string['changessaved'] = '对评分的更改已保存';
$string['changessavedwitherrors'] = '保存评分修改时出错';
...
$string['importparseerror' ] = '分析导入文件时发生错误。未导入任何试题。要导入任何良好的试题，请再次尝试将 \'停在错误处\'设置为 \'否\'';
...
$string['min'] = '最小';
$string['minutes'] = '分钟';
$string['missinganswer'] = '在位于第  $a  行的试题中，:ANSWER、:Lx和:Rx语句太少了。您需要定义至少两个答案。';
...
$string['nogradewarning'] = '此测验未评分，您无法设置按成绩划分的整体反馈。';
...
$string['outofpercent'] = '$a->grade 超出 $a->maxgrade 的最大值 ($a->percent%%)';
...
$string['popupwithjavascriptsupport'] = '具有某些 JavaScript 安全功能的全屏弹出窗口';
$string['preview'] = '预览';
...
$string['quiz:reviewmyattempts'] = '检查您自己的试答';
...
$string['requiresafeexambrowser'] = '需要使用安全测验浏览器';
...
$string['reviewresponsetoq'] = '检查答案（试题 $a）';
$string['rqp'] = '远程试题';
$string['rqps'] = '远程试题';
$string['safebrowsererror']='此测验已设置为仅可使用安全测验浏览器试答。无法使用此 Web 浏览器试答。';
$string['safebrowsernotice']='此测试已配置为学生仅可使用安全测验浏览器试答。';
$string['save'] = '保存';
