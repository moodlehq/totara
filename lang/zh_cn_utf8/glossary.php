...
$string['andmorenewentries'] = '以及另外 $a 个新词条。';
$string['answer'] = '答案';
$string['approve'] = '批准';
...
$string['defaulthook'] = '默认挂钩';
$string['defaultmode'] = '默认模式';
$string['defaultsortkey'] = '默认排序方式';
$string['defaultsortorder'] = '默认排列顺序';
...
$string['includegroupbreaks'] = '包括组分隔符';
$string['invalidrate'] = '无效的词汇表率 ($a)';
