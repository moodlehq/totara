...
$string['chooseexportformat'] = '选择您要导出的格式：';
...
$string['csvfailed'] = '无法读取 CSV 文件的原始数据';
$string['csvfile'] = 'CSV 文件';
$string['csvimport'] = 'CSV 文件导入';
$string['csvwithselecteddelimiter'] = '带有选定分隔符的 <acronym title=\"Comma Separated Values\">CSV</acronym> 文本：';
...
$string['entries'] = '条目';
$string['entrieslefttoaddtoview'] = '您必须添加一个或多个 $a->entrieslefttoview 条目才能查看其他参与者的条目。';
$string['entrieslefttoadd'] = '您必须添加一个或多个 $a->entriesleft 条目才能完成此活动。';
$string['entry'] = '条目';
$string['entrysaved'] = '您的条目已保存';
$string['errormustbeteacher'] = '只有教师能使用此页';
$string['example'] = '数据库模块样例';
$string['excel'] = 'Excel';
$string['expired'] = '对不起，该活动已在 $a 关闭且不再可用';
$string['export'] = '输出';
$string['exportaszip'] = '以压缩格式输出';
$string['exportdatabaserecords'] = '导出数据库记录';
...
$string['fieldnotmatched'] = '您文件中的以下字段在此数据库中未知：$a';
...
$string['foundrecords'] = '找到的记录：$a->num/$a->max (<a href=\"$a->reseturl\">重置过滤器</a>)';
$string['foundnorecords'] = '找不到记录（<a href=\"$a->reseturl\">重置过滤器</a>）';
...
$string['ods'] = '<acronym title=\"OpenDocument 电子表格\">ODS</acronym> (OpenOffice)';
...
$string['requiredentrieschanged'] = '<p><strong>重要信息 - 请阅读</strong></p><p>由于错误修补，使用 \'必须完成的条目数\'和 \'查看设置前必须完成的条目数\'设置的数据库活动行为将发生更改。有关此更改的详细说明，请访问<a href=\"http://moodle.org/mod/forum/discuss.php?d=110928\" target=\"_blank\">数据库模块论坛</a>。有关这些设置的预期行为，请参见 <a href=\"http://docs.moodle.org/en/Adding/editing_a_database#Required_entries\" target=\"_blank\">Moodle 文档</a>。
</p><p>此更改会影响您系统中的以下数据库：（请立即保存此列表，并在升级后，检查这些行为是否仍以教师期望的方式工作。）</p><strong style=\"color:red\">$a->text</strong><br/>';
...
$string['search'] = '查找';
$string['selectedrequired'] = '需要所有选定项';
