...
$string['cannotaddmembergroupiddoesntexist'] = 'Impossible d\'ajouter un membre au groupe : l\'identifiant du groupe n\'existe pas';
...
$string['cannotsaveconfig'] = 'Problème lors de l\'enregistrement de la configuration « {$a->name} » sur « {$a->value} » pour le plugin « {$a->plugin} »';
...
$string['cannotupdatecoursemodule'] = 'Impossible de modifier le module de cours';
...
$string['cmunknown'] = 'Impossible de trouver ce module de cours';
$string['codingerrorbaseurlrequired'] = 'Erreur de code : URL de base requise';
...
$string['coursedoesntexistcannotcreategroup'] = 'Impossible de créer le groupe : le cours n\'existe pas';
...
$string['listcantmoveright'] = 'Échec du déplacement de l\'élément vers la droite : il ny a pas d\'élément du même niveau sous lequel le ranger. Déplacez-le sous un autre élément et vous pourrez alors le déplacer';
...
$string['usernotcreated'] = 'L\'utilisateur n\'a pas été créé';
...
$string['wscouldnotaddgroupmembernopermission'] = 'WS - Impossible d\'ajouter un membre au groupe - Pas de permission';
$string['wscouldnotcreateecoursenopermission'] = 'WS - Impossible de créer le cours - Pas de permission';
$string['wscouldnotcreateeuserindb'] = 'WS - Impossible de créer l\'utilisateur';
$string['wscouldnotcreateeusernopermission'] = 'WS - Impossible de créer l\'utilisateur - Pas de permission';
$string['wscouldnotcreategroupnopermission'] = 'WS - Impossible de créer le groupe - Pas de permission';
$string['wscouldnotdeletegroupnopermission'] = 'WS - Impossible de supprimer le groupe - Pas de permission';
...
$string['wscouldnotgetgroupnopermission'] = 'WS - Impossible d\'obtenir le groupe - Pas de permission';
$string['wscouldnotremovegroupmembernopermission'] = 'WS - Impossible de retirer le membre du groupe - Pas de permission';
