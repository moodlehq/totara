...
$string['createtype'] = 'Le type de compétence \"{$a}\" a été créé';
$string['currentlyselected'] = 'Actuellement sélectionné';
$string['defaultvalue'] = 'Valeur par défaut';
$string['deletecheck'] = 'Etes vous sûr de vouloir supprimer cette compétence ainsi que les sous-compétences et toutes les données?';
$string['deletecheck11'] = 'Voulez-vous vraiment supprimer la compétence \"$a\" ?';
