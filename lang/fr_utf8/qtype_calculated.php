...
$string['calculatedsummary'] = 'Les questions calculées sont des questions numériques dont les nombres sont tirés aléatoirement d\'un jeu de données lorsque le test est effectué.';
$string['correctanswershows'] = 'La réponse correcte affiche';
$string['correctanswershowsformat'] = 'Format';
$string['editingcalculated'] = 'Modification d\'une question calculée';
