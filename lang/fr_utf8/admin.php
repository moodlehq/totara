...
$string['configlearnerroleid'] = 'Il s\'agit du rôle à utiliser pour les apprentis dans Totara.';
...
$string['configmanagerroleid'] = 'Il s\'agit du rôle à utiliser pour les gestionnaires dans Totara.';
...
$string['configpasswordreuselimit'] = 'Le nombre de fois qu\'un utilisateur doit changer de mot de passe avant de pouvoir en réutiliser un ancien.';
...
$string['coursecount'] = 'Nombre de cours sur site';
...
$string['cron_execution_crashed'] = 'Le Cron a crashé';
$string['cron_execution_running'] = 'Cron en cours';
$string['cron_execution_status'] = 'Statut';
$string['cron_execution_stopped'] = 'Cron arrêté';
$string['cron_execution_watch'] = 'Exécution Cron';
$string['cron_kill_mail_fail_notify_msg'] = 'L\'exécution du cron a dépassé le temps limite d\'exécution et l\'arrêt automatique a échoué ! Veuillez vérifier les réglages de votre serveur.';
$string['cron_kill_mail_fail_notify_title'] = 'Avertissement : l\'arrêt automatique du cron a échoué !';
$string['cron_kill_mail_notify_msg'] = 'L\'exécution du cron a dépassé le temps limite d\'exécution et a été arrêté ! Veuillez vérifier les réglages de votre serveur.';
$string['cron_kill_mail_notify_title'] = 'Avertissement : le cron a été automatiquement arrêté !';
$string['cron_max_time'] = 'Temps d\'exécution maximal';
$string['cron_max_time_info'] = 'Précise le temps d\'exécution maximal autorisé pour le cron, en heures. La valeur par défaut est 0, ce qui signifie qu\'il n\'y a pas de limite de temps.';
$string['cron_max_time_kill'] = 'Arrêter le cron automatiquement';
$string['cron_max_time_kill_info'] = 'Si coché, le processus de surveillance arrêtera le cron s\'il dépasse la limite de temps d\'exécution. Pour que cela fonctionne, vous devez configurer le processus observateur.';
$string['cron_max_time_mail_notify'] = 'Notifier l\'admin';
$string['cron_max_time_mail_notify_info'] = 'Si coché, l\'administrateur sera informé lorsque le cron dépassera la limite de temps d\'exécution. Pour que cela fonctionne, vous devez configurer le processus observateur.';
$string['cron_max_time_mail_notify_msg'] = 'L\'exécution du cron prend plus de temps que prévu ! Veuillez vérifier la configuration de votre serveur.';
$string['cron_max_time_mail_notify_title'] = 'Avertissement : Temps d\'exécution maximal du cron dépassé !';
...
$string['cron_watcher_info'] = 'Observateur cron';
...
$string['displayerrorsset'] = 'Ce site est configuré pour afficher les occurences d\'erreurs. <br />Ce réglage n\'est pas conseillé pour les sites en production. <br />Décochez <em>Afficher les messages de debug</em> dans la section <a href=\"$a->link\">Serveur/Debug</a> du bloc réglages admin du site.';
...
$string['intlrecommended'] = 'L\'extension Intl est utilisée pour améliorer la prise en charge de l\'internationalisation, par exemple avec le tri prenant en compte les locales.';
...
$string['learnerroleid'] = 'Rôle de l\'apprenti';
...
$string['managerroleid'] = 'Rôle du gestionnaire';
...
$string['moodlerelease'] = 'Identifiant release Moodle';
...
$string['numberofactiveusers'] = '$a utilisateurs se sont connectés sur ce site lors de l\'année passée.';
...
$string['orgname'] = 'Nom d\'organisation';
...
$string['php533warning'] = 'PHP 5.3.3 ou supérieur est recommandé';
...
$string['registrationinformation'] = 'Informations d\'enregistrement à envoyer';
$string['registrationisdisabled'] = 'L\'enregistrement est désactivé. La configuration du site de sorte à enregistrer des informations de base est conseillée pour vous assister lors du dépannage pour tous futurs problèmes que vous pourriez avoir.<br />
Vous pouvez activer l\'enregistrement à partir de la <a href=\"$a\">page de configuration de l\'enregistrement</a>';
$string['registrationisenabled'] = 'L\'enregistrement est activé.';
$string['registrationoutofdate'] = 'Les informations d\'enregistrement n\'ont pas été mises à jour sur une longue période de temps. Les informations d\'enregistrement devraient être gardées à jour pour vous assister plus tard en cas de problème. Assurez-vous que votre serveur a un accès illimité pour effectuer des requêtes https sur register.totaralms.com';
...
$string['sitehasntregistered'] = 'Ce site n\'est pas encore enregistré complètement avec Totara. Il est conseillé d\'enregistrer vos informations de base avec Totara pour vous assister plus tard en cas de problème. Assurez-vous que votre serveur a un accès illimité pour effectuer des requêtes https sur register.totaralms.com et que le cron Moodle est activé. Vous pouvez exécuter le cron manuellement en <a href=\"$a\">cliquant ici</a>';
$string['siteidentifier'] = 'Identifiant site';
...
$string['siteshortname'] = 'Nom court du site';
...
$string['splrequired'] = 'L\'extention PHP SPL est maintenant requise par Totara.';
...
$string['techsupportemail'] = 'E-mail assistance technique';
$string['techsupportemailhelp'] = 'Adresses e-mail de personnes gérant les problème techniques liés à l\'hébergement de sites.';
$string['techsupportphone'] = 'Numéro de téléphone du support technique.';
$string['techsupportphonehelp'] = 'Numéros de téléphone de personnes gérant les problème techniques liés à l\'hébergement de sites. (code pays inclus)';
...
$string['totarabuild'] = 'Numéro de build Totara';
$string['totarapre11'] = 'Totara (pré-version 1.1)';
$string['totararegistration'] = 'Enregistrement Totara';
$string['totararegistrationinfo'] = '<p>Cette page configure les mises à jour d\'enregistrement envoyées à totaralms.com.
Ces mises à jour permettent à Totara de savoir les versions de Totaralms et des logiciels de support que vous utilisez.
Ces informations permettent à Totara de mieux examiner et résoudre les problèmes que vous pourriez rencontrer à l\'avenir.</p>
<p>Ces informations seront transmises de façon sûre et gardées secrètes.</p>';
$string['totararelease'] = 'Identifiant release Totara';
...
$string['webserversoftware'] = 'Identifiant logiciel serveur';
