...
$string['backtoallcategories'] = 'Retour à toutes les catégories';
$string['backtoallcourses'] = 'Retour à tous les cours';
$string['backtoallprograms'] = 'Retour à tous les programmes';
...
$string['backtoparent'] = '&laquo; Retour au niveau parent';
...
$string['badcontext'] = 'Mauvais contexte';
$string['block'] = 'Bloc';
...
$string['brief'] = 'Résumé';
$string['browseallcategories'] = 'Parcourir toutes catégories';
$string['browsebycategory'] = 'Parcourir par catégorie';
...
$string['categorys'] = 'Catégories de cours';
...
$string['commentsrequirelogin'] = 'Vous devez être connecté pour voir les commentaires';
...
$string['coursecompletion'] = 'Avancée du cours';
$string['coursecompletiondata'] = 'Données d\'avancée du cours';
$string['coursecompletions'] = 'Cours terminés';
...
$string['coursesinthiscategory'] = 'Cours dans cette catégorie ({$a})';
...
$string['creatingcompetencyevidencedata'] = 'Création de données de preuve de compétence';
$string['creatingconditionalavailabilitydata'] = 'Création de données de disponibilité conditionnelle';
$string['creatingcoursecompletiondata'] = 'Création de données d\'avancée du cours';
...
$string['databasechecking11'] = 'Passage en version supérieure de la base de données Totara...';
$string['databasecompare'] = 'De :<br /><br /> $a->oldversion<br /><br /> à :<br /><br /> $a->newversion';
...
$string['displaylanguagepanel'] = 'Affichage panneau de langues';
...
$string['editortoggle'] = 'Basculement mode d\'édition de texte avancé';
...
$string['flashupgrademessage'] = 'Le plugin Flash est nécessaire pour afficher ce contenu ; cependant, la version installée sur votre ordinateur est trop ancienne.nn  Il vous sera peut-être nécessaire de vous déconnecter et vous re-connecter après la mise à jour.';
...
$string['legacythemeinuse'] = 'Ce site est affiché en mode compatibilité car votre navigateur est peut-être trop ancien.';
...
$string['managecategories'] = 'Gestion des catégories';
...
$string['manageruser'] = 'Gestion des utilisateurs';
$string['manageruserdescription'] = 'Les gestionnaires peuvent gérer d\'autres utilisateurs.';
...
$string['morethanonerecordinfetch'] = 'Erreur : plus d\'une entrée retournée (table \'$a\')';
...
$string['nocategoriesfound'] = 'Aucune catégorie trouvée pour les mots  \'$a\'';
...
$string['noprogramsfound'] = 'Aucun programme trouvé pour les mots \'$a\'';
...
$string['parentlanguage'] = '<< TRADUCTEURS : si votre langue possède une langue parente que Moodle doit utiliser pour les chaînes manquantes dans votre pack de langue, indiquez le code ici. Si vous laissez ce champ vide, l\'anglais sera utilisé Exemple: nl >>';
...
$string['passwordreused'] = 'Le mot de passe a été utilisé avant, et ne peut être réutilisé';
...
$string['performsearchoncourses'] = 'ou effectuez cette recherche pour les cours';
$string['performsearchonprograms'] = 'ou effectuez cette recherche pour les programmes';
...
$string['searchallprograms'] = 'Chercher tous les programmes';
...
$string['searchcategoriesmatchesplural'] = '{$a->count} catégories correspondent à \"{$a->terms}\"';
$string['searchcategoriesmatchessingle'] = '1 catégorie correspond à \"$a->terms\"';
$string['searchcategoriesshowall'] = 'Affichage de toutes les catégories';
$string['searchcourses'] = 'Rechercher des cours';
$string['searchcoursesmatchesplural'] = '{$a->count} cours correspondent à \"{$a->terms}\"';
$string['searchcoursesmatchessingle'] = '1 cours correspond à \"$a->terms\"';
...
$string['searchprogramsmatchesplural'] = '{$a->count} programmes correspondent à \"{$a->terms}\"';
$string['searchprogramsmatchessingle'] = '1 programme correspond à \"$a->terms\"';
$string['searchprogramsshowall'] = 'Affichage de tous les programmes';
$string['searchresults'] = 'Résultats de la recherche';
$string['searchresultsinx'] = 'Affichage des résultats dans {$a}';
...
$string['total'] = 'Total';
$string['totaracopyright'] = '<p class=\"totara-copyright\"><a href=\"http://www.totaralms.com\">TotaraLMS</a> est une distribution de Moodle. Une \"distri\" ou distribution est une version prête à l\'usage d\'un produit standard, avec une  vision et des objectifs particuliers. Totara est conçu pour l\'apprentissage professionnel, industriel et de vocation, contrairement aux réglages Moodle traditionnels.</p><p class=\"totara-copyright\">Extensions <a href=\"http://www.totaralms.com\">TotaraLMS</a> sont sous Copyright à partir de &copy; 2010 , Totara Learning Solutions Limited.</p>';
...
$string['writingcompetencyevidenceinfo'] = 'Écriture des informations de preuve de compétence';
