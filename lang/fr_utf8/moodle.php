...
$string['backtoallcategories'] = 'Retour aux catégories';
$string['backtoallcourses'] = 'Retour aux cours';
$string['backtoallprograms'] = 'Retour aux programmes';
...
$string['brief'] = 'Résumé';
$string['browseallcategories'] = 'Naviguer toutes catégories';
...
$string['coursecompletiondata'] = 'Données d\'achèvement du cours';
...
$string['coursesinthiscategory'] = 'Cours de la catégorie ({$a})';
...
$string['creatingcoursecompletiondata'] = 'Création de données d\'achèvement de cours';
...
$string['databasechecking11'] = 'Mise à jours base de données Totara...';
$string['databasecompare'] = 'De :<br /><br /> $a->oldversion<br /><br /> Vers :<br /><br /> $a->newversion';
...
$string['displaylanguagepanel'] = 'Afficher panneau de langue';
...
$string['editortoggle'] = 'Mode d\'édition de texte améliorée avec boutons';
...
$string['formatdemo'] = 'Format de démo';
...
$string['legacythemeinuse'] = 'Le site est affiché en mode compatibilité peut être car votre navigateur est daté.';
...
$string['manageruser'] = 'Utilisateur manager';
$string['manageruserdescription'] = 'Les managers peuvent gérer d\'autres utilisateurs';
...
$string['morethanonerecordinfetch'] = 'Erreur : plus d\'un enregistrement retourné (table \'$a\')';
...
$string['parentlanguage'] = '<< TRADUCTEURS : Si votre langue a une langue parent que Moodle doit utiliser lorsque des chaînes manques dans votre paquetage de langue, spécifiez le code ici. Sinon, l\'anglais sera utilisé par défaut. Exemple : nl >>';
...
$string['passwordreused'] = 'Le mot de passe a déjà été utilisé et ne peut plus l\'être';
...
$string['savecomment'] = 'Enregistrer commentaire';
...
$string['searchresultsinx'] = 'Résultats de recherche dans {$a}';
...
$string['writingcompetencyevidenceinfo'] = 'Écriture des infos de preuve de compétence';
