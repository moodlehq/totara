...
$string['auth_cas_certificate_check'] = 'Changer sur \"oui\" si vous voulez valider le certificat du serveur.';
$string['auth_cas_certificate_check_key'] = 'Validation serveur';
$string['auth_cas_certificate_path'] = 'Chemin vers le fichier de chaîne CA (format PEM) pour valider le certificat du serveur.';
$string['auth_cas_certificate_path_empty'] = 'Si vous souhaitez activer la validation du serveur, vous devez spécifier le chemin vers le certificat.';
$string['auth_cas_certificate_path_key'] = 'Chemin certificat';
...
$string['auth_passchangedays'] = 'Temps d\'expiration mot de passe (jours)';
$string['auth_passchangedayshelp'] = 'Le nombre de jours maximum pendant lequel il est autorisé de garder le même mot de passe';
$string['auth_passexpiration'] = 'Expiration mot de passe';
$string['auth_passexpirationhelp'] = 'Précisez si les changements de mots de passe doivent être forcés après la période d\'expiration spécifiée.';
$string['auth_passexpirationwarning'] = 'Avertissement modification mot de passe (jours)';
$string['auth_passexpirationwarninghelp'] = 'Le nombre de jours avant le changement forcé de mot de passe avant lequel un avertissement est envoyé.';
...
$string['authforcedchangeinstructions'] = 'Des instructions pour expliquer aux utilisateurs que faire lorsque leur mot de passe a expiré, et qu\'ils doivent en choisir un nouveau.';
...
$string['errorminpasswordthreeoffour'] = 'Votre mot de passe doit répondre à trois des conditions suivantes.';
...
$string['forcedchangeinstructions'] = 'Instructions de modification forcée';
