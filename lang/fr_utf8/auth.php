...
$string['auth_cas_certificate_check'] = 'Réglez sur \"oui\" si vous voulez valider le certificat du serveur';
...
$string['auth_cas_certificate_path_key'] = 'Chemin de certificat';
...
$string['auth_passchangedays'] = 'Période d\'expiration du mot de passe (jours)';
$string['auth_passchangedayshelp'] = 'Le nombre de jours maximum qu\'un utilisateur peut conserver un mot de passe';
$string['auth_passexpiration'] = 'Expiration du mot de passe';
$string['auth_passexpirationhelp'] = 'Spécifie si un changement de mot de passe doit être forcé après la période d\'expiration';
$string['auth_passexpirationwarning'] = 'Avertissement changement de mot de passe (jours)';
$string['auth_passexpirationwarninghelp'] = 'Le nombre de jours avant que le changement forcé de mot de passe où l\'utilisateur est averti de l\'obligation de changer de mot de passe.';
...
$string['authforcedchangeinstructions'] = 'Des instructions pour dire à vos utilisateurs que faire quand leur mot de passe a expiré, et qu\'ils doivent en choisir un nouveau.';
...
$string['errorminpasswordthreeoffour'] = 'Votre mot de passe doit remplir ces trois critères :';
...
$string['forcedchangeinstructions'] = 'Instructions de changement forcé';
