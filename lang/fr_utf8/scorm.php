...
$string['aicchacpkeepsessiondata'] = 'Données de session AICC HACPP';
$string['aicchacpkeepsessiondata_desc'] = 'La durée en jours de conservation des données de session AICC HACP externes (un paramètre élevé remplira la table de données anciennes mais peut servir pour le debug';
$string['aicchacptimeout'] = 'Expiration AICC HACP';
$string['aicchacptimeout_desc'] = 'La durée en minute qu\'une session AICC HACP externe peut rester ouverte';
$string['allowapidebug'] = 'Activer l\'API de débogage et de tracement (veuillez spécifier le masque de capture)';
$string['allowtypeaicchacp'] = 'Activer AICC HACP externe';
$string['allowtypeaicchacp_desc'] = 'Si activé cela permet les communations externes de AICC HACP sans demander d\'identifiant pour les requêtes post du paquetage AICC externe';
...
$string['direct'] = 'URL directe';
$string['directories'] = 'Afficher les liens de dossier';
$string['directview'] = 'Démarrer directement depuis le cours';
...
$string['invalidurl'] = 'URL invalide spécifiée pour l\'activité d\'URL directe';
...
$string['popupblocked'] = 'Si une nouvelle fenêtre n\'apparaît pas, $a';
$string['popupblockedlinkname'] = 'cliquez ici pour lancer l\'activité';
$string['popupblockmessage'] = 'Si une fenêtre pop-up ne s\'affiche pas, veuillez les autoriser depuis votre navigateur.';
...
$string['unpackmethod'] = 'Méthode de décompactage';
