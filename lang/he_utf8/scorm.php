<?PHP // $Id: scorm.php,v 1.13 2010/12/20 10:12:21 emanuel1 Exp $
...
?>
<?PHP // $Id$
      // scorm.php - created with Moodle 1.9.5+ (Build: 20090624) (2007101550)



$string['deleteallattempts'] = 'מחק את כל נסיונות הלומדה';
$string['entercourse'] = 'הכנס לקורס';
$string['hidetoc'] = 'תצוגת מבנה הקורס (תוכן עניינים)';
$string['modulename'] = 'לומדה';
$string['modulenameplural'] = 'לומדות';
$string['scorm:deleteresponses'] = 'מחק נסיונות לומדה';
