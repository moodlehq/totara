...
$string['datasetrole'] = 'התווים הכללים  <strong>{x..}</strong> יוחלפו על ידי ערך מספרי שיילקח ממערך הנתונים';
$string['deletelastitem'] = 'מחק את הפריט האחרון';
$string['existingcategory1'] = 'ליטרל מקבוצת הליטרלים שכבר קיימת ושמשתמשים בהם בשאלות אחרות בקטגוריה זו.';
...
$string['keptcategory1'] = 'ליטרל מאותה קטגוריה של קבוצת הליטרלים של שימוש חוזר כמו מקודם';
$string['keptcategory2'] = 'קובץ מתוך אותה הקטגוריה, סט קבצים הניתן לשימוש חוזר כמקודם';
$string['keptcategory3'] = 'קישור מתוך אותה הקטגוריה, סט קישורים הניתן לשימוש חוזר כמקודם';
$string['keptlocal1'] = 'ליטרך מאותה קבוצה ליטרלים של שאלות פרטיות כמו מקודם';
...
$string['newcategory3'] = 'קישור מתוך סט חדש של קישורים, בהם יכולות להשתמש גם שאלות אחרות בקטגוריה זו';
$string['newlocal1'] = 'ליטרל מקבוצה חדשה של ליטרלים שישתמשו בו אך ורק בשאלה זאת';
