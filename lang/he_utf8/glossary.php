...
$string['cnfallowdupentries'] = 'הגדר האם לפי ברירת המחדל אגרון המונחים יאפשר כפל הגדרות למונח.';
...
$string['errconceptalreadyexists'] = 'מונח זה כבר קיים. באגרון מונחים זה לא ניתן להכניס כפל הגדרות למונח בודד.';
...
$string['explainaddentry'] = 'הוסף מונח חדש לאגרון המונחים הנוכחי.<br />שדות המונח וההגדרה הם הכרחיים.';
$string['explainall'] = 'מציג את כל המונחים בעמוד אחד.';
$string['explainalphabet'] = 'עיין באגרון המונחים באמצעות מפתח זה';
$string['explainexport'] = 'כדי לייצא את המונחים של אגרון המונחים, לחץ על הכפתור למטה.<br /> אתה יכול לייצא אותם לקורס זה, או לקורס אחר, בכל עת.<p> אנא שים לב - קבצים מצורפים (לדוגמא: תמונות) ושמות המחברים אינם מיוצאים. </p>';
...
$string['globalglossary'] = 'אגרון מונחים מערכתי';
...
$string['glossary:view'] = 'הצג את אגרון המונחים';
...
?>
<?PHP // $Id$
      // glossary.php - created with Moodle 1.9.5+ (Build: 20090624) (2007101550)
