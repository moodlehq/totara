<?PHP // $Id: data.php,v 1.23 2011/03/03 08:43:17 emanuel1 Exp $
...
?>
<?PHP // $Id$
      // data.php - created with Moodle 1.9.5+ (Build: 20090624) (2007101550)



$string['addtemplate'] = 'תבנית הוספת רשומה';
$string['allowcomments'] = 'אפשר הערות משתתפים?';
$string['authorfirstname'] = 'שם פרטי של מעדכן הרשומה';
$string['authorlastname'] = 'שם משפחה של מעדכן הרשומה';
$string['csvwithselecteddelimiter'] = '<acronym title=\"Comma Separated Values\">CSV</acronym> text with selected delimiter:';
$string['savesettings'] = 'בצע חיפוש';
$string['sendinratings'] = 'שלח את הדירוגים שלי';
$string['timeadded'] = 'זמן ההוספה';
$string['timemodified'] = 'זמן העדכון';
