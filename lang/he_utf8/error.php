...
$string['cannotcustomizelocallang'] = 'אין לך רשות לבצע התאמה אישית לתרגום המחרוזות. הראשה זאת מבוקרת על ידי היכולת \"moodle/site:langeditlocal\". הפעל יכולת זאת בכדי לאפשר לך לערוך את חבילות השפה המקומיות במידה ואתה רוצה לשנות תרגומים עבור באתר שלך.';
...
$string['groupunknown'] = 'קבוצה $a אינה שייכת להקורס המצוין';
...
$string['invalidcoursemodule'] = 'מודול ID של קורס לא חוקי';
$string['invalidfieldname'] = '\"$a\" אינו שם תקף לשדה';
$string['invalidfiletype'] = '\"$a\" אינו סוג קובץ תקף';
$string['invalidipformat'] = 'פורמט כתובת IP שגויה.';
...
$string['iplookupfailed'] = 'לא ניתן למצוא מידע על תחילית הארץ עבור כתובת IP זו.';
...
$string['nopermissions'] = 'סליחה, אבל כרגע אין לך את ההרשאות לעשות זאת ($a). יש פעילויות הדורשות רישום להקורס. אנא בדוק אם אתה רשום להקורס.';
...
$string['sessionerroruser'] = 'נותקת מהמערכת כתוצאה מאי-פעילות ממושכת, אנא התחבר שוב.';
...
$string['usernotaddedadmin'] = 'לא ניתן למחוק את חשבון מנהל המערכת';
