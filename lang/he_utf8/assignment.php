...
$string['enableemailnotification'] = 'שלח הודעות דוא\"ל';
...
<p>(אם השתמשת בגרסאות קודמות של מוודל, סוג מטלה זה דומה להתנהגות של רכיב ה-Journal הישן.)</p>';
...
$string['nosubmitusers'] = 'לא נימצאו משתמשים עם הרשאות להגשת תרגיל זה';
