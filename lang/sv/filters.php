...
/**
 * Strings for component 'filters', language 'sv', branch 'MOODLE_22_STABLE'
 *
 * @package   filters
...
$string['isgreaterorequalto'] = 'är större än eller lika med';
$string['isgreaterthan'] = 'är större än';
$string['islessthan'] = 'är mindre än';
$string['islessthanorequalto'] = 'är mindre än eller lika med';
$string['isnotdefined'] = 'är inte definierad';
$string['isnotequalto'] = 'är inte lika med';
$string['matchesallselected'] = 'matchar alla valda';
$string['matchesanyselected'] = 'matchar någon vald';
