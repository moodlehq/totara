...
/**
 * Strings for component 'certificate', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
 * @package   certificate
...
$string['intro'] = '介绍';
$string['issued'] = '颂发';
$string['issueddate'] = '颂发日期';
$string['issueoptions'] = '颂发选项';
$string['landscape'] = '横排';
...
$string['notissued'] = '没有颂发';
$string['notissuedyet'] = '尚未颂发';
...
$string['viewcertificateviews'] = '查看 {$a} 颁发的证书';
