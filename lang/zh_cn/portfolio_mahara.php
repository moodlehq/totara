...
/**
 * Strings for component 'portfolio_mahara', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
...
$string['err_invalidhost_help'] = '此插件的配置错误地指向了一个无效（或已删除）的 MNet 主机。此插件依赖发布了 SSO IDP、订阅了 SSO_SP 和 订阅**且**发布了云存储的 Moodle 网络伙伴。';
...
$string['err_nomnethosts_help'] = '此插件要求 MNet 伙伴要发布 SSO IDP、订阅 SSO SP、发布云存储服务**并且**也订阅了MNet认证插件。在条件不都满足之前，此插件的所有实例都会隐藏。需要手工设置它们为可见。';
