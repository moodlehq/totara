...
/**
 * Strings for component 'calendar', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
 * @package   calendar
...
$string['pref_lookahead_help'] = '这里设置未来多少天内会发生的事件被显示为即将发生的事件。此天数以后发生的事件不会被显示为将发生。请注意，**并不保证**在此时间窗口内开始的事件会被显示；如果有太多（超过“将发生事件数最大值”设置），那么最远的事件不会被显示。';
