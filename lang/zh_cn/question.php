...
/**
 * Strings for component 'question', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
 * @package   question
...
$string['howquestionsbehave_help'] = '学生可以和此测验中的题目有多种交互方式。例如，您可能希望学生输入每道题的答案后再提交整个测验，然后才评分和显示反馈。那么就应该用“延迟反馈”模式。再比如，您可能希望学生在答题过程中每题都提交一下，并获得立即的反馈；如果他们没有答对，还有机会再次尝试，但只能得到较低的分数。那么就应该用“交互式多次尝试”模式。';
