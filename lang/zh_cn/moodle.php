...
/**
 * Strings for component 'moodle', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['duplicatenosupport'] = '不能复制活动“{$a->modname}”，因为{$a->modtype}模块不支持备份和恢复。';
