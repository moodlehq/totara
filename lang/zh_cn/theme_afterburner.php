...
/**
 * Strings for component 'theme_afterburner', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
...
<h2>关于</h2>
<p>涅槃是一款为 Moodle 2.0 编写的三列、可变宽主题。它在每个页面的网站名下方显示自定义菜单。让用户登录或登出的额外功能现在也集成到此主题的自定义菜单中。</p>
<h2>祖先</h2>
