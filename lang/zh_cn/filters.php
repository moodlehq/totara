...
/**
 * Strings for component 'filters', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
 * @package   filters
...
$string['isempty'] = '为空';
$string['isequalto'] = '等于';
$string['isgreaterorequalto'] = '大于或等于';
$string['isgreaterthan'] = '大于';
$string['islessthan'] = '小于';
$string['islessthanorequalto'] = '小于或等于';
$string['isnotdefined'] = '未定义';
$string['isnotequalto'] = '不等于';
$string['matchesallselected'] = '匹配所有选定项';
$string['matchesanyselected'] = '匹配任意选定项';
