...
/**
 * Strings for component 'plugin', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
 * @package   plugin
...
$string['nonehighlighted'] = '此次升级没有需要注意的插件';
...
$string['somehighlighted'] = '此次升级需要留意的插件数：{$a}';
...
$string['type_message'] = '消息处理器';
$string['type_message_plural'] = '消息处理器';
