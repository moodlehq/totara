...
/**
 * Strings for component 'filter_mediaplugin', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
...
$string['html5audio_help'] = '扩展名为*.ogg和*.aac等的文件。只和最新的web浏览器兼容，但不幸的是没有任何一种格式被所有浏览器支持。
