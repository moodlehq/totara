...
/**
 * Strings for component 'admin', language 'zh_cn', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['courselistshortnames'] = '显示简称';
$string['courselistshortnames_desc'] = '显示课程列表时，也显示简称。';
...
$string['navlinkcoursesections'] = '链接课程小节';
$string['navlinkcoursesections_help'] = '如果启用，导航中的课程小节会显示成链接。';
