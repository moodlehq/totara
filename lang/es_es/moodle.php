...
/**
 * Strings for component 'moodle', language 'es_es', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['backtoallcategories'] = 'Volver a todas las categorías';
$string['backtoallcourses'] = 'Volver a todos los cursos';
$string['backtoallprograms'] = 'Volver a todos los programas';
...
$string['badcontext'] = 'Contexto erróneo';
$string['browseallcategories'] = 'Ver todas las categorías';
...
$string['commentsrequirelogin'] = 'Necesita autentificarse para ver los comentarios';
...
$string['coursecompletiondata'] = 'Datos de finalización del curso';
$string['coursecompletions'] = 'Curso finalizado';
$string['coursecreators'] = 'Autores de curso';
$string['courseenrolstart'] = 'Inicio de matriculación en el curso';
...
$string['coursestart'] = 'Inicio del curso';
...
$string['editortoggle'] = 'Activar el modo de edición de texto mejorado';
...
$string['flashlinkmessage'] = 'Por favor, actualice su reproductor Flash ahora:';
$string['flashupgrademessage'] = 'El plug-in de Flash es necesario para reproducir este contenido, pero la versión que tiene es demasiado antigua.\n\nPuede que tenga que cerrar la sesión después de la actualización.';
...
$string['forcepasswordchangecheckfull'] = '¿Estás absolutamente seguro de que quiere forzar un cambio de contraseña a {$a}?';
$string['forcepasswordchangenot'] = 'No puede obligar a un cambio de contraseña a {$a}';
...
$string['manageruser'] = 'Administrador de usuarios';
$string['manageruserdescription'] = 'Los administradores puedes gestionar otros usuarios de usuarios';
...
$string['no'] = 'No';
$string['nocategoriesfound'] = 'No se ha encontrado ninguna categoría con las palabras \'{$a}\'';
...
$string['passwordreused'] = 'Esta contraseña ya la ha utilizado antes y no se le permite volver a utilizarla.';
...
$string['restorecannotassignroles'] = 'Necesita restaurar para asignar funciones y no tiene permiso para hacerlo';
$string['restorecannotcreateorassignroles'] = 'Necesita restaurar para crear o asignar funciones y no tiene permiso para hacerlo';
$string['restorecannotcreateuser'] = 'Necesita restaurar para crear el usuario \'{$a}\'  y no tiene permiso para hacerlo';
$string['restorecannotoverrideperms'] = 'Necesita restaurar anular los permisos y usted no tiene permiso para hacerlo';
$string['restorecoursenow'] = '¡Restaurar este curso ahora!';
$string['restoredaccount'] = 'Cuenta restaurada';
$string['restoredaccountinfo'] = 'Esta cuenta fue importada desde otro servidor y la contraseña se ha perdido. Para establecer una nueva contraseña por correo electrónico, por favor haga clic en "Continuar"';
$string['restorefinished'] = 'Restauración completada con éxito';
$string['restoreto'] = 'Restaurar a';
$string['restoreuserconflict'] = 'Tratar de restaurar el usuario \'{$a}\' del archivo de copia de seguridad provocará conflictos';
$string['restoreuserinfofailed'] = 'El proceso de restauración se ha detenido porque no tiene permiso para restaurar los datos del usuario.';
$string['restoreusersprecheck'] = 'Comprobación de los datos de usuario';
$string['restoreusersprecheckerror'] = 'Se detectaron algunos problemas al verificar los datos del usuario';
...
$string['scalestip'] = 'Para crear niveles personalizados utilice el enlace \'Niveles...\' en el menú de administración del curso.';
$string['scalestip2'] = 'Para crear niveles personalizados, haga clic en el enlace Calificaciones del menú de administración del curso, luego seleccione Editar, Niveles.';
...
$string['searchresultsinx'] = 'Buscar resultados en {$a}';
...
$string['writingcompetencyevidenceinfo'] = 'Escribiendo información de prueba de la competencia';
