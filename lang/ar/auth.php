...
/**
 * Strings for component 'auth', language 'ar', branch 'MOODLE_22_STABLE'
 *
 * @package   auth
...
$string['auth_fieldlocks_help'] = 'تستطيع غلق حقول بيانات المستخدم. هذا مفيد للمواقعِ التي يقوم المدرائها بتحرير سجلات المستخدمين يدوياً أو بإستخدام خدمة رفع ملف بيانات المستخدم. لو قمت بقفل حقول مطلوبة من مودل، تأكد من تزويدك لتلك البيانات عندما تنشئ حسابات المستخدمين؛ وإلا ستكون الحسابات غير صالحة للإستعمال.
خذ في اعتبارك وضع إعداد حالة الإغلاق في \'عدم الإغلاق إذا كان الحقل فارغا\' لتفادي هذه المشكلة.';
