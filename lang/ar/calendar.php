...
/**
 * Strings for component 'calendar', language 'ar', branch 'MOODLE_22_STABLE'
 *
 * @package   calendar
...
$string['detailedmonthview'] = 'معاينة شهرية مفصلة';
...
$string['pref_lookahead_help'] = 'يحدد هذا العدد الأقصى من الأيام التي يجب أن يبدأ الحدث فيها لكي يظهر كحدث قادم. الأحداث التي تبدأ خارج هذا المجال لن يتم عرضها في الأحداث القادمة. رجاءً لاحظ أنه **لا يوجد ضمانة** بعرض كل الأحداث التي تبدأ ضمن هذا المجال؛ إن كان هناك الكثير منها (أكثر من الحد الأقصى) فعندها لن يتم عرض الأحداث الأبعد.';
