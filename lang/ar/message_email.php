...
/**
 * Strings for component 'message_email', language 'ar', branch 'MOODLE_22_STABLE'
 *
...
$string['configsmtphosts'] = 'أعط الاسم الكامل لخادم (SMTP) إس إم تي بي محلي أو أكثر ليقوم مودل باستخامه لإرسال البريد (مثلاً: - \'mail.a.com\' or \'mail.a.com;mail.b.com \'). لتحديد منفذ غير الافتراضي (أي غير المنفذ 25)، يمكنك استخدام صيغة  [server]:[port] (مثلاً: \'mail.a.com:587\') إذا تركته فارغا، سيقوم مودل بإستخدام طريقة بي إتش بي الافتراضية لإرسال البريد.';
