...
/**
 * Strings for component 'forum', language 'ar', branch 'MOODLE_22_STABLE'
 *
 * @package   forum
...
$string['cannotadddiscussionall'] = 'لا تملك إذن لإضافة موضوع مناقشة جديدة لجميع المشاركين';
$string['cannotdeletepost'] = 'لايمكن حذف هذه المشاركة';
$string['cannotviewpostyet'] = 'لانك لم تقم بالمشاركة في هذا المنتدى لذا لا تستطيع قراءة اسئلة الطلاب الأخرين';
$string['cleanreadtime'] = 'حدد المشاركات القديمة بساعة القراءة';
$string['completiondiscussions'] = 'يجب أن ينشئ المستخدم موضوع مناقشة';
$string['completiondiscussionsgroup'] = 'يحتاج إلى مناقشة';
$string['completiondiscussionshelp'] = 'يحتاج إلى مواضيع مناقشة لإكماله';
$string['completionposts'] = 'يجب أن ينشر المستخدم مواضيع مناقشةأو ردود';
$string['completionpostsgroup'] = 'يتطلب النشر';
$string['completionpostshelp'] = 'يحتاج إلى موضوع مناقشة أو ردود لإكماله';
$string['completionreplies'] = 'الطلاب يجب عليهم الرد';
$string['completionrepliesgroup'] = 'يتطلب الرد';
$string['completionreplieshelp'] = 'يحتاج إلى ردود لإكماله';
...
$string['configenabletimedposts'] = 'تعيين "نعم" إذا كنت تريد أن تسمح بتحديد فترات العرض عند نشر موضوع مناقشة جديد في المنتدى.
(التجريبية ولم يتم اختبارها بالكامل)';
...
$string['confirmsubscribe'] = 'هل ترغب بالاشتراك في المنتدى \'{$a}\'؟';
$string['confirmunsubscribe'] = 'هل ترغب بإلغاء الاشتراك من المنتدى \'{$a}\'؟';
...
$string['forum:throttlingapplies'] = 'تطبيق التحكم بالنطاق';
...
$string['forumblockingalmosttoomanyposts'] = 'أنت على وشك النشر.
لقد سبق أن شاركت {$a->numposts} مرات، والحد الأقصى  للمشاركات هو  {$a->blockafter} .';
$string['forumbodyhidden'] = 'لا يمكنك عرض هذه المشاركة، وربما لأنك لم تشارك في المناقشة أو لم يتم اجتياز الحد الأقصى للمشاركة.';
...
$string['nopostforum'] = 'هذراً، غير مسموح لك بالمشاركة في هذا المنتدى.';
...
$string['oldpostdays'] = 'القراءة بعد أيام';
...
$string['postaddedsuccess'] = 'تم إضافة مشاركتك بنجاح';
$string['postaddedtimeleft'] = 'لديك  {$a} لتحريره، إذا كنت ترغب بإجراء أية تغييرات.';
...
$string['resettrackprefs'] = 'حذف جميع التفضيلات التابعة للمنتدى';
...
$string['thisforumisthrottled'] = 'هناك حد أقصى لعدد المشاركات في هذا المنتدى. يمكنك تحديد فترة زمنية للمشاركة.
التعيين الحالي للمشاركات {$a->blockafter} مشاركة في {$a->blockperiod}';
...
$string['unsubscribeallconfirm'] = 'أنت مشترك في {$a} منتدى حالياً.
هل ترغب في إلغاء الاشتراك من جميع المنتديات وتعطيل خاصية الاشتراك التلقائي؟';
$string['unsubscribealldone'] = 'تم إزالة جميع اشتراكات المنتدى، قد لا تزال تتلقى إشعارات من المنتدى حول الاشتراك القسري.
يرجى الانتقال إلى ملف التعريف الخاص بك وتعطيل عنوان البريد الإلكتروني هناك، إذا كنت لا ترغب في تلقي أية رسائل من هذا الخادم.';
$string['unsubscribeallempty'] = 'عذراً، أنت غير مشترك في المنتدى.
يرجى الانتقال إلى ملف التعريف الخاص بك وتعطيل عنوان البريد الإلكتروني هناك، إذا كنت لا ترغب في تلقي أية رسائل من هذا الخادم.';
$string['unsubscribed'] = 'إلغاء الاشتراك';
$string['unsubscribeshort'] = 'الغي الاشتراك';
$string['usermarksread'] = 'تحديد المشاركات المقروءة يدوياً';
