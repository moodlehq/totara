...
/**
 * Strings for component 'moodle', language 'ar', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['availability_help'] = 'هذا الخيار يسمح لك بإخفاء مقررك الدراسي تماماً.
...
$string['blockdeleteconfirm'] = 'أنت على وشك أن تحذف الكتلة \'{$a}\' بالكامل. هذا سيحذف بالكامل جميع المعلومات المتعلقة بها في قاعدة البيانات. هل أنت متأكد من الاستمرار في عملية الحذف هذه؟';
...
$string['category_help'] = 'هذا الإعداد يحدد التصنيف الذي سيظهر فيه المقرر الدراسي في قائمة المقررات الدراسية.';
...
$string['coursehelpnewsitemsnumber'] = 'عدد البنود الأخيرة التي تظهر في صفحة المقرر الدراسي الرئيسية، في مربع الأخبار في أسفل الجانب اليميني <br/>(0 تعني أن مربع الأخبار لن يظهر).';
$string['coursehelpnumberweeks'] = 'عدد الأسابيع/المواضيع التي تظهر في صفحة المقرر الدراسي الرئيسية.';
...
$string['courselegacyfiles_help'] = 'توفر مساحة "ملفات المقرر" بعض التوافق الرجعي مع موودل 1.9 وما قبله. جميع الملفات في هذه المساحة متاحة دائمًا لجميع المشاركين في المقرر (سواءً وضعت روابط إليها أو لا ) كما أنه لا مجال لمعرفة أين يستعمل أيٌُ من هذه الملفات في موودل.

إذا كنت ستستخدم هذه المساحة لتخزين ملفات المقرر، فقد تعرض نفسك لمجموعة من مسائل الأمن والخصوصية، وكذلك تواجه فقدان ملفات في النسخ الاحتياطية، ومستوردات المقرر في أي وقت يتم فيه مشاركة المحتوى أو إعادة استخدامه. لهذا فإنه يوصى بعدم استعمال هذه المساحة إلا إذا كنت حقًا تعرف ماذا تصنع.

يوفر الرابط أدناه المزيد من المعلومات حول كل هذا، وسيعرض لك بعضًا من وسائل أفضل ﻹدارة الملفات في موودل 2.';
...
$string['expirynotifystudents_help'] = 'إذا تم تحديد مدة للتسجيل، فإن هذا الإعداد يحدد إن كان يستقبل الطلاب إشعارات بالبريد الإلكتروني عندما يكونوا على وشك  أن يلغى تسجيلهم في المقرر أم لا';
$string['expirythreshold'] = 'البداية';
$string['expirythreshold_help'] = 'إذا تم تحديد مدة للتسجيل، فإن هذا الإعداد يحدد عدد الأيام التي يعطى فيها الإشعار قبل إلغاء تسجيل الطلاب في المقرر';
...
$string['hidetopicfromothers'] = 'إخفاء الموضوع';
$string['hideweekfromothers'] = 'إخفاء الأسبوع';
$string['hits'] = 'نتائج';
...
$string['local'] = 'محلّي';
$string['localplugindeleteconfirm'] = 'أنت على وشك حذف الإضافة المحلية \'{$a}\' بالكامل. سيؤدي هذا إلى حذف كل شيء متعلق بهذه الإضافة في قاعدة البيانات. هل أنت "متأكد" من أنك تريد الاستمرار؟
';
...
$string['order'] = 'ترتيب';
$string['orphanedactivities'] = 'أنشطة منفردة';
$string['other'] = 'أخر';
$string['outline'] = 'ملخص';
...
$string['screenreaderuse_help'] = 'إذا تم اختيار "نعم"، فسيتم توفير واجهة استخدام أكثر إتاحة في عديد من الأماكن مثل المحادثة.';
...
$string['showtopicfromothers'] = 'عرض المواضيع';
$string['showweekfromothers'] = 'عرض الأسبوع';
$string['since'] = 'منذ';
