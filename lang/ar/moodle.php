...
$string['cookiesenabled_help'] = '**كوكيز**
يستخدم الموقع نوعين من الكوكيز.
الأهم نوع منهما هو جلست الكوكي، التي تدعى **جلست موديل.
**للحفاظ على الاستمرار في دخولك  إلى موديل والتنقل من صفحة إلى أخر، يجب
عليك السماح بجلسات الكوكيز من خلال إعدادات متصفح الإنترنت الخاص بك. عند خروج من
مودل أو إغلاقك للمتصفح  ستحذف جلسات الكوكيز (من متصفحك ومن المزود).
النوع الأخر من الكوكي هو فقط لإعطاء نوع من الراحة
للمستخدمين، عادة يدعى **مودلد**. مهامه هي تذكر اسم المستخدم وكلمة المرور من
...
كتابة اسم المستخدم وكلمة المرور عند دخولك لمودل كل مرة.';
