...
$string['error:columntypenotfound11'] = 'La columna de tipo \'$a\' fue definida, pero no es una opción válida. Esto puede ocurrir si ha eliminado un campo personalizado o el nivel de profundidad de la jerarquía. La mejor alternativa consiste en eliminar esta columna pulsando la cruz roja a la derecha.';
