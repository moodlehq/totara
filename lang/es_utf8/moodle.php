...
$string['backtoallcategories'] = 'Regresar a todas las categorías';
$string['backtoallcourses'] = 'Regresar a todos los cursos';
$string['backtoallprograms'] = 'Regresar a todos los programas';
...
$string['backupmissinguserinfoperms'] = 'Nota: Esta copia de seguridad no contiene datos del usuario. Las actividades del taller y los ejercicios no serán incluidos en la copia de seguridad, ya que estos módulos no son compatibles con este tipo de copia de seguridad.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnext'] = 'Próxima copia de seguridad';
...
$string['badcontext'] = 'Contexto incorrecto';
$string['block'] = 'Bloque';
...
$string['browseallcategories'] = 'Buscar todas las categorías';
...
$string['categorys'] = 'Categorías de cursos';
...
$string['commentsrequirelogin'] = 'Debe acceder para ver los comentarios';
...
$string['coursecompletiondata'] = 'Datos de realización del curso';
$string['coursecompletions'] = 'Realizaciones del curso';
...
$string['coursesinthiscategory'] = 'Cursos en esta categoría ({$a})';
...
$string['creatingcompetencyevidencedata'] = 'Creando datos de evidencia de la competencia';
$string['creatingconditionalavailabilitydata'] = 'Creando datos de disponibilidad condicional';
$string['creatingcoursecompletiondata'] = 'Creando datos de realización del curso';
...
$string['databasechecking11'] = 'Actualizando la base de datos de Totara...';
$string['databasecompare'] = 'De:<br /><br /> $a->oldversion<br /><br /> A:<br /><br /> $a->newversion';
...
$string['displaylanguagepanel'] = 'Mostrar el panel de idiomas';
...
$string['editortoggle'] = 'Pasar al modo de edicion de texto enriquecido';
...
$string['flashlinkmessage'] = 'Por favor actualice su reproductor de Flash ahora:';
$string['flashupgrademessage'] = 'Se requiere el plugin de Flash para reproducir este contenido, pero la versión que tiene es muy vieja. 

Deberá salir y acceder nuevamente luego de la actualización.';
...
$string['forcepasswordchangecheckfull'] = '¿Está absolutamente seguro de que quiere forzar el cambio de contraseña a $a?';
...
$string['formatdemo'] = 'Formato demo';
...
$string['legacythemeinuse'] = 'El sitio se muestra en modo de compatibilidad porque su navegador es demasiado viejo.';
...
$string['manageruser'] = 'Gestor del usuario';
$string['manageruserdescription'] = 'Los gestores pueden ajustar otros usuarios.';
...
$string['moreprofileinfoneeded'] = 'Por favor, díganos algo acerca de sí mismo';
$string['morethanonerecordinfetch'] = 'Error: se ha regresado más de un archivo (tabla \'$a\')';
...
$string['nobody'] = 'Nadie';
$string['nocategoriesfound'] = 'No se encontraron categorías con las palabras \'$a\'';
...
$string['noteusercannotrolldatesoncontext'] = '<strong>Nota:</strong> Se ha desactivado la habilidad de implementar las fechas cuando se restauraba esta copia de seguridad porque no tiene los permisos requeridos.';
...
$string['passwordreused'] = 'Ya se ha utilizado esta contraseña, y no está permitido reutilizarla';
...
$string['publicsitefileswarning3'] = 'Nota: Los archivos colocados aquí pueden ser accesibles a cualquiera que conozca (o pueda adivinar) la URL. <br />Por razones de seguridad, se recomienda que las copias de seguridad solo se guarden en la carpeta de la copia de seguridad.';
...
$string['restorecannotassignroles'] = 'No tiene permiso para restablecer las necesidades para asignar roles';
$string['restorecannotcreateorassignroles'] = 'No tiene permiso para restablecer las necesidades para asignar o crear roles';
$string['restorecannotcreateuser'] = 'No tiene permiso para restablecer las necesidades para crear el usuario \'$a\' desde la copia de seguridad';
$string['restorecannotoverrideperms'] = 'No tiene permiso para restablecer las necesidades para anular los permisos';
$string['restorecoursenow'] = 'Restaurar este curso ahora';
$string['restoredaccount'] = 'Cuenta restablecida';
$string['restoredaccountinfo'] = 'Esta cuenta fue importada desde otro servidor y se ha perdido la contraseña. Para configurar una nueva contraseña por email, cliquee \"Continuar\"';
...
$string['restoreuserconflict'] = 'Intentar restablecer el usuario \'$a\' desde la copia de seguridad causará conflictos';
$string['restoreuserinfofailed'] = 'Se suspendió el proceso de restauración porque no tiene permiso para restaurar los datos del usuario';
$string['restoreusersprecheck'] = 'Revisando los datos del usuario';
$string['restoreusersprecheckerror'] = 'Se detectaron algunos problemas cuando se revisaba los datos del usuario';
...
$string['searchresultsinx'] = 'Resultados de la búsqueda en {$a}';
...
$string['showcommentsnonjs'] = 'Mostrar los comentarios';
...
$string['writingcompetencyevidenceinfo'] = 'Escribiendo la información de evidencia de la competencia';
