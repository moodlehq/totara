...
$string['assignmentadministration'] = 'Administración de la tarea';
...
$string['cannotinsertempty'] = 'No se ha podido insertar un nuevo envío vacío';
...
$string['submitformarking'] = 'Enviar tarea para calificación';
