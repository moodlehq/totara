...
$string['calendarexportsalt'] = 'Exportar calendario salt';
...
$string['configallowuserswitchrolestheycantassign'] = 'De forma predeterminada, moodle/rol: La asignación es requerida para los usuarios que pueden cambiar roles. Habilitando esta opción elimina este requisito, dando como resultado el rol disponible en el  menú desplegable \"Cambiar rol a\" determinado por la configuración en la sección \"Permitir la asignación de roles\".

Se recomienda que la configuración de \"permitir la asignación de roles\" no permita a usuarios cambiarse el rol a uno con mas capacidad que el actual.';
...
$string['configassessorroleid'] = 'Este es el rol de los asesores en Totara';
...
$string['configcalendarexportsalt'] = 'Este texto al azar se utiliza para mejorar la seguridad de los tokens de autenticación utilizados para la exportación de los calendarios. Por favor tenga en cuenta que todos los tokens actuales son invalidos si usted cambia el hash salt.';
...
$string['configconvertformat'] = 'Si <i>latex</i>, <i>dvips</i> y <i>convertir</i> están disponibles, las imagenes son creadas usando el formato específico. Si no es así, mimeTeX se usará y creará imagenes GIF.';
...
$string['configcourserequestnotify'] = 'Digite el username del usuario que será notificado cuando el nuevo curso sea solicitado.';
$string['configcourserequestnotify2'] = 'Usuarios quienes serán notificados cuando un curso sea solicitado. Solo son listados aquí los usuarios quienes puedan aprobar solicitudes de curso.';
...
$string['configenablesafebrowserintegration'] = 'Esto adiciona la opción \'Requerir examen seguro del navegador\' a el campo de \'Seguridad del navegador\' en el formulario de las configuraciones del quiz. Ver http://www.safeexambrowser.org/ para mas información.';
...
$string['configexcludeoldflashclients'] = 'Algunas versiones del plugin de Adobe Flash son conocidos por ser vulnerables a ataques maliciosos a partir de contenido de Flash. Puede especificar una versión mínima soportada aquí, y Moodle no mostrar archivos Flash a los usuarios con versiones más bajas. En su lugar ellos verán un archivo Flash alternativo diciendoles como actualizarlo. Deje esto en blanco para desactivar todos los chequeos.';
$string['configexperimentalsplitrestore'] = 'Si está habilitado, el backup del curso será chequeado para encontrar errores XML y dividirlo en partes más pequeñas para su uso en el proceso de restauración. Esto dará lugar a mejoras en los tiempos de restauración robustez y ejecución, particularmente para el backup de cursos grandes.';
...
$string['configextramemorylimit'] = 'Algunos scripts como el de busqueda, backup/restaurar o cron, requiere mas memoria. Establezca valores mas altos para los grandes sitios.';
...
$string['confighideactivitytypecrumb'] = 'Seleccione a quién ocultar la pista del tipo de actividad (e.g., Cuestionarios) en el rastro de caminos de navegación (\'breadcrumb\') que se muestra en los módulos de actividad.';
...
$string['configlearnerroleid'] = 'Este es el rol de los principiantes en Totara';
...
$string['configmanagerroleid'] = 'Este es el rol de los gestores en Totara';
...
$string['configmycoursesperpage'] = 'Máximo número de cursos a mostrar en cualquier lista del usuario dueño de cursos.';
...
$string['configpasswordreuselimit'] = 'La cantidad de veces que un usuario debe cambiar su contraseña antes de que pueda reutilizar una contraseña';
...
$string['configregenloginsession'] = 'Regeneración de la identificación de la sesión en cada petición de login es altamente recomendable por razones de seguridad. Este ajuste puede no ser compatible con algunos plugins de autenticación.';
...
$string['configsitemaxcategorydepth'] = 'Profundidad máxima de categoría';
$string['configsitemaxcategorydepthhelp'] = 'Esto especifica la máxima profundidad de hijos que se mostrarán';
...
$string['coursecount'] = 'Cantidad de cursos de sitio';
...
$string['courserequestnotify'] = 'Notificación de curso solicitado';
$string['courserequestnotifyemail'] = 'Usuario $a->user solicitó un nuevo curso en $a->link';
$string['courserequests'] = 'Solicitudes de cursos';
$string['courserequestspending'] = 'Solicitudes de cursos pendientes';
$string['courses'] = 'Cursos';
$string['coursesperpage'] = 'Cursos por página';
$string['creatornewroleid'] = 'Rol de los creadores en cursos nuevos';
$string['cron_execute'] = 'Ejecutar';
$string['cron_execution_crashed'] = 'Cron dejó de funcionar';
$string['cron_execution_running'] = 'Cron está funcionando';
$string['cron_execution_status'] = 'Estado';
$string['cron_execution_stopped'] = 'Cron se ha detenido';
$string['cron_execution_watch'] = 'Ejecución de cron';
$string['cron_kill_mail_fail_notify_msg'] = '¡La ejecución de cron llevó más tiempo de lo normal y la finalización automática falló! Por favor verifique la configuración del servidor.';
$string['cron_kill_mail_fail_notify_title'] = 'Advertencia: ¡La ejecución de cron no pudo ser finalizada automáticamente!';
$string['cron_kill_mail_notify_msg'] = '¡La ejecución de cron llevó más tiempo de lo normal y la finalización automática falló! Por favor verifique la configuración del servidor.';
$string['cron_kill_mail_notify_title'] = 'Advertencia: ¡La ejecución de cron fue finalizada automáticamente!';
$string['cron_max_time'] = 'Tiempo máximo de ejecución';
$string['cron_max_time_info'] = 'Especifica el tiempo máximo de ejecución permitido para cron, expresado en horas. El valor por defecto es 0, que significa que no tiene límite de tiempo.';
$string['cron_max_time_kill'] = 'Finalice cron automáticamente';
$string['cron_max_time_kill_info'] = 'Si se lo selecciona, el proceso de observación hará que cron finalice si se retrasa la ejecución configurada. Para que esto funcione, debe configurar el observador de cron.';
$string['cron_max_time_mail_notify'] = 'Notificar al Admin';
$string['cron_max_time_mail_notify_info'] = 'Si se lo selecciona, el sistema notificará al administrador enviándole un email en caso de que cron se ejecute por encima del tiempo máximo configurado. Para que esto funcione, debe configurar el observador de cron.';
$string['cron_max_time_mail_notify_msg'] = '¡El tiempo de ejecución está llevando más de lo especificado! Por favor revise la configuración del servidor.';
$string['cron_max_time_mail_notify_title'] = 'Advertencia: ¡La ejecución de cron se retrasó!';
$string['cron_refresh'] = 'Actualizar el estado';
$string['cron_settings'] = 'Cron';
$string['cron_status_info'] = 'Estado de la ejecución de cron';
$string['cron_terminate'] = 'Finalizar';
$string['cron_watcher_info'] = 'Observador de cron';
...
$string['displayerrorsset'] = 'Este sitio está configurado para mostrar los errores. <br /> No se recomienda esta configuración en los sitios de producción. <br /> Sin revisar <em> Mostrar mensajes de depuración</em> en el <a href=\"$a->link\"> Servidor/Depuración</a> sección bloqueada del sitio de configuración del admin.';
...
$string['enablesafebrowserintegration'] = 'Habilitar el examen seguro de integración del navegador';
...
$string['everyonewhocan'] = 'Todo el que puede \'$a\'';
$string['excludeoldflashclients'] = 'Versión requerida de Flash Player';
$string['experimental'] = 'Experimental';
$string['experimentalsettings'] = 'Experimental';
$string['experimentalsplitrestore'] = 'División de restauración Experimental';
$string['extendedusernamechars'] = 'Permitir caracteres extendidos en nombres de usuario';
$string['extramemorylimit'] = 'Límite de memoria extra PHP';
...
$string['gdrecommended'] = 'Extensión GD es usada para la conversión de imágenes, algunas características tales como imágenes de perfil de usuario no estarán disponible si faltan.';
...
$string['hideactivitytypecrumb'] = 'Ocultar pistas de tipo de actividad';
...
$string['iconvrequired'] = 'Instalación de extensiones ICONV es requerida.';
...
$string['intlrecommended'] = 'Extensión Intl es usada para mejorar el apoyo al soporte de internacionalización, con el conocimiento de la clasificación local.';
...
$string['langpackwillbeupdated'] = 'Nota para traductores: Durante la actualización, Moodle intentará actualizar el paquete de idioma. Las modificaciones en las carpetas de lenguaje no-locales se sobrescribirá.';
...
$string['learnerroleid'] = 'Rol del principiante';
...
$string['managecourses'] = 'Ajuste los cursos';
$string['managelang'] = '<b>Administrar</b>';
$string['manageprograms'] = 'Ajuste los programas';
$string['managerroleid'] = 'Rol del gestor';
...
$string['mediapluginyoutube'] = 'Habilitar filtro de links de YouTube';
...
$string['mnetrestore_extusers_admin'] = '<strong> Nota: </ strong> Este Backup parece venir de otra instalación de Moodle y contiene cuentas de usuarios de una red remota de Moodle. El proceso de restauración tratará de encontrar coincidencias con los Hosts de red Moodle para todos los usuarios creados. En los que no se encuentren coincidencias serán automáticamente intercambiados a una autenticación interna (en lugar de Mnet one). El Log de la restauración le informará acerca de esto.';
...
$string['mnetrestore_extusers_noadmin'] = '<strong>Nota:</strong> Esta copia de seguridad parece venir de otra Totara o instalación Moodle y contiene cuentas de usuarios remotos de la red Totara/Moodle. No tiene permiso para ejecutar este tipo de archivo. Contacte al administrador del sitio o, alternativamente, restablezca este curso sin ninguna información de usuario (módulos, archivos...).';
$string['mnetrestore_extusers_switchuserauth'] = 'El usuario remoto de la red Totara/Moodle $a->username (que viene de $a->mnethosturl) se cambió al usuario $a->auth local y autenticado.';
$string['modsettings'] = 'Gestionar actividades';
$string['modulesecurity'] = 'Seguridad del módulo';
$string['moodlerelease'] = 'Identificador de lanzamiento de Moodle';
...
$string['mycoursesperpage'] = 'Cantidad máxima de cursos';
...
$string['optionalsubsystems'] = 'Subsistemas opcionales';
$string['order1'] = 'Primero';
$string['order2'] = 'Segundo';
$string['order3'] = 'Tercero';
$string['order4'] = 'Cuarto';
$string['orgname'] = 'Nombre de la organización';
$string['orgnamehelp'] = 'El nombre de su organización.';
...
$string['phpfloatproblem'] = 'Se ha detectado un problema inesperado al manejar los números de punto flotante en PHP - $a';
...
$string['purgecachesfinished'] = 'Se purgaron todas las cachés.';
...
$string['regenloginsession'] = 'Regenerar el id de la sesión durante el acceso';
$string['registrationdisabled'] = 'Deshabilitado';
$string['registrationenabled'] = 'Habilitado';
$string['registrationinformation'] = 'Se enviará la información de registro';
$string['registrationisdisabled'] = 'El registro está deshabilitado. Se recomienda configurar su sitio para registrar la información básica para ser asistido en la detección de fallas y en futuros problemas que pueda tener.<br />
Puede habilitar el registro desde la página <a href=\"$a\"> de configuración de registro</a>';
$string['registrationisenabled'] = 'El registro está habilitado';
$string['registrationoutofdate'] = 'La información de registro no se ha actualizado por un período extenso de tiempo. La información de registro debe mantenerse actualizada por si necesita ser asistido en una posible detección de fallas en un futuro. Asegúrese de que su servidor de Internet tenga acceso ilimitado para realizar pedidos https a register.totaralms.com';
...
$string['sessioncookiedomain'] = 'Dominio de cookie';
...
$string['simplexmlrequired'] = 'Ahora Totara requiere la extensión SimpleXML PHP.';
$string['sitefullname'] = 'Nombre completo del sitio';
$string['sitehasntregistered'] = 'Este sitio aún no está satisfactoriamente registrado con Totara. Se recomienda registrar la información básica en Totara para ser asistido en la detección de fallas o en cualquier problema futuro que pueda surgir. Asegúrese de que su servidor de Internet pueda realizar pedidos https a register.totaralms.com y que el cron de Moodle esté habilitado. Puede ejecutar manualmente a cron si<a href=\"$a\">cliquea aquí</a>';
$string['siteidentifier'] = 'Identificador del sitio';
...
$string['soaprecommended'] = 'Es útil instalar la extensión opcional SOAP para los servicios web y algunos módulos \'contrib\'.';
$string['spamcleaner'] = 'Eliminador de correo basura';
$string['splrequired'] = 'Totara requiere la extensión SPL PHP.';
...
$string['techsupportemail'] = 'Email del servicio técnico';
$string['techsupportemailhelp'] = 'Dirreción de email de las personas que manejan los problemas de mayor complejidad técnica relacionados al servidor del sitio';
$string['techsupportphone'] = 'Número de teléfono del servicio técnico';
$string['techsupportphonehelp'] = 'Número de teléfono de las personas que manejan los problemas de mayor complejidad técnica relacionados al servidor del sitio. (Incluyendo el código del país).';
...
$string['totarabuild'] = 'Número de versión de Totara';
$string['totarapre11'] = 'Totara (pre versión 1.1)';
$string['totararegistration'] = 'Registro de Totara';
$string['totararegistrationinfo'] = '<p> Esta página configura las actualizaciones de los registros, que son enviadas a totaralms.com. Estas actualizaciones le permiten saber a Totara qué versiones de Totaralms y programas de soporte usted está utilizando.
Esta información le permitirá a Totara examinar y resolver, de una mejor manera, cualquier tipo de problemas técnicos que usted pueda experimentar en el futuro.</p>
<p> Esta información será  transmitida de forma segura y guardada en confidencia.</p>';
$string['totararelease'] = 'Identificador de lanzamiento de Totara';
$string['totaraversion'] = 'Número de versión de Totara';
...
$string['upgrade197notice'] = '<p> Moodle 1.9.7 contiene una cantidad de medidas de seguridad para las contraseñas de los usuarios y las copias de seguridad que protegen la información del usuario en su sitio. Como resultado, algunos puntos de su configuración y permisos relacionados a las copias de seguridad podrían haber cambiado.<br /> Vea las <a href=\"http://docs.moodle.org/dev/Moodle_1.9.7_release_notes\" target=\"_blank\">Moodle 1.9.7 release notes</a> para más datos.</p>';
$string['upgrade197noticesubject'] = 'Acualización de las observaciones de seguridad de Moodle 1.9.7';
$string['upgrade197salt'] = 'Para reducir el riesgo de robo de contraseña, es altamente recomendable configurar una contraseña con sal.<br />Vea la <a href=\"$a\" target=\"_blank\"> documentación de contraseñas con sal</a> para más detalles.';
...
$string['usercount'] = 'Número de usuarios del sitio';
...
$string['webserversoftware'] = 'Identificador de programas de los servidores web';
$string['wwwroot'] = 'Sitio raíz www';
