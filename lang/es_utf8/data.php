...
$string['cannotinsertempty'] = 'No se ha podido insertar un registro vacío';
...
$string['excel'] = 'Excel';
$string['expired'] = 'Disculpe, esta actividad se cerró el {$a} y ya no está más disponible.';
...
$string['updatingerror'] = 'Se ha producido un error al actualizar la base de datos';
