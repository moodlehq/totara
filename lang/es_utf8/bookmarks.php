...
$string['allbookmarks'] = 'Todos los marcadores';
$string['bookmarks'] = 'Marcadores';
$string['bookmarksintro'] = 'Descripción';
$string['bookmarksname'] = 'Nombre';
...
$string['noitems'] = 'No hay elementos';
$string['noresults'] = 'Su búsqueda no coincide con ningún marcador';
$string['repeatedlink'] = 'Aún tiene marcada esta URL';
$string['saving'] = 'Guardar su marcador';
$string['search'] = 'Buscar';
$string['searchingfor'] = 'Buscar por: ';
$string['selectedgroup'] = 'Grupo seleccionado:  $a';
