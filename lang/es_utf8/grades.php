...
$string['addevent'] = 'Agregar ítem calificado';
...
$string['addgrade'] = 'Gestionar ítems calificados';
...
$string['aggregationcoefextrahelp'] = 'Puntos extra para este elemento de calificación durante la agregación';
$string['aggregationcoefextrasum'] = 'Actuar como puntos extra';
$string['aggregationcoefextrasumhelp'] = 'Puntos extra para este elemento de calificación en el cálculo total.';
$string['aggregationcoefhelp'] = 'Peso aplicado a todas las calificaciones de este ítem durante la agregación con otros ítems de calificación.';
$string['aggregationcoefweight'] = 'Peso del elemento';
$string['aggregationcoefweighthelp'] = 'Peso aplicado a todas las calificaciones en este elemento de calificación durante el cálculo con los demás elementos de calificación.';
...
$string['aggregationsvisiblehelp'] = 'Seleccione todos los tipos de cálculo que deberían estar disponibles. Mantenga pulsada la tecla Control para seleccionar múltiples elementos.';
...
$string['categorytotalname'] = 'Nombre total de la categoría';
...
$string['configgradeitemadvanced'] = 'Seleccionar todos los elementos que se mostrarán al editar los elementos de calificación.';
...
$string['configshowhiddenitems'] = 'Mostrar elementos ocultos en el informe incluso si el usuario no tiene permiso moodle/grade:viewhidden. La visibilidad de las calificaciones ocultas no se ve afectada por este ajuste.';
...
$string['configshowpercentage'] = 'Mostrar el porcentaje de cada elemento de calificación.';
$string['configshowquickfeedback'] = 'La Retroalimentación Rápida agrega un elemento de texto a cada celda de calificación en el informe del calificador, permitiéndole editar los comentarios de muchas calificaciones a la vez. Puede entonces hacer clic en el botón Actualizar para ejecutar todos estos cambios de una vez en lugar de hacerlo uno a uno.';
...
$string['configshowrank'] = 'Mostrar rango de cada elemento.';
...
$string['configunlimitedgrades'] = 'Por defecto, las calificaciones están limitadas por los valores máximo y mínimo del elemento de calificación. Si se activa esta opción se eliminará ese límite, y se permitirá introducir directamente en el \'gradebook\' calificaciones por encima del 100%%. Se recomienda habilitar esta opción en un momento de baja demanda, puesto que recalcular todas las calificaciones puede resultar en una sobrecarga del servidor.';
...
$string['exportlettershelp'] = 'Cuando los ítems usen letras en lugar de valores, se exportarán las letras en lugar de los valores reales.';
$string['exportods'] = 'Exportar ODS';
$string['exportplugins'] = 'Conectores de exportación';
$string['exportsettings'] = 'Exportar ajustes';
$string['exportto'] = 'Exportar a';
$string['exporttxt'] = 'Exportar TXT';
$string['exportxml'] = 'Exportar XML';
...
$string['gradeeventname'] = 'Nombre del ítem calificado:';
...
$string['gradereports'] = 'Informe de calificaciones';
...
$string['hidetotalifhiddenitemsdescription'] = '¿Ocultar totales si contienen uno o más elementos ocultos?';
...
$string['newevent'] = 'Agregar nuevo ítem calificado';
...
$string['nogradeitemsinanycategory'] = 'No hay categorías de calificación que incluyan ítems calificados';
...
$string['nooutcomes'] = 'Los elementos de resultados deben estar vinculados a un resultado de curso, pero no existen resultados para este curso. ¿Desea agregar uno?';
...
$string['userreport'] = 'Informe de calificación del usuario';
