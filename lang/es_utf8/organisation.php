...
$string['deletecheckwithchildren'] = '¿Está seguro de que quiere eliminar la organización \"$a->itemname\" y sus $a->children_string?
<br /><br />
Esto eliminará los siguientes datos: <br />
...
$string['depthlevels'] = 'Niveles de profundidades';
$string['depths'] = 'Profundidades';
$string['descriptionview'] = 'Descripción';
$string['editdepthlevel'] = 'Editar el nivel de profundidad';
$string['editframework'] = 'Editar el cuadro de la organización';
...
$string['error:dialognotreeitems'] = 'No hay organizaciones en el cuadro';
...
$string['framework'] = 'Cuadro de organización';
$string['frameworks'] = 'Cuadros de organizaciones';
...
$string['missingname'] = 'No se encuentra el nombre de la organización';
$string['missingnameframework'] = 'No se encuentra el nombre del cuadro de la organización';
$string['missingnametype'] = 'No se encuentra el nombre del tipo de organización';
$string['missingshortname'] = 'No se encuentra el nombre corto de la organización';
...
$string['notypes'] = 'No hay tipos de organizaciones';
...
$string['parent'] = 'Padre';
$string['returntoframework'] = 'Regrese al cuadro de la organización';
...
$string['type'] = 'Tipo';
$string['types'] = 'Tipos';
$string['updatedframework'] = 'Se ha actualizado el cuadro de la organización \"{$a}\"';
$string['updatedorganisation'] = 'Se ha actualizado la organización \"{$a}\"';
$string['updatetype'] = 'Se ha actualizado el tipo de organización \"{$a}\"';
$string['weight'] = 'Peso';
