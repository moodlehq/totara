...
$string['backup:userinfo'] = 'Hacer una copia de seguridad de los datos del usuario';
...
$string['category:manage'] = 'Ajustar categorías';
$string['category:update'] = 'Actualizar categorías';
$string['category:viewhiddencategories'] = 'Ver las categorías ocultas';
...
$string['course:markcomplete'] = 'Marca completa del usuario';
...
$string['course:viewprogress'] = 'Ver el progreso del curso';
...
$string['legacy:manager'] = 'ROL DEL LEGADO: Gestor';
...
$string['restore:createuser'] = 'Crear usuarios al restaurar';
$string['restore:rolldates'] = 'Permiso para implementar las fechas de configuración de las actividades al restaurar';
