<?php
// es_utf8_moodle.org.php - created with Totara langimport script version 1.1

$string['aboutdemosite'] = 'Nuestro sitio de demostración es un sitio Moodle con todas sus características y algunos cursos de ejemplo donde puedes acceder como profesor, estudiante o incluso como administrador. No te preocupes por estropear algo, el sitio al completo se vacía y reinicia cada hora.';
...
<ul>
<li>Moodle dispone de características que le permiten escalar a grandes despliegues con cientos de miles de estudiantes, pero también puede ser utilizado en escuelas de educación infantil primaria.</li>
...
$string['browsecvstitle'] = 'Navega por nuestro código fuente';
...
$string['connectedsites'] = 'Algunos sitios Moodle han sido conectados con moodle.org usando la Red Moodle (Moodle Networking), de manera que puedes acceder a dichos sitios directamente una vez que te has autenticado aquí.';
$string['connectedsitestitle'] = 'Sitios conectados';
$string['contactbugs'] = 'Puedes informar de problemas en el programa Moodle o en cualquier sitio de moodle.org creando una nueva entrada en el Moodle Tracker.';
$string['contactbugstitle'] = 'Informar de errores';
$string['contactintro'] = 'Por favor, escoge entre las siguientes opciones de contacto:';
$string['contactlogin'] = 'Para otras consultas, accede a este sitio y usa el formulario de contacto que aparecerá en esta página.';
...
$string['contactmoodleorgemail'] = 'Si tenéis problemas con la confirmación de vuestra cuenta en moodle.org, enviar un correo electrónico a esta dirección:';
$string['contactmoodleorglogin'] = 'Entrar a este sitio ahora';
$string['contactmoodleorgother'] = 'Para otro tipo de consultas, utilizad el formulario de contacto situado en la parte inferior de la página.';
$string['contactmoodleorgtitle'] = 'Moodle.org';
$string['contactsecurity'] = 'También puedes informar de cuestiones de seguridad mediante el Tracker, siempre que el nivel de seguridad configurado sea adecuado.';
$string['contactsent'] = 'Su mensaje se envió por correo electrónico al Gestor de la Comunidad Moodle.';
$string['contactsupport'] = 'Si deseas obtener soporte para utilizar Moodle, por favor visita la página de Soporte donde encontrarás disponibles muchos recursos de ayuda.';
...
$string['developers'] = 'El desarrollo principal de Moodle lo lidera el equipo de Moodle.com, ayudados por cientos de desarrolladores en todo el mundo.  Muchos de esos desarrolladores son también responsables directos de diferentes módulos y extensiones.';
...
$string['developmentintro'] = 'Moodle se plantea como un proceso de desarrollo abierto y transparente que invita a toda la comunidad de usuarios a participar. Naturalmente damos la bienvenida a desarrolladores en PHP pero también puedes contribuir mediante las discusiones en los foros, probando la aplicación, dándonos vuestras opinión y documentando.';
$string['developmenttracker'] = 'Todos los temas sobre desarrollo, fallos, mejoras y nuevas funcionalidades las registramos en el Trakcer de Moodle. Podéis ver quién está trabajando y contribuir a las conversaciones. Si estás buscando algo sobre un tema específico deberías mirar lo primero de todo en el tracker y por favor no olvides <strong>votar</strong> en los temas que te gustaría ver o antes posible resueltos, vuestro voto determina las prioridades a la hora de resolver los temas.';
...
$string['downloadcore'] = 'Nuestro principal método de distribución es a través de estos paquetes estándares con la distribución base. Contienen un conjunto de módulos que son mantenidos por los desarrolladores de Moodle, y son adecuados para ser utilizados en cualquier plataforma donde tengas PHP y la base de datos instalados.';
$string['downloadcoretitle'] = 'Paquetes estándar de Moodle';
$string['downloadcvs'] = 'Otra forma de obtener el código fuente es utilizar directamente CVS para conectar directamente con alguno de los servidores que utilizan los desarrolladores de Moodle.  Esto facilita el proceso de actualización, incluso si has hecho cambios en el código fuente de tu sitio Moodle.';
...
$string['downloadmac'] = 'Si aún no dispones de un servidor web, estos paquetes con todo incluido te ayudarán a instalar de forma fácil Moodle en cualquier ordenador con Mac OS X.';
$string['downloadmactitle'] = 'Moodle para Mac OS X';
$string['downloadmodules'] = 'Navega por nuestra base de datos de módulos extra y extensiones que pueden ser instalados en tu sitio Moodle para dotarlo de funcionalidades extras más allá de las incluidas en la distribución base de Moodle.';
...
$string['downloadwin'] = 'Si aún no dispones de un servidor web, estos paquetes con todo incluido te ayudarán a instalar de forma fácil Moodle en cualquier ordenador con Microsoft Windows.';
$string['downloadwintitle'] = 'Moodle para Windows';
$string['events'] = 'Aunque estamos especializados en la enseñanza en línea, siempre es bueno verse todos juntos en persona. Visita estos enlaces para más información sobre nuestras conferencias (las llamamos MoodleMoots) y otros eventos.';
...
$string['frontpagewelcome2'] = 'Moodle.org es el sitio de nuestra comunidad donde se crea y discute Moodle. Por favor utiliza los menús para explorarla y unirte a ella.';
...
$string['jobs'] = 'Visita nuestra base de datos de trabajo para encontrar puestos de trabajo relacionados con Moodle en todo el mundo.';
...
$string['mycoursesintro'] = 'Actualmente estás matriculado en los siguientes \"cursos\" en este sitio de la comunidad, cada uno de ellos podría disponer de uno o más foros.';
...
$string['networkintro'] = 'Los sitios Moodle que figuran a continuación han sido conectados con moodle.org utilizando la Red Moodle, de manera que puedes entrar a ellos directamente desde aquí.';
...
$string['noenrolledcoursesyet'] = 'No te has matriculado en ningún curso de este sitio aún';
...
$string['overviewmy'] = 'Ver todos los cursos de moodle.org donde estás matriculado';
...
$string['shop'] = '¿Buscas la forma de hacer ver que formas parte de nuestra comunidad? Echa un ojo a nuestra tienda donde encontrarás camisetas, tazas y otras cosas.';
...
$string['supportdocs2'] = 'Una buena manera de acceder a documentación relevante de Moodle es utilizar el enlace \"Documentación de Moodle para esta página\" en la parte inferior de cada página de vuestro sitio Moodle.';
...
$string['supportforums'] = 'Nuestra comunidad de usuarios se comunica principalmente mediante los foros dentro de los \"cursos\" de este sitio Moodle .  Debes \"matricularte\" en el curso para poder enviar mensajes (la matriculación es totalmente gratuita).';
$string['supportforumsenglish'] = 'Aquí la mayoría del soporte y discusiones entre usuarios y desarrolladores sn en inglés:';
...
$string['supportintro'] = '¡No estás solo!  Hay muchas formas de conseguir ayuda con Moodle si lo necesitas.';
