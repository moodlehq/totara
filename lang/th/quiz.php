...
/**
 * Strings for component 'quiz', language 'th', branch 'MOODLE_22_STABLE'
 *
 * @package   quiz
...
$string['addingquestion'] = 'เพิ่มคำถาม';
...
$string['addmoreoverallfeedbacks'] = 'เพิ่ม {} ไม่มีเขตข้อมูลข้อเสนอแนะเพิ่มเติม';
...
$string['attemptsdeleted'] = 'แบบทดสอบความพยายามที่จะลบ';
...
$string['attemptsnumthisgroup'] = 'พยายาม: {$a->total} ({$a->group} กลุ่มจากกลุ่มนี้)';
$string['attemptsnumyourgroups'] = 'พยายาม: {$a->total} ({$a->group} กลุ่มจากกลุ่มของคุณ)';
...
$string['browsersecurity'] = 'การรักษาความปลอดภัยเบราว์เซอร์';
...
$string['cannoteditafterattempts'] = 'คุณไม่สามารถเพิ่มหรือลบคำถามได้เนื่องจากยังมีความพยายาม';
...
$string['closebeforeopen'] = 'ไม่สามารถปรับปรุงการตอบคำถาม ท่านได้ระบุวันที่ใกล้ชิดก่อนวันเปิด';
...
$string['continuepreview'] = 'ดำเนินการต่อตัวอย่างล่าสุด';
...
$string['correctansweris'] = 'คำตอบที่ถูกต้อง: {$a}';
...
$string['deletingquestionattempts'] = 'การลบความพยายามที่คำถาม';
...
$string['emailconfirmbody'] = '{$a->username} ชื่อผู้ใช้ที่รัก,

ขอขอบคุณที่ส่งคำตอบของคุณไป
\'{$a->quizname}\'
ในหลักสูตร \'{$a->coursename}\'
ที่ {$a->submissiontime}

อีเมลนี้จะยืนยันว่าเราได้รับคำตอบของคุณได้อย่างปลอดภัย

คุณสามารถเข้าถึงการตอบคำถามนี้อยู่ที่ {$a->quizurl}';
$string['emailconfirmsubject'] = 'แบบทดสอบการยืนยันการส่ง: {$a->quizname}';
$string['emailnotifybody'] = '{$a->username} ชื่อผู้ใช้ที่รัก,

{$a->studentName} ได้เสร็จสิ้นการทดสอบ
\'{$a->quizname}\' ({$a->quizurl})
ในหลักสูตร \'{$a->coursename}\'

คุณสามารถตรวจทานความพยายามนี้ที่ {$a->quizreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} ได้เสร็จสิ้นการทดสอบ {$a->quizname}';
$string['errorinquestion'] = 'ข้อผิดพลาดในคำถาม';
...
$string['feedbackerrorboundaryformat'] = 'ขอบเขตข้อเสนอแนะเกรดต้องเป็นเปอร์เซ็นต์หรือจำนวน ค่าที่คุณป้อนในขอบเขต {$a} ไม่เป็นที่รู้จัก';
$string['feedbackerrorboundaryoutofrange'] = 'ขอบเขตข้อเสนอแนะเกรดต้องอยู่ระหว่าง 0%% และ 100%% ค่าที่คุณป้อนในขอบเขต {$a} อยู่นอกช่วง';
$string['feedbackerrorjunkinboundary'] = 'คุณต้องกรอกข้อมูลลงในความคิดเห็นของเกรดกล่องขอบเขตโดยไม่ต้องออกช่องว่างใด ๆ';
$string['feedbackerrorjunkinfeedback'] = 'คุณต้องกรอกข้อมูลลงในกล่องความคิดเห็นโดยไม่ต้องออกช่องว่างใด ๆ';
$string['feedbackerrororder'] = 'ขอบเขตข้อเสนอแนะเกรดต้องในการสั่งซื้อสูงที่สุดก่อน ค่าที่คุณป้อนในขอบเขต {$a} จะออกจากลำดับ';
$string['file'] = 'ไฟล์';
$string['fileformat'] = 'รูปแบบไฟล์';
$string['fillcorrect'] = 'เติมที่ถูกต้อง';
$string['filloutnumericalanswer'] = 'คุณให้เวลาอย่างน้อยหนึ่งคำตอบที่เป็นไปได้และความอดทน คำตอบที่ตรงกันก่อนที่จะใช้ในการกำหนดคะแนนและข้อเสนอแนะ ถ้าคุณจัดหาข้อมูลบางอย่างกับไม่มีคำตอบในตอนท้ายที่จะแสดงให้กับนักเรียนที่มีการตอบสนองที่ไม่ตรงกันโดยใด ๆ ของคำตอบอื่น ๆ';
...
$string['finishreview'] = 'เสร็จสิ้นรีวิว';
...
$string['gradeboundary'] = 'ขอบเขตเกรด';
...
$string['importcategory'] = 'หมวดหมู่การนำเข้า';
...
$string['invalidcategory'] = 'ID ประเภทไม่ถูกต้อง';
$string['invalidnumericanswer'] = 'หนึ่งในคำตอบที่คุณป้อนไม่ได้ตัวเลขที่ถูกต้อง';
$string['invalidnumerictolerance'] = 'หนึ่งในความคลาดเคลื่อนที่คุณป้อนไม่ได้ตัวเลขที่ถูกต้อง';
...
$string['matchanswerno'] = 'การจับคู่คำตอบ {$a}';
$string['max'] = 'สูงสุด';
$string['min'] = 'ต่ำสุด';
$string['minutes'] = 'นาที';
...
$string['nogradewarning'] = 'คำถามนี้ไม่ได้ถูกจัดลำดับเพื่อให้คุณไม่สามารถตั้งค่าข้อมูลโดยรวมที่แตกต่างโดยเกรด';
...
$string['numattemptsmade'] = '{$a} พยายามทำในแบบทดสอบนี้';
$string['numberabbr'] = '#';
...
$string['openclosedatesupdated'] = 'แบบทดสอบวันที่เปิดและปิดปรับปรุง';
$string['optional'] = 'ทางเลือก';
$string['outof'] = 'จากคะแนนเต็ม';
$string['outofpercent'] = '{$a->grade} เกรดออกมาจากสูงสุด {$a->maxgrade} ({$a->percent}%%)';
$string['overallfeedback'] = 'ความคิดเห็นโดยรวม';
$string['overdue'] = 'เกินกำหนด';
$string['pagesize'] = 'แสดงจำนวนครั้งที่ทำต่อหน้า';
$string['parent'] = 'ประเภทที่สูงขึ้นไป';
$string['parsingquestions'] = 'คำถามแยกจากไฟล์นำเข้า';
...
$string['previewquiznow'] = 'ตัวอย่างคำถามในขณะนี้';
...
$string['questionsinthisquiz'] = 'คำถามในแบบทดสอบนี้';
$string['questionsperpage'] = 'จำนวนคำถามสูงสุดต่อหน้า';
$string['questiontext'] = 'ข้อความที่คำถาม';
$string['questiontype'] = 'ประเภทของคำถาม {$a}';
$string['questiontypesetupoptions'] = 'ตั้งค่าตัวเลือกสำหรับประเภทคำถาม :';
$string['quiz:attempt'] = 'พยายามทำแบบทดสอบ';
$string['quiz:deleteattempts'] = 'ลบแบบทดสอบความพยายาม';
$string['quiz:emailconfirmsubmission'] = 'รับอีเมลยืนยันในขณะที่ส่ง';
$string['quiz:emailnotifysubmission'] = 'รับแจ้งทางอีเมลของการส่ง';
$string['quiz:grade'] = 'เกรดแบบทดสอบด้วยตนเอง';
$string['quiz:ignoretimelimits'] = 'ละเว้นการ จำกัด เวลาในการทดสอบ';
$string['quiz:manage'] = 'จัดการทดสอบ';
$string['quiz:preview'] = 'ตัวอย่างแบบทดสอบ';
$string['quiz:reviewmyattempts'] = 'จากความพยายามของคุณเอง';
$string['quiz:view'] = 'ดูข้อมูลตอบคำถาม';
...
$string['quizcloseson'] = 'แบบทดสอบนี้จะปิดที่ {$a}';
$string['quizopen'] = 'วันแรกที่สามารถทำแบบทดสอบได้';
$string['quizopens'] = 'ทำแบบทดสอบได้';
$string['quizsettings'] = 'แบบทดสอบการตั้งค่า';
...
$string['regradenotallowed'] = 'คุณไม่ได้รับอนุญาตให้ regrade ตอบคำถามนี้';
$string['regradingquestion'] = 'ปรับคะแนน {$a}';
$string['regradingquiz'] = 'ปรับคะแนนแบบทดสอบ {$a}';
$string['remove'] = 'เอาออก';
$string['removeallquizattempts'] = 'ลบความพยายามในการตอบคำถามทั้งหมด';
...
$string['reviewofpreview'] = 'รีวิวของการทำแบบทดสอบ {$a}
รีวิวของตัวอย่าง';
$string['reviewopen'] = 'หลังจากนี้ขณะที่ยังเปิดการใช้งานแบบทดสอบ';
$string['reviewoptions'] = 'นักเรียนสามารถ review';
$string['reviewoptionsheading'] = 'ตัวเลือกในการรีวิว';
$string['reviewresponse'] = 'review ข้อที่เลือกตอบ';
$string['reviewresponsetoq'] = 'การตอบสนองต่อความคิดเห็น (คำถาม {$a})';
...
$string['stoponerror'] = 'หยุดกับข้อผิดพลาด';
...
$string['summaryofattempts'] = 'สรุปของความพยายามก่อนหน้าของคุณ';
...
$string['youneedtoenrol'] = 'คุณจำเป็นต้องลงทะเบียนเรียนในหลักสูตรนี้ก่อนที่คุณจะสามารถพยายามตอบคำถามนี้';
