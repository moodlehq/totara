...
$string['selfregistration_help'] = 'ถ้าส่วนติดตั้งเพิ่มเติม authentication เช่น การลงทะเบียนเข้าใช้ระบบด้วยตัวเองทางอีเมลถูกเลือก มันจะเปิดให้ผู้ใข้ให้ลงทะเบียนตัวเองและสร้างบัญชีผู้ใช้ ผลก็คือสแปมสามารถสร้างบัญชีผู้ใช้ขึ้นมาเองเพื่อจะใช้ ฟอรั่มในการ โพสต์ เข้าไปใน blog ดังนั้นเพื่อหลีกเลี่ยงปัญหานี้ การลงทะเบียนด้วยตัวเองจะถูกปิดการใช้งานหรือจำกัดการใช้โดย<em>โดเมนอีเมลที่ได้รับอนุญาต</em> การตั้ง';
