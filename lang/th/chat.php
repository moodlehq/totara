...
$string['usingchat_help'] = '<p>แชทโมดูลประกอบด้วยหลายส่วนประกอบที่จะทำให้การแชทสนุกสนานขึ้น</p>

<dl>
<dt><b>สไมลีส์</b></dt>
<dd>ใบหน้าสไมลีส์ (อีโมติคอน) ที่พิมพ์บนที่ใดๆ ใน Moodle สามารถพิมพ์และแสดงใบหน้าอย่างที่ต้องการในห้องแชทนี้ได้เช่นกัน เช่น :-) = <img src="pix/s/smiley.gif">  </dd>
 
<dt><b>ลิงค์</b></dt>
<dd>ที่อยู่อินเตอร์เน็ตต่างๆ สามารถเปลี่ยนเป็นลิงค์อัตโนมัติได้</dd>
 
<dt><b>การแสดงอารมณ์</b></dt>
<dd>ขึ้นต้นบรรทัดด้วย "/me" หรือ ":" เพื่อแสดงอารมณ์ เช่น สมมติว่าคุณชื่อ  คิ้ม เมื่อคุณพิมพ์ ":laughs!" หรือ "/me laughs!" ทุกคนในห้องแชทจะเห็น "คิ้ม หัวเราะ (Kim laughs)" เป็นต้น</dd>

<dt><b>ส่งเสียง "บี๊ป"</b></dt>
<dd>You can send a sound to other people by hitting the "beep" link next to their name.  A useful
    shortcut to beep all the people in the chat at once is to type "beep all". จะส่งเป็นเสียงให้กับคนอื่นๆ ในห้องก็ได้ โดยการกดที่ลิงค์ "บี๊ป (Beep)" ซึ่งอยู่ถัดจากชื่อของคนอื่นๆ ทางลัดที่จะส่งเสียง "บี๊ป" ให้กับทุกคนในห้องแชทพร้อมๆ กันในครั้งเดียวคือการพิมพ์ "บี๊ปทุกคน (Beep All)"</dd>

<dt><b>HTML</b></dt>
<dd>ถ้าพอรู้จักโค้ด HTML อยู่บ้าง ก็อาจใช้โค้ดในข้อความเพื่อแทรกรูปภาพ เล่นเสียง หรือ สร้างข้อความที่มีขนาดหรือสีแตกต่างกันไปก็ได้</dd>
