...
$string['directview'] = 'Iniciar diretamente do curso';
...
$string['finishscorm'] = 'Se terminou a visualização deste recurso, $a';
$string['finishscormlinkname'] = 'clique aqui para retornar a página do curso';
...
$string['popupblockmessage'] = 'Se a janela pop-up não aparecer, habilite os pop-ups no seu navegador.';
