...
$string['filecantmovefrom'] = 'Os arquivos de questões não poderão ser movidos porque você não tem permissão para remover arquivos do local que está tentando mover.';
$string['filecantmoveto'] = 'Os arquivos de questões não poderão ser movidos ou copiados porque você não tem permissão para remover arquivos do local que está tentando mover.';
