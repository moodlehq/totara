...
$string['configassessorroleid'] = 'Esta função é para ser utilizada pelo assessor da Totara';
...
$string['configlearnerroleid'] = 'Esta função é para ser utilizada pelos alunos da Totara.';
...
$string['configmanagerroleid'] = 'Esta função é para ser utilizada pelos gerentes da Totara.';
...
$string['intlrecommended'] = 'A extensão intl é usada para ampliar o suporte em âmbito internacional, como a ciência da variedade de localidades.';
...
$string['mnetrestore_extusers_switchuserauth'] = 'Totara Remoto/Usuário da Rede Moodle $a->username (vindo a partir de $a->mnethosturl) mudou para o local $a->auth usuário autorizado.';
...
$string['php533warning'] = 'Recomendável PHP 5.3.3 ou superior';
...
$string['purgecachesfinished'] = 'Todos os caches foram apagados.';
...
$string['splrequired'] = 'A extensão SPL PHP é atual exigência da Totara.';
