...
$string['allowmultiple'] = 'Permitir arquivos múltiplos';
...
$string['attachfiletoassignment'] = 'Anexar arquivo(s) à tarefa';
$string['availabledate'] = 'Disponível a partir de';
$string['backtoassignment'] = 'Retornar à tarefa';
$string['backtofeedback'] = 'Retornar ao feedback';
$string['cannotdeletefiles'] = 'Erro: os arquivos não foram apagados';
$string['choosereviewfile'] = 'Escolher um arquivo para carregar como revisão da tarefa';
...
$string['deletecheckfile'] = 'Tem certeza que quer excluir este arquivo?';
$string['deleteednotification'] = 'O arquivo foi cancelado';
$string['deletefail'] = 'O seguinte arquivo não foi cancelado:';
...
$string['markingsubmitnotification'] = 'O arquivo foi enviado para avaliação.';
$string['maximumgrade'] = 'Nota máxima';
$string['maximumsize'] = 'Tamanho máximo';
$string['modulename'] = 'Tarefa';
$string['modulenameplural'] = 'Tarefas';
$string['namedeletefile'] = 'Você está cancelando este arquivo:';
...
$string['nofilesforsubmit'] = 'Nenhum arquivo encontrado - você tem certeza que carregou o arquivo no site?';
...
$string['removelink'] = 'Remover';
$string['responsefile'] = 'Arquivo de resposta:';
$string['responsefiles'] = 'Arquivos de resposta';
$string['responsesfromteacher'] = 'Respostas enviadas pelo professor';
...
$string['step1'] = 'Passo 1:';
$string['step2'] = 'Passo 2:';
...
$string['submissionstatus'] = 'Status do documento:';
$string['submissionstatusblank'] = 'Em branco';
$string['submissionstatusdraft'] = 'Esboço';
$string['submissionstatusmarked'] = 'Avaliado';
$string['submissionstatusreturned'] = 'Devolvido';
$string['submissionstatussubmitted'] = 'Enviado';
