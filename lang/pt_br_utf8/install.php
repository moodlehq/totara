...
$string['aborting'] = 'Interrompendo...n';
$string['abortinstallation'] = 'Interrompendo instalação...n';
...
$string['adminfirstname'] = 'Primeiro Nome:';
$string['admininfo'] = 'Detalhes do Administrador';
$string['adminlastname'] = 'Último Nome:';
$string['adminpassword'] = 'Senha:';
$string['adminusername'] = 'Nome do Usuário:';
$string['askcontinue'] = 'Continuar (sim/não):';
$string['availabledbtypes'] = 'n tipos de db disponível';
$string['availablelangs'] = 'Lista de n idiomas disponíveis';
$string['cannotconnecttodb'] = 'Não pode conectar ao db n';
$string['caution'] = 'Atenção';
$string['checkingphpsettings'] = 'Verificando configurações PHP';
...
$string['configfilecreated'] = 'Arquivo de configuração criado com sucesso';
$string['configfiledoesnotexist'] = 'Arquivo de configuração não existe!!!';
...
$string['configurationfileexist'] = 'Arquivo de configuração já existe!n';
$string['creatingconfigfile'] = 'Criando arquivo de configuração...n';
...
$string['databasesettingsformoodle'] = 'Configurações do banco de dados para Moodle';
...
$string['databasetype'] = 'Tipo do banco de dados:';
$string['databaseuser'] = 'Usuário do banco de dados:';
$string['dataroot'] = 'Diretório de dados';
$string['datarooterror'] = 'O \'Diretório de dados\' indicado não foi encontrado e não foi possível criar um novo diretório. Corrija a indicação do percurso ou crie o diretório manualmente.';
$string['datarootpublicerror'] = 'O diretório de dados que você indicou é acessível no web, é melhor escolher um outro diretório.';
...
$string['dbcreationerror'] = 'Erro de criação de base de dados. Não foi possível criar o nome da base de dados indicado com os parâmetros fornecidos.';
...
$string['disagreelicense'] = 'A atualização não poderá continuar devido a discordância com GPL!';
...
$string['downloadlanguagepack'] = 'nnVocê deseja fazer o download do pacote de idiomas agora(sim/não):';
...
$string['downloadsuccess'] = 'Download do pacote de idiomas com sucesso';
$string['doyouagree'] = 'Está de acordo? (sim/não):';
...
$string['errorsinenvironment'] = 'Erros no ambiente!n';
$string['fail'] = 'Erro';
...
$string['installationiscomplete'] = 'A instalação está completa !n';
$string['invalidargumenthelp'] = 'Erro: Argumento(s) inválido(s)
Utilização: OPÇÕES \$php cliupgrade.php
Utilize a função ajuda para obter mais informações';
$string['invalidemail'] = 'E-mail inválido';
$string['invalidhost'] = 'Host inválido';
$string['invalidint'] = 'Erro: o valor não é um número inteiro';
$string['invalidintrange'] = 'Erro: o valor está fora da margem de validade';
$string['invalidpath'] = 'Caminho inválido';
$string['invalidsetelement'] = 'Erro: o valor fornecido não está nas alternativas de opções';
$string['invalidtextvalue'] = 'Valor de texto inválido';
$string['invalidurl'] = 'URL inválida';
$string['invalidvalueforlanguage'] = 'Valor inválido para opção de idioma. Digite ajuda para mais informações';
$string['invalidyesno'] = 'Erro: o valor não é um argumento válido sim/não';
...
$string['locationanddirectories'] = 'Locaalização e diretórios';
...
$string['pass'] = 'OK';
$string['pearargerror'] = 'A biblioteca PEAR não identificou os argumentos';
...
$string['releasenoteslink'] = 'Para informações sobre esta versão do Moodle, ver Notas de Liberação em $a';
...
$string['selectlanguage'] = 'Selecionando o idioma para instalação';
...
$string['siteinfo'] = 'Detalhes do site';
$string['sitenewsitems'] = 'Novos itens:';
$string['siteshortname'] = 'Nome curto do site:';
$string['sitesummary'] = 'Resumo do site:';
$string['skipdbencodingtest'] = 'Saltar Teste de Codificação da Base de Dados';
$string['tableprefix'] = 'Prefixo da tabela:';
$string['unsafedirname'] = 'Erro: caracteres não confiáveis no nome do diretório. Os caracteres validos são a-zA-Z0-9_-n';
$string['upgradingactivitymodule'] = 'Atualizando módulo de atividade';
$string['upgradingbackupdb'] = 'Atualizando o banco de dados de backup';
$string['upgradingblocksdb'] = 'Atualizando o banco de dados dos blocos';
$string['upgradingblocksplugin'] = 'Atualizando o Plugin dos Blocos';
$string['upgradingcompleted'] = 'Atualização completa...';
$string['upgradingcourseformatplugin'] = 'Atualizando o Plugin do Formato do Curso';
$string['upgradingenrolplugin'] = 'Atualizando o Plugin de Registro';
$string['upgradinggradeexportplugin'] = 'Atualizando o Plugin de Exportação de Nota';
$string['upgradinggradeimportplugin'] = 'Atualizando o Plugin de Importação de Nota';
$string['upgradinggradereportplugin'] = 'Atualizando o Plugin do Relatório de Nota';
$string['upgradinglocaldb'] = 'Atualizando o Banco de Dados Local';
$string['upgradingmessageoutputpluggin'] = 'Atualizando o Plugin de Resultado de Mensagem';
$string['upgradingqtypeplugin'] = 'Atualizando o Plugin Tipo/Questão';
$string['upgradingrpcfunctions'] = 'Atualizando as Funções RPC';
$string['usagehelp'] = 'Sinopse:
\$php cliupgrade.php OPÇÕESn
OPÇÕES
--idioma válido instalado Idioma para instalação. Padrão em Inglês(eng)
--webaddr Endereço web para o site Moodle
--moodledir Localização da pasta web moodle
--datadir Localização da pasta de dados moodle (não estará visível na web)
--dbtype Tipo do banco de dados. Padrão é mysql
--dbhost Host do banco de dados. Padrão é localhost
--dbname Nome do banco de dados. Padrão é o moodle
--dbuser Usuário do banco de dados. Padrão é vazio
--dbpass Senha do banco de dados. Padrão é vazio
--prefix Prefixo da tabela para as tabelas do banco de dados acima. Padrão é mdl
--verbose 0 Sem resultado, 1 resultado resumido(Padrão), 2 resultados detalhados
--interactivelevel 0 Não interativo, 1 semi interativo(Padrão), 2 interativo
--agreelicense Yes(Padrão) ou Não
--confirmrelease Yes(Default) ou Não
--sitefullname Nome completo para o site. Padrão é : Site Moodle (Mudar o Nome do Site!!)
--siteshortname Nome curto para o site. Padrão é moodle
--sitesummary Resumo do site. Padrão é vazio
--adminfirstname Primeiro nome do administrador. Padrão é Admin
--adminlastname Último nome do administrador. Padrão é User
--adminusername Nome de usuário para o administrador. Padrão é admin
--adminpassword Senha para o administrador. Padrão é admin
--adminemail Email do administrador. Padrão é root@localhost
...
$string['versionerror'] = 'Usuário interrompido devido ao erro de versão';
...
$string['welcometext'] = 'nn---Bem-vindo a linha de comando moodle instalador---nn';
$string['writetoconfigfilefaild'] = 'Erro: Grave para configurar o arquivo com falha';
