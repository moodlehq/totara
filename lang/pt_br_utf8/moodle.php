...
$string['back'] = 'Voltar';
$string['backtoallcategories'] = 'Voltar para todas as categorias';
$string['backtoallcourses'] = 'Voltar para todos os cursos';
$string['backtoallprograms'] = 'Voltar para todos os programas';
...
$string['badcontext'] = 'Contexto ruim';
$string['block'] = 'Bloco';
...
$string['browseallcategories'] = 'Navegar em todas as categorias';
...
$string['categorys'] = 'Percorrer as categorias';
...
$string['commentsrequirelogin'] = 'Você precisa realizar o login para visualizar os comentários';
...
$string['coursecompletiondata'] = 'Dados do término do curso';
$string['coursecompletions'] = 'Términos de curso';
...
$string['coursesinthiscategory'] = 'Cursos nesta categoria ({$a})';
...
$string['creatingcompetencyevidencedata'] = 'Criando dados de evidência de competência';
$string['creatingconditionalavailabilitydata'] = 'Criando dados disponíveis condicionais';
$string['creatingcoursecompletiondata'] = 'Criando dados de término de curso';
...
$string['databasechecking11'] = 'Atualizando o banco de dados da Totara...';
$string['databasecompare'] = 'De:<br /><br /> $a->oldversion<br /><br /> Para:<br /><br /> $a->newversion';
...
$string['displaylanguagepanel'] = 'Mostrar painel de idioma';
...
$string['editortoggle'] = 'Modo aprimorado de edição de texto alternado';
...
$string['formatdemo'] = 'Formato de demonstração';
...
$string['hiddenfromstudents'] = 'Oculto dos estudantes';
...
$string['legacythemeinuse'] = 'Este site está sendo exibido em modo de compatibilidade devido a versão antiga do seu navegador.';
...
$string['manageruser'] = 'Gerenciar usuário';
$string['manageruserdescription'] = 'Os gerentes poderão administrar outros usuários';
...
$string['morethanonerecordinfetch'] = 'Erro: mais de um registro retornou (tabela \'$a\')';
...
$string['nocategoriesfound'] = 'Nenhuma categoria foi encontrada com as palavras \'$a\'';
...
$string['nomatchingusers'] = 'Nenhum usuário corresponde \'{$a}\'';
...
$string['passwordreused'] = 'Esta senha já foi usada anteriormente e não poderá ser reutilizada';
...
$string['returntocourse'] = 'Retornar ao curso';
...
$string['searchresultsinx'] = 'Buscar resultados em {$a}';
...
$string['writingcompetencyevidenceinfo'] = 'Escrevendo informações de evidência de competência';
