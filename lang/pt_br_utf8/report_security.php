...
$string['check_courserole_anything'] = 'A ação \"doanything\" não deve ser permitida neste <a href=\"$a\">contexto</a>';
$string['check_courserole_details'] = '<p>Cada curso tem definido uma função padrão para inscrição. Por favor, certifique-se que nenhuma ação arriscada é permitida a esta função.</p><p>A única função herdada para a função padrão do curso é <em>Estudante</em>.</p>';
$string['check_courserole_error'] = 'Encontradas funções padrão de cursos definidas incorretamente!';
$string['check_courserole_name'] = 'Funções padrão (cursos)';
$string['check_courserole_notyet'] = 'Usado apenas função padrão de curso.';
$string['check_courserole_ok'] = 'As permissões dos papéis padrão de curso estão OK.';
$string['check_courserole_risky'] = 'Ações arriscadas foram encontradas no <a href=\"$a\">contexto</a>';
$string['check_courserole_riskylegacy'] = 'Função herdada arriscada encontrada em <a href=\"$a->url\">$a->shortname</a>.';
$string['check_defaultcourserole_anything'] = 'A ação \"doanything\" não deve ser permitida neste <a href=\"$a\">contexto</a>';
$string['check_defaultcourserole_details'] = '<p>A função padrão de estudante para inscrições nos cursos define a função padrão nos cursos. Por favor, certifique-se que nenhuma ação arriscada é permitida a esta função.</p><p>A única função herdada suportada para a função padrão é <em>Estudante</em>.</p>';
$string['check_defaultcourserole_error'] = 'Encontrada função padrão de curso \"$a\" definida incorretamente!';
$string['check_defaultcourserole_legacy'] = 'Função herdada arriscada encontrada.';
$string['check_defaultcourserole_name'] = 'Função padrão no curso (global)';
$string['check_defaultcourserole_notset'] = 'A função padrão não está definida.';
$string['check_defaultcourserole_ok'] = 'As permissões da função padrão do site estão OK.';
$string['check_defaultcourserole_risky'] = 'Ações arriscadas foram encontradas no <a href=\"$a\">contexto</a>';
$string['check_defaultuserrole_details'] = '<p>Todos os usuários autenticados recebem as permissões da função padrão. Por favor, certifique-se que nenhuma ação arriscada é permitida a este usuário.</p><p>A única função herdada suportada para esta função é <em>Usuário autenticado</em>. A ação de visualizar curso não deve estar habilitada.</p>';
$string['check_defaultuserrole_error'] = 'A função padrão \"$a\" está definida incorretamente!';
$string['check_defaultuserrole_name'] = 'Função padrão para todos usuários';
$string['check_defaultuserrole_notset'] = 'A função padrão não está definida.';
$string['check_defaultuserrole_ok'] = 'As permissões da função padrão para todos os usuários estão OK.';
...
$string['check_frontpagerole_ok'] = 'As permissões da função da página inicial estão OK.';
