...
/**
 * Strings for component 'resource', language 'pt_br', branch 'MOODLE_22_STABLE'
 *
 * @package   resource
...
$string['configframesize'] = 'Quando uma página web ou um arquivo é visualizado em um frame, este valor é a alturata, em pixels, do frame que contém a navegação (top frame).';
...
$string['printheading'] = 'Exibir o nome do recurso';
