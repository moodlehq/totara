 ...
 *
 * Strings for component 'totara_customfield', language 'pt_br', branch 'totara-2.2'
 * @package totara
...
$string['customfieldcategories_help'] = '**Categorias de campo personalizado** permitem configurar categorias personalizadas para conter campos personalizados em um nível de profundidade.
...
$string['customfieldcategory_help'] = 'Uma **Categoria** é criada para agrupar campos personalizados adicionais em uma página, por exemplo, em uma página de competência, posições ou organizações.';
$string['customfieldcategoryname_help'] = 'O nome da **Categoria do campo personalizado** ajuda a agrupar os tipos de campos personalizados necessários e deve ser exclusivo para o nível de profundidade no qual você está trabalhando

Digite o nome e clique em **Salvar alterações**.';
$string['customfieldcolumnstextarea_help'] = '**Colunas** define a largura da área de texto que estará disponível.';
$string['customfielddefaultdatacheckbox_help'] = 'Quando configurada como Sim, a caixa de seleção do Campo personalizado será marcada por padrão.

Quando configurado como Não, a caixa de seleção do Campo personalizado será desmarcada por padrão.';
$string['customfielddefaultdatamenu_help'] = 'Configure um valor padrão que irá aparecer na caixa suspensa. O valor padrão deve aparecer nas opções do menu acima.

Deixe em branco se nenhuma inserção padrão for exigida.';
$string['customfielddefaultdatatext_help'] = 'Valor padrão é o texto que irá aparecer no campo do texto por padrão.

Deixe esse campo em branco se nenhum texto padrão for necessário.';
$string['customfielddefaultdatatextarea_help'] = 'Valor padrão é o texto que irá aparecer na área do texto por padrão.

Deixe esse campo em branco se nenhum texto padrão for necessário.';
$string['customfieldfieldsizetext_help'] = 'O tamanho da exibição configura o número de caracteres que serão exibidos no campo de texto.';
$string['customfieldforceunique_help'] = 'Quando configurado como Sim, o campo personalizados só aceitará um valor exclusivo. Se um valor duplicado for usado neste campo, o sistema não permitirá que o item seja salvo.

Quando configurado como Não, o campo personalizado aceitará qualquer valor no campo.';
$string['customfieldfullname_help'] = 'Nome completo do campo personalizado é o título completo desse campo.';
$string['customfieldhidden_help'] = 'Quando configurado como Sim, o campo personalizado não será visível na página de configurações ou em outros lugares em que ele seria mostrado. Quando Não, o campo personalizado será visível.';
$string['customfieldlocked_help'] = 'Quando configurado como Sim, o campo personalizado só exibirá as informações configuradas quando o campo foi configurado. O campo não pode ser editado.';
$string['customfieldmaxlengthtext_help'] = 'O comprimento máximo configura o número máximo de caracteres que o campo de texto irá aceitar.';
$string['customfieldmenuoptions_help'] = 'Insira as opções do menu que serão exibidas na caixa suspensa.

Insira apenas uma opção por linha.';
$string['customfieldrequired'] = 'Este campo é exigido?';
$string['customfieldrequired_help'] = 'Este campo é exigido? Se configurado como Sim, este campo é compulsório ao criar novos itens neste nível de profundidade.

Se configurado como Não, ele é opcional ao criar novos itens neste nível de profundidade.';
$string['customfieldrowstextarea_help'] = 'Configure a altura da área do texto que estará disponível (número de linhas)';
$string['customfields'] = 'Campos personalizados';
$string['customfieldshortname_help'] = 'O nome curto do campo personalizado é o nome abreviado do campo personalizado e pode ser usado para fins de exibição.
