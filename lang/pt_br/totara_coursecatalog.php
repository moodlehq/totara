 ...
 *
 * Strings for component 'totara_coursecatalog', language 'pt_br', branch 'totara-2.2'
 * @package totara
 * @subpackage totara_coursecatalog
 */

$string['backtocategoryx'] = 'Voltar para {$a}';
$string['backtocourselisting'] = 'Voltar para a lista de cursos';
$string['backtoparent'] = '&laquo; Voltar para diretório pai';
$string['browsebycategory'] = 'Navegar por categoria';
...
$string['orviewcourses'] = 'ou visualizar cursos nesta categoria ({$a})';
$string['orviewprograms'] = 'ou visualizar programas nesa categoria ({$a})';
$string['performsearchoncourses'] = 'ou realize esta busca nos cursos';
$string['performsearchonprograms'] = 'ou realize esta busca nos programas';
...
$string['searchallcategories'] = 'Buscar todas as categorias';
$string['searchallcourses'] = 'Buscar todos os cursos';
$string['searchallprograms'] = 'Buscar todos os programas';
$string['searchcategories'] = 'Buscar categorias';
$string['searchcategoriesmatchesplural'] = '{$a->count} categorias correspondem a busca "{$a->terms}"';
$string['searchcategoriesmatchessingle'] = '1 categoria corresponde a busca "{$a->terms}"';
$string['searchcategoriesshowall'] = 'Mostrando todas as categorias';
$string['searchcourses'] = 'Buscar cursos';
$string['searchcoursesmatchesplural'] = '{$a->count} cursos correspondem a busca "{$a->terms}"';
$string['searchcoursesmatchessingle'] = '1 curso corresponde a busca "{$a->terms}"';
$string['searchcoursesshowall'] = 'Mostrando todos os cursos';
$string['searchprogramsmatchesplural'] = '{$a->count} programas correspondem a busca "{$a->terms}"';
$string['searchprogramsmatchessingle'] = '1 programa corresponde a busca "{$a->terms}"';
$string['searchprogramsshowall'] = 'Mostrando todos os programas';
$string['showallcategorys'] = 'Mostrar todas as categorias';
$string['showallcourses'] = 'Mostrar todos os cursos';
$string['showallprograms'] = 'Mostrar todos os programas';
$string['skipmanager'] = 'Não enviar para o líder de equipe/gerente';
$string['subject'] = 'Assunto';
$string['therearenocoursestodisplay'] = 'Não há cursos para exibição';
$string['title'] = 'Título';
$string['tracking'] = 'Monitorar';
$string['viewallcategories'] = 'Visualizar todas as categorias';
$string['viewallcourses'] = 'Visualizar todos os cursos';
