...
$string['err_invalidhost_help'] = 'Este plugin está mal configurado para apontar para um host do MNet inválido (ou excluído). Este plugin se baseia em pares Moodle Networking com SSO IDP publicou, SSO_SP subscrito e portfólio subscrito **e** publicado.';
...
$string['err_nomnethosts_help'] = 'Este plugin se baseia em pares MNet com SSO IDP publicou, SSO SP subscrito, portfólio de serviços publicados **e** subscrito, bem como o plugin de autenticação MNet. Todas as instâncias deste plugin foram escondidos até que essas condições sejam cumpridas. Eles, então, manualmente precisa definir a visível novamente.';
