...
* Para informações sobre como carregar módulos Qedoc ver: \[documentação Qedoc: Uploading\_modules\] (http://www.qedoc.org/en/index.php?title=Uploading\_modules)';
...
** Filtro de mídia do HotPot ** : O conteúdo passará por filtros que detectam links, imagens, sons e vídeos, que devem ser especificados usando uma notação de colchetes. Esta notação de colchetes tem a seguinte sintaxe: \` [url do player com opções delargura e altura] \`
