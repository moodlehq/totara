...
/**
 * Strings for component 'editor_tinymce', language 'pt_br', branch 'MOODLE_22_STABLE'
 *
...
$string['advanced:backcolor_desc'] = 'Selecionar cor de fundo';
...
$string['advanced:clipboard_msg'] = 'Copiar/recortar/colar não está disponível no Mozilla e Firefox. Deseja mais informações sobre este problema?';
...
$string['advanced:cut_desc'] = 'Recortar';
...
$string['advanced_dlg:link_target_blank'] = 'Abrir link em nova janela';
...
$string['advanced:indent_desc'] = 'Indentar';
...
$string['advanced:outdent_desc'] = 'Diminuir recuo';
...
$string['advimage_dlg:missing_alt'] = 'Tem certeza que deseja continuar sem acrescentar uma descrição à imagem? Sem ela a imagem pode não ser acessível a alguns usuários com deficiências, ou àqueles utilizando navegadores modo texto, ou navegando na web com imagens desligadas.';
...
$string['common:browseimage'] = 'Encontrar ou enviar uma imagem...';
$string['common:browsemedia'] = 'Encontrar ou enviar um som, vídeo ou applet...';
$string['common:cancel'] = 'Cancelar';
$string['common:class_name'] = 'Classe';
$string['common:clipboard_msg'] = 'Copiar/recortar/colar não está disponível no Mozilla e Firefox.
...
$string['dragmath:dragmath_desc'] = 'Inserir equação';
$string['dragmath:dragmath_javaneeded'] = 'Para utilizar esta página você precisa de um navegador com Java habilitado. Baixe o último plug-in Java em {$a}.';
$string['dragmath:dragmath_title'] = 'Editor de Equações DragMath';
...
$string['media:desc'] = 'Inserir/Editar mídia embedded';
...
$string['media_dlg:filename'] = 'Nome do arquivo';
...
$string['media_dlg:qt_stream_warn'] = 'Recursos de stream rtsp devem ser acrescentados ao campo QT Src na aba avançado.
Uma versão não-stream também deve ser acrescentada ao campo Src.';
...
$string['media_dlg:title'] = 'Inserir/Editar mídia embedded';
...
$string['paste:plaintext_mode_sticky'] = 'Comando colar está em modo texto simples. Clique novamente para voltar para o modo normal. Depois de colar alguma coisa você retornará para o modo normal.';
...
$string['table_dlg:thead'] = 'Cabeçalho da tabela';
