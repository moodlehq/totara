...
/**
 * Strings for component 'calendar', language 'pt_br', branch 'MOODLE_22_STABLE'
 *
 * @package   calendar
...
$string['pref_lookahead_help'] = 'Isso define o número (máximo) de dias no futuro em que um evento deverá começar de modo a ser exibido como um evento futuro. Eventos que iniciam além desta não serão exibidos como futuros. Por favor note que **não há garantias ** que todos os eventos iniciados neste período serão exibidos; se houver muitos (mais do que o "Total de eventos futuros"), então os eventos mais distantes não serão exibidos.';
...
$string['quickdownloadcalendar'] = 'Download veloz / assinar o calendário';
