...
$string['stickyblocksmymoodle'] = 'Minun Moodleni';
...
$string['uploaduserspreview'] = 'Lähetä käyttäjän esikatselunäkymä';
$string['uploadusersresult'] = 'Lähetä käyttäjän tulokset';
...
$string['verifychangedemail'] = 'Rajoita domaineja kun sähköpostiosoitetta vaihdetaan';
