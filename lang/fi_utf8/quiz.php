...
$string['browsersecurity'] = 'Selaimen turvallisuus';
...
$string['importparseerror'] = 'Tiedoston jäsentämisessä tapahtui virhe/virheitä. Yhtään kysymystä ei tuotu. Tuodaksesi kelpaavat kysymykset, valitse \'Lopeta virheen sattuessa\' -valikossa \'Ei\'.';
...
$string['nogradewarning'] = 'Tätä tenttiä ei ole arvosteltu, joten et voi määritellä palautetta, joka määräytyy arvostelun perusteella.';
...
$string['popupwithjavascriptsupport'] = 'Koko näytön pop-up -ikkuna JavaScript-suojauksella';
...
$string['quiz:reviewmyattempts'] = 'Tarkastele omia yrityksiäsi';
...
$string['requiresafeexambrowser'] = 'Vaadi Safe Exam Browser -selaimen käyttöä';
...
$string['reviewresponsetoq'] = 'Tarkastele vastausta (kysymys $a)';
$string['rqp'] = 'Etäkysymys';
$string['rqps'] = 'Etäkysymykset';
$string['safebrowsererror'] = 'Tentti on määritely siten, että sen suoritusta voi yrittää ainoastaan käyttäen Safe Exam Browser -selainta. Et voi suorittaa tenttiä tällä selaimella.';
$string['safebrowsernotice'] = 'Tämä tentti on konfiguroitu niin, että oppijat voivat yrittää sen suorittamista vain käyttäen Safe Exam Browser -selainta.';
