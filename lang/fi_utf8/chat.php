...
$string['idle'] = 'Tyhjä';
$string['list_all_sessions'] = 'Listaa kaikki istunnot.';
$string['list_complete_sessions'] = 'Listaa vain lopetetut istunnot.';
$string['listing_all_sessions'] = 'Listataan kaikki istunnot.';
...
$string['no_complete_sessions_found'] = 'Lopetettuja istuntoja ei löytynyt.';
...
$string['notallowenter'] = 'Sinulla ei ole oikeuksia tähän chat-huoneeseen.';
$string['oldping'] = 'Yhteyden katkaisun aikaraja';
$string['pastchats'] = 'Menneet chat istunnot';
$string['refreshroom'] = 'Päivitä huone';
$string['refreshuserlist'] = 'Päivitä käyttäjälista';
...
$string['servermax'] = 'Käyttäjien maksimimäärä';
