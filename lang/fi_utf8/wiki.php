...
$string['binimgtoolarge'] = 'Kuvatiedosto on liian iso!';
...
$string['diff'] = 'Erot';
$string['differences'] = 'Erot versioiden $a->new_ver ja $a->old_ver välillä sivulla $a->pagename.';
$string['disablecamel'] = 'Estä KameliKirjasin-linkittäminen';
...
$string['errorhtml'] = 'Sivu on tyyppiä HTML';
$string['errornotype'] = 'Virhe: Sivu ei ole tyyppiä  BIN eikä TXT';
...
$string['errversionsave'] = 'Sillä aikaa kun muokkasit sivua joku muu tallensi muuttuneen version. Palaa edelliseen näkymään ja kopioi tekemäsi muutokset koneesi leikepöydälle ja liitä ne uudelleen sivulle.';
...
$string['meta'] = 'Metatiedot';
$string['moduledirectory'] = 'Moduulihakemisto';
...
$string['noadministrationaction'] = 'Ylläpitotoimintoa ei annettu';
...
$string['nojslockwarning'] = 'Koska JavaScriptin käyttö on estetty selaimessasi, on mahdollista että joku muu voi muokata tätä sivua. Jos näin käy, et voi tallentaa muutoksiasi. Tee muutoksesi nopeasti tai pistä JavaScript päälle ja lataa tämä sivu uudelleen,';
...
$string['pagelocked'] = '<p><strong>$a->name muokkaa tätä sivua</strong>. Hän aloitti muokkauksen $a->since ja muokkausikkuna on ollut aktiivinen $a->seen alkaen.</p><p>Sinun täytyy odottaa, että $a->name lopettaa muokkauksen ennen kuin voit muokata tätä sivua.</p>';
...
$string['removenotice'] = 'Huomaa, että ainoastaan orposivut ovat listattuina tässä. Koska wiki testaa sivujen linkityksen vain osittain, voivat jotkut linkitetytkin sivut näkyä luettelossa.';
...
$string['revertlastonly'] = 'Vain, jos se on viimeinen muutos';
...
$string['savenolock'] = 'Et voi tallentaa tätä sivua koska sivun muokkausta ei ole lukittu sinulle. Näin voi käydä, jos selaimessasi ei ole JavaScriptin tukea. Palaa takaisin edelliselle sivulle painamalla selaimesi Takaisin-painiketta ja kopioi tekemäsi muutokset. Yritä muokkausta sen jälkeen uudelleen.';
...
$string['uplerror'] = 'Tiedoston lähettäminen epäonnistui';
...
$string['wikilinkoptions'] = 'Wikin automaattilinkityksen määritykset';
