...
$string['calculationofthefinalgrade'] = 'Lopulliset lasketut arvioinnit';
...
$string['displayofgrades'] = 'Milloin arvioinnit näytetään';
...
$string['gradingaccepted'] = 'Arviointi hyväksytty  $a kerran jälkeen';
$string['gradingacceptedon'] = 'Arviointi hyväksytty';
$string['gradingby'] = 'Arvioija $a';
$string['gradingdetails'] = 'Arvioinnin yksityiskohdat';
$string['gradinggiventothissubmission'] = 'Tälle tehtävälle annettu arviointi';
$string['gradingperformance'] = 'Arvioinnin tehokkuus';
$string['gradingrepliedtoon'] = 'Arviointiin vastattu';
$string['gradingsdone'] = 'Arviointi suoritettu [Vertaiskeskiarvo]';
$string['includeself'] = 'Opiskelija arvioi myös oman työnsä';
...
$string['nosubmissions'] = 'Palautuksia ei ole vastaanotettu';
$string['nosubmissionsgraded'] = 'Tällä hetkellä ei ole arvioituja tai uudelleen arvioituja palautuksia.';
...
$string['notenoughmarked'] = 'Valittuja tehtäviä ei ole riittävästi jotta  jaetut työt pitäisivät sisällään vähintään yhden huonon ja yhden hyvän tehtävän.';
$string['noteonassessmentelements'] = 'huomaa että vertaisarvioisun tehvän arvioiti on jaettu useisiin \'Arviointi elementteihin\'.<br />
	Tämä tekee arvioinnista helpompaa ja yhdenmukaisempaa. Opettaja sinun pitää lisätä nämä \'Arviointi Elementit\' ennen tehtävän antamista opiskelijoille.
	Tämä tehdään napsauttamalla lisättyä vertaiarvioitua tehtävää ja valitsemalla ensimmäinen vaihtoehto &quot;Vartaisarvioidun tehtävän hallinta&quot valikosta.';
...
$string['numberofassessors'] = 'Vertaisarvioitsijoiden määrä per työ';
...
$string['regradethissubmission'] = 'Uudelleen arvioi tämä tehtävä';
...
$string['removepeersubmissions'] = 'Poista arvioitavat tehtävät opiskelijoilta';
$string['reply'] = 'Vastaa';
...
$string['submissionsawaitingregrading'] = 'Uudelleen arviointia odottavat tehtävät ($a)';
...
$string['warningonamendingelements'] = 'VAROITUS: Järjestelmässä on jo suoritettu arviointeja. <br />ÄLÄ muuta elementtien lukumäärää, arviointi tapaa tai elementtien painotuksia.';
