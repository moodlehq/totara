...
$string['backtoallcategories'] = 'Takaisin kategorioihin';
$string['backtoallcourses'] = 'Takaisin kursseihin';
...
$string['backupgradebookhistoryhelp'] = 'Jos tämä toiminto on käytössä, tiedot arvosanahistoriasta ovat mukana automaattisissa varmuuskopioinneissa. Huomioi, että arvosanahistoria ei saa olla poistettu käytöstä palvelimen asetuksissa (disablegradehistory), jotta toiminto toimii.';
...
$string['backupmissinguserinfoperms'] = 'Huomio: Tässä varmuuskopiossa ei ole mukana käyttäjätietoja. Harjoitus ja Ryhmätyö -aktiviteetit eivät sisälly varmuuskopiointiin koska ne eivät ole yhteensopivia tämäntyyppisen varmuuskopioinnin kanssa.';
...
$string['browseallcategories'] = 'Selaa kategorioita';
...
$string['categorys'] = 'Kurssikategoriat';
...
$string['coursehelpcategory'] = 'Kurssin paikka kurssilistassa saattaa auttaa oppijoita sen löytämisessä.';
$string['coursehelpformat'] = 'Kurssin aloitussivu näytetään tässä muodossa.';
$string['coursehelphiddensections'] = 'Miten piilotetut osiot näytetään oppijoille.';
$string['coursehelpmaximumupload'] = 'Määrittele kuinka suuria tiedostoja kurssille voidaan tuoda, rajoituksena sivuston asetukset.';
$string['coursehelpmetacourse'] = 'Määrittele kurssi metakurssiksi. Metakurssi hakee ilmoittautumistiedot (ja muut roolitukset) \"lapsi\"kurss(e)ista.';
$string['coursehelpnewsitemsnumber'] = 'Montako viimeisintä kohdetta näytetään kurssin aloitussivulla olevassa uutisosiossa sivun oikeassa alareunassa <br/>(0 tarkoittaa, että uutisosiota ei näytetä)';
$string['coursehelpnumberweeks'] = 'Montako viikkoa/aihetta näytetään kurssin aloitussivulla.';
$string['coursehelpshowgrades'] = 'Näytä arvosanahistoria. Tämä ei estä arvosanojen näkyvyyttä yksittäisten aktiviteettien yhteydessä.';
...
$string['coursereasonforrejecting'] = 'Syy, miksi hylkäät tämän pyynnön';
$string['coursereasonforrejectingemail'] = 'Tämä lähetetään pyynnön lähettäjälle';
...
$string['coursereports'] = 'Kurssin raportit';
$string['courserequest'] = 'Kurssin anominen';
$string['courserequestdetails'] = 'Pyytämäsi kurssin tiedot';
...
$string['courserequestsupport'] = 'Lisätietoja hallinnoijalle pyynnön arvioimisen tueksi';
...
$string['coursesinthiscategory'] = 'Kurssit tässä kategoriassa ({$a})';
...
$string['creatingcompetencyevidencedata'] = 'Luodaan kompetenssitodistetietoja';
$string['creatingconditionalavailabilitydata'] = 'Luodaan ehdollisia saatavuustietoja';
$string['creatingcoursecompletiondata'] = 'Luodaan kurssin tilatietoja';
...
$string['deleteallcannotundo'] = 'Poista kaikki - peruuttamaton toiminto';
...
$string['donotclickcontinue'] = 'Älä klikkaa seuraavaa Jatka-linkkiä';
$string['down'] = 'Alas';
...
$string['editortoggle'] = 'Vaihda laajennettuun tekstinmuokkaustilaan';
$string['editremoteprofile'] = 'Muokkaa etäprofiilia';
...
$string['flashlinkmessage'] = 'Päivitä Flash player nyt:';
$string['flashupgrademessage'] = 'Tämän sisällön toistaminen vaatii Flash-lisäosan mutta versiosi siitä on vanhentunut.

Joudut mahdollisesti kirjautumaan ulos ja takaisin sisään päivityksen jälkeen.';
...
$string['forcepasswordchangecheckfull'] = 'Oletko varma, että haluat pakottaa salasanan vaihdon käyttäjälle $a?';
$string['forcepasswordchangehelp'] = 'Pakota salasanan vaihto seuraavan kirjautumisen yhteydessä';
$string['forcepasswordchangenot'] = 'Salasanan vaihtoa ei voitu pakottaa käyttäjälle $a';
...
$string['hiddenfromstudents'] = 'Piilotettu oppijoilta';
...
$string['legacythemeinuse'] = 'Sivusto näytetään mukaututetussa näkymässä koska selaimesi ei ole ajantaisainen.';
$string['license'] = 'GPL';
...
$string['manageruser'] = 'Esimieskäyttäjä';
$string['manageruserdescription'] = 'Esimiehet voivat hallinnoida muita käyttäjiä.';
...
$string['morethanonerecordinfetch'] = 'Virhe: useampi kuin yksi taulukko \'$a\' löytyi';
...
Sinulle on luotu uusi tili täällä: \'$a->sitename\' sekä uusi, väliaikainen salasana.

Sisäänkirjautumistietosi ovat:
käyttäjätunnus: $a->username
salasana: $a->newpassword
(Sinun täytyy vaihtaa salasana kun olet kirjautunut sisään ensimmäisen kerran)

Aloittaaksei sivuston \'$a->sitename\' kätyön, kirjaudu sisääb täällä: $a->link

Useimmissa sähköpostiohjelmissa ylläoleva linkki näkyy sinisenä linkkinä, jota klikkaamalla pääset kirjautumissivulle. Mikäli näin ei ole, kopioi osoite ja liitä se selaimesi yläosassa olevalle osoiteriville.

Terveisin sivuston \'$a->sitename\' hallinnoija $a->signoff';
...
$string['nocategoriesfound'] = 'Hakusanalla \'$a\' ei löytynyt kategorioita';
...
$string['nomatchingusers'] = 'Hakusanalla \'$a\' ei löytynyt käyttäjiä';
...
$string['noteusercannotrolldatesoncontext'] = '<strong>Huomio:</strong>Päivämäärien muuttaminen tämän varmuuskopion palauttamisen yhteydessä on pois käytösötä koska sinulla ei ole tarvittavia oikeuksia.';
...
$string['parentlanguage'] = '<< KÄÄNTÄJÄT: Jos käyttämälläsi kielellä on referenssikieli, jota sivuston tulisi käyttää, jos kääntämästäsi kielestä puuttuu käännöksiä, määrittele se tässä. Jos jätä tämän tyhjäksi, käytetään englantia. Esimerkki: sv >>';
...
$string['passwordreused'] = 'Tämä salasana on ollut jo käytössä, eikä sitä saa käyttää uudestaan';
...
$string['pendingrequests'] = 'Odottavat pyynnöt';
...
$string['preprocessingbackupfile'] = 'Varmuuskopiotiedostoa esikäsitellään';
...
$string['profilenotshown'] = 'Tämä profiilin kuvaus ei näy kenellekkään kunnes tämä käyttäjä on ilmoittautuneena vähintään yhdelle kurssille.';
...
$string['publicsitefileswarning2'] = 'Huomio: Kaikki, jotka tietävät (tai arvaavat) tämän web-osoitteen, pääsevät käsiksi täällä oleviin tiedostoihin. Turvallisuussyistä suositellaan varmuuskopioiden poistamista heti niiden tallentamisen jälkeen.';
$string['publicsitefileswarning3'] = 'Huomio: Kaikki, jotka tietävät (tai arvaavat) tämän web-osoitteen, pääsevät käsiksi täällä oleviin tiedostoihin. Turvallisuussyistä suositellaan varmuuskopioiden tallentamista vain turvattuun varmuuskopiokansioon.';
$string['question'] = 'Kysymys';
$string['questionsinthequestionbank'] = 'Kysymyspankit kysymykset';
...
$string['registrationinfotitle'] = 'Ilmoittautumistiedot';
...
$string['remoteappuser'] = 'Sovelluksen $a etäkäyttäjä';
$string['remotemaharauser'] = 'Mahara etäkayttäjä';
...
$string['requestedcourses'] = 'Pyydetyt kurssit';
...
$string['restorecannotassignroles'] = 'Palauttamistoiminnon on jaettava rooleja. Sinulla ei ole tarvittavia oikeuksia tähän.';
$string['restorecannotcreateorassignroles'] = 'Palauttamistoiminnon on luotava tai jaettava rooleja. Sinulla ei ole oikeuksia tehdä tätä.';
$string['restorecannotcreateuser'] = 'Palauttamistoiminnon on luotava käyttäjä \'$a\' käyttäen varmuuskopiotietoja. Sinulla ei ole tarvittavia oikeuksia tähän.';
$string['restorecannotoverrideperms'] = 'Palauttamistoiminto vaatii oikeuksia tietojen korvaamiseen. Sinulla ei ole tarvittavia oikeuksia tähän.';
$string['restorecoursenow'] = 'Palauta kurssi nyt';
$string['restoredaccount'] = 'Palautettu tili';
$string['restoredaccountinfo'] = 'Tämä tili on tuotu toiselta palvelimelta ja salasana on hävitetty. Asettaaksesi uuden salasanan sähköpostitse, valitse \"Jatka\".';
$string['restorefinished'] = 'Kurssin palautus tehty';
$string['restoreto'] = 'Palauta kohtaan';
$string['restoretositeadding'] = 'Varoitus: Olet palauttamassa etusivun tietoja, tietoa lisätään!';
$string['restoretositedeleting'] = 'Varoitus: Olet palauttamassa etusivun tietoja, nykyiset tiedot poistetaan ensin!';
$string['restoreuserconflict'] = 'Käyttäjän \'$a\' palauttaminen varmuuskopiosta aiheuttaa konfliktin';
$string['restoreuserinfofailed'] = 'Palauttamisprosessi on pysäytetty koska sinulal ei ole oikeuksia palauttaa käyttäjätietoja.';
$string['restoreusersprecheck'] = 'Tarkastetaan käyttäjän tietoja';
$string['restoreusersprecheckerror'] = 'Käyttäjän tietoja tarkastettaessa löytyi ongelmia';
...
$string['scalestip2'] = 'Voidaksesi luoda räätälöityjä asteikkoja, klikkaa Arvosnat-linkkiä kurssinhallintavalikossa ja valitse Muokkaa > Asteikot.';
...
$string['showthishelpinlanguage'] = 'Näytä tämä ohje kielellä: $a';
$string['since'] = 'Alkaen';
...
$string['skiptomaincontent'] = 'Siirry sisältöön';
...
$string['valuealreadyused'] = 'Tämä arvo on jo käytetty.';
...
$string['writingcompetencyevidenceinfo'] = 'Kirjoitetaan kompetenssitodisteiden tietoja';
