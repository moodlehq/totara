 ...
 *
 * Strings for component 'totara_customfield', language 'fi', branch 'totara-2.2'
 * @package totara
 * @subpackage totara_customfield
 */

$string['category'] = 'Kategoria';
$string['categorynamemustbeunique'] = 'Kategorian nimi (oltava uniikki)';
$string['categorynamenotunique'] = 'Tämä kategorian nimi on jo käytössä';
$string['commonsettings'] = 'Yleiset asetukset';
$string['confirmcategorydeletion'] = 'Tässä kategoriassa on {$a} kenttä(ä), joka/jotka siirretään ylempään kategoriaan (tai alempaan, jos kyseessä on ylin kategoria).<br /> Haluatko silti poistaa tämän kategorian?';
$string['confirmfielddeletion'] = 'Tässä kentässä on jo kirjauksia ({$a}), jotka poistetaan. <br />Haluatko silti poistaa tämän kentän?';
$string['coursecustomfields'] = 'Kurssin lisäkentät';
$string['createcustomfieldcategory'] = 'Luo lisäkenttäkategoria';
$string['createnewcategory'] = 'Luodaan uutta kategoriaa';
$string['createnewcustomfield'] = 'Luo uusi lisäkenttä';
$string['createnewfield'] = 'Luo uusi &quot;{$a}&quot; lisäkenttä';
$string['customfield'] = 'Lisäkenttä';
$string['customfieldcategories'] = 'Lisäkenttien kategoriat';
...
Lisäkenttien kategorioiden nimien tulee olla yksilöllisiä kyseisellä tasolla. Vähintään yksi lisäkenttäkategoria on oltava luotuna, jotta voit luoda lisäkentän.
...
$string['customfieldrequired'] = 'Onko tämä kenttä pakollinen?';
...
$string['customfieldtypecheckbox'] = 'Valintaruutu';
$string['customfieldtypefile'] = 'Tiedosto';
$string['customfieldtypemenu'] = 'Vaihtoehtovalikko';
$string['customfieldtypetext'] = 'Tekstinsyöttö';
$string['customfieldtypetextarea'] = 'Tekstialue';
$string['defaultchecked'] = 'Tarkastettu oletuksena';
$string['defaultdata'] = 'Oletusarvo';
$string['deletecategory'] = 'Poistetaan kategoriaa';
$string['deletefield'] = 'Poistetaan kenttää';
$string['description'] = 'Kentän kuvaus';
$string['editcategory'] = 'Muokataan lisäkenttäkategoriaa {$a}';
$string['editfield'] = 'Muokataan lisäkenttää {$a}';
$string['fieldcolumns'] = 'Sarakkeet';
$string['fieldispassword'] = 'Onko tämä salasanakenttä?';
$string['fieldmaxlength'] = 'Maksimipituus';
$string['fieldrows'] = 'Rivit';
$string['fieldsize'] = 'Koko';
$string['forceunique'] = 'Pitääkö tiedon olla uniikkia?';
$string['locked'] = 'Onko tämä kenttä lukittu?';
$string['menudefaultnotinoptions'] = 'Oletusarvo ei ole mikään vaihtoehdoista';
$string['menunooptions'] = 'Valikon vaihtoehtoja ei ole syötetty';
$string['menuoptions'] = 'Valikon vaihtoehdot (yksi per rivi)';
$string['menutoofewoptions'] = 'Sinun on määriteltävä vähintään 2 vaihtoehtoa';
$string['nocustomfieldcategories'] = 'Jotta voit lisätä lisäkenttiä, luo ensin lisäkenttäkategoria';
$string['nocustomfieldcategoriesdefined'] = 'Yhtään lisäkenttäkategoriaa ei ole määritelty';
$string['nocustomfieldsdefined'] = 'Yhtään kenttää ei ole määritelty';
$string['returntocategories'] = 'Palaa lisäkenttäkategorioihin';
$string['returntoframework'] = 'Palaa rakenteeseen';
$string['shortname'] = 'Lyhenne (pitää olla uniikki)';
