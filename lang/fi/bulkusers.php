...
/**
 * Strings for component 'bulkusers', language 'fi', branch 'MOODLE_22_STABLE'
 *
 * @package   bulkusers
...
$string['selectedlist_help'] = 'Käyttäjiä voidaan lisätä tai poistaa valittujen käyttäjien listalta klikkaamalla käyttäjien nimiä ja sitten klikkaamalla asianmukaista painiketta. Useita käyttäjiä voidaan valita pitämällä alhaalla Apple tai Ctrl -painiketta käyttäjiä valitessa.';
$string['users'] = 'Käyttäjät';
$string['usersfound'] = 'Löytyi {$a} käyttäjä(ä).';
$string['users_help'] = 'Kaikki käyttäjät jotka läpäisivät aktiiviset suodattimet ovat listattuna. Jos suodattimia ei ole asetettu, kaikki sivuston käyttäjät ovat listattuna.';
