...
/**
 * Strings for component 'quizaccess_password', language 'fi', branch 'MOODLE_22_STABLE'
 *
...
$string['pluginname'] = 'Salasana -tentin pääsyasetus';
$string['quizpassword'] = 'Tentin salasana';
