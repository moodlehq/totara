...
/**
 * Strings for component 'qtype_match', language 'fi', branch 'MOODLE_22_STABLE'
 *
 * @package   qtype_match
...
$string['availablechoices'] = 'Tarjolla olevat vaihtoehdot';
$string['correctansweris'] = 'Oikea vastaus on: {$a}.';
$string['filloutthreeqsandtwoas'] = 'Kysymyksiä tarvitaan vähintään kaksi ja vastausvaihtoehtoja vähintään kolme. Ylimääräisiä vääriä vastauksia voit lisätä kirjoittamalla vastauksen mutta jättämällä kysymys-kentän tyhjäksi. Jos sekä kysymys- että vastauskentät ovat tyhjiä, syötettyä kysymystä ei huomioida.';
$string['nomatchinganswer'] = 'Sinun pitää antaa yhteensopiva vastaus kysymykseen \'{$a}\'.';
$string['nomatchinganswerforq'] = 'Tälle kysymykselle pitää antaa vastaus.';
$string['notenoughqsandas'] = 'Kysymyksiä tarvitaan vähintään {$a->q} ja vastauksia vähintään {$a->a}.';
