...
/**
 * Strings for component 'imscp', language 'fi', branch 'MOODLE_22_STABLE'
 *
 * @package   imscp
...
$string['areabackup'] = 'Pakettiarkisto';
$string['areacontent'] = 'Sisältö';
$string['contentheader'] = 'Sisältö';
$string['deploymenterror'] = 'Sisällön pakkaamisvirhe!';
$string['imscp:view'] = 'Näytä IMS sisältö';
...
$string['page-mod-imscp-x'] = 'Kaikki IMS-sisältöpakettimoduulien sivut';
$string['pluginadministration'] = 'IMSCP hallinnointi';
$string['pluginname'] = 'IMS-sisältöpaketti';
