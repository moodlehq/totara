...
/**
 * Strings for component 'editor_tinymce', language 'fi', branch 'MOODLE_22_STABLE'
 *
...
$string['advanced_dlg:image_src'] = 'Kuvan web-osoite';
...
$string['advanced_dlg:link_url'] = 'Linkin web-osoite';
...
$string['advimage_dlg:src'] = 'Kuvan web-osoite';
...
$string['advlink_dlg:is_email'] = 'Syöttämäsi web-osoite näyttää olevan sähköpostiosoite, haluatko lisätä mailto:-etuliitteen?';
$string['advlink_dlg:is_external'] = 'Syöttämäsi web-osoite näyttää olevan sivuston ulkoinen osoite, haluatko lisätä http://-etuliitteen?';
...
$string['advlink_dlg:popup_url'] = 'Ponnahdusikkunan web-osoite';
...
$string['advlink_dlg:url'] = 'Linkin web-osoite';
...
$string['common:browseimage'] = 'Etsi tai lähetä kuva...';
$string['common:browsemedia'] = 'Etsi tai lähetä ääni, video tai sovelma...';
$string['common:cancel'] = 'Peruuta';
$string['common:class_name'] = 'Luokka';
$string['common:clipboard_msg'] = 'Kopioi/Leikkaa/Liitä ei ole käytettävissä Mozilla ja Firefox -selaimilla. Haluatko lisätietoa tästä ongelmasta?';
...
$string['dragmath:dragmath_desc'] = 'Aseta yhtälö';
$string['dragmath:dragmath_javaneeded'] = 'Tämän sivun käyttämiseen täytyy selaimessa olla käytössä Java. Lataa viimeisin Java plug-in osoitteesta {$a}.';
$string['dragmath:dragmath_title'] = 'DragMath kaavaeditori';
...
$string['media_dlg:autogotourl'] = 'Mene automaattisesti web-osoitteeseen';
...
$string['media_dlg:baseurl'] = 'Perus web-osoitteet';
...
$string['media_dlg:file'] = 'Tiedosto/web-osoite';
$string['media_dlg:filename'] = 'Tiedostonimi';
...
$string['media_dlg:invokeurls'] = 'Kutsu web-osoitteet';
...
$string['media_dlg:qt_stream_warn'] = 'Streamatut rtsp-resurssit tulisi lisätä QT Src -kenttään edistynyt-välilehdelle. Sinun kannattaa lisätä myös ei-streamattu versio Src-kenttään..';
...
$string['moodleemoticon:desc'] = 'Lisää hymiö';
$string['moodlenolink:desc'] = 'Estä automaattinen linkitys';
...
$string['paste:plaintext_mode'] = 'Liitä on nyt pelkkä teksti -tilassa. Klikkaa uudestaan vaihtaaksesi takaisin tavalliseen liitä -tilaan.';
$string['paste:plaintext_mode_sticky'] = 'Liitä on nyt pelkkä teksti -tilassa. Klikkaa uudestaan vaihtaaksesi takaisin tavalliseen liitä -tilaan. Kun liität jotakin, palaat takaisin tavalliseen liitä -tilaan.';
