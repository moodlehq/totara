...
/**
 * Strings for component 'folder', language 'fi', branch 'MOODLE_22_STABLE'
 *
 * @package   folder
...
$string['page-mod-folder-view'] = 'Kansiomoduulin pääsivu';
$string['page-mod-folder-x'] = 'Kaikki kansiomoduulin sivut';
$string['pluginadministration'] = 'Kansion hallinnointi';
$string['pluginname'] = 'Kansio';
