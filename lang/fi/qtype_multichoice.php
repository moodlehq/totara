...
/**
 * Strings for component 'qtype_multichoice', language 'fi', branch 'MOODLE_22_STABLE'
 *
...
$string['errgradesetanswerblank'] = 'Arvosana asetettu mutta vastaus on tyhjä';
$string['feedback'] = 'Palaute';
$string['fillouttwochoices'] = 'Valitse ainakin kaksi vaihtoehtoa. Tyhjäksi jätettyjä valintoja ei käytetä.';
...
$string['overallincorrectfeedback'] = 'Palaute mistä tahansa väärästä vastauksesta';
