...
/**
 * Strings for component 'moodle', language 'fi', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['alphanumerical'] = 'Voi sisältää ainoastaan kirjaimia tai numeroita, tavuviiva tai piste.';
...
$string['blockdeleteconfirm'] = 'Olet poistamassa lopullisesti lohkoa \'{$a}\'. Tämä poistaa kaikki lohkoon liittyvät tiedostot tietokannasta. Haluatko varmasti jatkaa?';
...
$string['coursehelphiddensections'] = 'Miten kurssin piilotetut osat näytetään opiskelijoille';
...
$string['coursehelpnewsitemsnumber'] = 'Uutisten lukumäärä Viimeisimmät uutiset -lohkossa (0 tarkoittaa, että Viimeisimmät uutiset -lohko ei näy lainkaan)';
$string['coursehelpnumberweeks'] = 'Kurssisivulla näytettävien viikkojen / aiheiden lukumäärä';
...
$string['coursesummary_help'] = 'Kurssin yhteenveto näytetään kurssilistauksessa. Kurssien hakutoiminto etsii yhteenvetotekstistä kurssien nimien lisäksi.';
...
{$a->admin}';
$string['emailpasswordconfirmationsubject'] = '{$a}: Muuta salasanan vahvistusta';
...
<p>Viestissä on ohjeet salasanan vahvistamisesta. Jos salasanan vaihtaminen ei kuitenkaan onnistu, ota yhtettä sivuston ylläpitäjään.</p>';
...
$string['enterusername'] = 'Syötä käyttäjänimesi';
...
$string['expirynotify'] = 'Kurssillaoloajan päättymisen ilmoitus';
...
$string['forcedmodeinbrackets'] = '{$a} (pakotettu tila)';
...
$string['hidetopicfromothers'] = 'Piilota aihe';
$string['hideweekfromothers'] = 'Piilota viikko';
...
$string['htmleditor'] = 'Käytä Rich Text -editoria';
...
$string['localplugindeleteconfirm'] = 'Olet poistamassa paikallisen pluginin \'{$a}\'. Tämä poistaa tietokannasta kaiken, mikä liittyy tähän pluginiin. Oletko varma, että haluat jatkaa?';
...
$string['missingstrings'] = 'Tarkista puuttuvat kääntämättömät sanat tai lauseet';
...
$string['missingurl'] = 'Puuttuva web-osoite';
...
Uusi käyttäjätili on luotu sinulle sivustolla \'{$a->sitename}\' ja sinulle on myönnetty uusi tilapäinen salasana.

Nykyiset kirjautumistietosi ovat nyt: käyttäjänimi: {$a->username}
salasana: {$a->newpassword} (sinun pitää muuttaa salasanasi kirjautuessasi ensimmäistä kertaa sivustolle) Alkaaksesi käyttää \'{$a->sitename}\', kirjaudu täältä {$a->link}

Useimmissa sähköpostiohjelmissa tämän pitäisi näkyä linkkinä, jota painamalla siirryt sivulle. Jos tämä ei toimi voit kopioida ja liittää linkin osoiteriville www-selaimessasi.

SuperMoikka \'{$a->sitename}\' adminkäyttäjältä, {$a->signoff}';
...
$string['orphanedactivities'] = 'Orvot aktiviteetit';
$string['other'] = 'Toinen';
...
$string['passwordforgotteninstructions2'] = 'Syötä käyttäjänimesi tai sähköpostiosoitteesi alle resetoidaksesi salasanasi. Jos löydämme sinut tietokannasta, lähetämme sinulle sähköpostilla ohjeet, miten saat pääsyn uudelleen.';
...
$string['screenreaderuse_help'] = 'Ruudunlukija on näkövammaisten käyttäjien apuväline, jota käytetään tietokoneeseen kytketyn äänisyntetisaattorin kanssa. Ruudunlukija lukee ääneen tabulaattorin kohdalla olevan tekstin, ja käyttäjä siirtyy tekstistä toiseen tabulaattorin avulla.';
...
$string['sectionusedefaultname'] = 'Käytä osan oletusnimeä';
...
$string['showtopicfromothers'] = 'Näytä aihe';
$string['showweekfromothers'] = 'Näytä viikko';
$string['since'] = 'Alkaen';
...
$string['someallowguest'] = 'Jotkut kurssit saattavat sallia vierailijatunnukset.';
...
$string['statsreportactivity'] = 'Koko aktivisuus (kaikki roolit)';
...
$string['userselectorsearchanywhere'] = 'Hae tekstiä mistä vain käyttäjän nimestä';
