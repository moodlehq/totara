...
$string['attemptsprepage'] = 'Versuche/Seite';
...
$string['regrade'] = 'Neubewerten';
$string['regradeall'] = 'Alle neubewerten';
$string['regradealldry'] = 'Probelauf einer vollständigen Neubewertung';
$string['regradealldrydo'] = 'Versuche neubewerten, die entsprechend markiert sind ($a)';
$string['regradealldrydogroup'] = 'Versuche ($a->countregradeneeded) neubewerten, die entsprechend in der Gruppe \'$a->groupname\' markiert sind';
...
$string['regradeselected'] = 'Markierte Versuche neubewerten';
$string['show'] = 'Anzeigen / Download';
$string['showattempts'] = 'Ausschließlich Versuche anzeigen / downloaden';
$string['showdetailedmarks'] = 'Bewertungen für jede Frage anzeigen / downloaden';
