...
$string['cannoffindgradeitem'] = 'Bewertung nicht gefunden!';
...
$string['cannotaddmembergroupiddoesntexist'] = 'Mitglied der Gruppe nicht hinzugefügt: Gruppe existiert nicht';
$string['cannotaddmodule'] = 'Modul $a konnte nicht zur Modulliste hinzugefügt werden!';
$string['cannotaddnewinstance'] = 'Neue Instanz von $a konnte nicht eingefügt werden.';
...
$string['cannotcreatedefaultcat'] = 'Fehler beim Anlegen der Default-Kategorie für Kontext $a';
$string['cannotcreatefield'] = 'Fehler beim Anlegen eines neuen Feldes';
...
$string['cannotcreateuser'] = 'Fehler beim Anlegen der Nutzerdaten';
...
$string['cannotdeletecap'] = 'Abgelehnte|ablehnende Berechtigung $a konnte nicht gelöscht werden.';
$string['cannotdeletecate'] = 'Fehler beim Löschen des Kursbereichs';
...
$string['cannotfindsite'] = 'Die Hauptseite kann nicht gefunden werden';
...
$string['cannotinsertcategory'] = 'Folgefehler. Der Kursbereich konnte nicht eingefügt werden.';
...
$string['cannotmovezip'] = 'Zip konnte nicht verschoben werden.';
...
$string['cannotupdateblock'] = 'Der Datensatz für Block \"$a\" konnte in der Blocktabelle nicht aktualisiert werden!';
$string['cannotupdatecategory'] = 'Der Kursbereich \"$a\" kann nicht aktualisiert werden.';
$string['cannotupdatecm'] = 'Das Kursmodul konnte nicht im richtigen Feld aktualisiert werden';
$string['cannotupdatecomment'] = 'Dieser Kommentar konnte nicht aktualisiert werden.';
$string['cannotupdatecoursemodule'] = 'Kursmodul konnte in dem Abschnitt nicht aktualisiert werden.';
$string['cannotupdatecustomprofile'] = 'Fehler beim Aktualisieren des Nutzerdatensatzes';
$string['cannotupdatefield'] = 'Fehler beim Aktualisieren des Feldes';
$string['cannotupdategroup'] = 'Fehler beim Aktualisieren der Gruppe';
$string['cannotupdatelevel'] = 'Die Einrückung der Anzeige für die Lernaktivität konnte nicht aktualisiert werden.';
$string['cannotupdatemod'] = '$a kann nicht aktualisiert werden';
$string['cannotupdatemodcap'] = '$a Berechtigungen konnten nicht aktualisiert werden!';
...
$string['cannotupdateplugincap'] = 'Datensatz ID $a konnte nicht upgedatet werden.';
$string['cannotupdateprofile'] = 'Fehler beim Aktualisieren des Nutzerdatensatzes';
$string['cannotupdaterate'] = 'Die alte Bewertung konnte nicht aktualisiert werden ($a->id = $a->rating)';
...
$string['cannotupdatesecret'] = 'Fehler beim Zurücksetzen des Sicherheitstextes';
...
$string['cannotupgradeblock'] = 'Die Aktualisierung des Blocksystems ist fehlgeschlagen! Die Versionsnummer konnte nicht in die Konfigurationstabelle eingetragen werden.';
$string['cannotupgradecaps'] = 'Beim Aktualisieren der Kernfähigkeiten im Rollensystem sind Schwierigkeiten aufgetreten';
...
$string['coursedoesntexistcannotcreategroup'] = 'Gruppe konnte nicht angelegt werden - der Kurs existiert nicht';
...
$string['groupiddoesntexistcannotdelete'] = 'Gruppe konnte nicht gelöscht werden - Gruppe existiert nicht';
...
$string['nopermissiontoupdateblock'] = 'Keine Berechtigung zum Aktualisieren von $a!';
...
$string['useriddoesntexist'] = 'Nutzer-ID existiert nicht';
$string['userisnotaparticipant'] = 'Nutzer ist kein Teilnehmer des kurses';
...
$string['usernotcreated'] = 'Nutzer konnte nicht angelegt werden';
...
$string['wscouldnotaddgroupmembernopermission'] = 'WS - Gruppenmitglied nicht angelegt - fehlende Berechtigung';
$string['wscouldnotcreateecoursenopermission'] = 'WS - Kurs nicht erstellt - fehlende Berechtigung';
$string['wscouldnotcreateeuserindb'] = 'WS - Konnte Nutzer nicht anlegen';
$string['wscouldnotcreateeusernopermission'] = 'WS - Konnte Nutzer nicht anlegen - fehlende Berechtigung';
$string['wscouldnotcreategroupnopermission'] = 'WS - Konnte Gruppe nicht anlegen - fehlende Berechtigung';
$string['wscouldnotdeletegroupnopermission'] = 'WS - Konnte Gruppe nicht löschen - fehlende Berechtigung';
$string['wscouldnotdeletenoexistinguser'] = 'WS - Konnte Nutzer nicht löschen - Nutzer existiert nicht';
$string['wscouldnotdeleteusernopermission'] = 'WS - Konnte Nutzer nicht löschen - fehlende Berechtigung';
$string['wscouldnotgetgroupnopermission'] = 'WS - Konnte Gruppe nicht finden - fehlende Berechtigung';
$string['wscouldnotremovegroupmembernopermission'] = 'WS - Konnte Gruppe nicht entfernen - fehlende Berechtigung';
$string['wscouldnotupdatenoexistinguser'] = 'WS - Konnte Nutzer nicht aktualisieren - Nutzer existiert nicht';
$string['wscouldnotupdateuserindb'] = 'WS - Konnte Nutzer nicht aktualisieren';
