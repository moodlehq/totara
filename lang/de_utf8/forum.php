...
$string['alreadyfirstpost'] = 'Dies ist der erste Beitrag in der Diskussion'; // ORPHANED
$string['attachmentnopost'] = 'Ohne Nachrichten-ID können keine Anhänge exportiert werden'; // ORPHANED
$string['attachments'] = 'Anhänge'; // ORPHANED
$string['blogforum'] = 'Standardforum, angezeigt in einem blog-ähnlichen Format'; // ORPHANED
$string['cannotadd'] = 'Sie können die Diskussion nicht zu diesem Forum hinzufügen.'; // ORPHANED
$string['cannotaddsubscriber'] = 'Abonnent mit der ID $a konnte nicht für das Forum registriert werden!'; // ORPHANED
$string['cannotaddteacherforumto'] = 'Es kann keine konvertierte Instanz des Trainer-Forums in den Abschnitt 0 des Kurses eingefügt werden.'; // ORPHANED
$string['cannotcreatediscussion'] = 'Es kann keine neue Diskussion erstellt werden.'; // ORPHANED
$string['cannotcreateinstanceforteacher'] = 'Es kann kein neue Kursmodul-Instanz für das Trainer-Forum erstellt werden.'; // ORPHANED
$string['cannotdeleteforummodule'] = 'Sie dürfen das Forenmodul nicht löschen.'; // ORPHANED
$string['cannoteditposts'] = 'Sie können keine Beiträge anderer Nutzer/innen ändern!'; // ORPHANED
$string['cannotfinddiscussion'] = 'Die Diskussion kann in diesem Forum nicht gefunden werden.'; // ORPHANED
$string['cannotfindfirstpost'] = 'Die erste Nachricht konnte nicht gefunden werden'; // ORPHANED
$string['cannotfindorcreateforum'] = 'Das Nachrichtenforum dieses Kurses wurde nicht gefunden oder konnte nicht angelegt  werden.'; // ORPHANED
$string['cannotfindparentpost'] = 'Der oberste Vorgänger des Beitrags $a kann nicht gefunden werden.'; // ORPHANED
$string['cannotmovefromsingleforum'] = 'Die Diskussion kann nicht von einem einfachen Einzel-Diskussions-Forum verschoben werden.'; // ORPHANED
$string['cannotmovenotvisible'] = 'Forum nicht sichtbar'; // ORPHANED
$string['cannotmovetonotexist'] = 'Sie können nicht zu diesem Forum wechseln - es existiert nicht!'; // ORPHANED
$string['cannotmovetonotfound'] = 'Das Zielforum wurde nicht in diesem Kurs gefunden.'; // ORPHANED
$string['cannotpurgecachedrss'] = 'Die zwischengespeicherten RSS-Feeds für die Quell- und/oder Ziel-Foren können nicht beseitigt werden - überprüfen Sie Ihre Forenberechtigungen.'; // ORPHANED
$string['cannotremovesubscriber'] = 'Abonnent mit id $a konnte nicht aus dem Forum ausgetragen werden!'; // ORPHANED
$string['cannotreply'] = 'Sie können nicht auf diesen Beitrag antworten.'; // ORPHANED
$string['cannotsplit'] = 'Die Diskussionen dieses Forums können nicht geteilt werden.'; // ORPHANED
$string['cannotsubscribe'] = 'Entschuldigung, aber Sie müssen für ein Abonnement ein Gruppenmitglied sein.'; // ORPHANED
$string['cannottrack'] = 'Das Tracking des Forums konnte nicht beendet werden'; // ORPHANED
$string['cannotunsubscribe'] = 'Sie könnten nicht aus dem Forum abgemeldet werden'; // ORPHANED
$string['cannotupdatepost'] = 'Sie können den Beitrag nicht aktualisieren.'; // ORPHANED
$string['configmaxattachments'] = 'Maximale Anzahl von Anhängen, die für einen Beitrag erlaubt sind'; // ORPHANED
$string['errorwhiledelete'] = 'Während dem Löschen des Eintrags ist ein Fehler aufgetreten.'; // ORPHANED
$string['forum:exportdiscussion'] = 'Gesamtes Thema exportieren'; // ORPHANED
$string['forum:exportownpost'] = 'Eigenen Beitrag exportieren'; // ORPHANED
$string['forum:exportpost'] = 'Beitrag exportieren'; // ORPHANED
$string['forumadministration'] = 'Forum-Administration'; // ORPHANED
$string['introblog'] = 'Die Beiträge dieses Forums wurden hier automatisch aus Teilnehmer-Blogs dieses Kurses erstellt, weil deren Blog-Einträge nicht mehr verfügbar sind'; // ORPHANED
$string['invalidaccess'] = 'Seitenzugriff war nicht korrekt.'; // ORPHANED
$string['invaliddiscussionid'] = 'Falsche Themen-ID'; // ORPHANED
$string['invalidforumid'] = 'Falsche Foren-ID'; // ORPHANED
$string['invalidparentpostid'] = 'Vorgänger Beitrags-ID war ungültig.'; // ORPHANED
$string['invalidpostid'] = 'Ungültige Beitrags-ID $a'; // ORPHANED
$string['maxattachments'] = 'Maximale Anhänge'; // ORPHANED
$string['messageprovider:digests'] = 'Abonnierte Forenzusammenfassungen'; // ORPHANED
$string['messageprovider:posts'] = 'Abonnierte Forenbeiträge'; // ORPHANED
$string['mustprovidediscussionorpost'] = 'Für den Export müssen Sie entweder eine Themen-ID oder eine Nachrichten-ID angeben'; // ORPHANED
$string['noattachments'] = 'Zu dieser Nachricht gibt es keine Anhänge'; // ORPHANED
$string['noguestrate'] = 'Gäste können Beiträge nicht bewerten.'; // ORPHANED
$string['nopermissiontosubscribe'] = 'Sie haben nicht die Berechtigung die Liste der Foren-Abonnenten einzusehen'; // ORPHANED
$string['nopermissiontoview'] = 'Sie haben nicht die Berechtigung diesen Beitrag anzusehen.'; // ORPHANED
$string['norate'] = 'Bewertungen der  Einträge sind nicht zulässig!'; // ORPHANED
$string['noresult'] = 'Keine Bewertung für den Beitrag $a'; // ORPHANED
$string['notexists'] = 'Diskussion existiert nicht länger'; // ORPHANED
$string['notinstalled'] = 'Das Forum-Modul ist nicht installiert.'; // ORPHANED
$string['notpartofdiscussion'] = 'Dieser Beitrag ist nicht Teil einer Diskussion!'; // ORPHANED
$string['noviewanyrate'] = 'Sie können Bewertungen für eigene Beiträge einsehen.'; // ORPHANED
$string['noviewrate'] = 'Sie haben nicht die Berechtigung, um Beitragsbewertungen einzusehen'; // ORPHANED
$string['viewalldiscussions'] = 'Alle Diskussionen anzeigen'; // ORPHANED
