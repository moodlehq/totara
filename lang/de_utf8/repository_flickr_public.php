...
$string['by-nc'] = 'Namensnennung-Keine kommerzielle Nutzung';
...
$string['configplugin'] = 'Öffentliche Flickr-Konfiguration';
$string['creativecommonscommercial'] = 'Nur Creative Commens Kommerziell';
$string['emailaddress'] = 'E-Mail-Adresse';
$string['flickr_public:view'] = 'Öffentliches Flickr Repository sehen';
...
$string['repositorydesc'] = 'Repository für Flickr';
$string['repositoryname'] = 'Öffentliches Flickr';
$string['secret'] = 'Code';
...
$string['watermark'] = 'Wasserzeichen zu den Fotos hinzufügen (Autor und URL)';
