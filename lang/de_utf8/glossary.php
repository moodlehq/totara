<?PHP // $Id$ 
      // glossary.php - created with Moodle 1.9.14 (Build: 20111010) (2007101591.06)
...
$string['andmorenewentries'] = 'und {$a} neue Einträge';
...
$string['alias'] = 'Keyword'; // ORPHANED
$string['errdeltimeexpired'] = 'Sie dürfen dies nicht löschen. Die Zeit ist abgelaufen!'; // ORPHANED
$string['glossary:exportentry'] = 'Einzeleintrag exportieren'; // ORPHANED
$string['glossary:exportownentry'] = 'Ihren Einzeleintrag exportieren'; // ORPHANED
$string['glossaryadministration'] = 'Glossar-Administration'; // ORPHANED
$string['guestnoedit'] = 'Gäste dürfen kein Glossar bearbeiten'; // ORPHANED
$string['nopermissiontodelcomment'] = 'Sie dürfen keine fremden Kommentare löschen!'; // ORPHANED
$string['nopermissiontodelinglossary'] = 'Sie dürfen in diesem Glossar keine Kommentare schreiben!'; // ORPHANED
$string['nopermissiontoviewresult'] = 'Sie dürfen ausschließlich Ergebnisse Ihrer eigenen Einträge anschauen.'; // ORPHANED
$string['ratingonlywithpermissions'] = 'Nur Berechtigte dürfen Einträge bewerten'; // ORPHANED
