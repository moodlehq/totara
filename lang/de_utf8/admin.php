<?PHP // $Id$ 
      // admin.php - created with Moodle 1.9.14 (Build: 20111010) (2007101591.06)
...
$string['configconvertformat'] = 'Wenn <i>latex</i>, <i>dvips</i> und <i>convert</i> vorhanden sind, Bilder werden in dem spezifizierten Format erstellt. Wenn nicht, mimeTeX wird verwendet und die Bilder werden im GIF Format erstellt.';
...
$string['convertformat'] = 'Output Format <i>konvertieren</i>';
...
$string['intlrecommended'] = 'intl Erweiterung wird benötigt um Internationalisierung zu unterstützen, z.B. Sortieren von Umlauten.';
...
$string['php533warning'] = 'PHP 5.3.3 oder höher ist empfohlen';
...
$string['purgecachesfinished'] = 'Alle Caches wurden geleert.';
...
$string['splrequired'] = 'Die SPL PHP Erweiterung wird von Totara benötigt';
...
$string['advancedfeatures'] = 'Zusatzoptionen'; // ORPHANED
$string['allcountrycodes'] = 'Alle Ländercodes'; // ORPHANED
$string['allowbeforeblock'] = 'Die Liste der zugelassenen IP-Adressen ist vorrangig'; // ORPHANED
$string['allowbeforeblockdesc'] = 'Standardmäßig wird die Liste der gesperrten IP-Adressen zuerst berücksichtigt. Falls diese Einstellung aktiviert ist, hat die Liste der zugelassenen IP-Adressen Vorrang.'; // ORPHANED
$string['allowblockstodock'] = 'Nutzung von Blöcken im Navigationsdock erlauben'; // ORPHANED
$string['allowediplist'] = 'Zugelassene IP-Adressen'; // ORPHANED
$string['allowthemechangeonurl'] = 'Änderungen des Designs über die URL erlauben'; // ORPHANED
$string['availableto'] = 'Verfügbar für'; // ORPHANED
$string['blockediplist'] = 'Gesperrte IP-Adressen'; // ORPHANED
$string['bloglevelupgrade'] = 'Aktualisierung der Blogsichtbarkeit'; // ORPHANED
...
<p>Sie können das Script über den folgenden Link starten: <a href=\"$a->fixurl\">Aktualisierung der Blogsichtbarkeit</a>.</p>'; // ORPHANED
...
$string['bloglevelupgradenotice'] = 'Ihr Moodle benutzt alte Blogberechtigungen. Die <a href=\"bloglevelupgrade.php\">Aktualisierung der Blogsichtbarkeit</a> wird empfohlen.'; // ORPHANED
$string['bloglevelupgradeprogress'] = 'Konvertierungsfortschritt: $a->userscount Nutzer geprüft - $a->blogcount Blogeinträge konvertiert'; // ORPHANED
$string['cannotdeletemissingqtype'] = 'Sie dürfen den fehlenden Fragetyp nicht löschen. Er wird vom System benötigt.'; // ORPHANED
$string['cannotdeletemodfilter'] = 'Sie können den Filter \'$a->filter\' nicht deinstallieren, weil er Teil des Moduls \'$a->module\' ist.'; // ORPHANED
$string['cannotdeleteqtypeinuse'] = 'Sie dürfen den Fragetyp \'$a\' nicht löschen. In der Fragedatenbank gibt es Fragen dieses Typs.'; // ORPHANED
$string['cannotdeleteqtypeneeded'] = 'Sie dürfen den Fragetyp \'$a\' nicht löschen. Andere installierte Fragetypen sind davon abgeleitet.'; // ORPHANED
$string['clianswerno'] = 'n'; // ORPHANED
$string['cliansweryes'] = 'j'; // ORPHANED
$string['cliincorrectvalueerror'] = 'Fehler: Falscher Wert \"$a->value\" für \"$a->option\"'; // ORPHANED
$string['cliincorrectvalueretry'] = 'Falscher Wert - versuchen Sie es nochmal'; // ORPHANED
$string['clistatusdisabled'] = 'Status: deaktiviert'; // ORPHANED
$string['clistatusenabled'] = 'Status: aktiviert'; // ORPHANED
$string['clitypevalue'] = 'Wert eingeben'; // ORPHANED
$string['clitypevaluedefault'] = 'Wert eingeben. Drücken Sie Enter, um den Standardwert zu benutzen ($a)'; // ORPHANED
$string['cliunknowoption'] = 'Nicht erkannte Optionen: $a.
Für Hilfe nutzen Sie bitte die Option --help'; // ORPHANED
$string['cliupgradefinished'] = 'Die Kommandozeilen-Aktualisierung wurde erfolgreich beendet'; // ORPHANED
$string['commonfiltersettings'] = 'Einfache Filtereinstellungen'; // ORPHANED
$string['condifmodeditdefaults'] = 'Die hier eingegebenen Werte definieren die Standardwerte, die beim Hinzufügen einer Aktivität im Einstellungsformular vorgegeben werden. Sie können zusätzlich angeben, welche der Einstellungen als erweitert bezeichnet werden sollen.'; // ORPHANED
$string['configallcountrycodes'] = 'Diese Länderliste wird an unterschiedlichen Stellen benutzt, z.B. im Nutzerprofil. Über eine kommagetrennte Liste können Sie die Auswahlmöglichkeiten einschränken, z.B. \'DE,GB,FR,ES\'. Falls das Feld leer bleibt, wird standardmäßig die gesamte Liste aus der Datei countries.php im englischen Sprachpaket benutzt. Dies ist die Liste gemäß ISO 3166-1.  Falls Sie weitere nicht standardmäßige Codes ergänzen möchten, so müssen Sie diese Codes in der Datei countries.php in Ihrem Sprachpaket hinzufügen.'; // ORPHANED
$string['configallowblockstodock'] = 'Wenn diese Option aktiviert ist und vom ausgewählten Design unterstützt wird, können die Nutzer/innen entscheiden, ob sie Blöcke in ein spezielles Navigationsdock verschieben.'; // ORPHANED
$string['configallowswitch'] = 'Legen Sie fest, in welche anderen Rollen ein Nutzer von der aktuellen Rollen aus wechseln kann. Zusätzlich zu dieser Einstellung ist die Berechtigung moodle/role:switchroles für die aktuelle Rolle erforderlich. <br />Anmerkung: Der Wechsel in eine Rolle kann nur erfolgen, wenn diese die Berechtigung moodle/course:view besitzen und nicht die Berechtigung moodle/site:doanything. Einige Spalten sind daher u.U. deaktiviert.'; // ORPHANED
$string['configallowthemechangeonurl'] = 'Wenn Sie diese Option aktivieren, kann das Design über den Zusatz \'theme={themename}&amp;sesskey={sesskey}\' zu jeder Moodle-URL gewechselt werden.'; // ORPHANED
$string['configcurlcache'] = 'Speicherzeit für cURL Cache (in Sekunden)'; // ORPHANED
$string['configdebugpageinfo'] = 'Wenn diese Option aktiviert ist, werden Seiteninformationen in der Fußzeile angezeigt.'; // ORPHANED
$string['configdebugstringids'] = 'Diese Option soll bei der Übersetzung helfen. Neben jeder Textausgabe werden zusätzlich die Sprachdatei und die Text-ID angezeigt. Eine Änderung der Einstellung ist erst bei einem Neuladen der  betreffenden Seite wirksam.'; // ORPHANED
$string['configdebugvalidators'] = 'Aktivieren Sie diese Option, um Links zu externen Validierungsservern in der Fußzeile anzuzeigen. Möglicherweise müssen Sie einen neuen Nutzer mit dem Anmeldenamen <em>w3cvalidator</em> erstellen und den Gastzugang freischalten. Diese Änderungen erlauben unauthorisierte Serverzugriffe und sollten nicht auf Produktivsystemen eingeschaltet werden!'; // ORPHANED
$string['configenablecomments'] = 'Kommentare erlauben'; // ORPHANED
$string['configenablewebservices'] = 'WebServices erlauben es anderen Systemen, sich in diesem Moodle anzumelden und Operationen auszuführen. Sicherheitshalber sollte diese Option deaktiviert sein, außer Sie verwenden sie tatsächlich.'; // ORPHANED
$string['configenablewsdocumentation'] = 'Die Selbsterstellung der Dokumentation zu WebServices erlauben. Ein WebService-Nutzer kann auf seine eigene \'$a\' zugreifen, ohne sich bei der Moodle-Instanz anmelden zu müssen. Es wird ausschließlich die Dokumentation für die aktivierten Protokolle angezeigt.'; // ORPHANED
$string['configextrauserselectorfields'] = 'Bei der Nutzerauswahl, z.B. bei einer Rollen- oder Gruppenzuweisung, werden diese Felder in der Nutzerliste durchsuchbar angezeigt. Vom Sicherheitsaspekt her ist die Auswahl des Nutzernamens an dieser Stelle eine schlechte Idee.'; // ORPHANED
$string['configmaxconsecutiveidentchars'] = 'Kennwörter dürfen maximal diese Zahl aufeinanderfolgender gleicher Zeichen haben. Der Wert \'0\' deaktiviert die Prüfung.'; // ORPHANED
$string['confignavshowallcourses'] = 'Die Aktivierung dieser Option stellt sicher, dass für registrierte Nutzer/innen jederzeit alle Kurse in der Navigation angezeigt werden. Standardmäßig werden nur Kurse angezeigt, die bereits angesehen wurden.'; // ORPHANED
$string['confignavshowcategories'] = 'Kursbereiche in Navigationsleiste und Navigationsblöcken anzeigen'; // ORPHANED
$string['configproxybypass'] = 'Komma getrennte Liste von Servernamen oder IP-Adressen (auch Teile davon), die ohne den Proxy geladen werden (z.B. 192.168., .meineseite.de)'; // ORPHANED
$string['configrequiremodintro'] = 'Deaktivieren Sie diese Option, wenn die Eingabe von Beschreibungen für jede Aktivität nicht verpflichtend sein soll.'; // ORPHANED
$string['configthemedesignermode'] = 'Alle Bilder und CSS-Dateien eines Designs werden lange Zeit im Browser und im Servers zwischengespeichert. Schalten Sie diese Option aus, wenn Sie neue Designs entwickeln oder optimieren. Sie können auch alle Zwischenspeicher manuell in der Design-Auswahl ausschalten. Achtung: Die Aktivierung des Design-Entwickler-Modus wirkt sich negativ auf die Serverleistung aus!'; // ORPHANED
$string['configuseblogassociations'] = 'Soll es für Nutzer/innen möglich sein, ihre Blogeinträge über die Zuordnung an Kurse und Kursmodule zu organisieren?'; // ORPHANED
$string['configuseexternalyui'] = 'An Stelle der lokalen Dateien können Dateien von Yahoo-Servern verwendet werden. ACHTUNG: Es ist dann eine Internetverbindung notwendig, damit Ajax mit ihrer Website funktioniert.'; // ORPHANED
$string['configyuicomboloading'] = 'Diese Option erlaubt eine Ladeoptimierung für Dateien der YUI Libraries. Zur Performance-Steigerung sollte die Einstellung auf Produktivsystemen aktiviert sein.'; // ORPHANED
...
$string['dbtest'] = 'Datenbank-Tests'; // ORPHANED
$string['debugpageinfo'] = 'Seiteninformation anzeigen'; // ORPHANED
$string['debugstringids'] = 'Originaltexte anzeigen'; // ORPHANED
$string['debugvalidators'] = 'Prüflinks anzeigen'; // ORPHANED
$string['defaulthtmleditor'] = 'Standard-HTML-Editor'; // ORPHANED
$string['deletefilterareyousure'] = 'Sind Sie sicher, dass Sie den Filter \'$a\' löschen möchten?'; // ORPHANED
$string['deletefilterareyousuremessage'] = 'Sie sind dabei, den Filter \'$a\' vollständig zu löschen. Sind Sie sicher, dass Sie ihn deinstallieren möchten?'; // ORPHANED
$string['deletefilterfiles'] = 'Alle Daten, die dem Filter \'$a->filter\' zugeordnet waren, wurden aus der Datenbank gelöscht. Um die Löschung abzuschließen (und um zu verhindern, dass der Filter  automatisch erneuert wird), sollten Sie jetzt noch das Verzeichnis \'$a->directory\' von Ihrem Server löschen'; // ORPHANED
$string['deleteqtypeareyousure'] = 'Sind Sie Sicher, dass Sie den Fragetyp \'$a\' löschen möchten?'; // ORPHANED
$string['deleteqtypeareyousuremessage'] = 'Sie sind dabei, den Fragetyp \'$a\' vollständig zu löschen. Sind Sie sicher, dass Sie ihn deinstallieren wollen?'; // ORPHANED
$string['deletingfilter'] = 'Filter \'$a\' löschen'; // ORPHANED
$string['deletingqtype'] = 'Fragetyp \'$a\' löschen'; // ORPHANED
$string['development'] = 'Entwicklung'; // ORPHANED
$string['enablecomments'] = 'Kommentare erlauben'; // ORPHANED
$string['enablewebservices'] = 'WebServices erlauben'; // ORPHANED
$string['enablewsdocumentation'] = 'Dokumentation zu WebServices'; // ORPHANED
$string['enrolmultipleusers'] = 'Nutzer/innen eintragen'; // ORPHANED
$string['environmentmustfixsetting'] = 'Die PHP-Einstellung muss geändert werden'; // ORPHANED
$string['environmentsettingok'] = 'Empfohlene Einstellung gefunden'; // ORPHANED
$string['environmentshouldfixsetting'] = 'Die PHP-Einstellung sollte geändert werden'; // ORPHANED
$string['errordeletingconfig'] = 'Fehler beim Löschen der Konfigurationsdaten für das Plugin \'$a\''; // ORPHANED
$string['exceptions'] = 'Ausnahmen'; // ORPHANED
$string['experimentalsettings'] = 'Experimentelle Einstellungen'; // ORPHANED
$string['extrauserselectorfields'] = 'Zur Nutzerauswahl suchen und anzeigen'; // ORPHANED
$string['fatalmagicquotesruntime'] = '<p>Schwerwiegender Konfigurationsfehler - bitte benachrichtigen Sie Ihren Server-Administrator</p> <p>Um ordnungsgemäß zu arbeiten, ist für Moodle eine Änderung in den PHP-Einstellungen notwendig.<br /><code>magic_quotes_runtime=off</code> muss gesetzt sein!<br />Diese Einstellung wird auf den Server geändert, u.z. in der Datei <code>php.ini</code>, in der Apache/IIS Konfiguration oder in der Datei  <code>.htaccess</code>.</p>'; // ORPHANED
$string['fatalsessionautostart'] = '<p>Schwerwiegender Konfigurationsfehler - bitte benachrichtigen Sie Ihren Server-Administrator</p> <p>Um ordnungsgemäß zu arbeiten, ist für Moodle eine Änderung in den PHP-Einstellungen notwendig.<br /><code> session.auto_start=off</code> muss gesetzt sein!<br />Diese Einstellung wird auf den Server geändert, u.z.  in der Datei <code>php.ini</code>, in der Apache/IIS Konfiguration oder in der Datei  <code>.htaccess</code>.</p>'; // ORPHANED
$string['filters'] = 'Filter'; // ORPHANED
$string['frontpagefilters'] = 'Filter der Startseite'; // ORPHANED
$string['frontpageoverrides'] = 'Rechteänderungen für Startseite'; // ORPHANED
$string['helpprofilefieldlink'] = 'Link aus den Nutzerdaten erzeugen'; // ORPHANED
$string['htmleditorsettings'] = 'Einstellungen für den HTML-Editor'; // ORPHANED
$string['installhijacked'] = 'Die Installation muss von der ursprünglichen IP-Adresse aus abgeschlossen werden.'; // ORPHANED
$string['installsessionerror'] = 'Die PHP Sessions können nicht initialisiert werden. Bitte prüfen Sie, ob Ihr Browser Cookies akzeptiert.'; // ORPHANED
$string['invalidlangpack'] = 'Um dieses Sprachpaket zu bearbeiten müssen Sie es in den Sprachordner legen'; // ORPHANED
$string['ipblocked'] = 'Diese Website ist im Moment nicht verfügbar.'; // ORPHANED
$string['ipblocker'] = 'IP-Blockierung'; // ORPHANED
$string['manageqtypes'] = 'Fragetypen verwalten'; // ORPHANED
$string['maxconsecutiveidentchars'] = 'Aufeinander folgende identische Zeichen'; // ORPHANED
$string['mediapluginimg'] = 'Automatische Einbettung von verlinkten Bildern aktivieren'; // ORPHANED
$string['modeditdefaults'] = 'Standardwerte für die Einstellungen der Aktivitäten'; // ORPHANED
...
Sie sollten über \"Shift-Neuladen\" sicherstellen, dass Ihr Browser auch das neue CSS lädt, weil sonst die neuen Blöcke nicht richtig funktionieren.'; // ORPHANED
$string['navshowallcourses'] = 'Alle eigenen Kurse anzeigen'; // ORPHANED
$string['navshowcategories'] = 'Kursbereiche anzeigen'; // ORPHANED
$string['nodatabase'] = 'Keine Datenbank'; // ORPHANED
$string['noroles'] = 'Keine Rollen'; // ORPHANED
$string['numquestions'] = 'Fragenanzahl'; // ORPHANED
$string['numquestionsandhidden'] = '$a->numquestions (+$a->numhidden verborgene)'; // ORPHANED
$string['plugin'] = 'Plugin'; // ORPHANED
$string['profilefieldlink'] = 'Link'; // ORPHANED
$string['profilefieldlinktarget'] = 'Verlinkungsziel'; // ORPHANED
$string['proxybypass'] = 'Proxy für diese Server nicht verwenden'; // ORPHANED
$string['qtypedeletefiles'] = 'Alle Daten, die mit dem Fragetyp \'$a->qtype\' verbunden sind, wurden aus der Datenbank gelöscht. Um die Löschung abzuschließen (und eine automatische Wiederinstallation des Fragetyps zu verhindern), sollten Sie jetzt noch das Verzeichnis \'$a->directory\' von Ihrem Server entfernen.'; // ORPHANED
$string['questiontype'] = 'Fragetyp'; // ORPHANED
$string['questiontypes'] = 'Fragetypen'; // ORPHANED
$string['registration'] = 'Registrierung'; // ORPHANED
...
<br/><br/>Diese Änderung betrifft die folgenden Daten in Ihrem System . Bitte sichern Sie die nachfolgende Liste und prüfen Sie nach der Aktualisierung, ob alle Aktivitäten noch wie beabsichtigt funktionieren.<br/><strong style=\"color:red\">$a->text</strong><br/>'; // ORPHANED
$string['requiremodintro'] = 'Beschreibung der Aktivität notwendig'; // ORPHANED
$string['requires'] = 'Erfordernisse'; // ORPHANED
$string['riskdataloss'] = 'Nutzer/innen könnten große Mengen von Inhalten und Informationen zerstören'; // ORPHANED
$string['riskdatalossshort'] = 'Risiko des Datenverlusts'; // ORPHANED
$string['roleswithexceptions'] = '$a->roles, mit $a->exceptions'; // ORPHANED
$string['save'] = 'Speichern'; // ORPHANED
$string['settingfileuploads'] = 'Datei-Upload ist für die normale Nutzung nötig - bitte aktivieren Sie dies in den PHP-Einstellungen.'; // ORPHANED
$string['settingmemorylimit'] = 'Unzureichende Speicherzuweisung - bitte setzen Sie eine höhere Speichergrenze memory_limit in den PHP-Einstellungen.'; // ORPHANED
$string['settingsafemode'] = 'Moodle ist nicht vollständig kompatibel mit dem Safe Mode. Bitten Sie Ihren Server-Administrator, diesen Modus auszuschalten. Rechnen Sie mit verschiedenen Problemen, falls Sie Moodle mit eingeschaltetem Safe Mode installieren.'; // ORPHANED
$string['showdetails'] = 'Details anzeigen'; // ORPHANED
$string['sitemaintenancewarning2'] = 'Die Website befindet sich aktuell im Wartungsmodus (nur Administratoren dürfen sich anmelden). Um die Website in den Normalbetrieb zu schalten deaktivieren Sie bitte den <a href=\"$a\">Wartungsmodus</a>.'; // ORPHANED
$string['tablenosave'] = 'Änderungen in der obigen Tabelle werden automatisch gesichert'; // ORPHANED
$string['tablesnosave'] = 'Änderungen in den obigen Tabellen werden automatisch gesichert'; // ORPHANED
$string['themedesignermode'] = 'Design-Bearbeitungsmodus'; // ORPHANED
$string['themeresetcaches'] = 'Design-Speicher löschen'; // ORPHANED
$string['uninstallplugin'] = 'Deinstallieren'; // ORPHANED
$string['uninstallqtype'] = 'Diesen Fragetyp deinstallieren'; // ORPHANED
$string['upgradeerror'] = 'Unbekannter Fehler beim Upgrade von $a->plugin zu Version $a->version. Fortsetzung unmöglich.'; // ORPHANED
$string['upgradetimedout'] = 'Die Aktualisierung wurde wegen Zeitüberschreitung abgebrochen. Bitte starten Sie den Vorgang noch einmal.'; // ORPHANED
$string['upgradingversion'] = 'Version wird aktualisiert...'; // ORPHANED
$string['useblogassociations'] = 'Blogverbund erlauben'; // ORPHANED
$string['useexternalyui'] = 'YUI Libraries online nutzen'; // ORPHANED
$string['yuicomboloading'] = 'YUI combo wird geladen'; // ORPHANED
