...
$string['assessorroleid'] = 'Rolle für Assessor';
...
$string['configassessorroleid'] = 'Dies ist die Rolle, die Assessoren in Totara einnehmen.';
...
$string['configlearnerroleid'] = 'Dies ist die Rolle, die Lernende in Totara einnehmen.';
...
$string['configmanagerroleid'] = 'Dies ist die Rolle, die Manager in Totara einnehmen.';
...
$string['configpasswordreuselimit'] = 'Anzahl der Passwortänderungen, bevor das Passwort wiederverwendet werden kann.';
...
$string['country'] = 'Land';
$string['coursecount'] = 'Anzahl der Seitenkurse';
...
$string['cron_execute'] = 'Ausführen';
$string['cron_execution_crashed'] = 'Cron ist abgestürzt';
$string['cron_execution_running'] = 'Cron läuft';
$string['cron_execution_status'] = 'Status';
$string['cron_execution_stopped'] = 'Cron wurde angehalten';
$string['cron_execution_watch'] = 'Cron-Ausführung';
$string['cron_kill_mail_fail_notify_msg'] = 'Die Ausführung des Cron-Prozesses dauerte länger als die maximale Ausführungszeit und der Abbruch ist fehlgeschlagen! Bitte Server Einstellungen überprüfen.';
$string['cron_kill_mail_fail_notify_title'] = 'Achtung: Cron-Ausführung ist fehlgeschlagen und wird automatisch abgebrochen!';
$string['cron_kill_mail_notify_msg'] = 'Die Ausführung des Cron-Prozesses dauerte länger als die maximale Ausführungszeit und wurde abgebrochen! Bitte Server Einstellungen überprüfen.';
$string['cron_kill_mail_notify_title'] = 'Achtung: Cron-Ausführung wurde automatisch abgebrochen!';
$string['cron_max_time'] = 'Maximale Ausführungszeit';
$string['cron_max_time_info'] = 'Maximale Ausführungszeit für Cron in Stunden. Standard is 0 (ohne Limit).';
$string['cron_max_time_kill'] = 'Cron automatisch abbrechen';
$string['cron_max_time_kill_info'] = 'Wenn diese Option aktiviert ist wird der Cron Prozess beim Beobachten abgebrochen wenn er überfällig ist. Dafür muss ein Cron Watcher installiert werden.';
$string['cron_max_time_mail_notify'] = 'Administrator benachrichtigen';
$string['cron_max_time_mail_notify_info'] = 'Wenn diese Option aktiviert ist wird der Administrator per EMail benachrichtigt, wenn der Cron die maximale Ausführungszeit überschreitet. Dafür muss ein Cron Watcher installiert werden.';
$string['cron_max_time_mail_notify_msg'] = 'Die Cron-Ausführung dauert länger als zulässig! Bitte Servereinstellungen überprüfen.';
$string['cron_max_time_mail_notify_title'] = 'Achtung: Cron-Ausführung ist überfällig!';
$string['cron_refresh'] = 'Refresh Status';
$string['cron_settings'] = 'Cron';
$string['cron_status_info'] = 'Cron-Ausführung Status';
$string['cron_terminate'] = 'Abbrechen';
...
$string['displayerrorsset'] = 'Die Seite wurde konfiguriert, Fehlermeldungen anzuzeigen. <br />Die Einstellung ist nicht für Produktionssysteme gedacht. <br />Die Option <em>Debug Nachrichten anzeigen</em> sollte in <a href=\"$a->link\">Server/Debugging</a> in der Seitenadministration abgeschaltet werden.';
...
$string['enableallowedip'] = 'Zugriffe von diesen IP-Adressen erlauben';
$string['enableallowedipdesc'] = 'Falls diese Option aktiviert ist, werden ausschließlich  IP-Adressen aus der Zulassungsliste bedient und gleichzeitig alle IP-Adressen aus der Sperrliste blockiert.';
...
$string['ipinblockedlist'] = 'Diese Website ist momentan nicht erreichbar.';
...
$string['ipoutallowedlist'] = 'Diese Website ist momentan nicht erreichbar.';
$string['ipwhitelist'] = 'IP-Whitelist';
$string['ipwhitelistdesc'] = 'Bei nichtleerer Liste werden ausschließlich die hier angegebenen IP-Adressen zugelassen, um den Webdienst unter dem Nutzernamen <strong>$a->username</strong> zu nutzen';
...
$string['learnerroleid'] = 'Rolle für Lernenden';
...
$string['managerroleid'] = 'Rolle für Manager';
$string['managews'] = 'Webdienste verwalten';
...
$string['optionalsubsystems'] = 'Zusatzfunktionen';
$string['order1'] = 'Erstens';
$string['order2'] = 'Zweitens';
$string['order3'] = 'Drittens';
$string['order4'] = 'Viertens';
$string['orgname'] = 'Organisationsname';
$string['orgnamehelp'] = 'Der Name Ihrer Organisation';
$string['passwordpolicy'] = 'Kennwortregeln';
$string['passwordreuselimit'] = 'Passwort Rotationslimit';
...
$string['registrationdisabled'] = 'Deaktiviert';
$string['registrationenabled'] = 'Aktiviert';
$string['registrationinformation'] = 'Registrierungsinformation';
$string['registrationisdisabled'] = 'Registrierung ist deaktiviert. Es wird empfohlen Standarddaten bei Totara zu registrieren, um bei ggf. auftretenden Probleme Hilfe leisten zu können.
<br />
Registrierung kann auf der Seite <a href=\"$a\">Registrierungs-Konfiguration</a> aktiviert werden.';
$string['registrationisenabled'] = 'Registrierung ist aktiviert.';
$string['registrationoutofdate'] = 'Die Registrierungsinformation wurde über einen längeren Zeitraum nicht aktualisiert. Die Information sollte auf dem neusten Stand gehalten werden um bei ggf. auftretenden Problem Hilfe leisten zu können. Stellen Sie sicher, dass der Webserver uneingeschränkten Zugriff über https zu register.totaralms.com hat.';
...
$string['sitefullname'] = 'Seite vollständiger Name';
$string['sitehasntregistered'] = 'Die Registrierung der Seite mit Totara war bisher nicht erfolgreich. Es wird empfohlen Standarddaten bei Totara zu registrieren, um bei ggf. auftretenden Probleme Hilfe leisten zu können. Stellen Sie sicher, dass der Webserver uneingeschränkten Zugriff über https zu register.totaralms.com hat und das der Moodle Cron aktiviert ist. Der Cron kann <a href=\"$a\">hier</a> manuell ausgeführt werden.';
$string['siteidentifier'] = 'Seiten-Identifier';
...
$string['sitemaxcategorydepth'] = 'Maximale Kategorientiefe';
$string['sitemaxcategorydepthhelp'] = 'Diese Einstellung legt die maximale Anzahl der angezeigten untergeordneten Kategorien fest';
...
$string['techsupportemail'] = 'Email technischer Support';
$string['techsupportemailhelp'] = 'Email-Adresse des Technikers der für die technischen Probleme der Seite zuständig ist.';
$string['techsupportphone'] = 'Telefonnummer technischer Support';
$string['techsupportphonehelp'] = 'Telefonnummer des Technikers der für die technischen Probleme der Seite zuständig ist (inkl. Landescode)';
...
$string['totarabuild'] = 'Totara Build-Nummer';
$string['totarapre11'] = 'Totara (Vorversion 1.1)';
$string['totararegistration'] = 'Totara Registrierung';
$string['totararegistrationinfo'] = '<p>Auf dieser Seite werden Registrierungs-Updates konfiguriert. Diese Daten werden an totaralms.com übertragen. Diese Updates stellen Totara Informationen über die installierte Version und Supportsoftware zur Verfügung. Diese Information ermöglicht Totara ggf. auftretende Probleme effizienter zu lösen.</p>
<p>Diese Information wird sicher übertragen und gespeichert.</p>';
$string['totararelease'] = 'Totara Release Identifier';
$string['totaraversion'] = 'Totara Versionsnummer';
...
$string['usercount'] = 'Anzahl der Benutzer auf der Seite';
...
$string['webserviceprotocols'] = 'Web-Service-Server';
$string['webservices'] = 'Web-Services';
$string['webservicesystemsettings'] = 'Allgemeine Einstellungen';
$string['webserviceusersettings'] = 'Nutzereinstellungen für Web-Services';
$string['wwwroot'] = 'Seiten wwwroot';
