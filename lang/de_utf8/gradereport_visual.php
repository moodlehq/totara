<?php
// gradereport_visual.php - created with Totara langimport script version 1.1
...
$string['axes'] = 'Achsen';
$string['continuousgradedistribution'] = 'Aggregierte Bewertungsverteilung';
$string['grade'] = 'Bewertung';
$string['gradedistribution'] = 'Verteilung (Linie)';
...
$string['item'] = 'Wert';
$string['modulename'] = 'Grafische Darstellung';
$string['nogroup'] = 'Keine Gruppe';
$string['numberstudents'] = 'Zahl der Teilnehmer/innen';
$string['percentstudents'] = 'Prozent Teilnehmer/innen';
$string['prefcalc'] = 'Berechnungen';
$string['preferences'] = 'Einstellungen für grafische Darstellung';
$string['prefgeneral'] = 'Generell';
$string['printable'] = 'Druck-Version';
$string['show'] = 'Anzeigen';
$string['showscaleitems'] = 'Werte mit Skala zeigen';
$string['showvalueitems'] = 'Werte anzeigen';
