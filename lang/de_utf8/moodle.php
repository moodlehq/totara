...
$string['backtoallcategories'] = 'Zurück zu allen Kategorien';
$string['backtoallcourses'] = 'Zurück zu allen Kursen';
$string['backtoallprograms'] = 'Zurück zu allen Programmen';
$string['backtocategoryx'] = 'Zurück zu {$a}';
$string['backtocourselisting'] = 'Zurück zur Kursliste';
$string['backtopageyouwereon'] = 'Zurück zur Seite, auf der Sie vorher waren';
...
$string['badcontext'] = 'Falscher Kontext';
$string['block'] = 'Block';
...
$string['browseallcategories'] = 'Alle Kategorien browsen';
...
$string['categorys'] = 'Kurskategorien';
...
$string['clickhelpiconformoreinfo'] = '... wird fortgesetzt ... klicken Sie auf das Hilfe-Icon, um den vollständigen Text lesen zu können';
...
$string['commentincontext'] = 'Diesen Kommentar im Zusammenhang suchen';
$string['comments'] = 'Kommentare';
$string['commentsrequirelogin'] = 'Um Kommentare anzusehen müssen Sie angemeldet sein';
...
$string['coursehelpenrollable'] = 'Teilnehmer/innen dürfen sich selber über das Standard-Plugin einschreiben';
$string['coursehelpenrolmentkey'] = 'Wenn ein Zugangsschlüssel gesetzt ist, dann wird dieser Zugangsschlüssel benötigt, um sich in den Kurs einzuschreiben';
$string['coursehelpenrolmentplugins'] = 'Standard-Plugin zur Einschreibung';
$string['coursehelpexpirynotifystudents'] = 'Wenn eine Teilnahmedauer festgelegt wurde, dann bestimmt diese Einstellung, ob Teilnehmer/innen eine E-Mail-Benachrichtigung erhalten, bevor sie aus dem Kurs entfernt werden.';
$string['coursehelpexpirythreshold'] = 'Wenn eine Teilnahmedauer festgelegt wurde, dann bestimmt die Zahl der Tage, mit welchen Vorlauf eine E-Mail-Benachrichtigung versandt wird, bevor Teilnehmer/innen aus dem Kurs entfernt werden.';
...
$string['coursehelpnotify'] = 'Wenn eine Teilnahmedauer festgelegt wurde, dann bestimmt diese Einstellung, ob Trainer/innen eine E-Mail-Benachrichtigung erhalten, bevor jemand aus dem Kurs entfernt wird.';
...
$string['coursesectionsummaries'] = 'Kurzübersichten zu Kursabschnitten';
$string['coursesettings'] = 'Standardeinstellungen';
$string['coursesinthiscategory'] = 'Kurse in dieser Kategorie ({$a})';
...
$string['creatingcompetencyevidencedata'] = 'Daten für Kompetenznachweise werden erstellt';
$string['creatingconditionalavailabilitydata'] = 'Daten für abhängige Verfügbarkeit werden erstellt';
...
$string['databasechecking11'] = 'Totara Datenbank wird aktualisiert...';
$string['databasecompare'] = 'Von:<br /><br /> $a->oldversion<br /><br /> Nach:<br /><br /> $a->newversion';
...
$string['deleteablock'] = 'Einen Block löschen';
...
$string['deletecomment'] = 'Diesen Kommentar löschen';
...
$string['editortoggle'] = 'Zu erweitertem Editormodus schalten';
...
$string['enterusername'] = 'Nutzernamen eingeben';
...
$string['hideshowblocks'] = 'Blocks sichtbar/verbergen';
...
$string['invalidusername'] = 'Der Anmeldename darf nur Kleinbuchstaben und Ziffern enthalten, außerdem die Zeichen Unterstrich (_), Bindestrich (-), Punkt (.) sowie das Symbol at (@).';
...
$string['legacythemeinuse'] = 'Diese Seite wird im Kompatibilitätsmodus angezeigt, da der Browser zu alt ist.';
...
$string['morethanonerecordinfetch'] = 'Fehler: mehr als ein Eintrag wurde zurückgegeben (Tabelle \'$a\')';
...
$string['nocategoriesfound'] = 'Keine Kategorien gefunden, die die Wörter \'$a\' beinhalten';
...
$string['noprogramsfound'] = 'Keine Programme gefunden, die die Wörter \'$a\' beinhalten';
...
$string['passwordforgotteninstructions2'] = 'Um Ihr Passwort zurückzusetzen, tragen Sie bitte Ihren Nutzernamen oder Ihre E-Mail-Adresse ein. Falls Sie in unserer Datenbank zu finden sind, wird eine E-Mail an Ihre E-Mail-Adresse verschickt, die eine Anleitung für Ihren Zugang enthält.';
...
$string['passwordreused'] = 'Das Passwort wurde in der Vergangenheit verwendet und kann nicht wiederverwendet werden';
...
$string['restorecannotassignroles'] = 'Wiederherstellen muss Rollen zuweisen wozu Sie keine Berechtigung besitzen';
$string['restorecannotcreateorassignroles'] = 'Wiederherstellen muss Rollen anlegen wozu Sie keine Berechtigung besitzen';
...
$string['restorecannotoverrideperms'] = 'Wiederherstellen muss Rechte überschreiben wozu Sie keine Berechtigung besitzen';
...
$string['searchresultsinx'] = 'Suchergebnisse in {$a}';
...
$string['skiptomaincontent'] = 'Vorwärtsspringen zum Hauptthema';
