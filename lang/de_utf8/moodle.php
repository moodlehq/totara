...
$string['adminhelpeditorsettings'] = 'Grundeinstellungen für den HTML-Editor festlegen';
$string['adminhelpedituser'] = 'Nutzerliste durchsuchen und Nutzerprofile bearbeiten';
$string['adminhelpenrolments'] = 'Konfigurieren Sie die Kurs-Einschreibeverfahren, die in Ihrem Moodle-System verfügbar sein sollen (interne oder externe Wege zur Kontrolle der Kurszugangsregelung).';
$string['adminhelpenvironment'] = 'Prüft, wie Ihr Server aktuelle und zukünftige Installationsanforderungen für Moodle erfüllt';
$string['adminhelpfailurelogs'] = 'Protokoll der gescheiterten Anmeldeversuche durchsehen';
...
$string['adminhelplogs'] = 'Logdaten aller Aktivitäten auf dieser Website anzeigen';
...
$string['adminhelpmanagemodules'] = 'Installierte Aktivitäten-Module und deren Einstellungen verwalten';
$string['adminhelpmanageroles'] = 'Rollen erzeugen und definieren, die an Nutzer/innen zugewiesen werden können.';
...
$string['adminhelpsitefiles'] = 'Allgemeine Dateien veröffentlichen oder externe Datensicherungen hochladen';
$string['adminhelpsitesettings'] = 'Aufbau der Startseite festlegen';
$string['adminhelpstickyblocks'] = 'Feste Blöcke für das gesamte Moodle konfigurieren';
$string['adminhelpthemes'] = 'Das Design (Farben, Schriften usw.) für die Website auswählen';
...
$string['adminhelpxmldbeditor'] = 'Interface zur Bearbeitung von XMLDB-Dateien. Ausschließlich für Entwickler/innen!!';
...
$string['areyousuretorestorethisinfo'] = 'Sie haben später die Möglichkeit, diese Sicherung einem bestehenden Kurs hinzuzufügen oder in einen völlig neuen Kurs einzuspielen.';
$string['asc'] = 'Aufsteigend';
$string['assessment'] = 'Beurteilung';
$string['assignadmins'] = 'Administrator/innen zuweisen';
$string['assigncreators'] = 'Kursverwalter/innen zuweisen';
$string['assignsiteroles'] = 'Rollen für die gesamte Website zuweisen';
$string['assignstudents'] = 'Teilnehmer/innen einschreiben';
$string['assignstudentsnote'] = 'Hinweis: Normalerweise werden Sie diese Funktion nicht benötigen, da sich die Teilnehmer/innen selbst in diesen Kurs einschreiben können.';
$string['assignstudentspass'] = 'Sie müssen den Teilnehmer/innen nur den Schlüssel dieses Kurses mitteilen. Er lautet gegenwärtig: \'$a\'';
$string['assignteachers'] = 'Trainer/innen zuweisen';
...
$string['backupfailed'] = 'Einige Ihrer Kurse wurden nicht gesichert !!';
...
$string['backupgradebookhistoryhelp'] = 'Wenn diese Einstellung aktiviert ist, dann wird der Bewertungsverlauf in die automatische Kurssicherung einbezogen. Beachten Sie, dass der Bewertungsverlauf in den Servereinstellungen nicht ausgeschaltet sein darf (disablegradehistory), damit dies funktioniert.';
...
$string['backuplogshelp'] = 'Wenn Sie diese Option aktivieren, werden die Logdaten des Kurses in die automatische Sicherung einbezogen.';
$string['backupmetacoursehelp'] = 'Wenn Sie diese Option aktivieren, werden die Metakursinformationen in die automatische Sicherung einbezogen.';
$string['backupmissinguserinfoperms'] = 'Hinweis: Diese Kurssicherung enthält keine Nutzerdaten. Beachten Sie bitte, dass die Aktivitäten \'Übung\' und \'Workshop\' nicht mitgesichert werden, weil diese Module nicht kompatibel mit dem Sicherungstyp sind.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnext'] = 'Nächste Sicherung';
$string['backupnoneusersinfo'] = 'Hinweis: Diese Kurssicherung enthält keine Nutzer, so dass alle Aktivitäten \'Ohne Nutzerdaten\' gespeichert werden. Beachten Sie bitte, dass die Aktivitäten \'Übung\' und \'Workshop\' nicht mitgesichert werden, weil diese Module nicht kompatibel mit dem Sicherungstyp sind.';
...
$string['backuproleassignments'] = 'Sicherung der Rollenzuordnungen für diese Rolle';
$string['backupsavetohelp'] = 'Vollständiger Pfad des Verzeichnisses, in dem die Sicherungsdateien abgelegt werden sollen <br />(leer lassen, um im Standardsicherungsverzeichnis des Kurses zu speichern)';
$string['backupschedulehelp'] = 'Wählen Sie, an welchen Wochentagen die automatischen Sicherungen durchgeführt werden sollen.';
$string['backupsitefileshelp'] = 'Falls diese Einstellung aktiviert ist, werden die in Kursen benutzten Dateien der Website in die automatischen Sicherungen einbezogen.';
...
$string['backupusershelp'] = 'Wählen Sie, ob die vollständige Nutzerliste des Servers oder nur die jeweilige Nutzerliste des Kurses in die Sicherung einbezogen werden sollen.';
$string['backupversion'] = 'Sicherungsversion';
$string['block'] = 'Block';
$string['blockconfiga'] = 'Block \'$a\' konfigurieren';
$string['blockconfigbad'] = 'Dieser Block wurde nicht richtig implementiert. Aus diesem Grund steht für ihn keine Konfigurationsseite zur Verfügung.';
...
$string['categorycontents'] = 'Kurse und Kursunterbereiche';
...
$string['chooseauthmethod'] = 'Wählen Sie ein Plugin zur Authentifizierung';
$string['choosecourse'] = 'Wählen Sie einen Kurs';
$string['chooseenrolmethod'] = 'Kurs-Einschreibeverfahren auswählen';
$string['chooselivelogs'] = 'Oder momentane Aktivitäten anzeigen';
...
$string['convertingwikitomarkdown'] = 'Konvertiere Wiki in Markdown';
$string['cookiesenabled'] = 'Cookies müssen in Ihrem Browser aktiviert sein!';
$string['cookiesnotenabled'] = 'Leider sind Cookies in Ihrem Browser deaktiviert.';
$string['copy'] = 'Kopieren';
$string['copyasnoun'] = 'Kopie';
$string['copyingcoursefiles'] = 'Kursdateien kopieren';
$string['copyingsitefiles'] = 'Im Kurs benutzte Dateien der Website kopieren';
...
$string['coursecompletion'] = 'Abschlussverfolgung';
$string['coursecompletiondata'] = 'Abschlussverfolgung Daten';
$string['coursecompletions'] = 'Abschlussverfolgung';
...
$string['coursehelphiddensections'] = 'Diese Einstellung gibt an, wie verborgene Abschnitte für die Teilnehmer/innen dargestellt werden';
$string['coursehelpmaximumupload'] = 'Definieren Sie die maximale Größe einer Datei, die Teilnehmer/innen dieses Kurses hochladen dürfen, eingeschränkt durch die Einstellungen der Website';
$string['coursehelpmetacourse'] = 'Den Kurs als Metakurs setzen. Ein Metakurs benutzt die Teilnehmereinschreibungen (und andere Rollenzuweisungen) von einem oder mehreren zugeordneten Kursen.';
...
$string['coursehidden'] = 'Der Kurs steht derzeit für Teilnehmer/innen nicht zur Verfügung.';
$string['courseimportnotaught'] = 'Sie sind in keinem anderen Kurs als Trainer/in mit Bearbeitungsrechten eingetragen. Es gibt daher keinen Kurs, aus dem Sie Daten importieren können.';
...
$string['courserequestsuccess'] = 'Ihr Kursantrag wurde erfolgreich gespeichert. In Kürze erhalten Sie per E-Mail eine Benachrichtigung, wie über Ihren Antrag entschieden wurde.';
...
$string['creatingcoursecompletiondata'] = 'Erstelle Abschlussverfolgungsdaten';
$string['creatingcoursemodules'] = 'Kursaktivitäten erstellen';
...
$string['creatinggroupingsgroups'] = 'Gruppen in die Gruppierungen einfügen';
...
$string['creatingtemporarystructures'] = 'Vorübergehende Strukturen erstellen';
...
$string['databasechecking11'] = 'Aktualisiere Moodle-Datenbank von Version $a->oldversion auf $a->newversion...';
$string['databaseperformance'] = 'Datenbankleistung';
$string['databasesetup'] = 'Richte Datenbank ein';
...
$string['datemostrecentfirst'] = 'Daten - neueste zuerst';
$string['datemostrecentlast'] = 'Daten - älteste zuerst';
$string['day'] = 'Tag';
$string['days'] = 'Tage';
$string['decodinginternallinks'] = 'Dekodiere interne Links';
$string['default'] = 'Grundeinstellung';
$string['defaultcoursefullname'] = 'Kursname (bitte ausfüllen)';
$string['defaultcourseshortname'] = 'Kurs (bitte ändern)';
...
$string['defaultcoursesummary'] = 'Beschreiben Sie kurz und prägnant, worum es in diesem Kurs geht.';
$string['defaultcourseteacher'] = 'Trainer/in';
$string['defaultcourseteacherdescription'] = 'Trainer/innen dürfen in einem Kurs alles tun, incl. der Veränderung von Aktivitäten und der Beurteilung von Teilnehmer/innen.';
...
$string['donotclickcontinue'] = 'Klicken Sie nicht auf den nachfolgenden Link  ;-)';
$string['down'] = 'Abwärts';
...
$string['edhelpcleanword'] = 'Aktivierung/Deaktivierung des Filters für Word-formatierte Texte';
$string['edhelpenablespelling'] = 'Aktivierung/Deaktivierung der Rechtschreibprüfung. Wenn die Rechtschreibprüfung aktiviert wird, muss <strong>aspell</strong> auf dem Server installiert sein. Der zweite Parameter gibt das <strong>Standardwörterbuch</strong> an. Dieser Parameter wird benutzt, wenn aspell kein Wörterbuch für die aktuell eingestellte Sprache zur Verfügung hat.';
$string['edhelpfontfamily'] = 'Liste von Schriftarten und/oder allgemeinen Schriftfamilien, die im Editor zur Verfügung stehen sollen. Die einzelnen Schriftarten/ -familien müssen durch Komma voneinander getrennt werden.';
$string['edhelpfontlist'] = 'Festlegung der Schriften, die im Dropdown-Menü des WYSIWYG-Editors angezeigt werden.';
...
$string['editcategorythis'] = 'Diesen Kursbereich bearbeiten';
...
$string['editorcommonsettings'] = 'Standard-Einstellungen';
...
$string['editorhelptopics'] = 'Hilfethemen zum Editor';
...
$string['emailactive'] = 'E-Mail-Adresse aktivieren';
...
$string['emaildigestsubjects'] = 'Ja, täglich eine E-Mail mit den Betreffs aller Forenbeiträge senden';
$string['emaildisable'] = 'Nein, diese Adresse ist ausgeschaltet';
...
$string['emaildisplaycourse'] = 'Ja, nur für Kursteilnehmer/innen sichtbar';
$string['emaildisplayno'] = 'Nein, für niemanden sichtbar';
$string['emaildisplayyes'] = 'Ja, für alle sichtbar';
$string['emailenable'] = 'Ja, Nachrichten an diese Adresse senden';
...
$string['enrolledincourse'] = 'Eingeschrieben im Kurs';
$string['enrolledincoursenot'] = 'Nicht eingeschrieben im Kurs';
$string['enrolledincoursenotrole'] = 'Fehler beim Eintragen in \"$a->course\" als \"$a->role\"';
$string['enrolledincourserole'] = 'Eingetragen in \"$a->course\" als \"$a->role\"';
$string['enrollfirst'] = 'Sie müssen in mindestens einem Kurs eingeschrieben sein, bevor Sie die Aktivitäten auf dieser Webseite nutzen können.';
...
$string['enrolmentkeyfrom'] = 'Für diesen Kurs benötigen Sie einmalig einen \'Zugangsschlüssel\' - ein Kennwort. Sie erhalten diesen von $a';
...
$string['existingcreators'] = 'Vorhandene Kursverwalter/innen';
...
$string['extendenrol'] = 'Anmeldung verlängern';
...
$string['forcepasswordchangehelp'] = 'Aufforderung zur Kennwortänderung beim nächsten Login';
$string['forcepasswordchangenot'] = 'Die Kennwortänderung konnte für $a nicht angefordert werden';
...
$string['forgottenduplicate'] = 'Diese E-Mail-Adresse wird von mehreren Nutzern verwandt. Geben Sie daher bitte den Nutzernamen ein.';
...
$string['from'] = 'Von';
$string['frontpagecategorycombo'] = 'Kombi-Liste';
$string['frontpagecategorynames'] = 'Liste der Kursbereiche';
...
$string['frontpagenews'] = 'Nachrichten anzeigen';
...
$string['groupinfomembers'] = 'Informationen über die markierten Gruppenmitglieder';
$string['groupinfopeople'] = 'Informationen über die markierten Teilnehmer/innen';
...
$string['helpformatting'] = 'Wie Sie Text formatieren';
$string['helphtml'] = 'Wie Sie einen HTML-Text schreiben';
$string['helpindex'] = 'Index aller Hilfe-Dateien';
$string['helpinterestslist'] = 'Liste der persönlichen Interessen, jeweils durch Komma getrennt.';
$string['helppicture'] = 'Wie Sie ein Foto hochladen';
$string['helpprefix'] = 'Hilfe: $a';
$string['helpprefix2'] = 'Hilfe für $a';
$string['helpquestions'] = 'Wie Sie effektiv Fragen stellen';
$string['helpreading'] = 'Wie Sie sorgfältig lesen';
$string['helprichtext'] = 'Über den HTML-Editor';
...
$string['helpwriting'] = 'Wie Sie verständlich schreiben';
...
$string['hiddensectionscollapsed'] = 'Mit hellgrauer Schrift angezeigt';
$string['hiddensectionsinvisible'] = 'Vollständig unsichtbar';
$string['hide'] = 'Verbergen';
$string['hideadvancedsettings'] = 'Erweiterte Einstellungen verbergen';
...
$string['importmetacoursenote'] = 'Verwenden Sie dieses Formular, um Ihren Metakurs mit anderen Kursen zu verbinden. Dadurch werden die Nutzer/innen dieser Kurse in den Metakurs eingeschrieben.';
...
$string['interestslist'] = 'Interessenfelder';
...
$string['managemeta'] = 'Metakurs';
$string['managemetadisabled'] = 'Diese Funktion ist deaktiviert, weil der Kurs mit einem Metakurs verbunden ist.';
$string['managemetaexplan'] = '(Das bedeutet, dass Anmeldungen von Nutzer/innen aus anderen Kursen übernommen werden)';
$string['managemodules'] = 'Module';
$string['manageroles'] = 'Rollen und Rechte';
$string['manageruser'] = 'Manager Benutzer';
$string['manageruserdescription'] = 'Managers können andere Benutzer managen.';
...
$string['metaalreadyhascourses'] = 'Dieser Metakurs wurde bereits mit anderen Kursen verbunden.';
$string['metaalreadyhasenrolments'] = 'Dieser Kurs hat bereits normale Anmeldungen';
$string['metaalreadyinmeta'] = 'Dieser Kurs ist bereits mit einem Metakurs verbunden.';
$string['metaassigncourses'] = 'Kurse mit Metakurs verbinden';
$string['metacourse'] = 'Metakurs';
$string['metanoalreadycourses'] = 'Bisher keine Kurse mit Metakurs verbunden';
$string['metanopotentialcourses'] = 'Keine Kurse verfügbar';
$string['metapotentialcourses'] = 'Verfügbare Kurse';
$string['metaremovecourse'] = 'Diesen Kurs löschen';
...
$string['noneditingteacherdescription'] = 'Trainer/innen ohne Bearbeitungsrecht dürfen in Kursen unterrichten und Teilnehmer/innen bewerten, aber sie können nichts verändern.';
...
$string['passwordforgotteninstructions'] = 'Ihre Daten müssen zuerst in der Moodle-Datenbank gesucht werden. Tragen Sie entweder Ihren Anmeldenamen <strong>oder </strong> Ihre in Moodle registrierte E-Mail-Adresse im entsprechenden Textfeld ein.';
...
$string['potentialcreators'] = 'Mögliche Kursverwalter/innen';
...
$string['publicsitefileswarning3'] = 'Achtung: Jeder könnte die hier befindlichen Dateien herunterladen, der die URL kennt (oder erraten kann). Aus Sicherheitsgründen sollten Kurssicherungen ausschließlich im besonders geschützen Ordner \"backupdata\" bleiben.';
...
$string['savechangesandreturntocourse'] = 'Speichern und zum Kurs zurück';
...
$string['scheduledbackupsinactive'] = 'Regelmäßige automatische Backups wurden vom Admin nicht eingerichtet.';
...
$string['statsreport14'] = 'Aktivste Kurse (meiste Zugriffe und Beiträge)';
$string['statsreport2'] = 'Zugriffe (Trainer/innen und Teilnehmer/innen)';
...
$string['studentviewon'] = 'Teilnehmeransicht: ein';
...
Hinweis für Übersetzer: Diese Zeichenkette legt die Leserichtung Ihrer Sprache fest: von links nach rechts (geben Sie \'ltr\' an), von rechts nach links (geben Sie \'rtl\' an).';
$string['thislanguage'] = 'Deutsch 

Hinweis für Übersetzer: Geben Sie den Namen Ihrer Sprache an. Verwenden Sie, wenn möglich, die Unicodebezeichnung für Ihre Sprache.';
$string['time'] = 'Zeit';
...
$string['unenrolallstudents'] = 'Alle Teilnehmer/innen aus diesem Kurs LÖSCHEN !! Alle teilnehmerspezifischen Daten werden dann gelöscht.';
$string['unenrolallstudentssure'] = 'Sind Sie sicher, dass Sie alle Teilnehmer/innen aus  diesem Kurs löschen wollen? Alle teilnehmerspezifischen Daten werden dann gelöscht.';
$string['unenrolme'] = 'Abmelden aus $a';
$string['unenrolroleusers'] = 'Nutzer/innen abmelden';
$string['unenrolsure'] = 'Sind Sie sicher, dass Sie $a als Teilnehmer/in aus diesem Kurs löschen wollen? <br /><strong>Hinweis: Die teilnehmerspezifischen Daten von $a werden dann gelöscht.</strong>';
...
$string['virusplaceholder'] = 'Die hochgeladene Datei ist virenverdächtig. Sie wurde verschoben oder gelöscht. Eine Nutzernachricht wurde versandt.';
...
Damit die anderen Nutzer/innen mehr über Sie erfahren können, sollten Sie Ihr persönliches Profil bearbeiten. Mit diesem Link gelangen Sie direkt dort hin:
$a->profileurl';
...
$string['writingcompetencyevidenceinfo'] = 'Schreibe Informationen über Kompetenznachweis';
...
$string['writingloginfo'] = 'Log-Info schreiben';
...
$string['activitymodules'] = 'Aktivitäten'; // ORPHANED
$string['addblock'] = 'Block hinzufügen'; // ORPHANED
$string['addcomment'] = 'Kommentar hinzufügen...'; // ORPHANED
$string['addcountertousername'] = 'Nutzernamen durch Anhängen einer Zahl erzeugen'; // ORPHANED
$string['adddots'] = 'Hinzufügen...'; // ORPHANED
$string['backto'] = 'Zurück zu $a'; // ORPHANED
$string['backtopageyouwereon'] = 'Zurück zur Seite, auf der Sie vorher waren'; // ORPHANED
$string['brief'] = 'Auftrag'; // ORPHANED
$string['choosedots'] = 'Auswählen...'; // ORPHANED
$string['clear'] = 'Bereinigen'; // ORPHANED
$string['clickhelpiconformoreinfo'] = '... wird fortgesetzt ... klicken Sie auf das Hilfe-Icon, um den vollständigen Text lesen zu können'; // ORPHANED
$string['clicktohideshow'] = 'Zum Erweitern oder Zusammenfassen klicken'; // ORPHANED
$string['commentincontext'] = 'Diesen Kommentar im Zusammenhang suchen'; // ORPHANED
$string['comments'] = 'Kommentare'; // ORPHANED
$string['courseadministration'] = 'Kurs-Administration'; // ORPHANED
$string['courseapprovedemail2'] = 'Der von Ihnen beantragte Kurs \'$a->name\' wurde angelegt. Zum neuen Kurs gelangen Sie über $a->url.'; // ORPHANED
$string['courseenrolend'] = 'Ende der Kurseinschreibung'; // ORPHANED
$string['courseenrolstart'] = 'Beginn der Kurseinschreibung'; // ORPHANED
$string['coursehelpenrollable'] = 'Teilnehmer/innen dürfen sich selber über das Standard-Plugin einschreiben'; // ORPHANED
$string['coursehelpenrolmentkey'] = 'Wenn ein Zugangsschlüssel gesetzt ist, dann wird dieser Zugangsschlüssel benötigt, um sich in den Kurs einzuschreiben'; // ORPHANED
$string['coursehelpenrolmentplugins'] = 'Standard-Plugin zur Einschreibung'; // ORPHANED
$string['coursehelpexpirynotifystudents'] = 'Wenn eine Teilnahmedauer festgelegt wurde, dann bestimmt diese Einstellung, ob Teilnehmer/innen eine E-Mail-Benachrichtigung erhalten, bevor sie aus dem Kurs entfernt werden.'; // ORPHANED
$string['coursehelpexpirythreshold'] = 'Wenn eine Teilnahmedauer festgelegt wurde, dann bestimmt die Zahl der Tage, mit welchen Vorlauf eine E-Mail-Benachrichtigung versandt wird, bevor Teilnehmer/innen aus dem Kurs entfernt werden.'; // ORPHANED
$string['coursehelpforce'] = 'Den Gruppenmodus für alle Aktivitäten des Kurses festlegen'; // ORPHANED
$string['coursehelpnotify'] = 'Wenn eine Teilnahmedauer festgelegt wurde, dann bestimmt diese Einstellung, ob Trainer/innen eine E-Mail-Benachrichtigung erhalten, bevor jemand aus dem Kurs entfernt wird.'; // ORPHANED
$string['coursesectionsummaries'] = 'Kurzübersichten zu Kursabschnitten'; // ORPHANED
$string['coursestart'] = 'Kursbeginn'; // ORPHANED
$string['deleteablock'] = 'Einen Block löschen'; // ORPHANED
$string['deletecomment'] = 'Diesen Kommentar löschen'; // ORPHANED
$string['disabledcomments'] = 'Kommentare sind deaktiviert'; // ORPHANED
$string['download'] = 'Herunterladen'; // ORPHANED
$string['downloadall'] = 'Alles herunterladen'; // ORPHANED
$string['downloadfile'] = 'Datei herunterladen'; // ORPHANED
$string['english'] = 'Englisch'; // ORPHANED
$string['enroldetails'] = 'Einschreibedetails'; // ORPHANED
$string['enteremail'] = 'E-Mail-Adresse eingeben'; // ORPHANED
$string['enterusername'] = 'Nutzernamen eingeben'; // ORPHANED
$string['filter'] = 'Filter'; // ORPHANED
$string['frontpagesettings'] = 'Einstellungen der Startseite'; // ORPHANED
...
$string['hideshowblocks'] = 'Blocks sichtbar/verbergen'; // ORPHANED
$string['hidetopicfromothers'] = 'Themenfeld verbergen'; // ORPHANED
$string['hideweekfromothers'] = 'Woche verbergen'; // ORPHANED
$string['invalidusername'] = 'Der Anmeldename darf nur Kleinbuchstaben und Ziffern enthalten, außerdem die Zeichen Unterstrich (_), Bindestrich (-), Punkt (.) sowie das Symbol at (@).'; // ORPHANED
$string['invalidusernameupload'] = 'Ungültiger Anmeldename'; // ORPHANED
$string['localplugindeleteconfirm'] = 'Sie sind dabei, das lokale Plugin \'{$a}\' zu löschen. Der Vorgang wird endgültig alle Daten in der Datenbank löschen, die mit diesem Plugin verknüpft sind. Sind Sie wirklich sicher, dass Sie weitermachen möchten?'; // ORPHANED
$string['localplugins'] = 'Lokale Plugins'; // ORPHANED
$string['localpluginsmanage'] = 'Lokale Plugins verwalten'; // ORPHANED
$string['matchingsearchandrole'] = 'Anpassung von \'$a->search\' und $a->role'; // ORPHANED
$string['maximumgradex'] = 'Beste Bewertung: $a'; // ORPHANED
$string['messageprovider:errors'] = 'Schwerwiegende Fehler mit dieser Website'; // ORPHANED
$string['messageprovider:notices'] = 'Benachrichtigung bei kleinen Fehlern'; // ORPHANED
$string['moduleintro'] = 'Beschreibung'; // ORPHANED
$string['mymoodledashboard'] = 'Mein Bereich'; // ORPHANED
$string['myprofile'] = 'Mein Profil'; // ORPHANED
$string['navigation'] = 'Navigation'; // ORPHANED
$string['noblockstoaddhere'] = 'Es gibt keine Blocks, die Sie zu dieser Seite hinzufügen können'; // ORPHANED
$string['nomatchingusers'] = 'Keine passenden Nutzer/innen \'$a\''; // ORPHANED
$string['pageshouldredirect'] = 'Die Weiterleitung sollte automatisch funktionieren - falls nichts passiert, klicken Sie bitte auf den nachfolgenden Link'; // ORPHANED
$string['participantslist'] = 'Teilnehmerliste'; // ORPHANED
$string['passwordforgotteninstructions2'] = 'Um Ihr Passwort zurückzusetzen, tragen Sie bitte Ihren Nutzernamen oder Ihre E-Mail-Adresse ein. Falls Sie in unserer Datenbank zu finden sind, wird eine E-Mail an Ihre E-Mail-Adresse verschickt, die eine Anleitung für Ihren Zugang enthält.'; // ORPHANED
$string['path'] = 'Pfad'; // ORPHANED
$string['pleasesearchmore'] = 'Bitte suchen Sie weiter'; // ORPHANED
$string['pleaseusesearch'] = 'Bitte benutzen Sie die Suchfunktion'; // ORPHANED
$string['plugin'] = 'Plugin'; // ORPHANED
$string['plugindeletefiles'] = 'Alle mit dem Plugin \'{$a->name}\' verknüpften Daten wurden in der Datenbank gelöscht. Um zu verhindern, dass sich das Plugin selbst wieder zurückinstalliert, sollten Sie nun folgendes Verzeichnis von Ihrem Server löschen:  {$a->directory}'; // ORPHANED
$string['previouslyselectedusers'] = 'Früher gewählte Nutzer passen nicht zu \'$a\''; // ORPHANED
$string['redirect'] = 'Weiterleiten'; // ORPHANED
$string['repositories'] = 'Speicherorte'; // ORPHANED
$string['returntooriginaluser'] = 'Zurück zu $a'; // ORPHANED
$string['searchbyemail'] = 'Über die E-Mail-Adresse suchen'; // ORPHANED
$string['searchbyusername'] = 'Über den Anmeldenamen suchen'; // ORPHANED
$string['searchoptions'] = 'Suchoptionen'; // ORPHANED
$string['seconds'] = 'Sekunden'; // ORPHANED
$string['selectedfile'] = 'Ausgewählte Datei'; // ORPHANED
$string['selectfiles'] = 'Dateien auswählen'; // ORPHANED
$string['shortnamecourse'] = 'Kursname (kurz)'; // ORPHANED
$string['shortnameuser'] = 'Nutzername (kurz)'; // ORPHANED
$string['showcomments'] = 'Kommentare sichtbar/verbergen'; // ORPHANED
$string['showtopicfromothers'] = 'Themenfeld anzeigen'; // ORPHANED
$string['showweekfromothers'] = 'Woche anzeigen'; // ORPHANED
$string['sortbyx'] = 'Sortierung nach $a aufsteigend'; // ORPHANED
$string['sortbyxreverse'] = 'Sortierung nach $a absteigend'; // ORPHANED
$string['toomanyusersmatchsearch'] = 'Zu viele Nutzer/innen ($a->count) passen zu \'$a->search\''; // ORPHANED
$string['toomanyuserstoshow'] = 'Zu viele Nutzer/innen ($a), um alle anzuzeigen'; // ORPHANED
$string['uploadfilecontainerror'] = 'Die hochgeladene Datei wurde wegen eines Fehlers nicht verarbeitet. Bitte ändern Sie die Datei, bevor Sie sie erneut hochladen.'; // ORPHANED
$string['uploadfilecontentsnovaliddata'] = 'Die hochgeladene Datei enthält keine gültigen Daten'; // ORPHANED
$string['uploadinvalidpreprocessedcount'] = 'Anzahl der ungültig verarbeiteten Datensätze: $a'; // ORPHANED
$string['uploadnewfile'] = 'Neue Datei hochladen'; // ORPHANED
$string['url'] = 'URL'; // ORPHANED
$string['usercurrentsettings'] = 'Mein Profil'; // ORPHANED
$string['userdetails'] = 'Nutzerdetails'; // ORPHANED
$string['userselectorautoselectunique'] = 'Wenn nur ein/e Nutzer/in zur Suche passt, wähle diesen automatisch.'; // ORPHANED
$string['userselectorpreserveselected'] = 'Verwerfe ausgewählte Nutzer/innen, wenn sie nicht mehr zur Suche passen.'; // ORPHANED
$string['userselectorsearchanywhere'] = 'Vergleiche den Suchtext irgendwo im Namen des Benutzers'; // ORPHANED
$string['useruploadtype'] = 'Art des Nutzeruploads'; // ORPHANED
$string['userviewingsettings'] = 'Profil von $a'; // ORPHANED
$string['viewfileinpopup'] = 'Datei im Popup-Fenster anzeigen'; // ORPHANED
$string['viewprofile'] = 'Profil anzeigen'; // ORPHANED
$string['windowclosing'] = 'Dieses Fenster sollte sich automatisch schließen - falls nicht, dann tun Sie es jetzt'; // ORPHANED
$string['yourwordforx'] = 'Ihre Bezeichnung für \'$a\''; // ORPHANED
