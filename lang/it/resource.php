...
/**
 * Strings for component 'resource', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   resource
...
$string['configparametersettings'] = 'Puoi decidere se mostrare o meno le impostazioni che influenzano l\'invio di parametri alle risorse di tipo "Link a file o sito web". Dopo il primo accesso tuttavia, per ogni utente saranno mantenute le rispettive preferenze di visualizzazione.';
