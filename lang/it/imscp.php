...
/**
 * Strings for component 'imscp', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   imscp
...
$string['modulename_help'] = 'IMS content package permette di utilizzare nel corso pacchetti creati secondo questo standard.';
