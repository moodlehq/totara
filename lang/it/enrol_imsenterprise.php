...
/**
 * Strings for component 'enrol_imsenterprise', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['allowunenrol_desc'] = 'Permette di rimuovere le iscrizione dai corsi quando se specificato nel file IMS Enterprise';
...
$string['createnewcourses_desc'] = 'L\'impostazione permette di creare nuovi corsi se nel file IMS Enterprise sono presenti corsi non ancora creati in Moodle. Tutti i nuovi corsi creati saranno nascosti.';
$string['createnewusers'] = 'Crea nuovi account per gli utenti non presenti in Moodle';
$string['createnewusers_desc'] = 'I dati di iscrizione IMS Enterprise descrivono insiemi di utenti e permettono di creare account per gli utenti non presenti nel database di Moodle.

Gli utenti vengono cercati prima tramite il numero ID e poi in base allo username. Le password non vengono importate, pertanto si suggerisce di affiancare l\'iscrizione con un plugin di autenticazione.';
$string['cronfrequency'] = 'Frequenza di attivazione';
$string['deleteusers'] = 'Elimina gli account se è specificato nei dati IMS';
$string['deleteusers_desc'] = 'L\'impostazione permette di eliminare account utenti se specificato nel file IMS (recstatus deve essere impostato a 3, che significa eliminazione di un account). Per default l\'account non viene fisicamente eliminato dalla tabella degli utenti di Moodle ma solo contrassegnato come eliminato.';
