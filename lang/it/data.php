...
/**
 * Strings for component 'data', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   data
...
$string['modulename_help'] = 'Il modulo attività database permette ai partecipanti di creare, gestire e ricercare insiemi di record. Il formato e la struttura dei record è libero e può includere immagini, file, URL, numeri, testi, eccetera.';
...
$string['saveaspreset_help'] = 'Permette di salvare la struttura di questo database come preimpostazione rendendola disponibile agli utenti del sito, comparendo nella lista delle preimpostazioni. E\' possibile eliminare in qualsiasi momento la preimpostazione salvata.';
