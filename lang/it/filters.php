...
/**
 * Strings for component 'filters', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   filters
...
$string['includesubcategories'] = 'Includere le sotto categorie?';
...
$string['isgreaterorequalto'] = 'è superiore o uguale a';
$string['isgreaterthan'] = 'è superiore a';
$string['islessthan'] = 'è inferiore a';
$string['islessthanorequalto'] = 'è inferiore o uguale a';
$string['isnotdefined'] = 'non è definito';
$string['isnotequalto'] = 'non è uguale a';
$string['matchesallselected'] = 'corrisponde a tutti i selezionati';
$string['matchesanyselected'] = 'corrisponde a qualsiasi selezionato';
