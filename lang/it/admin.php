...
/**
 * Strings for component 'admin', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['allowframembedding_help'] = 'Permette di effettuare l\'embed di questo in frame di altri siti.
...
$string['backup_shortnamehelp'] = 'Il nome del corso sarà utilizzato come parte del nome del file di backup al posto del numero id.';
...
$string['configcronclionly'] = 'L\'opzione disabilita l\'esecuzione del cron via web, permettendola solo dalla linea di comando. L\'opzione annulla le eventuali impostazioni sottostanti relative alla password cron.';
...
$string['configgeoipfile'] = 'Posizione del file dati GeoIP City. Questo file non fa parte della distribuzione di Moodle e deve essere scaricato separatamente da <a href="http://www.maxmind.com/">MaxMind</a>. E\' possibile acquistare la versione commerciale o utilizzare la versione gratuita.<br/> Per il download andare su <a href="http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz">http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz</a> ed estrarre il file nella cartella "{$a}" del proprio server.';
...
$string['configusesitenameforsitepages'] = 'Permette di usare il nome abbreviato del sito per il nodo pagine del sito nel blocco navigazione. Il nome del sito sostituirà la stringa "Pagine del sito"';
...
$string['courselistshortnames'] = 'Visualizza titoli abbreviati';
$string['courselistshortnames_desc'] = 'Visualizza nell\'elenco dei corsi i titoli anche in forma abbreviata.';
...
$string['debugstringids_desc'] = 'L\'opzione è pensata per facilitare i traduttori: attivandola, posponendo all\'URL il parametro strings=1, verrà visualizzata la provenienza di ciascuna  stringa della lingua.';
...
$string['frontpageitem'] = 'Elemento {$a} della pagina home';
$string['frontpageitemloggedin'] = 'Elemento {$a} della pagina home dopo il login';
...
$string['maturitycorewarning'] = 'Stai per installare o aggiornare Moodle alla versione "{$a}". Non trattandosi di una versione pronta per andare in produzione, accertati che tu voglia effetivamente installare/aggiornare a questa versione e che tu abbia effettuato il checkout della versione desiderata del codice sorgente di Moodle.';
...
$string['navlinkcoursesections'] = 'Link alle sezioni del corso';
$string['navlinkcoursesections_help'] = 'Nel blocco navigazione saranno visualizzati i link alle sezioni del corso.';
...
$string['reportsdeleteconfirm'] = 'Stai per eliminare il report \'{$a}\'. Tutti i dati associati a questo plugin attualmente memorizzati nel database verranno eliminati. Sei sicuro di continuare ?';
...
$string['spelllanguagelist'] = 'Elenco lingue per il correttore';
...
$string['toolsdeleteconfirm'] = 'Stai per eliminare il tool amministrativo \'{$a}\'. Tutti i dati associati a questo plugin saranno eliminati., Sei sicuro di proseguire ?';
