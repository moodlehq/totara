...
/**
 * Strings for component 'portfolio_mahara', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['err_invalidhost_help'] = 'Il plugin è mal configurato, punta a un host MNet non valido (o eliminato). Per funzionare il plugin ha bisogno di peer Moodle Networking che pubblichino il servizio SSO IDP, sottoscrivano il servizio SSO SP ed del servizio Portfolio pubblicato **e** sottoscritto.';
...
$string['err_nomnethosts_help'] = 'Questo plugin ha bisogno di un nodo MNet che pubblichi il servizio SSO IDP, sottoscriva il servizio SSO SP, pubblichi **e** sottoscriva il servizio Portfolio, inoltre ha bisogno dell plugin di autenticazione MNet abilitato. Qualsiasi istanza di questo plugin sarà invisibile finché non saranno soddisfatte tutte le condizioni precedenti, quando potrai impostare manualmente la visibilità.';
