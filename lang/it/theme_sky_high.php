...
/**
 * Strings for component 'theme_sky_high', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['configtitle'] = 'Impostazioni Sky High';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'E\' possibile inserire l\'URL di una immagine per personalizzare il logo, ad esempio http://www.yoursite.com/path/to/logo.png. Il logo deve essere alto 50 pixel.';
$string['pluginname'] = 'Sky High';
$string['region-side-post'] = 'Destra';
$string['region-side-pre'] = 'Sinistra';
$string['regionwidth'] = 'Larghezza colonne';
$string['regionwidthdesc'] = 'Imposta la larghezza delle regioni laterali destra e sinistra dove appaiono i blocchi.';
$string['tagline'] = 'Tagline';
$string['taglinedesc'] = 'Il testo inserito sarà visualizzato sotto il nome del sito nella pagina home';
