...
/**
 * Strings for component 'label', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   label
...
$string['modulename_help'] = 'L\'etichetta consente di inserire immagini e testo nella home page del corso';
