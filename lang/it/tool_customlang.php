...
/**
 * Strings for component 'tool_customlang', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['confirmcheckin'] = 'Stai per salvare le modifiche sul il check in delle stringhe modificate nel language pack locale. Le stringhe modificate saranno esportate dal translator e salvate nelle cartella moodledata per consentire a Moodle di utilizzarle. Premi il tasto "Continua" per eseguire il salvataggio.';
