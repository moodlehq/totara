...
/**
 * Strings for component 'gradingform_rubric', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['enableremarks'] = 'Permetti al valutatore di aggiungere commenti testuali ai criteri';
...
$string['regrademessage5'] = 'Stai per salvare modifiche significative ad un rubric che è già stato utilizzato per valutare. I valori presenti nel registro valutatore non saranno modificate, ma il rubric on sarà visualizzabile dagli studenti finché non verranno nuovamente valutati.';
...
$string['showdescriptionstudent'] = 'Visualizza la descrizione del rubric a coloro che riceveranno la valuatzione';
