...
/**
 * Strings for component 'role', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   role
...
$string['highlightedcellsshowdefault'] = 'Le caselle evidenziate nella tabella sottostante indicano i privilegi di default per questo tipo di ruolo, ereditati dal \'Tipo di ruolo origine\' selezionato sopra.';
...
$string['my:configsyspages'] = 'Configurare modelli di pagina My Moodle a livello di sistema';
$string['my:manageblocks'] = 'Gestire blocchi nella pagina \'My Moodle\'';
...
$string['user:manageownblocks'] = 'e blocchi nel proprio profilo';
