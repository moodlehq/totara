...
/**
 * Strings for component 'block', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   block
...
$string['defaultweight_help'] = 'Il peso di default permette di indicare grossolanamente la posizione del blocco in una data regione. La posizione effettiva sarà calcolata tenendo presenti tutti i blocchi presenti nella regione, (ad esempio, solo un blocco può essere presente nel punto più alto della regione). Tenere presente che le impostazioni di pagine specifiche possono avere la precedenza sul peso di default.';
