...
/**
 * Strings for component 'completion', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   completion
...
$string['achievinggrade'] = 'Voto da raggiungere';
...
$string['addcourseprerequisite'] = 'Aggiungi un corso prerequisito';
$string['afterspecifieddate'] = 'Trascorsa questa data';
...
$string['completiononunenrolment'] = 'Completamento all\'atto della disisicrizione';
$string['completionsettingslocked'] = 'Impostazioni di completamento bloccate';
$string['completionstartonenrol'] = 'Inizio tracciamento stato di completamento all\'iscrizione';
$string['completionstartonenrolhelp'] = 'Il tracciamento dello stato di  completamento inizierà dopo l\'iscrizione dello studente al corso';
...
$string['confirmselfcompletion'] = 'Conferma auto completamento';
$string['coursealreadycompleted'] = 'Hai già completato questo corso';
$string['coursecomplete'] = 'Completamento corso';
$string['coursecompleted'] = 'Corso completato';
$string['coursegrade'] = 'Valutazione del corso';
$string['courseprerequisites'] = 'Prerequisiti del corso';
...
$string['coursesavailableexplaination'] = '<i>Affinché un corso possa comparire nell\'elenco dei corsi disponibili è necessario impostare i relativi criteri di completamento</i>';
$string['criteria'] = 'Criteri';
$string['criteriagradenote'] = 'Da notare che aggiornando qui la valutazione richiesta, non sarà aggiornata l\'attuale valutazione richiesta per superare il corso.';
...
$string['days'] = 'Giorni';
$string['daysafterenrolment'] = 'Giorni di iscrizione al corso';
$string['deletecoursecompletiondata'] = 'Elimina dati completamento corso';
$string['deletedcourse'] = 'Corso eliminato';
$string['dependencies'] = 'Dipendenze';
$string['dependenciescompleted'] = 'Dipendenze completate';
$string['durationafterenrolment'] = 'Durata dell\'iscrizione al corso';
$string['editcoursecompletionsettings'] = 'Modifica criteri per il completamento del corso';
...
$string['enrolmentduration'] = 'Giorni mancanti';
...
$string['err_noroles'] = 'In questo corso non ci sono ruoli con il privilegio moodle/course:markcomplete\'. Puoi abilitare questo criterio aggiungendo il privilegio ai ruoli esistenti.';
$string['err_nousers'] = 'Nel corso o nel gruppo non ci sono utenti per i quali visualizzare il Report dello completamento. (Per default questo Reportviene visualizzato per gli studenti, tuttavia se il corso non ha studenti comparirà il presente messaggio. Gli amministratori possono modificare le impostazioni di visualizzazione.)';
$string['err_settingslocked'] = 'Uno o più studenti hanno già soddisfatto dei criteri di completamento, pertanto le impostazioni sono bloccate. Sbloccando i criteri di completamento eliminerà lo stato degli utenti e potrà creare confusione.';
...
$string['graderequired'] = 'Valutazione richiesta';
$string['gradexrequired'] = 'E\' richiesto {$a}';
$string['inprogress'] = 'In corso';
$string['manualcompletionby'] = 'Completamento approvato manualmente';
$string['manualselfcompletion'] = 'Auto completamento manuale';
...
$string['overallcriteriaaggregation'] = 'Metodo di aggregazione dei criteri';
$string['pending'] = 'In attesa';
$string['periodpostenrolment'] = 'Periodo post iscrizione';
$string['prerequisites'] = 'Prerequisiti';
$string['prerequisitescompleted'] = 'Prerequisiti soddisfatti';
