...
/**
 * Strings for component 'lesson', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   lesson
...
$string['customscoring_help'] = 'L\'impostazione permette di assegnare un punteggio numerico a ciascuna risposta (positivo o negativo).';
$string['deadline'] = 'Fino al';
$string['defaultessayresponse'] = 'Il tuo testo libero sarà valutato dal docente del corso.';
...
$string['dependencyon_help'] = 'L\' impostazione permette di rendere la lezione dipendente dai risultati ottenuti dallo studente in un\'altra lezione presente nello stesso corso. E\' possibile usare qualsiasi combinazione di
...
$string['displayleftmenu_help'] = 'Permette di visualizzare un elenco di pagine.';
$string['displayofgrade'] = 'Visualizzazione voti (solo per studenti)';
$string['displayreview'] = 'Permette di riprovare una domanda';
$string['displayreview_help'] = 'Farà apparire un pulsante se la una domanda è errata, permettendo allo studente di riprovare senza ricevere valutazione oppure di proseguire.';
...
$string['handlingofretakes_help'] = 'Se è permesso ripetere la lezione, l\'opzione permette di scegliere come valutare la lezione, voto medio dei tentativi o voto migliore.';
...
$string['importppt_help'] = 'Permette di importare un file zip creato con PowerPoint 2003 attraverso la funzione di salvataggio come pagine web.';
...
$string['modulename_help'] = 'Il modulo lezione consente al docenti di creare esperienze di apprendimento adattivo attraverso una serie di pagine con domande.';
...
$string['multianswer_help'] = 'Spunta la casella se ci sono più risposte correte';
...
$string['progressbar_help'] = 'Permette di visualizzare una barra con la percentuale di completamento.';
...
$string['retakesallowed_help'] = 'Permette agli studenti di svolgere la lezione più di una volta.';
...
$string['slideshow_help'] = 'Permette di visualizzare la lezione come uno slideshow di altezza e larghezza fissi.';
