...
/**
 * Strings for component 'tag', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   tag
...
$string['count'] = 'Qta';
$string['coursetagging'] = 'Tag del corso';
$string['coursetagginghelp'] = 'Abilita questa opzione per consentire il tagging del corso.';
