...
/**
 * Strings for component 'theme_overlay', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['headercolor'] = 'Colore header';
$string['headercolordesc'] = 'Il colore dello sfondo dell\'header';
$string['linkcolor'] = 'Colore link';
$string['linkcolordesc'] = 'Il colore dei link';
