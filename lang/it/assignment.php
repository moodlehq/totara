...
/**
 * Strings for component 'assignment', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   assignment
...
$string['enablenotification_help'] = 'Gli studenti riceveranno via email il voto ottenuto e il feedback del docente.';
...
$string['helpupload'] = '<p>Questo tipo di compito permette ai partecipanti di caricare uno o più file di qualsiasi formato. E\' possibile caricare documenti Word, immagini, siti web zippati, eccetera.</p>
...
$string['helpuploadsingle'] = '<p>Questo tipo di compito permette ai partecipanti di consegnare un file, in qualsiasi formato.</p><p>Il file può essere un documento di testo, un\'immagine, un sito web compresso, eccetera.</p>';
...
$string['messageprovider:assignment_updates'] = 'Notifiche compito';
$string['modulename'] = 'Compito';
$string['modulename_help'] = 'I compiti permettono di assegnare agli studenti attività valutate da svolgere sia on line che off line.';
...
$string['quickgrade_help'] = 'La Valutazione rapida permette di valutare velocemente più compiti nella stessa pagina. Dopo aver modificato valutazioni e commenti sarà possibile premere il pulsante Salva per memorizzare contemporaneamente tutte le modifiche apportate.';
...
$string['trackdrafts_help'] = 'Il pulsante "Segnala il completamento della consegna" permette agli studenti di segnalare che il proprio lavoro su un compito è terminato. I docenti che valutano possono comunque riportare il compito allo stato di bozza (qualora sia richiesta, per esempio, una ulteriore elaborazione).';
