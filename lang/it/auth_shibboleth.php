...
/**
 * Strings for component 'auth_shibboleth', language 'it', branch 'MOODLE_22_STABLE'
 *
...
Dovrebbe includere un collegamento a "**{$a}**" in modo che gli utenti Shibboleth possano effettuare facilmente il login.';
