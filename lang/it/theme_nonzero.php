...
/**
 * Strings for component 'theme_nonzero', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['configtitle'] = 'Impostazioni Nonzero';
...
$string['regionpostwidth'] = 'Larghezza colonna di destra';
$string['regionpostwidthdesc'] = 'Imposta la larghezza della colonna di destra dove compaiono i blocchi.';
$string['regionprewidth'] = 'Larghezza colonna di sinistra';
$string['regionprewidthdesc'] = 'Imposta la larghezza della colonna di sinistra dove compaiono i blocchi. Quando si usa il layout blog, questa colonna verrà visualizzata al centro.';
