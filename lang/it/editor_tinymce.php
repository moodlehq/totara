...
/**
 * Strings for component 'editor_tinymce', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['advanced:indent_desc'] = 'Rientro';
...
$string['advanced:outdent_desc'] = 'Rientroaa sinistra';
...
$string['advanced_dlg:link_is_external'] = 'L\'URL inserito sembra essere un link esterno, vuoi aggiungere il prefisso http://?';
...
$string['advlink_dlg:is_email'] = 'L\'URL inserito sembra essere un indirizzo email, vuoi  aggiungere il prefisso mailto: ?';
$string['advlink_dlg:is_external'] = 'L\'URL inserito sembra essere un link esterno, vuoi aggiungere il prefisso http:// ?';
...
$string['autosave:restore_content'] = 'Ripristina contenuto salvato automaticamente.';
$string['autosave:unload_msg'] = 'I cambiamenti effettuati saranno persi se si abbandona la pagina corrente.';
$string['autosave:warning_message'] = 'Ripristinando il contenuto salvato, si perderà tutto il testo presente nell\'editor. Sei sicuro di ripristinare il contenuto salvato?.';
$string['common:apply'] = 'Applica';
$string['common:browse'] = 'Sfoglia';
$string['common:browseimage'] = 'Cerca o carica un\'immagine...';
...
$string['media_dlg:qt_stream_warn'] = 'Le risorse rstp \'streamed\' devono essere aggiunte al campo Src QT nel tab Avanzate. Si dovrebbe inserire anche una versione non \'streamed\' al campo Src..';
...
$string['moodleemoticon:desc'] = 'Inserisci emoticon';
...
$string['paste:plaintext_mode'] = 'Incolla è ora in modalità testo. Clicca di nuovo per tornare alla modalità incolla normale';
$string['paste:plaintext_mode_sticky'] = 'Incolla è ora in modalità testo. Clicca di nuovo per tornare alla modalità incolla normale. Dopo aver incollato, sarà ripristinata la modalità incolla normale';
