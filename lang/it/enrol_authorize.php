...
/**
 * Strings for component 'enrol_authorize', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['description'] = 'Il modulo Authorize.net permette le iscrizioni a pagamento. E\' possibile impostare il costo in due modi (1) a livello di sito oppure (2) a livello di corso. Il costo a livello di corso ha precedenza sul costo a livello di sito.';
