...
/**
 * Strings for component 'question', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   question
...
$string['deletebehaviourareyousuremessage'] = 'Stai per eliminare il comportamento {$a}. L\'eliminazione comporterà anche l\'eliminazione di qualsiasi dato correlato a questo comportamento delle domande. Se sicuro di voler proseguire ?';
...
$string['howquestionsbehave_help'] = 'Gli studenti possono interagire con le domande del quiz in vari modi. Ad esempio, puoi consentire agli studenti di dare una riposta ad ogni domanda e poi terminare il quiz prima di ricevere valutazioni o feedback: questo è il "feedback differito". In alternativa puoi consentire agli studenti di dare una risposta ad ogni domande e ricevere un feedback immediato: se la risposta non è giusta possono provare ancora. Questa p la modalità \'Interattiva con tentativi multipli\'.';
...
$string['showquestiontext'] = 'Visualizza il copro del testo della domanda';
