...
/**
 * Strings for component 'lti', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   lti
...
$string['display_description_help'] = 'Permette di visualizzare l\'introduzione dell\'attività sopra il contenuto del tool provider.
...
$string['display_name_help'] = 'Permette di visualizzare il nome dell\'attività sopra il contenuto del tool provider.
...
* **Aggiungi** - Permette di creare una configurazione di tool a livello di corso. Qualsiasi istanza di tool esterno nello stesso corso potrà usare questa configurazione.
* **Modifica** - Permette di scegliere una configurazione di tool a livello di corso e di modificarla.
...
$string['id'] = 'id';
$string['imsroleadmin'] = 'Docente,Amministratore';
$string['imsroleinstructor'] = 'Docente';
...
$string['lti_launch_error_unsigned_help'] = 'L\'errore può essere causato dalla mancanza di consumer key e/o shared secret per l\'accesso al tool provider.
...
In alternativa, puoi creare una configurazione di tool provider a livello di corso [here]({$a->course_tool_editor}).';
...
$string['modulename_help'] = 'Con i tool esterni gli utenti di Moodle possono interagire con risorse formative ed attività presenti su altri siti web. Ad esempio, un tool esterno può fornire l\'accesso a nuovi tipi di attività o materiali di un editore.
Per impostare una istanza di tool esterno, è necessario un tool provider che supporti LTI (Learning Tools Interoperability).
Un tool provider che supporta LTI è di solito in grado di fornirti le istruzioni per la configurazione del tool esterno in Moodle. Inoltre, saranno anche disponibili eventuali tool esterni configurati dall\'amministratore del sito.
I tool esterni si differenziano da una risorsa di tipo URL per diversi aspetti:
* **Conoscenza del contesto** - I tool esterni possono avere accesso alle informazioni dell\'utente che li ha lanciati, come l\'istituzione di appartenenza, il corso, il nome, eccetera.
* **Integrazione profonda** - I tool esterni possono leggere, aggiornare ed eliminare le valutazioni associate alla istanza dell\'attività. Release future di Moodle aumenteranno queste integrazioni.
* **Sicurezza** - Le configurazioni di I tool esterni creano una relazione di trust tra Moodle e il tool provider, assicurando un canale di comunicazione sicuro.';
...
$string['quickgrade_help'] = 'Permette di valutare più tool nella stessa pagina. E\' possibile aggiungere valutazioni e commenti e poi fare click su "Salva tutti i miei feedback" per salvare tutte le modifiche apportate nella pagina.';
...
$string['send'] = 'Invia';
$string['setdefault'] = 'Imposta un valore di default per il docente se delegato';
$string['setupbox'] = 'Setup Box Tool LTI';
...
Se due configurazioni di tool si riferiscono allo stesso dominio, verrà utilizzata la corrispondenza più rilevante.';
