...
/**
 * Strings for component 'message', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['couldnotfindpreference'] = 'Non è stato possibile caricare la preferenza {$a}. La componente e i il nome fornito a message_send() corrispondono ad una riga in message_providers ? I Message providers devono essere presenti nel database cosicché gli utenti possano configurare l\'instradamento dei messaggi.';
...
$string['notpermitted'] = 'Non consentito';
...
$string['showmessagewindow'] = 'Mostra automaticamente la finestra dei messaggi alla ricezione';
