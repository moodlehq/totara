...
/**
 * Strings for component 'group', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   group
...
$string['enrolmentkey_help'] = 'Una chiave di iscrizione consente l\'accesso al gruppo alle sole persone che ne sono in possesso. Specificando una chiave di iscrizione al gruppo, questa non solo permetterà l\'accesso al corso, ma aggiungerà la persona come membro del gruppo.';
...
$string['removefromgroupconfirm'] = 'Sei sicuro di rimuovere l\'utente "{$a->user}" dal grouppo "{$a->group}"?';
