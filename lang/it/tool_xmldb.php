...
/**
 * Strings for component 'tool_xmldb', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   tool_xmldb
...
$string['mysqlextracheckbigints'] = 'Se utilizzi MySQL, verranno cercati anche signed bigint errati e verrà generato il codice SQL per risolvere eventuali problemi individuati su questi tipi di campi.';
...
$string['textincorrectlength'] = 'Lunghezza errata per un campo text';
