...
/**
 * Strings for component 'error', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   error
...
$string['sessionwaiterr'] = 'Si è verificato un time out durante l\'acquisizione del session lock<br />Attendi che la tua richiesta venga completata e riprova più tardi.';
