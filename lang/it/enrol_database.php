...
/**
 * Strings for component 'enrol_database', language 'it', branch 'MOODLE_22_STABLE'
 *
...
$string['newcoursecategory'] = 'Campo id categoria per i nuovi corsi';
$string['newcoursefullname'] = 'Campo Titolo per i nuovi corsi';
$string['newcourseidnumber'] = 'Campo Numero ID per i nuovi corsi';
