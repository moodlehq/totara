...
/**
 * Strings for component 'webservice', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   webservice
...
$string['accesstofunctionnotallowed'] = 'L\'accesso alla funzione {$a}() non è consentito. Per favore verifica se esiste un servizio attivo che includa tale funzione: se l\'accesso al servizio è riservato, verifica che l\'utente sia nell\'elenco degli utenti autorizzati. Inoltre verifica eventuali limitazioni basate su IP o basate sul possesso di un privilegio';
...
$string['createtokenforuserauto'] = 'Crea automaticamente un token per l\'utente';
...
$string['downloadfiles_help'] = 'Permette a qualsiasi utente di scaricare file tramite le chiavi di sicurezza. I file scaricabili sono limitati a quelli che gli utenti possono effettivamente scaricare';
$string['editaservice'] = 'Modifica servizio';
$string['editservice'] = 'Modifica il servizio: {$a->name} (id: {$a->id})';
$string['enabled'] = 'Abilitato';
$string['enabledirectdownload'] = 'Il download dei file tramite web service deve essere abilitato nelle impostazioni del servizio esterno';
...
$string['invalidtokensession'] = 'Token basato sulla sessione non valido - la sessione non è stata trovata oppure è terminata.';
$string['iprestriction'] = 'Restrizione IP';
$string['iprestriction_help'] = 'L\'utente deve chiamare i web service da uno degli IP elencati.';
$string['key'] = 'Chiave';
...
$string['protocolnotallowed'] = 'Non sei autorizzato ad usare il protocollo {$a} (manca il privilegio webservice/{$a}:use)';
