...
/**
 * Strings for component 'forum', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   forum
...
$string['configtrackreadposts'] = 'Impostare su "Si" se desideri tracciare lo stato "letto/non letto" per ciascun utente.';
...
$string['displayend_help'] = 'L\'impostazione permette di nascondere un post dopo la data stabilita. Notare che gli amministratori potranno comunque visualizzare gli interventi.';
...
$string['displaystart_help'] = 'L\'impostazione permette di visualizzare un post a partire dalla data stabilita. Notare che gli amministratori potranno';
$string['eachuserforum'] = 'Ciascuno avvia una sola discussione';
$string['edit'] = 'Modifica';
$string['editedby'] = 'Modificato da {$a->name} - inserimento originale effettuato il {$a->date}';
...
$string['erroremptymessage'] = 'Il copro del messaggio non può essere vuoto';
...
$string['modulename_help'] = 'Il forum consente discussioni asincrone tra i partecipanti.';
...
$string['namenews_help'] = 'Il forum news è un forum speciale creato automaticamente in ogni corso Ci può essere un solo forum news per ciascun corso. Solo i docenti e gli amministratori possono creare interventi nei forum news. Il blocco \'Notizie recenti\' mostra le discussioni più recenti dal forum news';
...
$string['nodiscussionsstartedbyyou'] = 'Non ha avviato nessuna discussione';
$string['noguestpost'] = 'Spiacente, gli ospiti non possono effettuare interventi.';
$string['noguesttracking'] = 'Spiacente, agli ospiti non è concesso impostare le opzioni di evidenziazione dei messaggi non letti.';
...
$string['notrackforum'] = 'Non evidenziare gli interventi non letti';
...
$string['rssarticles_help'] = 'L\'impostazione permette di definire il numero di articoli (discussioni p interventi) da includere nel feed RSS. Un buon valore è in genere compreso tra 5 e 20.';
