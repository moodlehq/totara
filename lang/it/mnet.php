...
/**
 * Strings for component 'mnet', language 'it', branch 'MOODLE_22_STABLE'
 *
 * @package   mnet
...
$string['configmnet'] = 'MNet permette a questo server di comunicare con altri server o altri servizi.';
...
$string['nopubkey'] = 'Si è verificato un problema nella ricerca della chiave pubblica.</br>Forse l\'host non permette MNet oppure la chiave non è valida.';
