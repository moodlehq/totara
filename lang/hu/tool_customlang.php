...
/**
 * Strings for component 'tool_customlang', language 'hu', branch 'MOODLE_22_STABLE'
 *
...
$string['checkin'] = 'Szövegek rögzítése a nyelvi csomagban';
$string['checkout'] = 'Nyelvi csomag megynitása szerkesztésre';
$string['checkoutdone'] = 'Nyelvi csomag betöltve';
...
$string['filtermodified'] = 'Csak a módosított';
...
$string['modifiednum'] = '{$a} módosított szöveg fordul elő. Menti a változásokat helyi nyelvi csomagjába?';
...
$string['savecheckin'] = 'Változások mentése a nyelvi csomagban';
