...
/**
 * Strings for component 'filters', language 'hu', branch 'MOODLE_22_STABLE'
 *
 * @package   filters
...
$string['includesubcategories'] = 'Tartalmaz alkategóriát?';
...
$string['isgreaterorequalto'] = 'nagyobb vagy egyenlő';
$string['isgreaterthan'] = 'nagyobb, mint';
$string['islessthan'] = 'kisebb, mint';
$string['islessthanorequalto'] = 'kisebb vagy egyenlő';
$string['isnotdefined'] = 'nincs meghatározva';
$string['isnotequalto'] = 'nem egyenlő';
$string['matchesallselected'] = 'megegyezik az összes';
$string['matchesanyselected'] = 'megegyezik bármely';
