...
/**
 * Strings for component 'plugin', language 'hu', branch 'MOODLE_22_STABLE'
 *
 * @package   plugin
...
({$a->version})';
$string['pluginchecknotice'] = 'Ezen az oldalon jelennek meg a frissítés során esetleg beavatkozást igényló segédprogramok. Kiemelten láthatók az új, telepítésre váró segédprogramok, a frissített, újratelepítésre váró segédprogramok, és az esetleg hiányzó segédprogramok. Úgyszintén kielemten láthatók a külső fejlesztésű segédprogramok. Ajánlatos ellenőrizni, nincs-e ez utóbbiakból frissebb változat, és telepíteni forráskódjukat a Moodle verziófrissítése előtt.';
...
$string['showall'] = 'Az összes segédprogram újratöltése és megjelenítése';
$string['somehighlighted'] = 'A verziófrissítés során beavatkozást igénylő segédprogramok száma: {$a}';
$string['somehighlightedinfo'] = 'Az összes telepített segédprogram teljes felsorolásának megjelenítése';
$string['source'] = 'Forrás';
$string['sourceext'] = 'Kiterjesztés';
...
$string['status_uptodate'] = 'Legújabb';
...
$string['type_message'] = 'Üzenetfeldolgozó';
$string['type_message_plural'] = 'Üzenetfeldolgozók';
...
$string['type_plagiarism'] = 'Másolás megakadályozása';
$string['type_plagiarism_plural'] = 'Plágiumot megelőző segédprogramok';
