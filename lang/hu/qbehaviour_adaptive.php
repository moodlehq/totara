...
/**
 * Strings for component 'qbehaviour_adaptive', language 'hu', branch 'MOODLE_22_STABLE'
 *
...
$string['gradingdetails'] = 'Leadásra bejelöl: {$a->raw}/{$a->max}.';
$string['gradingdetailsadjustment'] = 'Korábbi próbálkozásokkal: <strong>{$a->cur}/{$a->max}</strong>.';
