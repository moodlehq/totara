...
/**
 * Strings for component 'completion', language 'hu', branch 'MOODLE_22_STABLE'
 *
 * @package   completion
...
$string['activityrpl'] = 'Elismert előzetes tevékenység(ek)';
$string['addcourseprerequisite'] = 'Kurzus előzetes követelményeinek hozzáadása';
$string['afterspecifieddate'] = 'Meghatározott időpont után';
$string['aggregateall'] = 'Minden';
$string['aggregateany'] = 'Bármely';
...
$string['completedwarningtext'] = 'Egy vagy több felhasználó ({$a}) a tevékenységet már megjelölte mint teljesítettet. A teljesítési lehetőségek módosításakor törlődik teljesítési állapotuk, ami zavarhoz vezethet. A lehetőségek zárolva vannak, csak akkor oldja fel őket, ha ez elengedhetetlen.';
...
$string['completion-title-manual-n'] = 'Megjelöli mint teljesíttet: {$a}';
$string['completion-title-manual-y'] = 'Megjelöli mint nem teljesítettet: {$a}';
$string['completion-y'] = 'Teljesítette';
...
$string['configenablecourserpl'] = 'Ha engedélyezett, a kurzus teljesítetté tehető az elismert előzetes tanulmányok alapján.';
$string['configenablemodulerpl'] = 'Ha engedélyezve van a modulban, bármely teljesítési kritérium a kurzus modulban teljesítetté tehető az elismert előzetes tanulmányok alapján.';
...
$string['courseprerequisites'] = 'Kurzus előzetes követelményei';
$string['courserpl'] = 'A kurzus elismert előzetes tanulmányai';
$string['courserplorallcriteriagroups'] = 'Elismert előzetes tanulmány kurzushoz vagy<br />az összes kritérium csoporthoz';
$string['courserploranycriteriagroup'] = 'Elismert előzetes tanulmány kurzushoz vagy<br />bármely kritérium csoporthoz';
...
$string['criteriagradenote'] = 'Ne feledje, hogy itt az előírt osztályzat  nem frissíti a kurzus adott elégséges osztályzatát.';
...
$string['days'] = 'Nap';
$string['daysafterenrolment'] = 'Nap a beiratkozás után';
$string['deletecoursecompletiondata'] = 'A kurzusteljesítés adatainak törlése';
$string['deletedcourse'] = 'Törölt kurzus';
$string['dependencies'] = 'Függőségek';
$string['durationafterenrolment'] = 'Időtartam a beiratkozás után';
...
$string['enablecourserpl'] = 'Az elismert előzetes tanulmányok engedélyezése a kurzusokhoz';
$string['enablemodulerpl'] = 'Az elismert előzetes tanulmányok engedélyezése a modulokhoz';
$string['enrolmentduration'] = 'Hátralévő napok száma';
...
$string['err_nocriteria'] = 'Nincs kurzus teljesítési kritérium megadva ehhez a kurzushoz';
...
$string['err_noroles'] = 'A kurzusban nincs megadva \'moodle/course:markcomplete\' jogosultságú szerep. A követelménytípus bekapcsolásához adja hozzá a jogosultságot a szerep(ek)hez.';
$string['err_nousers'] = 'A kurzusban vagy a csoportban nincs olyan felhasználó, akivel kapcsolatosan a teljesítésre vonatkozó információk megjelenhetnének. (A teljesítésre vonatkozó információk alaphelyzetben csak a tanulóknál jelennek meg, így ha nincsenek tanulók, megjelenik ez a hibaüzenet. A rendszergazdák az adminisztrációs képernyőkön módosíthatnak ezen.)';
...
$string['error:rplsaredisabled'] = 'Az előzetes tanulmányi napló lett tiltva egy adminisztrátor által';
...
$string['manualcompletionby'] = 'Kézzel teljesítette';
...
$string['overallcriteriaaggregation'] = 'Globális követelménytípus összegzése';
$string['pending'] = 'Függőben';
$string['periodpostenrolment'] = 'Beiratkozás utáni időszak';
$string['prerequisites'] = 'Előzetes követelmények';
$string['prerequisitescompleted'] = 'Előzetes követelmények teljesítve';
...
$string['showrpl'] = 'Elismert előzetes tanulmány(ok) megjelenítése';
$string['showrpls'] = 'Elismert előzetes tanulmány(ok) megjelenítése';
