...
/**
 * Strings for component 'quiz', language 'hu', branch 'MOODLE_22_STABLE'
 *
 * @package   quiz
...
$string['cannotstartgradesmismatch'] = 'A teszt kitöltése nem indítható el. A teszt {$a->grade} ponthatáron belül osztályozandó, de még nincs hozzáadva pontot érő kérdés. Ezt a "Teszt szerkesztése" oldalon módosíthatja.';
...
$string['confirmclose'] = 'A leadás után a próbálkozással kapcsolatos válaszait nem módosíthatja.';
...
$string['emailconfirmbody'] = 'Tisztelt {$a->username}!  Köszönjük, hogy a(z) \'{$a->quizname}\' tesztre a(z) \'{$a->coursename}\' kurzus keretében adott válaszait {$a->submissiontime} időpontban leadta. Ez az e-mail megerősíti, hogy válaszai rendben megérkeztek. A tesztet itt érheti el: {$a->quizurl}.';
...
$string['notyetgraded'] = 'Még nincs lepontozva';
...
$string['questionnonav'] = '<span class="accesshide"></span>{$a->number}. kérdés<span class="accesshide"> {$a->attributes}</span>';
$string['questionnonavinfo'] = '<span class="accesshide"></span>{$a->number}. információ<span class="accesshide"> {$a->attributes}</span>';
...
$string['reviewattempt'] = 'Próbálkozás ellenőrzése';
...
$string['savingnewgradeforquestion'] = '{$a} kérdésre adott új pont mentése';
$string['savingnewmaximumgrade'] = 'Új maximális pont mentése.';
...
$string['updatingatttemptgrades'] = 'A próbálkozásra adott pontok frissítése';
$string['updatingfinalgrades'] = 'Végleges pontok frissítése';
$string['updatingthegradebook'] = 'Osztályozónapló frissítése';
