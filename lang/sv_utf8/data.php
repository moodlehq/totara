...
$string['authorfirstname'] = 'Författares förnamn';
$string['authorlastname'] = 'Författares efternamn';
...
$string['chooseexportfields'] = 'Välj vilka fält du vill exportera:';
$string['chooseexportformat'] = 'Välj vilket format du vill exportera till:';
...
$string['csvfailed'] = 'Kan inte läsa rådata från CSV-filen';
$string['csvfile'] = 'CVS-fil';
$string['csvimport'] = 'Import av CVS-fil';
$string['csvwithselecteddelimiter'] = '<acronym title=\"Comma Separated Values\">CSV</acronym> text med vald avgränsare:';
...
$string['entrieslefttoaddtoview'] = 'Du måste lägga till $a->entrieslefttoview fler inlägg innan du kan se andra deltagares inlägg.';
$string['entry'] = 'Bidrag';
...
asearchtemplate	
You have entered the maximum number of entries allowed!
atmaxentry	
Author first name
authorfirstname	
Author surname
...
$a comment(s)
commentsn	
This switch will enable the possibility of RSS feeds for all databases. You will still need to turn feeds on manually in the settings for each database.
configenablerssfeeds	
You are about to delete this field, are you sure?
confirmdeletefield	
...
CSV file import
csvimport	
<acronym title=\"Comma Separated Values\">CSV</acronym> text with selected delimiter:
csvwithselecteddelimiter	  
...
data:manageentries	
Manage templates
data:managetemplates	
Manage all template presets
data:manageuserpresets	
Rate entries
data:rate	
Read entries
data:readentry	
View presets from all users
data:viewalluserpresets	
View entries
data:viewentry	
View ratings
data:viewrating	
...
Descending
descending	
$a->directory Not a preset: missing files: $a->missing_files
directorynotapreset	
Download
download	
Edit
...
entrieslefttoaddtoview	  
Entry
entry	
Your entry has been saved
entrysaved	
You need to be a teacher to use this page!
errormustbeteacher	
Database module example
example	
Excel';
$string['expired'] = 'Det här aktiviteten är stängd den {$a} och är inte längre tillgänglig';
$string['export'] = 'Exportera';
$string['exportaszip'] = 'Exportera som zip';
$string['exportdatabaserecords'] = 'Exportera databasposter';
...
$string['fieldnotmatched'] = 'Följande fält i din fil finns inte i din databas: $a';
...
$string['foundnorecords'] = 'Inga poster hittade (<a href=\"$a->reseturl\">Återställ filter</a>)';
$string['foundrecords'] = 'Hittade poster: $a->num/$a->max (<a href=\"$a->reseturl\">Återställ filter</a>)';
...
$string['invalidrate'] = 'Ogiltigt databasvärde ($a)';
...
$string['notapproved'] = 'Inmatningen är inte godkänd än.';
...
$string['overwritesettings'] = 'Skriv över nuvarande inställningar';
...
$string['resetsettings'] = 'Fält för återställning';
...
$string['search'] = 'Sök';
$string['selectedrequired'] = 'Alla valda krävs';
...
$string['timeadded'] = 'Tid tillagd';
$string['timemodified'] = 'Tid modifierad';
...
$string['unsupportedexport'] = '($a->fieldtype) kan inte exporteras.';
