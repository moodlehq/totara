...
$string['enrol_ldap_contexts'] = 'Sammanhang för LDAP';
...
$string['enrol_ldap_memberattribute'] = 'Attribut för medlem i LDAP';
$string['enrol_ldap_objectclass'] = 'objectClass som används för att söka kurser. Vanligtvis \'posixGroup\'.';
$string['enrol_ldap_roles'] = 'Kartläggning av roller';
