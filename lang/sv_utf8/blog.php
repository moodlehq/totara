...
$string['deleteotagswarn'] = 'Är Du säker på att Du vill ta bort den/de här etiketten/erna från alla inlägg i bloggen och ta bort den från systemet?';
...
$string['viewcourseentries'] = 'Visa inlägg inom kursen';
