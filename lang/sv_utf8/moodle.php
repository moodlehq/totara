...
$string['adminprimarynoedit'] = 'Du har inte behörighet att ändra på den primära administratörens lösenord.';
...
$string['backtocourselisting'] = 'Tillbaks till kurslista';
...
$string['backupfromthissite'] = 'Backup gjordes på den här siten?';
$string['backupgradebookhistoryhelp'] = 'Om det är aktiverat kommer betygsbokshistorien att ingå i automatiska säkerhetskopieringar. Observera att betygetshistorien inte skall inaktiveras serverinställningar (disablegradehistory) för att detta ska fungera';
...
$string['backupmetacoursehelp'] = 'Om detta är aktiverat så kommer metainformation om kursen (ärvda registreringar) att tas med i automatiska säkerhetskopieringar.';
$string['backupmissinguserinfoperms'] = 'Notera: Den här säkerhetskopian innehåller inga användardata. Övningar och workshopaktiviteter kommer inte att ingå i säkerhetskopian, eftersom dessa moduler inte är kompatibla med den här typen av säkerhetskopiering.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnext'] = 'Nästa backup';
...
$string['badcontext'] = 'Dålig kontext';
$string['block'] = 'Block';
...
$string['categorymodifiedcancel'] = 'Kategorin modifierades! Avbryt och försök igen.';
...
$string['chooseenrolmethod'] = 'Förstahandsvalet av plugin-program för registrering.';
...
$string['coursecategorydeleted'] = 'Raderad kurskategori $a';
$string['coursecompletion'] = 'Färdigställande för kurs';
$string['coursecompletiondata'] = 'Färdigställandedata för kurs';
$string['coursecompletions'] = 'Färdigställande för kurs';
...
$string['coursedeleted'] = 'Raderad kurs $a';
...
$string['coursehelpcategory'] = 'Läget i kurslistan kan göra det lättare för en student att hitta kursen.';
$string['coursehelpformat'] = 'Kursens huvudsida kommer att visas i detta format.';
$string['coursehelphiddensections'] = 'Hur dolda avsnitt i kursen visas för studenterna.';
$string['coursehelpmaximumupload'] = 'Definiera den största storleken på fil som kan laddas upp i denna kurs, begränsad av hela webbplatsen inställning.';
$string['coursehelpmetacourse'] = 'Sätt kursen till en metakurs. En metakurs tar inskrivningar (och andra rolltilldelningar) från en \"underkurs\" eller \"underkurser\".';
$string['coursehelpnewsitemsnumber'] = 'Antal nya poster som visas på kursens hemsida, i en nyhetsruta nere till höger <br/> (0 betyder nyheterna rutan inte visas)';
$string['coursehelpnumberweeks'] = 'Antal veckor/ämnen som visas på kursens huvudsida.';
$string['coursehelpshowgrades'] = 'Aktivera visning av betygsbok. Det hindrar inte att betyg visas inom individuella aktiviteter.';
$string['coursehidden'] = 'Den här kursen är f.n. inte tillgänglig för studenter/elever/deltagare/lärande.';
$string['courseimportnotaught'] = 'Du förefaller inte att vara lärare med rätt attt redigera i någon annan kurs så det finns inga kurser som Du kan importera från.';
...
$string['coursereasonforrejecting'] = 'Dina skäl att avslå förfrågan';
$string['coursereasonforrejectingemail'] = 'Detta kommer att e-mailas till frågeställaren';
...
$string['courserequestdetails'] = 'Detaljer för kursen du efterfrågar';
$string['courserequestdisabled'] = 'Tyvärr, Din ansökan om en kurs har avslagits.';
...
$string['courserequestsupport'] = 'Stödjande information för att hjälpa administratören att utvärdera denna begäran';
...
$string['coursesmovedout'] = 'Kureser har flyttats från $a';
...
$string['creatingblogsinfo'] = 'Skapar blog-info';
$string['creatingcategoriesandquestions'] = 'Skapar kategorier och frågor...';
$string['creatingcompetencyevidencedata'] = 'Skapar data för kompetensbevis';
$string['creatingconditionalavailabilitydata'] = 'Skapar data för villkorad tillgänglighet';
$string['creatingcoursecompletiondata'] = 'Skapa färdigställandedata för kurs';
...
$string['deletecategorycheck2'] = 'Om du raderar denna kategori måste du bestämma vad du skall göra med de kurser och underkategorier den innehåller.';
$string['deletecategoryempty'] = 'Denna kategori är tom';
...
$string['donotclickcontinue'] = 'Klicka INTE på följande länk för att fortsätta ;-)';
$string['down'] = 'Ner';
...
$string['editorhelptopics'] = 'Hjälpavsnitt för redigerare';
...
$string['editortoggle'] = 'Skifta till utökat texediteringsmode';
$string['editremoteprofile'] = 'Redigera fjärrprofil';
...
$string['enroldate'] = 'Tidsperiod';
$string['enrolenddate'] = 'Slutdatum';
$string['enrolenddaterror'] = 'Datum för registrering kan inte vara senare än startdatumet.';
$string['enrollable'] = 'Ska användare kunna registrera sig själva på kursen?';
$string['enrolledincourse'] = 'Registerad på kurs \"$a\"';
$string['enrolledincoursenot'] = 'Inte registerad på kurs \"$a\"';
$string['enrolledincoursenotrole'] = 'Fel vid registrering i \"$a->course\" som\"$a->role\"';
...
$string['enrolmentconfirmation'] = 'Du håller på att registrera Dig som <br /> student/elev/deltagare/lärande på denna kurs. <br /> Är Du säker på att Du vill fullfölja detta?';
$string['enrolmentend'] = 'Registrering upphör';
...
$string['enrolmentplugins'] = '\'Plugins\' för registreringar';
$string['enrolments'] = 'Registreringar';
$string['enrolmentstart'] = 'Registrering har påbörjats';
...
$string['extendenrol'] = 'Förläng registrering';
...
$string['firstaccess'] = 'Första access';
$string['firstdayofweek'] = '0';
$string['firstname'] = 'Förnamn';
$string['firsttime'] = 'Är det första gången Du är här?';
$string['flashlinkmessage'] = 'Vänligen uppdatera din Flash-player nu:';
$string['flashupgrademessage'] = 'Flash-plugin krävs för att spela det här innehållet, men den version du har är för gammal.';
...
$string['forcepasswordchangenot'] = 'Kunde inte ändra lösenord till $a';
...
$string['formattopicsajax'] = 'Ämnesformat - AJAX';
$string['formattopicscss'] = 'Ämneformat - CSS/Inga tabeller';
$string['formatweeks'] = 'Veckoformat';
$string['formatweekscss'] = 'Veckoformat . CSS/Inga tabeller';
...
$string['helpinterestslist'] = 'Skriv in dina intressen separerade med komman';
$string['helppicture'] = 'Hur Du laddar upp en bild';
$string['helpprefix'] = 'Hjälp, $a';
...
$string['importmetacoursenote'] = 'Använd det här formuläret för att lägga till kurser till Din metakurs. I och med detta kommer Du att importera registreringarna.';
...
$string['managemeta'] = 'Är det här en metakurs?';
$string['managemetadisabled'] = 'Det här är avaktiverat eftersom den här kursen redan finns i en metakurs.';
$string['managemetaexplan'] = '(Det här betyder att registreringar \'ärvs\' från andra kurser)';
$string['managemodules'] = 'Moduler';
$string['manageroles'] = 'Roller och rättigheter';
$string['manageruser'] = 'Chef-användare';
$string['manageruserdescription'] = 'Chefer kan hantera andra användares användare';
...
$string['metaaddcourse'] = 'Lägg till den här kursen';
$string['metaalreadycourses'] = 'Kurserna är redan fördelade.';
$string['metaalreadyhascourses'] = 'Den här metakursen har redan \'barn\'-kurser.';
$string['metaalreadyhasenrolments'] = 'Den här kursen har redan vanliga registreringar.';
$string['metaalreadyinmeta'] = 'Den här kursen är redan del av en metakurs.';
$string['metaassigncourses'] = 'Fördela kurser';
...
$string['missingrecaptchachallengefield'] = 'Saknar reCAPTCHA fält';
...
$string['morethanonerecordinfetch'] = 'Fel: mer än en post returnerades (tabell \'$a\')';
$string['mostrecently'] = 'allra senaste';
$string['move'] = 'Flytta';
$string['movecategorycontentto'] = 'Flytta till';
$string['movecategoryto'] = 'Flytta kategori till:';
$string['movecontentstoanothercategory'] = 'Flytta innehåll till annan kategori';
...
$string['nostatstodisplay'] = 'Det finns tyvärr inga tillgängliga data att visa.';
...
$string['notenrollable'] = 'Det går inte att registrera sig på den här kursen f.n.';
...
$string['noteusercannotrolldatesoncontext'] = '<strong>Obs!</strong> Förmågan att rulla datum när du återställer den här säkerhetskopian har avaktiverats eftersom du saknar den behörighet som krävs.';
...
$string['parentcoursenotmetacourse'] = '\'Föräldra\'-kursen är inte en metakurs.';
$string['parentfolder'] = '\'Föräldra\'-katalog';
$string['parentlanguage'] = '<< ÖVERSÄTTARE: Om ditt språk har ett föredraget Språk som Moodle ska använda när strängar saknas i ditt språkpaket ange koden för det här. Om du lämnar fältet tomt så engelska kommer att användas. Exempel: nl>>';
...
$string['passwordreused'] = 'Detta lösenord har använts förut och får inte användas igen.';
...
$string['preprocessingbackupfile'] = 'Förbereder backup-fil';
...
$string['profilenotshown'] = 'Profilbeskrivning kommer inte att visas förrän personen antagits till minst en kurs.';
...
$string['publicdirectorytitle'] = 'Se den aktuella listan över webbplatser';
$string['publicsitefileswarning'] = 'Obs! de filer som är placerade här är tillgängliga för alla.';
$string['publicsitefileswarning2'] = 'Obs! Filer placeras här kan nås av alla som vet (eller kan gissa) webbadressen. Av säkerhetsskäl rekommenderas att eventuella backup-filer raderas omedelbart efter återställning av dem.';
$string['publicsitefileswarning3'] = 'Obs! Filer placeras här kan nås av alla som vet (eller kan gissa) webbadressen. <br /> Av säkerhetsskäl bör säkerhetskopior sparas i säker backupdata mapp.';
...
$string['requestedcourses'] = 'Efterfrågade kurser';
...
$string['restorecannotassignroles'] = 'Återställning behöver tilldela roller och du inte har behörighet att göra det';
$string['restorecannotcreateorassignroles'] = 'Återställning behöver skapa eller tilldela roller och du inte har behörighet att göra det';
$string['restorecannotcreateuser'] = 'Återställning behöver skapa användare \'$a\' från backup-fil och du inte har behörighet att göra det';
$string['restorecannotoverrideperms'] = 'Återställning behöver åsidosätta behörighet och du inte har behörighet att göra det';
$string['restorecoursenow'] = 'Återställ denna kurs nu!';
$string['restoredaccount'] = 'Återställt konto';
$string['restoredaccountinfo'] = 'Detta konto importerades från en annan server och lösenordet saknas. För att skapa ett nytt lösenord via e-mail, klicka \"Fortsätt\"';
$string['restorefinished'] = 'Återställning framgångsrikt avslutad.';
$string['restoreto'] = 'Återställ till';
$string['restoretositeadding'] = 'Varning! Du är på väg att återställa sitens förstasida och addera data till den!';
$string['restoretositedeleting'] = 'Varning! Du är på väg att återställa sitens förstasida och radera data från den först!';
$string['restoreuserconflict'] = 'Att återställa användaren \'$a\' kommer att åstadkomma konflikt.';
$string['restoreuserinfofailed'] = 'Återställningsprocessen har stoppat eftersom du inte har behörighet att återställa användardata.';
$string['restoreusersprecheck'] = 'Kontrollerar användardata';
$string['restoreusersprecheckerror'] = 'Problem upptäcktes vid kontroll av användardata';
...
$string['rolerenaming'] = 'Namnbyte på roll';
$string['roles'] = 'Roller';
$string['rss'] = 'RSS';
...
$string['studentviewoff'] = 'Avaktivera studentvy';
$string['studentviewon'] = 'Aktivera studentvy';
...
$string['thiscategorycontains'] = 'Denna kategori innehåller';
...
$string['unenrolallstudents'] = 'Avregistrera alla studenter/<br />deltagare/<br />elever/<br />lärande';
...
$string['updatemymoodleoff'] = 'Normalt läge';
$string['updatemymoodleon'] = 'Redigera den här sidan';
...
$string['uploadcantwrite'] = 'Misslyckades att skriva fil till disk';
...
$string['uploadextension'] = 'Filuppladdning stoppades av filändelsen';
...
$string['uploadnotempdir'] = 'Saknade en tillfällig mapp';
...
$string['usethiscourse'] = 'Använd den här kursen.';
...
$string['writingblogsinfo'] = 'Skriver blog-info';
$string['writingcategoriesandquestions'] = 'Skriver kategorier och frågor...';
$string['writingcompetencyevidenceinfo'] = 'Skriver info för kompetensbevis';
