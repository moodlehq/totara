<?PHP // $Id$ 
      // hotpot.php - created with Moodle 1.9.12 (Build: 20110510) (2007101591.03)
...
$string['configshowtimes'] = 'Bör den tid som det tar att bearbeta registrering av resultat visas i listor och rapporter? Det här är bara av intresse om Du vill ta reda på varför Din server är långsam.';
...
$string['deleteallattempts'] = 'Radera alla försök';
...
$string['hotpot:deleteattempt'] = 'Ta bort försök på test';
$string['hotpot:grade'] = 'Modifiera betyg/omdömen';
$string['hotpot:view'] = 'Använd test';
$string['hotpot:viewreport'] = 'Visa rapporter';
$string['hotpotcloses'] = 'Hot Potatoes test stänger';
$string['hotpotopens'] = 'Hot Potatoes test öppnar';
...
$string['removegradeitem'] = 'Ta bort betyg';
