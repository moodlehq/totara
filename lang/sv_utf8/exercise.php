<?PHP // $Id$ 
      // exercise.php - created with Moodle 1.9 Beta + (2007090600)
...
$string['comparisonofassessments'] = 'Jämförelse av bedömningar/värderingar/betygssättning';
...
$string['exercise:assess'] = 'Utvärdera övningsuppgifter';
...
$string['gradinggrade'] = 'Betyg/omdöme på betygssättning/ömdömen';
...
$string['late'] = 'Sen';
$string['lax'] = 'Vagt';
$string['leaguetable'] = 'Tabell för rangordning av inskickade bidrag';
...
$string['maximum'] = 'Max';
$string['maximumgradeforstudentassessments'] = 'Maxbetyg/omdöme för studenters/elevers/deltagares/lärandes bedömningar/värderingar/betygssättningar: $a';
$string['maximumgradeforsubmissions'] = 'Maxbetyg/omdöme för bidrag:$a';
...
\"Hantera uppgifter\"';
$string['noteongradinggrade'] = 'Det här betyget/omdömet är ett mått på hur väl Din bedömning/värdering/betygssättning av den bedömning/värdering/betygssättning<br /> av Ditt arbete som $a har gjort. Ju högre betyg/omdöme desto större överensstämmelse.';
...
$string['numberofcriterionelements'] = 'Antalet kriteriekomponenter måste vara större än ett.';
$string['numberofentries'] = 'Antal bidrag';
$string['numberofentriesinleaguetable'] = 'Antal bidrag till den rangordnande tabellen';
...
$string['pleasemakeyourownassessment'] = 'Var snäll och gör Din egen bedömning/värdering/betygssättning av det arbete som $a har bidragit med.<br />Lägg märke till att formuläret för bedömning/värdering/betygssättning till att börka med visas med studentens/elevens/deltagarens/den lärandes bedömning/värdering/betygssättning.';
...
$string['regradestudentassessments'] = 'Förnya betyget/omdömet för studenternas/elevernas/deltagarnas/de lärandes bedömningar/värderingar/betygssättningar';
...
$string['studentsubmissionsforassessment'] = '$a av studenter/elever/deltagare/lärande inskickade arbeten för  bedömning/värdering/betygssättning';
...
$string['view'] = 'Visa';
$string['viewteacherassessment'] = 'Visa $a bedömningar/värderingar/betygsättningar';
