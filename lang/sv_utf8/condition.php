...
$string['availablefrom'] = 'Bara tillgänglig från';
$string['availableuntil'] = 'Bara tillgänglig till slutet av';
$string['badavailabledates'] = 'Ogiltiga datum. Om du registrerar två datum måste \"tillgänglig från\" vara innan \"till\"-datum.';
$string['completion_complete'] = 'måste markeras som färdig';
$string['completion_fail'] = 'måste vara färdig med underkänt betyg';
$string['completion_incomplete'] = 'får inte markeras som färdig';
$string['completion_pass'] = 'måste vara färdig med godkänt betyg';
$string['completioncondition'] = 'Villkor för färdig aktivitet';
...
$string['enableavailability'] = 'Aktivera villkorlig tillgänglighet';
$string['grade_atleast'] = 'måste vara minst';
$string['grade_upto'] = 'och mindra än';
$string['gradecondition'] = 'Betygsvilkor';
$string['help_conditiondates'] = 'tillgängliga datum';
$string['help_showavailability'] = 'visa icke tillgängliga aktiviteter';
$string['none'] = '(ingen)';
$string['notavailableyet'] = 'Inte tillgänglig än';
...
$string['showavailability_hide'] = 'Göm aktiviteten helt';
$string['showavailability_show'] = 'Visa aktivitet utgråad med begränsad information';
$string['userrestriction_hidden'] = 'Begränsad(helt dold,inget meddelande): &lsquo;$a&rsquo;';
$string['userrestriction_visible'] = 'Begränsad: &lsquo;$a&rsquo;';
