...
$string['cannotdeletepost'] = 'Fel vid radering av post';
$string['configenablenotes'] = 'Tillåt lagring av anteckningar om individuella användare.';
...
$string['enablenotes'] = 'Tillåt anteckningar';
$string['groupaddnewnote'] = 'Lägg till en ny anteckning för alla';
$string['invalidid'] = 'Felaktig antecknings-id vald';
...
$string['nopermissiontodelete'] = 'Du kan inte radera anteckningen';
$string['note'] = 'Anteckning';
$string['notes'] = 'Anteckningar';
$string['notesdisabled'] = 'Anteckningar är inte tillåtna.';
