...
$string['advanced_dlg:link_target_blank'] = 'Öppna länken i ett nytt fönster';
$string['advanced_dlg:link_target_same'] = 'Öppna länken i samma fönster';
...
$string['advimage_dlg:misc'] = 'Övrigt';
...
$string['simple:undo_desc'] = 'Ångra (Ctrl+Z)';
...
$string['style_dlg:overflow'] = 'Överflöde';
...
$string['table_dlg:mime'] = '';
$string['table_dlg:missing_scope'] = 'Ör du säker på att du vill fortsätta utan att ange en omfattning, denna underlättar för icke-grafiska webbläsare.';
