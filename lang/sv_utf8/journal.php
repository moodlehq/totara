...
Du kan hitta återkopplingen som ett tillägg till Ditt <a href=\"$a->url\"> inlägg till Utvecklingskontakten.';
$string['journalname'] = 'Namn på Utvecklingskontakt';
$string['journalquestion'] = 'Fråga för Utvecklingskontakt';
$string['journalrating1'] = 'Inte tillfredställande';
$string['journalrating2'] = 'Tillfredställande';
$string['journalrating3'] = 'Utomordentligt';
$string['mailsubject'] = 'Återkoppling på Utvecklingskontakt';
$string['modulename'] = 'Utvecklingskontakt';
$string['modulenameplural'] = 'Utvecklingskontakter';
$string['newjournalentries'] = 'Nya inlägg i Utvecklingskontakt';
$string['noentry'] = 'Inget inlägg';
$string['noratinggiven'] = 'Ingen betyg/omdöme avgivet';
$string['notopenuntil'] = 'Denna Utvecklingskontakt öppnas inte förrän:';
$string['notstarted'] = 'Du har inte påbörjat denna Utvecklingskontakt ännu.';
$string['overallrating'] = 'Översiktligt om  betyg/omdömen';
$string['rate'] = 'Värdera';
$string['saveallfeedback'] = 'Spara alla mina återkopplingar';
$string['startoredit'] = 'Starta eller redigera mitt inlägg i Utvecklingskontakt';
$string['viewallentries'] = 'Visa $a inlägg i Utvecklingskontakt';
