...
$string['changetype'] = 'Ändra typ av rubrik för intresse';
$string['count'] = 'Räkna';
$string['coursetagging'] = 'Kurstaggning';
$string['coursetagginghelp'] = 'Tillåt detta alternativ för kurstaggning';
$string['delete'] = 'Ta bort';
$string['deleted'] = 'Borttagen';
$string['description'] = 'Beskrivning';
$string['edittag'] = 'Redigera den här rubriken för intresse';
$string['flag'] = 'Flagga';
...
$string['name'] = 'Namn på rubrik för intresse';
...
$string['seeallblogs'] = 'Visa alla bloggar med den här rubriken för intresse';
$string['select'] = 'Välj';
...
$string['typechanged'] = 'Typen av rubrik för intresse har  ändrats';
$string['updated'] = 'Uppdaterad';
$string['updatetag'] = 'Uppdatera';
$string['userstaggedwith'] = 'Användare som har rubricerats med \"$a\"';
$string['withselectedtags'] = 'Med valda rubriker för intressen...';
