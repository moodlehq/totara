...
$string['andmorenewentries'] = 'och {$a} fler nya poster';
$string['answer'] = 'Svar';
...
$string['defaulthook'] = 'Standardkrok';
$string['defaultmode'] = 'Standardläge';
$string['defaultsortkey'] = 'Standard sorteringsnyckel';
$string['defaultsortorder'] = 'Standard sorteringsordning';
...
$string['exportentriestoxml'] = 'Exportera poster till XML-fil';
...
$string['includegroupbreaks'] = 'Inkludera gruppbrytningar';
$string['invalidrate'] = 'Ogiltigt värde för ord-och begreppslista ($a)';
