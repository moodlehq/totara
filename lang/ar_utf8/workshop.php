...
$string['reply'] = 'اجب';
$string['resetworkshopall'] = 'حذف البيانات والدرجات والتقديرات';
...
$string['standarddeviationofelement'] = 'الانحراف المعياري للعنصر $a';
$string['strict'] = 'صارم';
...
$string['workshop:manage'] = 'إدارة الإعدادات';
$string['workshop:participate'] = 'المشاركة في ورشةالعمل';
