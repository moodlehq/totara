...
$string['alreadygraded'] = 'تم وضع درجة على مهمتك . وإعادة تقديمها غير مسموح';
...
$string['deleteallsubmissions'] = 'حذف كافة التقديمات';
...
$string['early'] = '$a مبكر';
$string['editmysubmission'] = 'حرر تقديمي';
...
$string['enableemailnotification'] = 'ارسال رسائل بريد';
...
$string['finalize'] = 'لا مزيد من المهام';
...
$string['nosubmitusers'] = 'لم يتم العثور على مستخدمين لديهم صلاحية لتقديم هذة المهمة';
...
$string['pagesize'] = 'عدد المهام المقدمة التي تظهر في كل صفحة';
$string['preventlate'] = 'أمنع تقديم المهام المتأخر';
...
$string['showrecentsubmissions'] = 'عرض التقديمات الاخيرة';
$string['submission'] = 'تقديم';
$string['submissiondraft'] = 'تقديم مسودة';
$string['submissionfeedback'] = 'اجابة تقييمية للمهمة المقدمة';
$string['submissions'] = 'رسالات مسلمة';
$string['submissionsaved'] = 'تم حفظ التغيرات التي قمت بها';
$string['submissionsnotgraded'] = '$a لم يتم تصحيح المهام المقدمة';
$string['submitassignment'] = 'قم بتقديم مهمتك باستخدام هذا النموذج';
$string['submitedformarking'] = 'لا يمكن تحديث المهام المقدمة لتصحيح وإعطاء الدرجات';
$string['submitformarking'] = 'قدم المهمة ليتم تقييمها';
$string['submitted'] = 'تم التقديم';
$string['submittedfiles'] = 'الملفات المقدمة';
...
$string['uploadfailnoupdate'] = 'تم تحميل الملف بالفعل لكن تعذر تحديث ما قمت بتقديمه!';
...
$string['viewsubmissions'] = 'معاينة $a المهام المقدمة';
$string['yoursubmission'] = 'مهمتك المقدمة';
