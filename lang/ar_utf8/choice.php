...
$string['choicefull'] = 'هذا الاختيار مكتمل وليس هناك أي اماكن متاحة.';
...
$string['expired'] = 'عذراً, هذا النشاط مغلق على $a ولم يعد متوفرا.';
$string['fillinatleastoneoption'] = 'يجب تزويد بإجابتين محتملة على الأقل.';
$string['full'] = '(كامل)';
...
$string['removemychoice'] = 'احذف اختياري';
$string['removeresponses'] = 'احذف كل الاستجابات';
