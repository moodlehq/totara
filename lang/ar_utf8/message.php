...
$string['disabled'] = 'الرسائل معطلة حالياً';
...
$string['mailsent'] = 'تم ارسال رسالتك عبر البريد الالكتروني';
...
$string['messagingdisabled'] = 'تم تعطيل المراسلات في هذا الموقع , سيتم إرسال رسائل البريد الإلكتروني بدلا من ذلك';
...
$string['sendmessagetopopup'] = 'ارسال رسالة الى $a - نافذة جديدة';
