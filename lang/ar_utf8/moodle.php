...
$string['addadmin'] = 'إضافة مدير';
$string['addcomment'] = 'إضافة تعليق';
$string['addcreator'] = 'إضافة منشئ مقرر  دراسي';
...
$string['addedtogroupnotenrolled'] = 'لم تتم الإضافة إلى المجموعة $a وذلك لعدم تسجيله في المقرر';
...
$string['addnewcategory'] = 'إضافة صنف جديد';
$string['addnewcourse'] = 'إضافة مقرر جديد';
$string['addnewuser'] = 'إضافة مستخدم جديد';
$string['addnousersrecip'] = 'إضافة المستخدمين الذين لم يدخلوا على هذا $a إلى قائمة المستلمين';
$string['addresource'] = 'إضافة مصدر';
$string['address'] = 'العنوان';
$string['addstudent'] = 'إضافة طالب';
$string['addsubcategory'] = 'إضافة صنف فرعي';
$string['addteacher'] = 'إضافة معلم';
$string['admin'] = 'مدير الموقع';
$string['adminbookmarks'] = 'مفضلات المدير';
$string['adminhelpaddnewuser'] = 'إنشاء حساب مستخدم جديد يدوياً';
$string['adminhelpassignadmins'] = 'المدراء يستطيعون القيام بجميع العمليات في أي مكان في الموقع';
$string['adminhelpassigncreators'] = 'المنشئون يستطيعون إنشاء المقررات الدراسية الجديد والتدريس فيها';
$string['adminhelpassignsiteroles'] = 'تطبيق الأدوار المعرفة على مستخدمين محددين';
...
$string['adminhelpmanageblocks'] = 'أدر الكتل المثبته وإعداداتها';
...
$string['alphanumerical'] = 'لا يقبل إلا حروفا هجائية أو أرقام';
...
$string['areyousuretorestorethisinfo'] = 'لاحقاً في هذا الأجراء ستخير لإضافة هذه النسخة الاحتياطية إلى مقرر دراسي موجود أو إنشاء مقرر دراسي جديد';
$string['asc'] = 'تصاعدي';
$string['assessment'] = 'تقييم';
$string['assignadmins'] = 'تعين مدراء';
$string['assigncreators'] = 'تعين منشئون';
$string['assignsiteroles'] = 'تعيين ادوار عامة لكل الموقع';
...
$string['back'] = 'رجوع';
$string['backtoallcategories'] = 'العود لكافة التصنيفات';
$string['backtoallcourses'] = 'العودة لكافة المقررات';
$string['backtoallprograms'] = 'العودة لكافة البرامج';
...
$string['backupfromthissite'] = 'هل تم عمل النسخ الاحتياطي على هذا الموقع؟';
$string['backupgradebookhistoryhelp'] = 'إذا تم التمكين فسيتم إضافة تاريخ كتاب الدرجات إلى النسخ الاحتياطي الآلي. يرجى ملاحظة أنه لا يجب تعطيل تاريخ الدرجات في إعدادات السيرفر (تعطيل تاريخ الدرجات) من أجل هذا العمل';
$string['backupincludemoduleshelp'] = 'حدد رغبتك في إضافة وحدات المقرر مع أو بدون معلومات المستخدم في النسخ الاحتياطي الآلى';
$string['backupincludemoduleuserdatahelp'] = 'اختر إذا كنت تريد إضافة بيانات مستخدم الوحدة في النسخ الاحتياطي الآلي.';
...
$string['backupmissinguserinfoperms'] = 'ملاحظة: لا تحتوي هذه النسخة الاحتياطية على معلومات مستخدم. سيتم إضافة أنشطة التمارين وورش العمل في النسخة الاحتياطية لأن هذه الوحدات غير متلائمة مع هذا النوع من النسخة الاحتياطية.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnext'] = 'النسخة الاحتياطية التالية';
$string['backupnoneusersinfo'] = 'ملاحظة: لا تحتوي هذه النسخة الاحتياطية على مستخدمين لذا فإن جميع الأنشطة تم تحويلها إلى \"بدون بيانات مستخدم\". لم يتم إضافة أنشطة التمارين وورش العمل إلى النسخة الاحتياطية لأن هذه الوحدات غير متلائمة مع هذا النوع من النسخة الاحتياطية.';
$string['backupnonisowarning'] = 'تحذير: هذه النسخة الاحتياطية من نسخة مودل (pre 1.6) لا تدعم Unicode . إذا كانت هذه النسخة تحتوي على أي من نصوص non-ISO-8859-1 فربما تتلف عند محاولة إسترجاعها إلى نسخة مودل التي لا تدعم Unicode. اذهب إلى <a href=\"http://docs.moodle.org/en/Backup_FAQ\">Backup FAQ</a> من أجل المزيد من المعلومات عن كيفية استعادة هذه النسخة بشكل صحيح.';
$string['backuporiginalname'] = 'اسم النسخة الاحتياطية';
$string['backuproleassignments'] = 'تعيينات دور النسخة الاحتياطية لهذه الأدوار';
$string['backupsavetohelp'] = 'المسار الكامل للمجلد الذي تريد أن تحفظ في ملفات النسخ الاحتياطية <br /> (أترك فارغاً للحفظ في المجلد الافتراضي للمقرر الدراسي)';
$string['backupschedulehelp'] = 'اختر ايام الأسبوع التي يتم فيها تشغيل النسخ الأحتياطية الآلية.';
$string['backupsitefileshelp'] = 'إذا تم تمكينها فسيتم إضافة ملفات الموقع المستخدمة في المقررات في النسخة الاحتياطية الآلية';
$string['backuptakealook'] = 'يرجى الإطلاع على سجل النسخة الاحتياطية في: $a';
$string['backupuserfileshelp'] = 'قم بالاختيار إذا ما كنت ترغب في إضافة ملفات المستخدم(مثل: صور الملف التعريفي) ضمن النسخ الاحتياطية الآلية';
$string['backupusershelp'] = 'اختر لو كنت ترغب في إضافة جميع المستخدمين في السيرفر أو المستخدمين المطلوبين لكل مقرر فقط';
$string['backupversion'] = 'إصدار النسخة الإحتياطية';
$string['badcontext'] = 'سياق خاطيء';
$string['block'] = 'مجموعة';
$string['blockconfiga'] = 'يتم إعداد مجموعة الـ $a';
$string['blockconfigbad'] = 'لم يتم تطبيق هذه المجموعة بشكل صحيح لهذا لا يمكن توفير واجهة للإعدادات.';
$string['blockdeleteconfirm'] = 'أنت على وشك حذف المجموعة \'$a\' كلياً. وهذا الإجراء سيحذف جميع ما يخص المجموعة في قاعدة البيانات كلياً. هل أنت متأكد برغبتك في المواصلة؟';
$string['blockdeletefiles'] = 'جميع المعلومات المتعلقة بهذه المجموعة \'$a->block\' تم حذفها من قاعدة البيانات. لإتمام عملية الحذف (وتجنب إعادة التثبيت الذاتي لهذه المجموعة)، يجب عليك حذف مجلد هذه المجموعة من خادم الملفات $a->directory';
$string['blocks'] = 'مجموعات';
$string['blocksaddedit'] = 'أضف/حرر المجموعات';
$string['blockseditoff'] = 'تحرير المجموعات معطل';
$string['blocksediton'] = 'تحرير المجموعات ممكن';
$string['blocksetup'] = 'إعداد جداول المجموعة';
$string['blocksuccess'] = '$a  تم إعداد الجداول بشكل صحيح';
$string['browseallcategories'] = 'استعراض كافة التصنيفات';
...
$string['categories'] = 'فئات المقررات';
$string['category'] = 'فئة';
$string['categoryadded'] = 'فئة \'$a\' أضيف';
$string['categorycontents'] = 'المقررات والفئات الفرعية';
$string['categorycurrentcontents'] = 'محتويات $a';
$string['categorydeleted'] = 'تم حذف الفئة \'$a\'';
$string['categoryduplicate'] = 'اسم الفئة\'$a\' موجود مسبقاً!';
$string['categorymodifiedcancel'] = 'تم تعديل الفئة ! يرجى الإلغاء والمحاولة مرة أخرى.';
$string['categoryname'] = 'اسم الفئة';
$string['categorys'] = 'فئات المقرر';
$string['categoryupdated'] = 'تم حذف الفئة \'$a\'';
...
$string['clamlost'] = 'لقد تم إعداد مودل لتشغيل clam عند تحميل الملفات، ولكن المسار الذي تم تزويده لclam AV ،$a، غير صحيح.';
$string['clamlostandactinglikevirus'] = 'بالإضافة، تم إعداد مودل على أن يعمل جميع الملفات مثل الفيروسات في حالة فشل clam من العمل. هذا يعني انه لن يتمكن أي طالب من تحميل أي ملف حتى يتم تعديل هذه المشكلة.';
$string['clammovedfile'] = 'لقد تم نقل الملف إلى مجلد الحجر الإلزامي الذي حددته، الموقع الجديد هو $a';
$string['clammovedfilebasic'] = 'لقد تم نقل الملف إلى مجلد الحجر الإلزامي.';
$string['clamquarantinedirfailed'] = 'لم نتمكن من نقل الملف إلى مجلد الحجر الإلزامي المحدد،$a. تحتاج تصحيح هذا عندما تحذف الملفات التي ربما تكون مصابة بالفيروسات.';
$string['clamunknownerror'] = 'يوجد أخطاء غير معروفة مع clam.';
$string['cleaningtempdata'] = 'مسح المعلومات المؤقتة';
$string['clickhere'] = 'انقر هنا';
$string['clicktochange'] = 'انقر للتغير';
$string['closewindow'] = 'أغلق هذه النافذة';
$string['comments'] = 'تعليقات';
$string['commentsrequirelogin'] = 'أنت بحاجة للدخول لعرض التعليقات';
...
$string['confirmcheckfull'] = 'هل انت متأكد تماماً من رغبتك في تأكيد $a؟';
$string['confirmed'] = 'تم تأكيد التسجيل';
$string['confirmednot'] = 'لم يتم تأكيد التسجيل بعد !';
...
$string['copyingsitefiles'] = 'نسخ ملفات الموقع في المقرر';
$string['copyinguserfiles'] = 'نسخ ملفات المستخدم';
$string['copyingzipfile'] = 'نسخ ملف مضغوط';
$string['copyrightnotice'] = 'ملحوظة حقوق النسخ';
...
$string['coursecategorydeleted'] = 'حذف تصنيف المقرر $a';
$string['coursecompletion'] = 'إتمام المقرر';
$string['coursecompletiondata'] = 'بيانات إتمام المقرر';
$string['coursecompletions'] = 'إتمام المقرر';
...
$string['coursedeleted'] = 'حذف مقرر $a';
$string['courseenrolenddate'] = 'بيانات إنهاء تسجيل المقرر';
$string['courseenrolstartdate'] = 'بيانات بدء تسجيل المقرر';
$string['coursefiles'] = 'ملفات مقرر';
$string['courseformatdata'] = 'بيانات تنسيق مقرر';
$string['courseformats'] = 'تنسيق المقرر';
$string['coursegrades'] = 'درجات  مقرر';
$string['coursehelpcategory'] = 'ضع المقرر في قائمة المقررات لأن ذلك يسهل للطلاب إيجادها.';
$string['coursehelpformat'] = 'سيتم عرض الصفحة الرئيسية للمقرر في هذا التنسيق.';
$string['coursehelphiddensections'] = 'كيفية عرض الأقسام المخفية في المقرر للطلاب.';
$string['coursehelpmaximumupload'] = 'حدد أكبر حجم للملف الذي يمكن تحميله في هذا المقرر، ومحدودة بإعدادات مستوى الموقع.';
...
$string['coursehelpnumberweeks'] = 'عدد الأسابيع/المواضيع المعروضة على الصفحة الرئيسية للمقرر.';
...
$string['coursereasonforrejecting'] = 'أسبابك لرفض هذا الطلب';
$string['coursereasonforrejectingemail'] = 'سيتم إرسال هذا بالبريد الإلكتروني لصاحب الطلب';
$string['coursereject'] = 'رفض طلب مقرر';
$string['courserejected'] = 'تم رفض المقرر، وتم إشعار صاحب الطلب';
$string['courserejectemail'] = 'عذراً، لقد تم رفض المقرر الذي قمت بطلبه، وذلك للأسباب التاليه:-
$a';
$string['courserejectreason'] = 'لخص أسبابك لرفض هذا المقرر';
$string['courserejectsubject'] = 'لقد تم رفض مقررك';
$string['coursereports'] = 'تقارير المقرر';
$string['courserequest'] = 'طلب مقرر دراسي';
$string['courserequestdetails'] = 'تفاصيل المقرر الذي تقوم بطلبه';
...
$string['courserequestsupport'] = 'المعلومات الداعمة لمساعدة المدير بتقييم هذا الطلب';
...
$string['coursesettings'] = 'إعدادات المقرر الإفتراضية';
$string['coursesinthiscategory'] = 'المقررات في هذا المقرر ({$a})';
$string['coursesmovedout'] = 'تم نقل المقررات من $a';
...
$string['creatingblogsinfo'] = 'إنشاء معلومات المدونات';
...
$string['creatingcoursecompletiondata'] = 'إنشاء بيانات إتمام المقرر';
...
$string['creatinggroupingsgroups'] = 'إضافة مجموعات إلى التجمعات';
...
$string['defaultcoursestudentdescription'] = 'الطلاب بشكل عام يتمعون بامتيازات أقل في المقرر.';
...
$string['defaultcourseteacherdescription'] = 'يستطيع المعلمون عمل أي شيء في المقرر، بما في ذلك تغيير الأنشطة وتقييم الطلاب.';
$string['defaultcourseteachers'] = 'معلمون';
$string['delete'] = 'حذف';
$string['deleteall'] = 'حذف الكل';
$string['deleteallcannotundo'] = 'حذف الكل - لا يمكن التراجع';
$string['deleteallcomments'] = 'حذف كافة التعليقات';
$string['deleteallratings'] = 'حذف كافة التقييمات';
...
$string['deletecategorycheck2'] = 'إذا قمت بحذف هذا التصنيف فانت بحاجة إلى اختيار ما سيتم عمله مع المقررات وما تحتويه من مقررات فرعية.';
...
$string['deleteselectedkey'] = 'حذف المفتاح الذي تم اختياره';
...
$string['donotclickcontinue'] = 'لا تضغط على رابط الإكمال التالي ;-)';
$string['down'] = 'أسفل';
...
$string['editortoggle'] = 'وضع تحرير نص Toggle enhanced';
$string['editremoteprofile'] = 'تحرير الملف التعريفي عن بعد';
...
لقد طلب شخص ما (ربماأنت) كلمة مرور جديدة لحسابك في \'$a->sitename\'.

لتغيير كلمة المرور الخاصة بك يرجى الذهاب للموقع التالي:

$a->link

يجب أن يظهر هذا الرابط كرابط تشعبي في معظم برامج البريد بحيث تتمكن من ضغطه. إذا لم يعمل ذلك فقم بقص ولصق العنوان في المكان المخصص لذلك في متصفحك.

إذا كنت بحاجة للمساعدة فيرجى التواصل مع مدير الموقع
$a->admin';
$string['emailpasswordchangeinfodisabled'] = 'مرحباً $a->firstname!

لقد طلب شخص ما (ربماأنت) كلمة مرور جديدة لحسابك في \'$a->sitename\'.

للأسف حسابك على هذا الموقع معطل ولا يمكن إعادة تهيئته، يرجى التواصل مع مدير الموقع
$a->admin';
$string['emailpasswordchangeinfofail'] = 'مرحباً $a->firstname!

لقد طلب شخص ما (ربماأنت) كلمة مرور جديدة لحسابك في \'$a->sitename\'.

للأسف لا يمكن إعادة تهيئة كلمات المرور، يرجى التواصل مع مدير الموقع
$a->admin';
$string['emailpasswordchangeinfosubject'] = '$a: معلومات تغير كلمة المرور';
$string['emailpasswordconfirmation'] = 'أهلا
$a->firstname,
لقد طلب شخص ما(ربما أنت) كلمة سر جديد لحسابك في
\'$a->sitename\'
...
$string['emailpasswordconfirmmaybesent'] = '<p> إذا قمت بإدخال عنوان بريد إلكتروني او اسم مستخدم صحيح فيجب إرسال بريد إلكتروني لك.</p>
<p>يحتوي على تعليمات سهلة لتأكيد وغكمال تغيير كلمة المرور هذه. إذا واجهتك صعوبة في الإكمال فيرجى التواصل مع مدير الموقع</p>';
...
$string['enrolledincoursenotrole'] = 'هناك خطأ في تسجيل \"$a->course\" كـ \"$a->role\"';
$string['enrolledincourserole'] = 'تم تسجيلها في \"$a->course\" كـ \"$a->role\"';
...
$string['enrolmentend'] = 'ينتهي التسجيل';
...
$string['enrolmentkeyfromguest'] = 'يتطلب هذا المقرر \"مفتاح تسجيل\" كزائر <br /> يجب عليك إدخال كل مرة في دخولك للمقرر. لا بد ان يصلك من $a';
...
$string['flashlinkmessage'] = 'يرجى ترقية نسخة برنامج Flash player الىن:';
$string['flashupgrademessage'] = 'يتطلب مشغل الفلاش تشغيل هذا المحتوى ولكن النسخة الموجودة لديك قديمة جداً.

ربما تحتاج لتسجيل الخروج ومن ثم تسجيل الدخول بعد ترقية النسخة.';
$string['folder'] = 'مجلد';
...
$string['forceno'] = 'عدم الإلزام';
$string['forcepasswordchange'] = 'تغيير كلمة المرور بشكل إلزامي';
$string['forcepasswordchangecheckfull'] = 'هل أنت متاكد تماماً من رغبتك في إلزام $a لتغيير كلمة المرور ؟';
$string['forcepasswordchangehelp'] = 'أشعر المستخدم بتغير كلمة المرور عند الدخول للموقع ثانياً';
$string['forcepasswordchangenot'] = 'لا يمكن إلزام $a بتغيير كلمة المرور';
$string['forcepasswordchangenotice'] = 'يجب عليك تغيير كلمة المرور من أجل الاستمرار.';
$string['forcetheme'] = 'ألزم الموضوع';
$string['forgotaccount'] = 'هل فقدت كلمة المرور؟';
$string['forgotten'] = 'هل نسيت اسم الدخول أو كلمة المرور؟';
$string['forgottenduplicate'] = 'هذا البريد الإلكتروني مستخدم في أكثر من إشتراك، الرجاء ادخال أسم مستخدم عوضاً عن البريد الإلكتروني.';
$string['forgotteninvalidurl'] = 'رابط إعادة تعيين كلة المرور غير صالح';
$string['format'] = 'تنسيق';
$string['formatdemo'] = 'تنسيق نسخة العرض';
$string['formathtml'] = 'تنسيق HTML';
$string['formatlams'] = 'تنسيق مقرر LAMS';
$string['formatmarkdown'] = 'تنسيق Markdown';
$string['formatplain'] = 'تنسيق نصية';
$string['formatscorm'] = 'تنسيق SCORM';
$string['formatsocial'] = 'تنسيق اجتماعي';
$string['formattext'] = 'تنسيق تلقائي لMoodle';
$string['formattexttype'] = 'تنسيق';
$string['formattopics'] = 'تنسيق موضوعات';
$string['formattopicsajax'] = 'تنسيق موضوعات - AJAX';
$string['formattopicscss'] = 'تنسيق موضوعات - CSS/بدون جداول';
...
$string['go'] = 'اذهب';
$string['gotoyourserver'] = 'روابط للعودة للسيرفر الخاص بك';
...
$string['groupextendenrol'] = 'تمديد التسجيل (عام)';
...
$string['guest'] = 'ضيف';
$string['guestdescription'] = 'صلاحيات الزوار محدودة ولا يمكن لهم إضافة أي نص في أي مكان.';
$string['guestskey'] = 'السماح للزوار الذين لديهم المفتاح';
$string['guestsno'] = 'لا يسمح بدخول الزوار';
$string['guestsnotallowed'] = 'عفوا \'$a\' غير مسموح للزوار بالدخول';
$string['guestsyes'] = 'السماح للزوار بدون المفتاح';
$string['guestuser'] = 'مستخدم زائر';
$string['guestuserinfo'] = 'يسمح لهذا المستخدم الدخول إلى بعض المقررات بغرض القراءة فقط.';
$string['healthcenter'] = 'المركز الصحي';
$string['healthnoproblemsfound'] = 'لم يتم العثور على مشاكل صحية !';
...
$string['helpinterestslist'] = 'أدخل اهتماماتك وضع فواصل بينهم';
...
$string['hiddenfromstudents'] = 'مخفية عن الطلاب';
...
$string['hidesection'] = 'إخفاء قسم $a';
...
$string['idnumbertaken'] = 'لقد تم حجز رقم المعرف هذا مسبقاً';
...
$string['includeroleassignments'] = 'إضافة تعيينات الدور';
$string['includesitefiles'] = 'إضافة الملفات المستخدمة في هذا المقرر';
...
$string['legacythemeinuse'] = 'يتم عرض هذا الموقع لك في وضع التوافق لأن متصفحك قديم جداً.';
...
$string['mailstudents'] = 'أخبر الطلاب';
$string['mailteachers'] = 'أخبر المعلمون';
...
$string['manageruser'] = 'إدارة المستخدم';
$string['manageruserdescription'] = 'يمكن للمدراء إدارة مستخدمين آخرين.';
...
$string['metaremovecourse'] = 'استبعد هذا المقرر';
$string['migratinggrades'] = 'ترحي الدرجات';
...
$string['missingfromdisk'] = 'مفقودة من سطح المكتب';
...
$string['missingrecaptchachallengefield'] = 'حقل إستعادة رمز التحقق مفقود';
...
$string['moreprofileinfoneeded'] = 'يرجى إخبارنا المزيد عن نفسك';
$string['morethanonerecordinfetch'] = 'خطأ: تم استرجاع أكثر من تسجيل واحد (جدول \'$a\')';
$string['mostrecently'] = 'الأحدث';
$string['move'] = 'نقل';
$string['movecategorycontentto'] = 'نقل إلى';
$string['movecategoryto'] = 'نقل الفئة إلى:';
$string['movecontentstoanothercategory'] = 'نقل المحتويات إلى فئة أخرى';
...
$string['nocategoriesfound'] = 'لم يتم العثور على فئات مع الكلمات \'$a\'';
...
$string['nomatchingusers'] = 'لا يوجد مستخدمين يتطابقون مع \'{$a}\'';
...
$string['noneditingteacherdescription'] = 'يمكن للمعلمين الذين لا توجد لديهم صلاحية التحرير أن يقوموا بالتدريس في المقررات وتقييم الطلاب ولكن لا يمكنهم تغيير الأنشطة.';
$string['nonstandard'] = 'غير قياسي';
...
$string['noprogramsfound'] = 'لم يتم العثور على برامج مع الكلمات \'$a\'';
$string['norecentactivity'] = 'لا يوجد أي انشطة حديثة';
...
$string['notenrolledprofile'] = 'لا يتوفر هذا الملف التعريفي لأن هذا المستخدم غير مسجل في هذا المقرر.';
$string['noteusercannotrolldatesoncontext'] = '<strong>ملاحظة:</strong>  تم تعطيل إمكانية تغيير التواريخ عند إستعادة النسخة الاحتياطية لأنك لا تملك التصريحات المطلوبة.';
...
$string['novalidcourses'] = 'لا يوجد مقررات صالحة للعرض';
$string['now'] = 'الآن';
...
$string['olduserdirectory'] = 'هذا دليل المستخدمين القديم , ولم يعد مطلوباً. يمكنك حذفه بأمان . تم نسخ الملفات التي تحتوي على دليل المستخدم الجديد .';
...
$string['passwordreused'] = 'كلمة المرور هذة قد تم استخدامها من قبل ,وغير مسموح بإعادة استخدامها.';
...
$string['pendingrequests'] = 'في انتظار الطلبات';
$string['people'] = 'أشخاص';
...
$string['plugincheck'] = 'تحقق الاضافات';
$string['pluginchecknotice'] = 'الجداول التالية تبين الوحدات والكتل والعوامل التي تم اكتشافها في تثبييت موودل الحالي الخاص بك, 
إنها تشيير الى الإضافات القياسية, والتي ليست كذلك . ينبغي فحص جميع الإضافات غير القياسية ورفع مستواها لتصبح على أحدث الإصدارات
قبل الاستمرار مع تحديث موودل هذا.';
$string['pluginsetup'] = 'أعداد جداول التوصيلات';
$string['policyaccept'] = 'فهمت و أوافق';
...
$string['popupwindowname'] = 'نافذة منبثقة';
$string['post'] = 'مشاركة';
...
$string['preprocessingbackupfile'] = 'قبل معالجة ملف النسخة الاحتياطية';
...
$string['profilenotshown'] = 'لن يتم عرض وصف الملف الشخصي هذا حتى يتم تسجيل هذا الشخص في مقرر دراسي واحد على الأقل.';
...
$string['publicsitefileswarning2'] = 'ملاحظة : يمكن الوصول للملفات الموضوعة هنا بواسطة أي شخص يعرف (او يخمن ) عنوان URL.لأسباب أمنية , من المستحسن أن يتم حذف أية ملفات احتياطية مباشرة بعد استعادتها.';
$string['publicsitefileswarning3'] = 'ملاحظة : يمكن الوصول للملفات الموضوعة هنا بواسطة أي شخص يعرف (او يخمن ) عنوان URL. <br /> لأسباب أمنية , يجب حفظ الملفات الاحتياطية في المجلد backupdata الآمن فقط.';
$string['question'] = 'سؤال';
$string['questionsinthequestionbank'] = 'الأسئلة في بنك السؤال';
...
$string['registrationinfotitle'] = 'تسجيل المعلومات';
...
$string['resetcomponent'] = 'عنصر';
$string['resetcourse'] = 'إعادة تثبيت مقرر دراسي';
$string['resetinfo'] = 'هذه الصفحةِ تَسْمحُ لك بحذف بياناتِ المستخدمين، في حين تَحتفظُ بالنشاطاتِ والأعدادات الأخرى. رجاءً كُنْ حَذَّراً، بمجرد إخْتياَرك للعناصر التاليه والقيام بتنفيذ الإجراءا سيتم حْذفُ بياناتَ المستخدمين نهائياً!';
$string['resetnotimplemented'] = 'لم يتم تعيين إعادة الضبط';
$string['resetstartdate'] = 'إعادة تثبيت تاريخ البدء';
$string['resetstatus'] = 'حالة';
...
$string['restorecannotassignroles'] = 'الاسترجاع يحتاج الى تعيين الأدوار وليس لديك أذن للقيام بذلك.';
$string['restorecannotcreateorassignroles'] = 'الاسترجاع يحتاج الى إنشاء أو تعيين الأدوار وليس لديك أذن للقيام بذلك.';
$string['restorecannotcreateuser'] = 'الاسترجاع يحتاج الى انشاء المستخدم \'$a\' من ملف النسخة الاحتياطية وليس لديك أذن للقيام بذلك.';
$string['restorecannotoverrideperms'] = 'الاسترجاع يحتاج تجاوز الأذونات وليس لديك أذن للقيام بذلك.';
$string['restorecoursenow'] = 'استرجع هذا المقرر الدراسي الآن!';
$string['restoredaccount'] = 'الحساب المستعاد';
$string['restoredaccountinfo'] = 'تم استيراد هذا الحساب من خادم آخر وقد تم فقدان كلمة المرور . لتعيين كلمة مرور جديدة بواسطة البريد الالكتروني ,  الرجاء النقر فوق \"متابعة\"';
$string['restorefinished'] = 'الإسترجاع تم بنجاح';
$string['restoreto'] = 'أسترجع إلي';
$string['restoretositeadding'] = 'تحذير : انت على وشك الإعادة للصفحة الأولى للموقع, إضافة البيانات له!';
$string['restoretositedeleting'] = 'تحذير : انت على وشك الإعادة للصفحة الأولى للموقع, حذف البيانات منه أولاً!';
$string['restoreuserconflict'] = 'محاولة استعادة المستخدم\'$a\' من ملف النسخ الاحتياطي سيسبب مشاكل';
$string['restoreuserinfofailed'] = 'تم إيقاف عملية الإستعادة لأنك لا تملك الصلاحية لإستعادة بيانات المستخدم.';
$string['restoreusersprecheck'] = 'التحقق من بيانات المستخدم';
$string['restoreusersprecheckerror'] = 'تم الكشف عن بعض المشاكل عند التحقق من بيانات المستخدم';
...
$string['savechangesanddisplay'] = 'حفظ وعرض';
$string['savechangesandreturntocourse'] = 'حفظ والعودة إلى المقرر الدراسي';
...
$string['scalestandard'] = 'معيار النطاق';
$string['scalestip'] = 'لإنشاء مقاييس مخصصة، استخدم رابط ’مقاييس’من قائمة إدارة المقرر الدراسي';
$string['scalestip2'] = 'لإنشاء جداول مخصصة , انقر فوق رابط الدرجات في قائمة إدارة المقرر الدراسي , ثم اختر تحرير , جداول.';
$string['schedule'] = 'الجدول الزمني';
$string['scheduledbackupsinactive'] = 'النسخ الاحتياطية المجدولة لا يمكن تفعيلها بواسطة مشرف الموقع.';
...
$string['searchresultsinx'] = 'نتائج البحث في {$a}';
...
$string['selectdefault'] = 'التحديد الافتراضي';
...
$string['setcategorytheme'] = 'تعيين فئة الموضوع';
...
$string['showcommentsnonjs'] = 'عرض التعليقات';
...
$string['showthishelpinlanguage'] = 'إظهار هذه المساعدة في اللغة :$a';
$string['since'] = 'منذ';
...
$string['sitefilesused'] = 'ملفات الموقع المستخدمة في هذا المقرر الدراسي';
...
$string['thereareno'] = 'لا يوجد $a في هذا المقرر';
$string['thiscategorycontains'] = 'تحتوي هذه الفئة';
...
$string['unenrolroleusers'] = 'الغاء تسجيل مستخدمين';
...
$string['uploadcantwrite'] = 'فشل في كتابة الملف إلى القرص';
...
$string['uploadextension'] = 'إيقاف تحميل الملف بواسطة الامتداد';
...
$string['uploadnotempdir'] = 'فقدان مجلد مؤقت';
...
$string['userswithfiles'] = 'المستخدمين مع الملفات';
...
$string['valuealreadyused'] = 'تم استخدام هذه القيمة مسبقاً';
...
$string['writingblogsinfo'] = 'كتابة معلومات المدونات';
$string['writingcategoriesandquestions'] = 'القيام بكتابة الفئات والاسئله';
$string['writingcompetencyevidenceinfo'] = 'كتابة معلومات دليل المنافسة';
$string['writingcoursedata'] = 'كتابة معلومات المقرر';
$string['writingeventsinfo'] = 'كتابة معلومات الاحداث';
$string['writinggeneralinfo'] = 'كتابة المعلومات العامة';
$string['writinggradebookinfo'] = 'كتابة المعلومات سجل الدرجات';
$string['writinggroupingsgroupsinfo'] = 'كتابة معلومات المجموعات';
$string['writinggroupingsinfo'] = 'كتابة معلومات الشعب (المجموعات)';
$string['writinggroupsinfo'] = 'كتابة معلومات مجموعات';
$string['writingheader'] = 'كتابة راس الصفحة';
$string['writingloginfo'] = 'كتابة معلومات السجلات';
$string['writingmessagesinfo'] = 'كتابة معلومات الرسائل';
$string['writingmoduleinfo'] = 'كتابة معلومات الوحدات';
$string['writingscalesinfo'] = 'كتابة معلومات المقاييس';
$string['writinguserinfo'] = 'كتابة معلومات المستخدمين';
