...
/**
 * Strings for component 'scorm', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   scorm
...
$string['autocontinue_help'] = '自動継続を「Yes」にした場合、学習オブジェクトが「close communication」メソッドをコールすることで、自動的に次の利用可能な学習オブジェクトが起動されます。
「No」にした場合、ユーザは次に進むため「続ける」ボタンをクリックする必要があります。';
...
$string['completed'] = '完了';
$string['completionscorerequired'] = '最小スコアを要求する';
$string['completionstatus_completed'] = '完了しました';
$string['completionstatus_failed'] = '失敗しました';
$string['completionstatus_help'] = '# 活動完了：必要ステータス
1つまたは複数のステータスをチェックすると、ユーザがこのSCORM活動で完了とマークされるためには、チェックされたステータスを少なくとも1つ達成することが他の活動完了要件と合わせて必要となります。';
$string['completionstatus_passed'] = '合格しました';
$string['completionstatusrequired'] = 'ステータスを要求する';
...
$string['lastattemptlock_help'] = 'この設定を有効にした場合、学生が割り当てられた受験をすべて完了した後、SCORMプレイヤーをロックします。
学生はコースアウトラインページにアクセスして、受験状況の情報を閲覧することができます。しかし、「Enter」をクリックして、SCORMプレイヤーを起動することはできません。';
...
$string['optionsadv_desc'] = 'このオプションを有効にした場合、フォームの高度なオプションとしてウィンドウオプションが設定されます。';
