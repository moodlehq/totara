...
/**
 * Strings for component 'message', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['beepnewmessage'] = '新しいメッセージに音を鳴らす';
...
$string['couldnotfindpreference'] = 'プリファレンス {$a} を読み込むことができませんでした。あなたが提供したコンポーネントおよび名称はmessage_providerの行に合致しますか? ユーザがどのようにメッセージを受信するか設定できるようにするため、メッセージプロバイダはデータベース内に登録されています。';
