...
/**
 * Strings for component 'userkey', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   userkey
...
$string['keyiprestriction_help'] = 'このデータにアクセスすることのできる唯一のIPアドレスまたはIPアドレスのレンジを入力してください。IP制限を無効にするには、空白のままにしてください (お勧めできません)。';
$string['keymanager'] = 'キーマネージャ';
$string['keyvaliduntil'] = 'キーの有効期限';
$string['keyvaliduntil_help'] = 'それ以降、キーが無効になる任意の日時を選択してください (セキュリティ上お勧めします)。';
$string['keyvalue'] = 'キー値';
