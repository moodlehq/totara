...
$string['casesensitive_help'] = '<p>ここでは、エントリにオートリンクする場合、大文字小文字を厳密に区別するかどうか設定します。</p>
...
$string['rsstype_help'] = '<p>ここでは、用語集のRSSフィードを利用可にすることができます。</p>
...
$string['showall_help'] = '<p>ここでは、ユーザが用語集を閲覧する方法をカスタマイズすることができます。用語集は、常に閲覧および検索することができますが、下記の3つのオプションを設定することもできます:</p>
...
$string['showalphabet_help'] = '<p>ここでは、ユーザが用語集を閲覧する方法をカスタマイズすることができます。用語集は、常に閲覧および検索することができますが、下記の3つのオプションを設定することもできます:</p>
