...
/**
 * Strings for component 'error', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   error
...
$string['cannotnetgeo'] = 'http://netgeo.caida.orgのNetGeoサーバに接続できません。プロクシ設定またはMaxMind GeoLite Cityデータファイルのインストールを確認してください。';
...
$string['csvloaderror'] = 'CSVファイルの読み込み中にエラーが発生しました!';
...
$string['maxbytes'] = 'このファイルは最大サイズを超えています。';
