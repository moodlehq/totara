...
/**
 * Strings for component 'tool_profiling', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['cannotfindanyrunforurl'] = '申し訳ございません、{$a} URI実行に関するプロファイリング実行が見つかりません。';
$string['comment'] = 'コメント';
...
$string['viewdiff'] = '最新の参照実行とのプロファイリングの違いを表示する';
