...
/**
 * Strings for component 'hub', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   hub
...
$string['geolocation_help'] = '将来的に私たちはロケーションベースの検索を提供します。あなたのコースロケーションを指定したい場合、ここに緯度/経度情報を入力してください (例: -31.947884,115.871285)。この値を求める1つの方法はGoogleマップを使用することです。';
$string['hub'] = 'ハブ';
...
$string['moodleorgregistrationdetail'] = 'メインのコミュニティハブは、hub.moodle.orgにあり、MOOCHと呼ばれます。あなたのサイトをMOOCHに登録することで、世界中のMoodleコミュニティに統計情報を提供することができます。あなたはセキュリティ修正に関する早い時期の通知および新しいMoodleのリリースを提供する、配信頻度の低いメーリングリストに参加することもできます。';
...
$string['registeronmoodleorg'] = '今からMoodle.org (MOOCH) に登録する';
...
$string['unpublishconfirmation'] = '本当にコース「 {$a->courseshortname} 」をハブ「 {$a->hubname} 」から削除してもよろしいですか?';
