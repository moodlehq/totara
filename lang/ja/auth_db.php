...
/**
 * Strings for component 'auth_db', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbdescription'] = 'ここでは、ユーザ名およびパスワードが有効であるか確認するため、外部データベースを使用します。新しいアカウントを作成する場合、他のフィールドの情報がMoodleに複製されます。';
...
$string['auth_dbtype'] = 'データベースタイプ (詳細は、<a href="http://phplens.com/adodb/supported.databases.html" target="_blank">をご覧ください)';
