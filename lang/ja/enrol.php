...
/**
 * Strings for component 'enrol', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol
...
$string['configenrolplugins'] = '必要なプラグインすべてを選択した後、適切な順番に並び替えてください。';
...
$string['deleteinstanceconfirm'] = '本当に {$a->users} 名の登録ユーザが存在する登録プラグイン「 {$a->name} 」を削除してもよろしいですか?';
...
$string['uninstallconfirm'] = 'あなたは登録プラグイン「 {$a} 」を完全に削除しようとしています。これにより、この登録タイプに関連するデータベース内すべてのデータが完全削除されます。本当に続けてもよろしいですか?';
