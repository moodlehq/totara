...
/**
 * Strings for component 'filters', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   filters
...
$string['filtersettings_help'] = 'このページでは、あなたはサイトの特定部分においてフィルタを有効または無効にすることができます。また、このページでは管理者が有効にしたフィルタのみ、あなたはアクセスすることができます。
...
$string['includesubcategories'] = 'サブカテゴリを含めますか？';
$string['isactive'] = '有効?';
...
$string['isgreaterorequalto'] = '次以上である';
$string['isgreaterthan'] = '次より大きい';
$string['islessthan'] = '次より小さい';
$string['islessthanorequalto'] = '次以下である';
$string['isnotdefined'] = '次が定義されていない';
$string['isnotequalto'] = '次の文字と等しくない';
$string['matchesallselected'] = '選択されたもの全てに一致する';
$string['matchesanyselected'] = '選択されたいかなるものにも一致する';
