...
/**
 * Strings for component 'choice', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   choice
...
$string['modulename_help'] = '投票モジュールでは、教師は質問すること、複数回答の選択肢を指定することができます。';
...
$string['numberofuserinpercentage'] = 'ユーザ数 (%)';
$string['option'] = 'オプション';
