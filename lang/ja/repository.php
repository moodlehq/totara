...
/**
 * Strings for component 'repository', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   repository
...
$string['errorpostmaxsize'] = 'アップロードファイルがphp.iniのpost_max_sizeディレクティブを超えました。';
...
$string['instancesforcourses'] = '{$a} コース全体の共通インスタンス';
$string['instancesforsite'] = '{$a} サイト全体の共通インスタンス';
$string['instancesforusers'] = '{$a} ユーザプライベートインスタンス';
