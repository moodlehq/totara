...
/**
 * Strings for component 'data', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   data
...
$string['cancel'] = 'キャンセル';
$string['cannotaccesspresentsother'] = 'あなたは、他のユーザのプリセットへのアクセスを許可されていません。';
...
エクスポート機能であなたのコンピュータに保存されたZIPファイルをアップロードするには、ここを使用してください。';
...
$string['maxentries_help'] = '参加者が、このデータベースに登録できる最大エントリ数です。';
...
$string['modulename_help'] = 'データベース活動モジュールでは参加者がレコードエントリを作成、管理および検索することができます。これらのエントリのフォーマットおよび構造にはイメージ、ファイル、URI、数値およびテキスト等、ほとんど制限がありません。';
