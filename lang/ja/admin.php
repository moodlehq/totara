...
/**
 * Strings for component 'admin', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['backup_shortnamehelp'] = 'コースIDナンバーの代わりにコース名をバックアップファイル名の一部として使用します。';
...
$string['configpasswordreuselimit'] = 'ユーザがパスワード再使用を許可されるのに必要なパスワード変更回数';
$string['configpathtoclam'] = 'clam AVのパスを指定してください。おそらく /usr/bin/clamscan または /usr/bin/clamdscan のようになります。あなたがclam AVを動作させるためには、clam AVのパスを指定する必要があります。';
...
$string['configstatsmaxruntime3'] = '1日のうち、統計の計算に許される最大時間を指定してください。統計処理は、サーバに対して大きな負荷がかかることに留意してください。1つのcronで処理する最大日数は、次の設定で指定することができます。';
...
$string['configxmlstrictheaders'] = 'この設定を有効にした場合、それぞれのページはXML http headerおよびprologを使用して生成されるため、ブラウザには、XHTMLエラーがインライン表示されます。これは、開発者のみに有用です。';
...
$string['coursecount'] = 'サイトコース数';
$string['courselistshortnames'] = '拡張コース名をを表示する';
$string['courselistshortnames_desc'] = 'コース一覧を表示する場合、または管理画面でコースを参照する場合、コースフルネームと同時にコース省略名を表示します。あなたがこの設定を有効にした場合、表示に関して「courseextendednamedisplay」言語ストリングを使用します。そのため、あなたは言語カスタマイゼーションを使って、表示される内容を変更することができます。';
...
$string['cron'] = 'Cron';
$string['cron_execute'] = '実行';
$string['cron_execution_crashed'] = 'cronがクラッシュしました';
$string['cron_execution_running'] = 'cronが作動中です';
$string['cron_execution_status'] = 'ステータス';
$string['cron_execution_stopped'] = 'cronが停止しました';
$string['cron_execution_watch'] = 'cronの実行';
...
$string['cron_kill_mail_fail_notify_msg'] = 'cronの実行が最大実行時間を超え、自動終了が失敗しました!サーバーの設定を確認してください。';
$string['cron_kill_mail_fail_notify_title'] = '警告：cronの実行が自動終了に失敗しました！';
$string['cron_kill_mail_notify_msg'] = 'cronの実行が最大実行時間を超え、終了しました。サーバーの設定を確認してください。';
$string['cron_kill_mail_notify_title'] = '警告：cronの実行が自動終了しました！';
$string['cron_max_time'] = '最大実行時間';
$string['cron_max_time_info'] = 'cronの実行に許可される最大実行時間を1時間単位で指定してください。デフォルトの0は時間制限がないことを意味しています。';
$string['cron_max_time_kill'] = 'cronを自動的に終了する';
$string['cron_max_time_kill_info'] = 'チェックすると、cronが設定した実行の期限を過ぎている場合、ウォッチングプロセスにより終了されます。これを作動させるにはcronウォッチャーをセットアップする必要があります。';
$string['cron_max_time_mail_notify'] = '管理者に通知する';
$string['cron_max_time_mail_notify_info'] = 'チェックすると、cronが最大設定時間を超過して実行した場合に、システムが管理者にEメールを送信して通知します。これを作動させるにはcronウォッチャーをセットアップする必要があります。';
$string['cron_max_time_mail_notify_msg'] = 'cronの実行が指定した時間を超えています。サーバーの設定を確認してください。';
$string['cron_max_time_mail_notify_title'] = '警告：cronの実行が期限切れです！';
$string['cron_refresh'] = 'ステータスを更新する';
$string['cron_settings'] = 'Cron';
$string['cron_status_info'] = 'cron実行ステータス';
$string['cron_terminate'] = '終了';
$string['cron_watcher_info'] = 'cronウォッチャー';
...
$string['displayerrorsset'] = 'このサイトはエラーの発生を表示するよう設定されています。<br />この設定は実稼動サイトではお勧めできません。<br />サイト管理者設定ブロックにある<a href="{$a->link}">サーバー/デバッグ</a>セクションの中の<em>デバッグメッセージの表示</em>のチェックをはずしてください。';
...
$string['frontpageitem'] = 'フロントページアイテム {$a}';
$string['frontpageitemloggedin'] = 'ログイン時のフロントページアイテム {$a}';
...
$string['managerroleid'] = 'マネージャのロール';
...
$string['moodlerelease'] = 'MoodleリリースID';
...
$string['navlinkcoursesections'] = 'コースセクションにリンクする';
$string['navlinkcoursesections_help'] = '有効にした場合、コースセクションがリンクとしてナビゲーション内に表示されます。';
...
$string['order4'] = '4番目';
$string['orgname'] = '組織名';
$string['orgnamehelp'] = 'あなたの組織の名称です。';
...
$string['registrationdisabled'] = '無効';
$string['registrationenabled'] = '有効';
$string['registrationinformation'] = '送信する登録情報';
$string['registrationisdisabled'] = '登録が無効にされています。今後問題が起きた時の解決に役立てるため、Totaraに基本情報を登録できるようあなたのサイトを設定することが推奨されます。<br />\n登録は<a href="{$a}">登録設定ページ</a>で有効にできます';
$string['registrationisenabled'] = '登録が有効です。';
$string['registrationoutofdate'] = '登録情報が長期間アップデートされていません。登録情報は今後のトラブルシューティングに備え、常に最新のものにしておく必要があります。あなたのウェブサーバーがregister.totaralms.comへのHTTPリクエストを無制限に行えるようにしてください';
...
$string['showuseridentity'] = 'ユーザ固有情報を表示する';
...
$string['sitehasntregistered'] = 'このサイトはまだTotaraに正常に登録されていません。今後問題が起きた時の解決に役立てるため、Totaraに基本情報を登録することが推奨されます。あなたのウェブサーバーがregister.totaralms.comにHTTPリクエストを行うことができるようにするとともに、Moodle cronを有効にしてください。cronを手動で実行するには<a href="{$a}">ここをクリック</a>してください。';
$string['siteidentifier'] = 'サイトID';
...
$string['techsupportemail'] = '技術サポートメールアドレス';
$string['techsupportemailhelp'] = 'サイトホスティングに関して、ほとんどの技術的なトラブルを処理する担当者のメールアドレスです。';
$string['techsupportphone'] = '技術サポート電話番号';
$string['techsupportphonehelp'] = 'サイトホスティングに関して、ほとんどの技術的なトラブルを処理する担当者の電話番号 (国番号を含む) です。';
...
$string['totarabuild'] = 'Totaraビルドナンバー';
$string['totararegistration'] = 'Totara登録';
$string['totararegistrationinfo'] = '<p>このページではtotaralms.comへ送信する登録情報のアップデートを設定します。このアップデートにより、あなたが実行しているTotaralmsとサポートソフトウェアのバージョン情報がTotaraに通知されます。\nTotaraは今後のサポート問題を調査し解決するためにこの情報を役立てます。</p>\n<p>この情報は安全に送信され、機密情報として保持されます。</p>';
$string['totararelease'] = 'TotaraリリースID';
$string['totaraversion'] = 'Totaraバージョンナンバー';
...
$string['webserversoftware'] = 'ウェブサーバソフトウェアID';
$string['wwwroot'] = 'サイトWWWルート';
