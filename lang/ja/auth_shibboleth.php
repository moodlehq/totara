...
/**
 * Strings for component 'auth_shibboleth', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['auth_shib_instructions_help'] = 'Shibbolethに関して、あなたのユーザに提示する説明文です。 これは、ログインページの説明セクションに表示されます。Shibbolethユーザが簡単にログインできるよう、「**{$a}**」 のようなリンクを入れてください。';
