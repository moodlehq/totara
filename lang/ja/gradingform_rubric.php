...
/**
 * Strings for component 'gradingform_rubric', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['enableremarks'] = 'クライテリアに対して、評定者によるテキストの追加を許可する';
...
$string['restoredfromdraft'] = '注意: このユーザの最後の受験の評定は適切に保存されていないため、下書き評定がリストアされました。この変更をキャンセルしたい場合、以下の「キャンセル」ボタンをクリックしてください。';
...
$string['sortlevelsasc'] = 'レベルの並び替え順:';
