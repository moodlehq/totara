...
/**
 * Strings for component 'completion', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   completion
...
$string['completeviarpl'] = 'RPLにより完了';
...
$string['configenablecourserpl'] = '有効にすると、ユーザへの「以前の学習記録」の割り当てを通じ、コースを完了としてマークすることができます。';
$string['configenablemodulerpl'] = 'モジュールについて有効にすると、ユーザへの「以前の学習記録」の割り当てを通じ、そのモジュールについてのいかなるコース完了クライテリアでも完了したとマークすることができます。';
...
$string['courserpl'] = 'コースRPL';
$string['courserplorallcriteriagroups'] = 'コースまたは<br />すべてのクライテリアグループのRPL';
$string['courserploranycriteriagroup'] = 'コースまたは<br />いかなるクライテリアグループのRPL';
...
$string['deletedcourse'] = '削除されたコース';
$string['dependencies'] = '依存';
$string['dependenciescompleted'] = '依存が完了しました';
...
$string['enablecourserpl'] = 'コースにRPLを有効化する';
$string['enablemodulerpl'] = 'モジュールにRPLを有効化する';
...
$string['err_nocriteria'] = 'このコースに設定されたコース完了クライテリアはありません';
...
$string['error:rplsaredisabled'] = '「以前の学習記録」が管理者により無効にされています';
...
$string['showrpl'] = 'RPLを表示する';
$string['showrpls'] = 'RPLを表示する';
