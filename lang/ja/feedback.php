...
/**
 * Strings for component 'feedback', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   feedback
...
$string['depending'] = '依存アイテム';
$string['depending_help'] = 'あなたは依存アイテムを使用して他のアイテムの値に依存するアイテムを表示することができます。
**以下、使用例です。**
* 最初に他のアイテムが値を依存することになるアイテムを作成してください。
* 次に改ページ (Page break) を追加してください。
* そして、最初に作成したアイテムの値に依存するアイテムを追加してください。
アイテム作成フォーム内の「依存アイテム」リストから依存アイテム、そして「依存値」テキストボックスに必要な値を入力してください。
...
$string['emailnotification_help'] = '有効にした場合、フィードバックの送信に関して管理者宛にメール通知されます。';
...
$string['modulename_help'] = 'フィードバックモジュールでは独自調査を作成することができます。';
