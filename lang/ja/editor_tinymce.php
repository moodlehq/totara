...
/**
 * Strings for component 'editor_tinymce', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['advanced:clipboard_msg'] = 'コピー/切り取り/貼り付けはMozilla及びFirefoxでは使用できません。n詳細はこちら';
...
$string['advanced_dlg:image_alt'] = '画像説明';
...
$string['advimage_dlg:missing_alt'] = '本当に画像説明なしで続けますか? 画像説明がない場合、障害のあるユーザ、テキストブラウザを使用しているユーザ、イメージ表示を無効にしているユーザがアクセスできないことがあります。';
...
$string['autosave:warning_message'] = 'あなたが保存されたコンテンツをリストアした場合、エディタ内の現在のコンテンツすべてを失うことになります。

本当に保存されたコンテンツをリストアしてもよろしいですか?';
$string['common:apply'] = '適用';
$string['common:browse'] = '参照';
$string['common:browseimage'] = 'イメージを探すまたはアップロードする ...';
$string['common:browsemedia'] = 'サウンド、ビデオまたはアプレットを探すまたはアップロードする ...';
$string['common:cancel'] = 'キャンセル';
$string['common:class_name'] = 'クラス';
$string['common:clipboard_msg'] = 'コピー/切り取り/貼り付けは、FirefoxおよびMozillaでは使用できません。この件に関して、詳細情報を閲覧しますか?';
...
$string['media_dlg:filename'] = 'ファイル名';
...
$string['media_dlg:qt_stream_warn'] = 'rtspストリーミングリソースを「高度な設定」タブの「QT Src」欄に入力してください。また、「Src」欄にはストリーミングではないバージョーンを入力してください。';
...
$string['paste:plaintext_mode'] = '現在、ペーストはプレインテキストモードです。通常ペーストモードに戻るには、再度クリックしてください。';
$string['paste:plaintext_mode_sticky'] = '現在、ペーストはプレインテキストモードです。通常ペーストモードに戻るには、再度クリックしてください。何らかのテキストをペーストした後、あなたは通常ペーストモードに戻ります。';
