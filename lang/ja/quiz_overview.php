...
/**
 * Strings for component 'quiz_overview', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['optonlygradedattempts'] = '各ユーザの評定された受験のみ ({$a})';
...
$string['showdetailedmarks'] = 'それぞれの問題評点の表示 / ダウンロード';
