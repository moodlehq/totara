...
/**
 * Strings for component 'calendar', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   calendar
...
$string['expired'] = '期間終了';
$string['explain_site_timeformat'] = 'あなたは12時間表示または24時間表示をサイトの時間表示方法として選択することができます。「デフォルト」を選択した場合、使用言語に合わせて、フォーマットが自動的に選択されます。この設定はユーザ設定によりオーバーライドすることができます。';
...
$string['pref_lookahead_help'] = 'この設定では直近イベントとしてイベントを表示するための将来的な日数の範囲を指定します。この日数を超えるイベントは直近イベントとして表示されることはありません。この日数範囲内のすべてのイベントが表示されるという**保証はありません**。多くの直近イベント (「直近イベントの最大表示件数」以上) が登録されている場合、最も時間の離れたイベントは表示されません。';
