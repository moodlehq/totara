...
/**
 * Strings for component 'tool_unittest', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['confignonwritable'] = 'ウェブサーバからconfig.phpを書き込めません。パーミッションを変更するか、適切なユーザアカウントで編集した後、PHPタグを閉じる前に次の行を追加してください: 
