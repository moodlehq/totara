 ...
 *
 * Strings for component 'totara_hierarchy', language 'ja', branch 'totara-2.2'
 * @package totara
...
$string['competencydescription'] = '説明';
...
$string['competencyframeworkdescription'] = '説明';
...
$string['competencyframeworkfullname'] = '正式名';
...
$string['competencyscaledefault'] = 'デフォルト値';
...
$string['competencyscaledescription'] = '説明';
...
$string['fullnametype_help'] = 'タイプの正式名';
$string['globalsettings'] = 'グローバル設定';
$string['hidden'] = '非表示';
$string['hidecustomfields'] = 'カスタムフィールドを非表示にする';
$string['hidedetails'] = '詳細を非表示にする';
$string['hierarchies'] = '階層';
$string['hierarchy:assignselfposition'] = '自己ポジションを割り当てる';
$string['hierarchy:assignuserposition'] = 'ユーザポジションを割り当てる';
$string['hierarchy:createcompetency'] = 'コンピテンシーを作成する';
$string['hierarchy:createcompetencycustomfield'] = 'コンピテンシーカスタムフィールドを作成する';
$string['hierarchy:createcompetencydepth'] = 'コンピテンシー深さを作成する';
$string['hierarchy:createcompetencyframeworks'] = 'コンピテンシーフレームワークを作成する';
$string['hierarchy:createcompetencytemplate'] = 'コンピテンシーテンプレートを作成する';
$string['hierarchy:createcompetencytype'] = 'コンピテンシータイプを作成する';
$string['hierarchy:createcoursecustomfield'] = 'コースカスタムフィールドを作成する';
$string['hierarchy:createorganisation'] = '組織を作成する';
$string['hierarchy:createorganisationcustomfield'] = '組織カスタムフィールドを作成する';
$string['hierarchy:createorganisationdepth'] = '組織的深さを作成する';
$string['hierarchy:createorganisationframeworks'] = '組織的フレームワークを作成する';
$string['hierarchy:createorganisationtype'] = '組織的タイプを作成する';
$string['hierarchy:createposition'] = 'ポジションを作成する';
$string['hierarchy:createpositioncustomfield'] = 'ポジションカスタムフィールドを作成する';
$string['hierarchy:createpositiondepth'] = 'ポジション深さを作成する';
$string['hierarchy:createpositionframeworks'] = 'ポジションフレームワークを作成する';
$string['hierarchy:createpositiontype'] = 'ポジションタイプを作成する';
$string['hierarchy:deletecompetency'] = 'コンピテンシーを削除する';
$string['hierarchy:deletecompetencycustomfield'] = 'コンピテンシーカスタムフィールドを削除する';
$string['hierarchy:deletecompetencydepth'] = 'コンピテンシー深さを削除する';
$string['hierarchy:deletecompetencyframeworks'] = 'コンピテンシーフレームワークを削除する';
$string['hierarchy:deletecompetencytemplate'] = 'コンピテンシーテンプレートを削除する';
$string['hierarchy:deletecompetencytype'] = 'コンピテンシータイプを削除する';
$string['hierarchy:deletecoursecustomfield'] = 'コースカスタムフィールドを削除する';
$string['hierarchy:deleteorganisation'] = '組織を削除する';
$string['hierarchy:deleteorganisationcustomfield'] = '組織カスタムフィールドを削除する';
$string['hierarchy:deleteorganisationdepth'] = '組織的深さを削除する';
$string['hierarchy:deleteorganisationframeworks'] = '組織的フレームワークを削除する';
$string['hierarchy:deleteorganisationtype'] = '組織的タイプを削除する';
$string['hierarchy:deleteposition'] = 'ポジションを削除する';
$string['hierarchy:deletepositioncustomfield'] = 'ポジションカスタムフィールドを削除する';
$string['hierarchy:deletepositiondepth'] = 'ポジション深さを削除する';
$string['hierarchy:deletepositionframeworks'] = 'ポジションフレームワークを削除する';
$string['hierarchy:deletepositiontype'] = 'ポジションタイプを削除する';
$string['hierarchy:updatecompetency'] = 'コンピテンシーを更新する';
$string['hierarchy:updatecompetencycustomfield'] = 'コンピテンシーカスタムフィールドをアップデートする';
$string['hierarchy:updatecompetencydepth'] = 'コンピテンシー深さをアップデートする';
$string['hierarchy:updatecompetencyframeworks'] = 'コンピテンシーフレームワークをアップデートする';
$string['hierarchy:updatecompetencytemplate'] = 'コンピテンシーテンプレートを更新する';
$string['hierarchy:updatecompetencytype'] = 'コンピテンシータイプを更新する';
$string['hierarchy:updatecoursecustomfield'] = 'コースカスタムフィールドをアップデートする';
$string['hierarchy:updateorganisation'] = '組織をアップデートする';
$string['hierarchy:updateorganisationcustomfield'] = '組織カスタムフィールドをアップデートする';
$string['hierarchy:updateorganisationdepth'] = '組織的深さをアップデートする';
$string['hierarchy:updateorganisationframeworks'] = '組織的フレームワークをアップデートする';
$string['hierarchy:updateorganisationtype'] = '組織的タイプをアップデートする';
$string['hierarchy:updateposition'] = 'ポジションをアップデートする';
$string['hierarchy:updatepositioncustomfield'] = 'ポジションカスタムフィールドをアップデートする';
$string['hierarchy:updatepositiondepth'] = 'ポジション深さをアップデートする';
$string['hierarchy:updatepositionframeworks'] = 'ポジションフレームワークをアップデートする';
$string['hierarchy:updatepositiontype'] = 'ポジションタイプをアップデートする';
$string['hierarchy:viewcompetency'] = 'コンピテンシーを表示する';
$string['hierarchy:vieworganisation'] = '組織を表示する';
$string['hierarchy:viewposition'] = 'ポジションを表示する';
...
$string['organisationdescription'] = '説明';
...
$string['organisationframeworkdescription'] = '説明';
...
$string['positionframeworkdescription'] = '説明';
...
$string['positionframeworkidnumber'] = 'ID番号';
...
$string['useraspirationalposition'] = 'アスピレーショナルポジション';
