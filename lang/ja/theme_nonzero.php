...
/**
 * Strings for component 'theme_nonzero', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['regionpostwidth'] = '右カラム幅';
$string['regionpostwidthdesc'] = 'ここでは右カラムを形成するブロックの幅を設定します。';
$string['regionprewidth'] = '左カラム幅';
$string['regionprewidthdesc'] = 'ここでは左カラムを形成するブロックの幅を設定します。ブログレイアウトを使用する場合、このカラムはページ中央に表示されます。';
