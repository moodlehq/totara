...
/**
 * Strings for component 'grades', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   grades
...
$string['aggregation_help'] = 'このメニューでは、このカテゴリにおける参加者の総合評点を計算するため使用される総計方法を選択できます。各オプションの内容は下記のとおりです。
...
: A1 70/100 加重 10, A2 20/80 加重 5, A3
10/10 加重 3, カテゴリ最大 100:
...
$string['aggregationcoefextrasum_help'] = '総計方法「評点の合計」が使用された場合、評定項目はカテゴリの追加点として使用することができます。これは、評定項目の最大評点がカテゴリ合計にすべて追加されるわけではないことを意味します。以下、追加点の適用例です:

* アイテム1の評点は、0-100です。
* アイテム2の評点は、0-75です。
* アイテム1の「追加点として使用する」チェックボックスがチェックされ、アイテム2ではチェックされていません。
* 両方のアイテムは、総計方法「評点の合計」を持つカテゴリ1に属しています。
* カテゴリ1の合計は、0-75で評定されます。
* 学生がアイテム1で20点、アイテム2で70点取得するとします。
* カテゴリ1の学生合計は、75/75 (20 + 70 = 90となりますが、アイテム1は追加点として使用されるため、最大評点を限度として合計に適用されます) となります。';
$string['aggregationcoefextraweight'] = '追加点加重';
$string['aggregationcoefextraweight_help'] = 'ゼロより大きな値の場合、この評定項目は総計において追加点として評定に使用されます。数値は、評点が評点合計に追加される前に乗算されます。しかし、この評定項目自体は除算に数えられません。例えば:

* アイテム1は、0-100で評定され、「追加点」の値に「2」が設定されています。
* アイテム2は、0-100で評定され、「追加点」の値は「0.0000」のままにされています。
* アイテム3は、0-100で評定され、「追加点」の値は「0.0000」のままにされています。
* すべての3アイテムはカテゴリ1に属し、総計方法「評点の平均値 (追加点扱い)」が設定されています。
* 学生がアイテム1で20点、アイテム2で40点、そしてアイテム3で70点取得したとします。
* カテゴリ1の学生合計は、95/100 20*2 + (40 + 70)/2 = 95 となります。';
$string['aggregationcoefweight'] = '評定項目の加重';
$string['aggregationcoefweight_help'] = '他の評定項目との総計時、この評定項目のすべての評点に適用される加重です。';
$string['aggregationposition'] = '総計の位置';
$string['aggregationposition_help'] = '評点の総計に関連するレポートの総計カラムの位置を定義します。';
...
$string['averagesdecimalpoints_help'] = 'それぞれのカラム平均に表示する小数点以下桁数を指定してください。継承が選択された場合、それぞれのカラムの表示タイプが選択されます。';
$string['averagesdisplaytype'] = 'カラム平均の表示タイプ';
$string['averagesdisplaytype_help'] = 'それぞれのカラムにどのように平均を表示するか指定してください。継承が選択された場合、それぞれのカラムの表示タイプが選択されます。';
...
$string['decimalpoints_help'] = 'それぞれの評定に表示する小数点以下桁数を指定してください。この設定は、小数位5桁の精度の評定計算に影響はありません。';
...
$string['droplow_help'] = 'このオプションを設定した場合、X件の最低評点が除外されます。Xは、このオプションで選択された値です。';
$string['dropped'] = '件除外';
...
$string['excluded'] = '除外';
$string['excluded_help'] = '除外が有効にされた場合、この評点は、すべての親評定項目またはカテゴリで実行されるすべての総計から除外されます。';
$string['expand'] = 'カテゴリを拡張する';
...
$string['feedback_help'] = '教師から評定に追加されるメモです。広範囲、個別のフィードバックまたはフィードバックの内部システムを参照するシンプルなコードを使用することができます。';
...
$string['finalgrade_help'] = 'すべての計算が実行された後の (キャッシュされた) 最終的な 評点です。';
...
$string['gradeboundary_help'] = '評定文字表示タイプが使用される場合、評定文字を評定に割り当てる境界のパーセンテージです。';
...
$string['gradedisplaytype_help'] = '評定者およびユーザレポートでどのように評定を表示するか指定してください。評定を実データ、(最小および最大評点に関する) パーセンテージまたは文字 (A、B、C等..) で表示することができます。';
...
$string['gradeletter_help'] = '評点の範囲を示すために使用される文字または他の記号です。';
...
$string['grademax_help'] = '「値」の評定タイプを使用する場合、最大評点を設定することができます。活動ベースの評定項目の最大評点は、活動の更新ページで設定します。';
$string['grademin'] = '最小評点';
$string['grademin_help'] = '「値」の評定タイプを使用する場合、最小評点を設定することができます。';
$string['gradeoutcomeitem'] = '評定アウトカム項目';
$string['gradeoutcomes'] = 'アウトカム';
$string['gradeoutcomescourses'] = 'コースアウトカム';
$string['gradepass'] = '合格点';
$string['gradepass_help'] = '合格するために、同等またはそれ以上の評点に達する必要のある項目がある場合、ここで設定することができます。';
...
$string['gradetype_help'] = '使用する評定タイプを指定してください: なし (評定不可)、値 (最大および最小評点の設定を有効にします)、尺度 (評価尺度設定を有効にします)、テキスト (フィードバックのみ)。値および尺度評定タイプのみ合計することができます。活動ベースの評定項目は、活動の更新ページで設定します。';
$string['gradeview'] = '評定を表示する';
$string['gradeweighthelp'] = '評定加重ヘルプ';
$string['groupavg'] = 'グループ平均';
$string['hidden'] = '隠す';
$string['hidden_help'] = 'チェックした場合、評定は学生から隠されます。評定完了後に評定を開放するには、「次の日時まで隠す」を設定することができます。';
...
$string['hidetotalifhiddenitems_help'] = 'この設定では、非表示項目を含んでいる場合、学生に合計を表示するか、ハイフン (-) を表示するか指定します。表示する場合、合計に非表示項目を含むことも、含まないこともできます。
隠す場合、非表示項目は除外されます。表示または非表示に係わらず、教師は常に項目すべての計算された合計を閲覧することができるため、この場合、教師に表示される合計は異なります。
非表示項目を含む場合、学生は、非表示項目も計算することができます。';
...
$string['importoutcomenofile'] = 'アップロードされたファイルは、空または破損しています。このファイルが有効かどうか確認してください。問題は {$a} 行目で検出されました。これは、最初の行 (ヘッダ行) のカラムと同数のカラムがデータ行に含まれていないか、インポートファイルに必要なヘッダ行が含まれていなことが原因です。有効なヘッダ行の例として、エクスポートされたファイルをご覧ください。';
...
$string['iteminfo_help'] = '評定項目に関する情報を入力するスペースです。入力されたテキストは、どこにも表示されることはありません。';
$string['itemname'] = '項目名';
...
$string['linkedactivity_help'] = 'このアウトカム項目がリンクされる任意の活動を指定してください。これは、活動評定により評定されないクライテリアにおける、学生のパフォーマンスを測定するため使用されます。';
$string['linktoactivity'] = '{$a->name} 活動にリンクする';
$string['lock'] = 'ロック';
$string['locked'] = 'ロック';
$string['locked_help'] = 'チェックした場合、関連する活動の評定が自動更新されないようになります。';
...
$string['multfactor_help'] = '最大評点の最大値を上限として、この評定項目のすべての評点に掛けられる要素です。';
...
$string['overridden_help'] = '「優先」が有効にされた場合、将来的な受験の評点が自動的に調整されることを優先フラグが防ぎます。多くの場合、このフラグは評定表で内部的に設定されますが、このフォーム要素を使用して、手動で有効および無効に変更することができます。';
$string['overriddennotice'] = 'この活動に関するあなたの評点は、手動で調整されました。';
$string['overridesitedefaultgradedisplaytype'] = 'サイトデフォルトをオーバーライドする';
$string['overridesitedefaultgradedisplaytype_help'] = '評定表の評定表示サイトデフォルトをオーバーライドしたい場合、このチェックボックスをチェックしてください。チェックボックスをチェックすることで、あなたが「評定文字」および「評定文字の境界」を選択できるフォーム要素がアクティブにされます。';
...
$string['pointsdescending'] = '評点の降順で並び替える';
...
$string['quickgrading_help'] = '多くの評定を1度に編集できるようにするため、クイック評定は評定者レポートのそれぞれの評定セルにテキスト入力欄を追加します。フィードバックを1つずつ変更する代わりに、更新ボタンをクリックすることで、すべての変更を1度に実行することができます。';
$string['range'] = '範囲';
$string['rangedecimals'] = '小数点範囲';
$string['rangedecimals_help'] = '表示する小数点の範囲です。';
$string['rangesdecimalpoints'] = '範囲で表示する小数点以下桁数';
$string['rangesdecimalpoints_help'] = 'それぞれの範囲に表示する小数点以下桁数を指定してください。この設定は、評定項目ごとにオーバーライドすることができます。';
$string['rangesdisplaytype'] = '範囲表示タイプ';
$string['rangesdisplaytype_help'] = '範囲をどのように表示するか指定してください。継承が選択された場合、それぞれのカラムの表示タイプが選択されます。';
$string['rank'] = 'ランク';
$string['rawpct'] = '実%';
$string['real'] = '実データ';
...
$string['showactivityicons_help'] = '活動名の横に活動アイコンを表示するかどうか指定してください。';
...
$string['sortbyfirstname'] = '名で並び替える';
$string['sortbylastname'] = '姓で並び替える';
...
$string['typenone'] = 'なし';
$string['typescale'] = '尺度';
$string['typescale_help'] = '「尺度」評定タイプを使用する場合、評価尺度を選択することができます。活動ベースの評価尺度は、活動の更新ページで選択します。';
