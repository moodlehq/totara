...
$string['aggregationcoefextrasum_help'] = '<p>総計方法「評点の合計」が使用された場合、評定項目はカテゴリの追加点として使用することができます。これは、評定項目の最大評点がカテゴリ合計にすべて追加されるわけではないことを意味します。以下、追加点の適用例です:</p>
...
<dl id="grade-aggregation-help">
    ...
    <dt>評点の中央値</dt>
        <dd>中央値 (または中央にある2つの評点の平均) は、大きさの順に評点を並び替える時点で使用されます。平均値に対して有利な点は、異常値 (平均から極めて懸け離れている評点) に影響されないことです。</dd>
        <dd class="example">A1 70/100, A2 20/80, A3 10/10, カテゴリ最大 100:<br />
...
$string['linkedactivity_help'] = '<p>このアウトカム項目がリンクされる任意の活動を指定してください。これは、活動評定により評定されないクライテリアにおける、学生のパフォーマンスを測定するため使用されます。</p>';
