...
/**
 * Strings for component 'theme_magazine', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['backgrounddesc'] = '新しいイメージのURIを入力することで背景画像を変更します (例 http://www.somesite/mybackground.jpg)。';
...
$string['linkcolordesc'] = 'テーマ内のリンク色を16進で設定します。';
$string['linkhover'] = 'リンクホバー';
$string['linkhoverdesc'] = 'テーマ内のリンク色 (ホバー時) を16進で設定します。';
$string['logo'] = 'ロゴ';
$string['logodesc'] = '新しいロゴのURIを入力することで、このテーマのロゴを変更します (例 http://www.somesite/animage.png)。参考として、デフォルトロゴのサイズは幅300px、高さ80pxです。 透過的な.pngが最適です。';
