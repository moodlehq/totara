...
/**
 * Strings for component 'theme_sky_high', language 'ja', branch 'MOODLE_22_STABLE'
 *
...
$string['taglinedesc'] = 'このテキストエリアのコンテンツはフロントページのサイト名下部に表示されます。';
