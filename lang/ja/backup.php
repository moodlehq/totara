...
/**
 * Strings for component 'backup', language 'ja', branch 'MOODLE_22_STABLE'
 *
 * @package   backup
...
$string['automatedsetup'] = '自動バックアップセットアップ';
...
$string['configloglifetime'] = 'ここではあなたが希望するログイン情報の保持期間を指定します。設定値より古いログは自動的に削除されます。バックアップログ情報は肥大化する可能性があるため、この値を小さく設定することをお勧めします。';
