...
/**
 * Strings for component 'portfolio_mahara', language 'de', branch 'MOODLE_22_STABLE'
 *
...
$string['err_invalidhost_help'] = 'Das Plugin ist falsch konfiguriert und versucht zu einem ungültigen oder gelöschten MNet-Host zu verbinden. Das Plugin basiert auf Moodle Networking Peers. SSO\_IDP ist veröffentlicht und SSO\_SP ist abonniert. Portfolio ist abonniert **und** veröffentlicht.';
...
$string['err_nomnethosts_help'] = 'Das Plugin basiert auf MNet Peers mit veröffentlichten SSO IDP. SSO SP und Portfolio gezeichnet **und** veröffentlicht sowie dem MNet Authentifizierungsplugin. Jede Instanz des Plugins wird auf unsichtbar gesetzt, bis dies geschehen ist. Die Einstellung sichtbar/verfügbar muss manuell vorgenommen werden. Erst dann kann das Plugin genutzt werden.';
