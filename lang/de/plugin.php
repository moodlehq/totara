...
/**
 * Strings for component 'plugin', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   plugin
...
$string['nonehighlighted'] = 'Kein Plugin erwartet Ihre Aufmerksamkeit beim Upgrade';
...
$string['pluginchecknotice'] = 'Diese Seite informiert über Plugins, die bei einem Update Ihrer besonderen Aufmerksamkeit bedürfen. Hervorgehoben werden neue, upzudatende und fehlende Plugins. Sie sollten bevor Sie das Update fortsetzen prüfen, ob für diese Plugins neuere Versionen vorliegen.';
...
$string['requiredby'] = 'Erforderlich für: {$a}';
$string['requires'] = 'Erfordert';
$string['rootdir'] = 'Verzeichnis';
$string['settings'] = 'Einstellungen';
$string['showall'] = 'Neu laden und alle Plugins zeigen';
$string['somehighlighted'] = 'Anzahl der Plugins, die Ihre Aufmerksamkeit beim Upgrade erfordern: {$a}';
$string['somehighlightedinfo'] = 'Liste aller installierten Plugins anzeigen';
$string['source'] = 'Quelle';
$string['sourceext'] = 'Erweiterung';
$string['sourcestd'] = 'Standard';
$string['status'] = 'Status';
$string['status_delete'] = 'Wird gelöscht';
$string['status_downgrade'] = 'Eine höhere Version ist bereits installiert!';
...
$string['type_message'] = 'Mitteilungssystem';
$string['type_message_plural'] = 'Mitteilungssysteme';
