...
/**
 * Strings for component 'data', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   data
...
$string['csvimport_help'] = 'Daten können über eine CVS-Datei importiert werden, wobei die erste Zeile eine Liste von Feldnamen enthalten muss, gefolgt von den Daten mit jeweils einem Datensatz pro Zeile.';
...
$string['modulename_help'] = 'Die Aktivität Datenbank erlaubt es Teilnehmer/innen, eine Fülle von Datensätzen anzulegen, zu verwalten und darin zu suchen. Format und Struktur der Einträge sind weitgehend unbegrenzt. Texte, Zahlen, Bilder, Dateien, URLs usw. können verwaltet werden';
