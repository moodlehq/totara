...
/**
 * Strings for component 'backup', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   backup
...
$string['currentstage1'] = 'Voreinstellungen';
...
$string['error_course_module_not_found'] = 'Verwaiste Blockinstanz (id: {$a}) gefunden. Dieses Modul wird nicht gesichert.';
...
$string['generalsettings'] = 'Allgemeine Sicherungseinstellungen';
...
$string['setting_course_shortname'] = 'Kurskurzname';
