...
/**
 * Strings for component 'enrol_flatfile', language 'de', branch 'MOODLE_22_STABLE'
 *
...
$string['mapping'] = 'CVS-Einschreibung (Flat file)';
$string['messageprovider:flatfile_enrolment'] = 'Mitteilungen bei Einschreibung über Textdatei';
$string['pluginname'] = 'CVS-Einschreibung (Flat file)';
$string['pluginname_desc'] = 'Die CVS-Einschreibung (Flat file) verarbeitet eine Textdatei, die mehrere Zeilen mit 4 oder 6 kommagetrennten Werten enthält:
