...
/**
 * Strings for component 'install', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   install
...
<p>GD ist eine Funktionssammlung, um in Moodle Bilder zu verarbeiten (z.B. Nutzerbilder verkleinern) oder neue Bilder zu generieren (z.B. grafische Darstellung von Logdaten). Moodle kann auch ohne GD arbeiten, aber die grafischen Funktionen sind dann nicht verfügbar.</p>
