...
/**
 * Strings for component 'wiki', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   wiki
...
$string['filtername'] = 'Automatische Wikiverlinkung';
$string['firstpagetitle'] = 'Wikistartseite';
$string['firstpagetitle_help'] = 'Name der ersten Seite im Wiki';
...
$string['javascriptdisabledlocks'] = 'Javascript ist bei Ihrem Browser deaktiviert, so dass die Datensperre nicht funktioniert. Die  Änderungen könnten eventuell nicht richtig gespeichert sein.';
$string['links'] = 'Links';
...
$string['nomanagecommentpermission'] = 'Keine Berechtigung zur Kommentarverwaltung';
$string['nomanagewikipermission'] = 'Keine Berechtigung zur Wikiverwaltung';
$string['noorphanedpages'] = 'Keine unverlinkten Seiten';
$string['nooverridelockpermission'] = 'Keine Berechtigung zum Ändern der Datensperre';
...
$string['noviewcommentpermission'] = 'Keine Berechtigung zur Kommentaranzeige';
$string['noviewpagepermission'] = 'Keine Berechtigung zur Seitenanzeige';
$string['nwiki'] = 'NWiki';
