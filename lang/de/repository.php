...
/**
 * Strings for component 'repository', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   repository
...
$string['activaterep'] = 'Aktivierte Dateiverwaltung';
$string['activerepository'] = 'Verfügbare Dateiverwaltung';
$string['activitybackup'] = 'Aktivitätssicherung';
$string['add'] = 'Hinzufügen';
$string['addfile'] = 'Datei hinzufügen';
$string['addplugin'] = 'Dateiverwaltungs-Plugin hinzufügen';
...
$string['commonrepositorysettings'] = 'Einstellungen für Dateiverwaltung';
...
$string['confirmdelete'] = 'Sind Sie sicher, dass Sie den Dateiverwaltungs- Typ {$a} löschen möchten?';
$string['confirmdeletefile'] = 'Sind Sie sicher, dass Sie diese Datei löschen möchten?';
$string['confirmremove'] = 'Sind Sie sicher, dass Sie das Dateiverwaltungs-Plugin mit seinen Optionen und <strong>allen Instanzen</strong> löschen möchten? - {$a}';
...
$string['createinstance'] = 'Dateiverwaltungsinstanz erstellen';
$string['createrepository'] = 'Dateiverwaltungsinstanz erstellen';
$string['createxxinstance'] = 'Instanz \'{$a}\' erstellen';
$string['date'] = 'Datum';
$string['deleted'] = 'Dateiverwaltungstyp gelöscht';
$string['deleterepository'] = 'Dateiverwaltungstyp löschen';
...
$string['editrepositoryinstance'] = 'Dateiverwaltungsinstanz ändern';
$string['emptylist'] = 'Leere Liste';
$string['emptytype'] = 'Dateiverwaltungstyp kann nicht erstellt werden - kein Name angegeben';
$string['enablecourseinstances'] = 'Nutzer/innen erlauben, einen Dateiverwaltungstyp zum Kurs hinzuzufügen';
$string['enableuserinstances'] = 'Nutzer/innen erlauben, einen Dateiverwaltungstyp auf Nutzerebene hinzuzufügen';
...
$string['errorpostmaxsize'] = 'Die ausgewählte Datei könnte größer sein als die Einstellung post_max_size in der Datei php.ini';
...
$string['instances'] = 'Dateiverwaltungsinstanzen';
$string['instancesforcourses'] = '{$a} kursweite offene Instanzen';
$string['instancesforsite'] = '{$a} website-weite offene Instanzen';
...
$string['invalidplugin'] = 'Ungültiges Dateiverwaltungsplugin {$a}';
$string['invalidrepositoryid'] = 'Ungültige Dateiverwaltungs-ID';
...
$string['nofilesavailable'] = 'Keine Dateien verfügbar';
...
$string['nopermissiontoaccess'] = 'Kein Zugriffsrecht für diesen Dateiverwaltungsytp';
$string['norepositoriesavailable'] = 'Keine Ihrer aktuellen Dateiverwaltungen kann Dateien im nötigen Format liefern';
...
$string['notyourinstances'] = 'Sie können Dateiverwaltungs-Instanzen anderer Nutzer/innen nicht einsehen oder ändern';
...
$string['personalrepositories'] = 'Verfügbare Dateiverwaltungstypen';
$string['plugin'] = 'Dateiverwaltungs-Plugins';
$string['pluginerror'] = 'Fehler im Dateiverwaltungs-Plugin';
...
$string['removed'] = 'Dateiverwaltungstyp entfernt';
$string['renameto'] = 'Umbenennen nach';
...
$string['usercontextrepositorydisabled'] = 'Sie können diesen Dateiverwaltungstyp nicht auf Nutzerebene bearbeiten';
