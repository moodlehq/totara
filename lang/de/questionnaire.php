...
/**
 * Strings for component 'questionnaire', language 'de', branch 'MOODLE_22_STABLE'
 *
...
$string['additionalinfo'] = 'Zusatzinformation';
$string['addnewquestion'] = 'Frage {$a} hinzufügen';
$string['addselqtype'] = 'Gewählten Fragetyp hinzufügen';
$string['alignment'] = 'Anordnung der Radio Buttons';
$string['alignment_help'] = 'Anordnung auswählen: senkrecht (standard) oder waagerecht';
$string['all'] = 'Alles';
$string['alreadyfilled'] = 'Sie haben diese Befragung bereits ausgefüllt {$a}. Vielen Dank.';
$string['anonymous'] = 'Anonym';
$string['average'] = 'Durchschnitt';
$string['averagerank'] = 'Durchschnittsbewertung';
$string['bodytext'] = 'Anleitung';
$string['boxesnbexact'] = 'genau {$a} Box(es)';
$string['boxesnbmax'] = 'maximal {$a} Box(es)';
$string['boxesnbmin'] = 'minimal {$a} Box(es)';
$string['by'] = 'von';
$string['checkallradiobuttons'] = 'Prüfen Sie bitte <strong>{$a}</strong> Radio Buttons!';
$string['checkboxes'] = 'Check Boxes';
$string['closed'] = 'Die Befragung wurde am {$a} beendet.';
...
$string['contentoptions'] = 'Optionen für den Inhalt';
...
$string['downloadtextformat'] = 'In diesem Format herunterladen';
...
$string['email'] = 'E-Mail';
$string['errnewname'] = 'Name bereits vorhanden. Ändern Sie bitte den Namen.';
...
$string['missingquestion'] = 'Fehler! Beantworten Sie die Frage:';
$string['missingquestions'] = 'Fehler! Beantworten Sie die Fragen:';
$string['modulename'] = 'Befragung';
$string['modulenameplural'] = 'Befragung';
$string['move'] = 'Diese Frage bewegen';
$string['movedn'] = 'Frage nach unten';
$string['movehere'] = 'Frage hierher bewegen';
$string['moveup'] = 'Frage nach oben';
$string['myresponses'] = 'Alle meine Antworten';
$string['myresponsetitle'] = 'Meine Antworten: {$a}';
...
$string['notopen'] = 'Die Befragung ist ab {$a} verfügbar.';
$string['num'] = '#';
...
$string['private'] = 'Persönlich';
$string['public'] = 'Öffentlich';
$string['qtype'] = 'Typ';
$string['qtypedaily'] = 'täglich ausfüllen';
...
$string['qtypemonthly'] = 'monatlich ausfüllen';
$string['qtypeonce'] = 'einmal ausfüllen';
$string['qtypeunlimited'] = 'mehrfach ausfüllen';
$string['qtypeweekly'] = 'wöchentlich ausfüllen';
...
$string['resume'] = 'Sichern und weitermachen';
...
$string['sectiontext'] = 'Textfeld';
$string['sendemail'] = 'E-Mail senden';
$string['settings'] = 'Einstellungen';
$string['settingssaved'] = 'Einstellungen gesichert';
$string['strfdate'] = '%d.%m.%Y';
$string['strfdateformatcsv'] = 't.m.j h:m:s';
...
$string['surveyresponse'] = 'Antwort aus der Befragung';
$string['template'] = 'Vorlage';
$string['text'] = 'Fregetext';
...
$string['thank_head'] = 'Danke für die Mitarbeit bei der Befragung';
$string['theme'] = 'Thema';
...
$string['viewyourresponses'] = 'Meine Antworten: {$a}';
