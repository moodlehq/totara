...
/**
 * Strings for component 'theme_brick', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   theme_brick
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'Um das Logo zu ändern, geben Sie die URL zu einem neuen Logo in der Form  http://www.domain.de/verzeichnis/logo.png an. Das Standardlogo ist 265px breit und 60px hoch. Am besten funktioniert ein transparentes Logo im Format PNG.';
