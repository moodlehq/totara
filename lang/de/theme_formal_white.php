...
/**
 * Strings for component 'theme_formal_white', language 'de', branch 'MOODLE_22_STABLE'
 *
...
$string['creditstomoodleorgdesc'] = 'Kleines Moodle-Logo unten auf der Seite zeigen';
...
$string['frontpagelogo'] = 'Eigenes Logo auf der Startseite';
$string['frontpagelogodesc'] = 'Um das Logo auf der Startseite zu ändern, geben Sie die URL zu einem neuen Logo in der Form http://www.domain.de/verzeichnis/logo.png an. Das Standardlogo ist 300px breit und 80px hoch. Am besten funktioniert ein transparentes Logo im Format PNG.';
...
$string['logo'] = 'Eigenes Logo';
$string['logodesc'] = 'Um das Logo in diesem Design zu ändern, geben Sie die URL zu einem neuen Logo in der Form http://www.domain.de/verzeichnis/logo.png an. Das Standardlogo ist 200px breit und 50px hoch. Am besten funktioniert ein transparentes Logo im Format PNG.';
