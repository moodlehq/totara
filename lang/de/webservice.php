...
/**
 * Strings for component 'webservice', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   webservice
...
$string['accesstofunctionnotallowed'] = 'Zugriff zur Funktion  {$a}() istnicht zugelassen. Prüfen Sie, ob ein Service mit dieser Funktion deaktiviert wurde. Falls dies der Fall ist, prüfen sie, ob der Nutzer aufgelistet ist . Prüfen Sie in den Einstellungen des Service auch, ob die  IP-Adresse eingeschränkt oder der Service eine Berechtigung benötigt.';
...
$string['cannotgetcoursecontents'] = 'Kann nicht auf Kursinhalte zugreifen';
...
$string['downloadfiles'] = 'Kann Dateien downloaden';
$string['downloadfiles_help'] = 'Wenn die Funktion aktiv ist kann jeder Nutzer Dateien mit Sicherheitsschlüssel herunterladen. Sie sind jedoch beschränkt auf die Dateien mit denen Sie verbunden sind.';
$string['editaservice'] = 'Service bearbeiten';
$string['editservice'] = 'Service bearbeiten: {$a->name} (id: {$a->id})';
$string['enabled'] = 'Aktiviert';
$string['enabledirectdownload'] = 'Der Download für WebService Dateien muss in den Einstellungen für externe Dienste aktiviert sein';
...
$string['protocolnotallowed'] = 'Sie sind nicht berechtigt das {$a}-Protokoll zu verwenden (fehlende Berechtigung: webservice/{$a}:use)';
