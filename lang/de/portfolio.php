...
/**
 * Strings for component 'portfolio', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   portfolio
...
$string['leap2a_overwritingselection'] = 'Überschreiben des bestehenden Eintrags ({$a)} für Auswahl in make_selection';
