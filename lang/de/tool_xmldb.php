...
/**
 * Strings for component 'tool_xmldb', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   tool_xmldb
...
$string['yesmissingindexesfound'] = 'Einige fehlende Indizes wurden in Ihrer Datenbank gefunden. Es folgen genauere Einzelheiten und die nötigen SQL-Anweisungen, die Sie mit Ihrem bevorzugten SQL-Werkzeug ausführen müssen, um alle Indizes zu erzeugen.Sichern Sie Ihre Daten unbedingt bevor Sie fortfahren.<br /><br /> Es wird dringend empfohlen, die Suche nach fehlenden Indizes danach noch einmal auszuführen.';
