...
/**
 * Strings for component 'moodle', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['adminhelpassignstudents'] = 'Gehen Sie in einen Kurs und fügen Sie die Teilnehmer/innen über den Einstellungsblock hinzu.';
...
$string['coursehelpcategory'] = 'Kursreihenfolge festlegen und den Teilnehmer/innen das Auffinden erleichtern';
...
$string['coursehelpnewsitemsnumber'] = 'Anzahl der im Nachrichtenblock auf der Kursseite gezeigten Einträge<br />(0 bedeutet, dass der Nachrichtenblock nicht angezeigt wird)';
...
$string['duplicateconfirm'] = 'Sind Sie sicher, dass Sie {$a->modtype} \'{$a->modname}\' duplizieren möchten?';
$string['duplicatecontcourse'] = 'Zurück zum Kurs';
$string['duplicatecontedit'] = 'Neue Kopie bearbeiten';
$string['duplicatenosupport'] = 'Die Aktivität \'{$a->modname}\' konnte nicht dupliziert werden, weil das Modul {$a->modtype} keine Sicherung und Wiederherstellung unterstützt.';
...
$string['forcedmodeinbrackets'] = '{$a} (nicht änderbar)';
...
$string['formattext'] = 'Totara-Text-Format';
...
$string['gravatarenabled'] = '<a href="http://www.gravatar.com/">Gravatar</a> wurde für diese Website aktiviert. Wenn Sie kein Profilbild hochladen, wird Moodle versuchen, für Sie ein Profilbild von Gravatar zu laden.';
$string['group'] = 'Gruppe';
...
$string['nopotentialcreators'] = 'Niemand kann zum/zur Kursersteller/in ernannt werden.';
...
$string['notenrolledprofile'] = 'Dieses Profil ist nicht verfügbar, weil die Person bisher den Kurs noch nicht betreten hat.';
...
$string['resetinfo'] = 'Diese Seite ermöglicht es Ihnen, nutzerspezifische Daten und Beiträge aus dem Kurs zu entfernen. Alle anderen Daten (Arbeitsmaterialien, Aktivitäten, Einstellungen) bleiben erhalten.
...
$string['rolerenaming_help'] = 'Mit dieser Option können die Namen der Rollen in Ihrem Kurs umbenannt werden. Wenn Sie z.B. \'Trainer/in\' in \'Dozent/in\' für den aktuellen Kurs umbenennen wollen, tragen Sie dies hier ein. Die Rollenberechtigungen werden durch das Umbenennen nicht verändert. Die geänderten Rollenbezeichnungen sind in der Nutzerliste und an anderen Stellen des Kurses zu sehen. Wenn Sie die Rolle "Trainer/in" umbennnen, wird der neue Rollenname auch in der Kursliste gezeigt.';
$string['roles'] = 'Rollen';
...
$string['someallowguest'] = 'Einige Kurse lassen auch Gäste zu';
...
$string['switchdevicerecommended'] = 'Zum empfohlenen Design für dieses Gerät wechseln';
