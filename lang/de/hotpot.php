...
/**
 * Strings for component 'hotpot', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   hotpot
...
$string['activityopens'] = 'Aktivität beginnt';
...
$string['exitgrade'] = 'Nächste Wertung';
...
$string['hints'] = 'Tipps';
$string['hotpot:addinstance'] = 'HotPot hinzufügen';
...
$string['outputformat_hp_6_jcloze_xml_v6_autoadvance'] = 'JCloze HP6 xml: Auto-Advance';
...
$string['outputformat_hp_6_jmix_xml_v6_plus_deluxe'] = 'JMix HP6 xml: Prefix, Suffix mit Distractors';
...
$string['outputformat_html_ispring'] = 'iSpring-Datei';
$string['outputformat_html_xerte'] = 'Xerte-Datei';
$string['outputformat_html_xhtml'] = 'HTML-Datei';
...
Weitere Information zum Hochladen von Qedoc-Modulen finden Sie unter: [Qedoc documentation: Uploading_modules](http://www.qedoc.org/en/index.php?title=Uploading_modules)';
