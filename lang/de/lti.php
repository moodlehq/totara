...
/**
 * Strings for component 'lti', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   lti
...
$string['basiclti_parameters'] = 'LTI Start Parameter';
...
$string['basicltisettings'] = 'Basiseinstellungen für Learning Tool Interoperability (LTI)';
...
* **|Standardeinstellung** - Startcontainer wie in Tool-Konfiguration festgelegt verwenden. 
...
* **|Neues Fenster** - Das Tool öffnet in einem neuen Fenster und nutzt den gesamten Raum im Fenster aus. Abhängig vom Browser wird ein neuer Tab angelegt oder ein neues Fenster geöffnet. es ist möglich, dass Browser das Öffnen eines neuen Fenster behindern und einen Hinweis anzeigen.';
...
$string['display_name_help'] = 'Der Aktivitätenname kann über dem Inhalt des Toolanbieters angezeigt werden. Es ist auch möglich, das der Toolanbieter den Namen direkt anzeigt. Die Option kann damit eine doppelte Anzeige verhindern. Die Titelanzeige ist nicht verfügbar wenn das Tool in einem neuen Fenster geöffnet wird.';
...
$string['extensions'] = 'LTI Erweiterungen-Service';
...
$string['icon_url_help'] = 'Die unktion Icon URl ermöglich es, das für die Aktivität verwandte Icon auszutauschen. An Stelle des Standard LTI Icons kann ein Icon, das zur eingebundenen Aktivität passt, gewählt werden.';
$string['id'] = 'ID';
$string['imsroleadmin'] = 'Trainer/in, Administrator/in';
$string['imsroleinstructor'] = 'Trainer/in';
$string['imsrolelearner'] = 'Teilnehmer/in';
...
$string['lti_launch_error_unsigned_help'] = 'Der Fehler kann seine Ursache in einem fehlenden Anwenderschlüssel und Sicherheitseinstellungen für den Toolanbieter haben
WennSie einen Anwenderschlüssel und Daten für die Sicherheitskonfiguration haben, geben Sie diese bei den Einstellungen für das externe Tool ein. Beachten Sie auch die erweiterten Einstelloptionen.
Alternativ können Sie auch eine kursweite Konfiguration für den Tool-Anbieter anlegen. Klicken Sie dazu
[hier] ({$a->course_tool_editor}).';
...
Wenn dies der Fall ist, kann der Administrator ein solches externes System systemweit in Moodle zur Nutzung zur Verfügung stellen. Trainer können es auch direkt für einen einzelnen Kurs einbinden. Der Tool Anbieter versorgt Sie mit Informationen zur Einbindung und den entsprechenden Daten zur Konfiguration.
Die Einbindung von externe Tools unterscheidet sich von der Verlinkung zu einer Webseite:
* **|Kontextbezug** - Das externe Tool erhält von Moodle Informationen über den Nutzer wie Name, Mail, Institution u.a.
* **|Integration** - externe Tools können Bewertungsdaten in Moodle lesen, aktualisieren oder löschen, die mit der Lernaktivitäteninstanz verbunden sind. Weitere Integrationsarten sind künftig geplant.
* **|Sicherheit** - Die Konfiguration ermöglicht eine verschlüsselte Verbindung der Übertragung der Daten zwischen Moodle und dem Tool-Anbieter.';
...
$string['password_admin'] = 'Kennwort';
...
$string['press_to_submit'] = 'Klicken zum Statrt der Aktivität';
...
$string['send'] = 'Senden';
$string['setdefault'] = 'Standardwert für Trainer setzen';
$string['setupbox'] = 'LTI Tool Setupbox';
...
$string['toolurl_help'] = 'Die Basis URL des Toolos wird verwendet um die Start URLs mit der korrekten Konfiguration zu verknüpfen. Die Verwendung von http(s) am Beginn ist optional. Die Basis URL wird auch verwandt wenn das Tool keine separate Start URL zur Verfügung stellt.
| **Basis URL** | **Zuordnung** |
||
...
| quiz.tool.com | quiz.tool.com, quiz.tool.com/take.php?id=10 | Falls zwei unterschiedliche Tool-Konfigurationen für die gleiche Domain vorhanden sind wird die spezifischere verwandt.';
