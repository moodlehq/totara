...
/**
 * Strings for component 'message', language 'de', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['addsomecontacts'] = 'Um eine Mitteilung an jemanden zu versenden oder einen Kurzlink zu erstellen, verwenden Sie die <a href="{$a}">Suchoption </a>.';
...
$string['backupmessageshelp'] = 'Wenn diese Option aktiviert ist, werden die Mitteilungen in die automatisierten Sicherungen einbezogen';
...
$string['disableall'] = 'Benachrichtungen zeitweise ausschalten';
$string['disableall_help'] = 'Zeitweise alle Benachrichtungen ausschalten. ausgenommen sind nur solche, die durch den Admin als \'vorgegeben\' markiert wurden.';
$string['disabled'] = 'Bei dieser Website sind die Mitteilungen deaktiviert';
$string['disallowed'] = 'Verboten';
...
$string['errortranslatingdefault'] = 'Fehler beim Übersetzen der Plugin-Einstellung. Ab sofort werden stattdessen die Systemeinstellungen benutzt.';
$string['forced'] = 'Vorgegeben';
...
$string['keywordssearchresultstoomany'] = 'Mehr als {$a} Mitteilungen gefunden - verfeinern Sie Ihre Suche.';
...
$string['mailsent'] = 'Ihre Mitteilung wurde als E-Mail versandt.';
...
$string['messageoutputs'] = 'Nachrichtenversand';
...
$string['notpermitted'] = 'Nicht zulässig';
