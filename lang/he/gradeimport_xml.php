...
/**
 * Strings for component 'gradeimport_xml', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['errbadxmlformat'] = 'שגיאה - תסדיר קובץ XML פגום';
...
$string['errincorrectgradeidnumber'] = 'שגיאה - מספר id \'{$a}\' מקובץ היבוא לא מותאם לאף רכיב ציון.';
...
$string['error'] = 'התרחשה שגיאה';
$string['fileurl'] = 'קובץ URL מרוחק';
$string['pluginname'] = 'יבוא קובץ XML';
