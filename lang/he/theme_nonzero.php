...
/**
 * Strings for component 'theme_nonzero', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['configtitle'] = 'הגדרות Nonzero';
$string['customcss'] = 'CSS מותאם';
$string['customcssdesc'] = 'כל CSS שיוסף כאן יוסף לכל דף ויאפשר לך לבצע התאמה נוחה לערכה זאת.';
$string['pluginname'] = 'Nonzero';
$string['region-side-post'] = 'ימין';
$string['region-side-pre'] = 'שמאל';
$string['regionpostwidth'] = 'רוחב עמודה ימנית';
$string['regionpostwidthdesc'] = 'הגדרת הרוחב של אזור היוצר את העמודה הימנית.';
$string['regionprewidth'] = 'רוחב עמודה שמאלית';
$string['regionprewidthdesc'] = 'הגדרת הרוחב של אזור היוצר את העמודה השמאלית. העמודה מוצגת במרכז הדף כאשר היא משתמשת בתכנית רשומון.';
