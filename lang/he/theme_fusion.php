...
/**
 * Strings for component 'theme_fusion', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['configtitle'] = 'הגדרות Fusion';
$string['customcss'] = 'CSS מותאם';
$string['customcssdesc'] = 'כל CSS שירשם כאן יוסף לכל דף ויאפשר לבצע התאמה נוחה לערכה זאת.';
$string['footertext'] = 'טקסט שולים';
$string['footertextdesc'] = 'הגדרת הערת שוליים או טקסט שוליים.';
$string['linkcolor'] = 'צבע קישורית';
$string['linkcolordesc'] = 'הגדרת צבע הקישורית בערכה.';
$string['pluginname'] = 'Fusion';
$string['region-side-post'] = 'ימין';
$string['region-side-pre'] = 'שמאל';
$string['tagline'] = 'Tagline';
$string['taglinedesc'] = 'שורה קצרה שתוצג מתחת לשם האתר על הדף הקדמי. <br />';
