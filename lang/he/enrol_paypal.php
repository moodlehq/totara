...
/**
 * Strings for component 'enrol_paypal', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['currency'] = 'שער מטבע';
$string['defaultrole'] = 'ברירת מחדל של הקצאת התפקיד';
$string['defaultrole_desc'] = 'בחר תפקיד אשר יוקצה למשתמשים בזמן רישום ה- PayPal';
$string['enrolenddate'] = 'תאריך סיום';
$string['enrolenddate_help'] = 'אם מאופשר, משתמשים יוכלו להירשם עד תאריך זה בלבד.';
$string['enrolenddaterror'] = 'תאריך סיום ההרשמה לא יכול להיות מוקדם מתאריך ההתחלה';
$string['enrolperiod'] = 'תקופת הרישום';
$string['enrolperiod_desc'] = 'ברירת מחדל לתקופת הרישום (בשניות). אם מסומן ערך 0 (אפס) , תקופת הרישום תיהיה בלתי מוגבלת כברירת מחדל';
...
$string['enrolstartdate_help'] = 'אם מאופשר, משתמשים יוכלו להיות רשומים מתאיך זה והלאה בלבד.';
$string['mailadmins'] = 'הודעה למנהל';
$string['mailstudents'] = 'הודעה לסטודנטים';
...
$string['status'] = 'אפשר הרשמות  PayPal';
$string['status_desc'] = 'אפשר משתמשים להשתמש ב-PayPal להירשם לקורס כברירת מחדל.';
$string['unenrolselfconfirm'] = 'האם הינך בטוח כי  ברצונך להסיר עצמך מרישום לקורס "{$a}"?';
