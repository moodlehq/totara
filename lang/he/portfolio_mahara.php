...
$string['err_nomnethosts_help'] = 'תוסף זה תלוי בעמיתים של MNET עם SSO IDP שפורסמו, מינויים ל SSO_SP ותיק העבודות מנוי <b>ומפורסם</b> וכן תוסף האימות של mnet. כל המקרים של התוסף הוצבו כנסתרים מצפיה עד שנושא זה יטופל ואז יהיה עליך להגדירם מחדש, באופן ידני, כברי צפיה. לא ניתן להשתמש בהם עד שכל האמור לעיל יבוצע.';
