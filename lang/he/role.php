...
<p>ניתן להשתמש בעקיפות גם כדי \'לפתוח\' איזורים באתר ובקורסים שלכם במטרה לתת למשתמשים היתרים נוספים. לדוגמא, יכול להיות שתירצו להתנסות ולתת לסטודנטים את היכולת לבדוק, להעריך ולתת ציון למטלות מסויימות.
</p>
...
<p> הרשאות הן ההגדרות שאתם מעניקים ליכולות מסויימות.
</p>

<p>לדוגמא, יכולת אחת היא "פתח בדיונים חדשים" (בפורומים).
</p>
...
<p> שימו לב שלרוב חשבון משתמש אורח לא יוכל לפרסם תוכן (לדוגמא פורומים, רשומות בלוח השנה, בלוגים) אפילו אם ניתנת לו היכולת לעשות זאת.
</p>
