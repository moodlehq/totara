...
/**
 * Strings for component 'glossary', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   glossary
...
$string['allowprintview_help'] = '<p align="center"><b>אפשר ראיית גירסה להדפסה</b></p>

<p>ניתן לאפשר לסטודנטים לראות את גרסת ההדפסה של אגרון המונחים.</p>

<p>אתם יכולים לבחור אם להפעיל את התכונה הזו או למנוע אותה.</p>

<p>המורים תמיד יכולים להשתמש בגרסה להדפסה.</p>';
...
$string['cnfdefaulthook'] = 'הגדר את המבחר שיוצג לפי ברירת המחדל כאשר מעיינים לראשונה באגרון המונחים.';
$string['cnfdefaultmode'] = 'הגדר את המבנה שיוצג לפי ברירת המחדל כאשר מעיינים לראשונה באגרון המונחים.';
...
$string['cnfrelatedview'] = 'הגדר את מבנה התצוגה שישמש ליצירת קישורים אוטומטיים וצפיה בערכים.';
...
<p>אם האפשרות ליצירת קישורים באופן אוטומטי מופעלת, אז הפעלה של ההגדרה הזו תאולץ קישורים רק על מילים מלאות.</p>
...
$string['modulename_help'] = 'רכיב אגרון מונחים זה מאפשר למשתתפים ליצור ולתחזק רשימת הגדרות כמו מילון.
מונחי האגרון יכולים להיות מקושרים באופן אוטומטי לכל מושג או מילה  וצירוף המילים או הביטוי יופיע באורך הקורס כולו.';
...
$string['showall_help'] = '<p align="center"><b>אפשרויות גלישה בתצוגה לפי סדר האלף-בית</b></p>

<p>אתם יכולים להתאים אישית את גלישת המשתמש באגרון המונחים. שתי אפשרויות שתמיד זמינות הן גלישה ועריכת חיפוש, אבל אתם יכולים להגדיר שלוש אפשרויות נוספות:</p>

<p><b>הראה מיוחד</b> אפשר או מנע גלישה באמצעות תווים מיוחדים כמו @, #, וכו\'.</p>

<p><b>הראה אלף-בת</b> אפשר או מנע גלישה באמצעות אותיות האלף-בת.</p>

<p><b>הראה הכל</b> אפשר או מנע גלישה בכל הרשומות בבת אחת.</p>';
$string['showalphabet'] = 'הצג סרגל ניווט ה"אלף-בית"';
$string['showalphabet_help'] = '<p align="center"><b>אפשרויות גלישה בתצוגה לפי סדר האלף-בית</b></p>
...
$string['showspecial_help'] = '<p align="center"><b>אפשרויות גלישה בתצוגה לפי סדר האלף-בית</b></p>
...
$string['standardview'] = 'עיון לפי האלף-בית';
$string['studentcanpost'] = 'סטודנטים יכולים להוסיף מונחים';
$string['totalentries'] = 'כלל המונחים';
$string['usedynalink'] = 'צור קישורים באופן אוטומטי לאגרון המונחים';
