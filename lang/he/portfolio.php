...
/**
 * Strings for component 'portfolio', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   portfolio
...
$string['addalltoportfolio'] = 'ייצא הכל לתיק עבודות';
$string['addnewportfolio'] = 'הוספת תיק עבודות חדש';
$string['addtoportfolio'] = 'יצוא לתיק עבודות';
$string['alreadyalt'] = 'תהליך היצוא פועל כעת - אנא לחץ כאן לפתירת העברה זו';
...
$string['confirmcancel'] = 'האם הינך בטוח כי ברצונך לבטל את היצוא?';
$string['confirmexport'] = 'אנא אשר את יצוא זה';
$string['confirmsummary'] = 'סיכום היצוא שלך';
$string['continuetoportfolio'] = 'המשך אל תיק העבודות שלך';
$string['deleteportfolio'] = 'מחק מופע תיק העבודות';
$string['destination'] = 'יעד';
$string['disabled'] = 'לצערנו יצוא תיקי עבודות לא מאופשר באתר זה';
$string['disabledinstance'] = 'אל תאפשר';
$string['displayarea'] = 'יצוא איזור';
$string['displayexpiry'] = 'זמן פקיעת העברה';
$string['displayinfo'] = 'יצוא מידע';
$string['dontwait'] = 'אל תחכה';
$string['enabled'] = 'אפשר תיק עבודות';
$string['enableddesc'] = 'הדבר יאפשר למנהלי מערכת להגדיר מערכות מרוחקות עבור משתמשים ליצוא תוכן ל';
$string['err_uniquename'] = 'שם תיק העבודות חייב להיות חד ערכי (לכל תוסף)';
...
exporter object';
$string['exportexpired'] = 'יצוא תיק העבודות פג תוקף';
...
$string['exportqueued'] = 'יצוא תיק העבודות התבצע בהצלחה, נכנס לתור העברות';
$string['exportqueuedforced'] = 'יצוא תיק העבודות התבצע בהצלחה, נכנס לתור העברות (מערכות מרוחקות אילצו מעבר לתור)';
$string['failedtopackage'] = 'לא ניתן היה למצוא קבצים לארוז';
$string['failedtosendpackage'] = 'נכשל בנסיון לשליחת המידע למערכת תיק העבודות שנבחרה: שגיאה מקורית הייתה
{$a}';
...
$string['format_leap2a'] = 'תסדיר Leap2A תיק העבודות';
...
$string['insanesubject'] = 'מספר מופעי תיקי עבודות נוטרלו אוטומטית';
$string['instancedeleted'] = 'תיק העבודות נמחק בהצלחה';
$string['instanceismisconfigured'] = 'מופע תיק העבודות גדר כהלכה, מדלג. שגיאה הייתה : {$a}';
$string['instancenotdelete'] = 'נשכל בנסיון מחיקת תיק העבודות';
$string['instancenotsaved'] = 'נכשל בנסיון שמירת תיק העבודות';
...
$string['invalidformat'] = 'משהו מייצא תסדיר שאינו תקף , {$a}';
$string['invalidinstance'] = 'לא ניתן למצוא את מופע תיק עבודות זה';
...
קובץ או קבצים רבים מוכרחים להיות מוגדרים';
$string['invalidtempid'] = 'id היצוא לא תקף. יתכן כי הוא פג תוקף';
...
$string['manageyourportfolios'] = 'נהל את תיקי העבודות שלך';
$string['mimecheckfail'] = 'תוסף תיק העבודות
{$a->plugin}
...
ב- portfolio_button';
$string['nocommonformats'] = 'תסדירים לא נפוצים בין כל תוסף של תיק עבודות זמין
ומיקום הקריאה {$a->location} (caller supported {$a->formats})';
$string['noinstanceyet'] = 'לא נבחר עדיין';
$string['nologs'] = 'אין דוחות מעקב להצגה!';
$string['nomultipleexports'] = 'לצערנו , יעד התיק העבודות ({$a->plugin})  לא תומך ביצוא מרובה באותו זמן, אנא
<a href="{$a->link}">סיים את היצוא הראשון קודם לכן</a>
ונסה שנית';
$string['nonprimative'] = 'הוכנס ערך לא פשוט כcallback  למשתנה
portfolio_add_button.
לא ניתן להמשיך. המפתח היה {$a->key} והערך הוא {$a->value}';
$string['nopermissions'] = 'לצערנו, אין לך הרשאות מתאימות לייצא את הקבצים במאיזור זה.';
$string['notexportable'] = 'לצערנו , סוג הקבצים אשר אותו אתה מנסה לייצא לא ניתן ליצוא.';
$string['notimplemented'] = 'הינך מנסה לייצא תוכן בתסדיר שאיננו ידוע או לא מיושם עדיין
({$a})';
...
$string['pluginismisconfigured'] = 'תוסף תיק העבודות לא מוגדר כהלכה. מדלג, שגיאה ב-{$a}';
$string['portfolio'] = 'תיק עבודות';
$string['portfolios'] = 'תיקי עבודות';
$string['queuesummary'] = 'העברות שנמצאות בתור כרגע';
$string['returntowhereyouwere'] = 'חזור להיכן שהיית';
$string['save'] = 'שמירה';
