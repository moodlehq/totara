...
/**
 * Strings for component 'qtype_multianswer', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['layoutselectinline'] = 'תפריט נפתח עם חלקים מסודרים בשורה בטקסט';
...
<li> שנה את סוג השאלה (מספרי, תשובה-קצרה, מרובת-בחירה).
<li>
</ul>';
...
<br>
אנא חפש';
$string['questionusedinquiz'] = 'משתמשים בשאלה ב-{$a->nb_of_quiz} בוחנים, מספר הנסיונות הכולל הוא: {$a->nb_of_attempts}';
...
$string['youshouldnot'] = '<b>אל תעשה זאת</b>';
