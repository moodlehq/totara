...
/**
 * Strings for component 'moodle', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['activitymodules'] = 'רכיבי פעילות';
...
$string['addcountertousername'] = 'צור משתמש ע"י הוספת מספר לקורס';
...
$string['adminhelpassignstudents'] = 'להיכנס לקורס ולהוסיף סטודנטים מתפריט המנהל';
...
$string['adminhelpmanageblocks'] = 'נהל משבצות מותקנות והגדרות שלהן';
...
$string['administratordescription'] = 'מנהלים יכולים בד"כ לעשות הכל באתר זה, בכל הקורסים.';
$string['administrators'] = 'מנהלים';
$string['administratorsall'] = 'כל המנהלים';
$string['administratorsandteachers'] = 'מנהלים ומורים';
$string['advanced'] = 'הצג ב"הגדרות נוספות"';
...
$string['availability_help'] = 'ההגדרות האלו קובעות עם הקורס יפיע או לא יופיע ברשימת הקורסים.פרט למרצים / מורים ומנהלים לא מורשים משתמשים אחרים להכנס לקורס.';
...
$string['backup'] = 'גיבוי';
$string['backupactivehelp'] = 'בחר האם לעשות גיבויים ממוכנים, או לא';
...
$string['backupexecuteathelp'] = 'בחר מתי להריץ את הגיבויים הממוכנים';
...
$string['backupincludemoduleshelp'] = 'בחר האם אתה רוצה לכלול את המודולים של הקורס, עם או ללא נתוני משתמש, בגיבויים אוטומטיים';
$string['backupincludemoduleuserdatahelp'] = 'בחר האם אתה רוצה לכלול מודול נתוני משתמש בגיבויים הממוכנים.';
...
$string['block'] = 'משבצת';
$string['blockconfiga'] = 'הגדרות תצורת משבצת {$a}';
$string['blockconfigbad'] = 'משבצת זה לא מומש כהלכה ולכן הוא לא יכול לספק ממשק הגדרות.';
$string['blockdeleteconfirm'] = 'אתה עומד למחוק לחלוטין את המשבצת (בלוק) \'{$a}\'. פעולה זו תמחוק לחלוטין את כל מה שקשור למשבצת (בלוק) זו בבסיס הנתונים. האם אתה בטוח שאתה רוצה לעשות זאת?';
$string['blockdeletefiles'] = 'כל המידע הקשור למשבצת \'{$a->block}\' (בלוק) נמחק ממסד הנתונים. להשלמת המחיקה (ומניעת האפשרות ממשבצת זו להתקין את עצמה מחדש), עליך למחוק כעת את הספריה {$a->directory} מהשרת.';
$string['blocks'] = 'משבצות (בלוקים)';
$string['blocksaddedit'] = 'עריכתהוספת משבצות';
...
מתנתקים מהמערכת או כשאתם סוגרים את הדפדפן העוגייה הזו נהרסת (בן על הדפדפן והן על
השרת שלכם). </span></p>
...
$string['courseapprovedemail2'] = 'הקורס שבקשת, {$a->name}, אושר. בכדי לגשת לקורס החדש שלך, לך ל-{$a->url}';
...
$string['coursecreatorsdescription'] = 'יוצרי קורס יכולים ליצור קורסים חדשים וללמד בהם';
...
$string['coursehelpforce'] = 'אלץ מצב קבוצה של הקורס לכל פעילות בקורס.';
$string['coursehelpformat'] = 'דף הבית של הקורס יוצג במבנה זה.';
$string['coursehelphiddensections'] = 'כיצד קטעים מוסתרים בקורס מוצגים לסטודנטים.';
$string['coursehelpmaximumupload'] = 'הגדר את הגודל המירבי להעלאת קובץ ע"י הסטודנטים בקורס זה, מוגבל ע"י ההגדרות הנרחבות של האתר.';
$string['coursehelpnewsitemsnumber'] = 'מספר הפריטים האחרונים המופיעים בעמוד הבית של הקורס, במשבצת חדשות בד"כ מצד ימין למטה. 0 משמעותו כי המשבצת לא תופיע.';
$string['coursehelpnumberweeks'] = 'מספר שבועותנושאים שיופיעו בדף הבית של הקורס.';
...
$string['courselegacyfiles'] = 'קבצי הקורס כפי שנוהלו במהדורות קודמות';
...
$string['courseprofiles'] = 'פרופילי הקורס';
...
$string['courserequestsupport'] = 'אנא ציינו סיבות עינייניות לקבשת פתיחת קורס זו המיועדות מנהל המערכת';
$string['courserestore'] = 'שחזר קורס';
$string['courses'] = 'קורסים';
$string['coursesectionsummaries'] = 'סיכומי קטע הקורס';
$string['coursesettings'] = 'הגדרות ברירות מחדל הקורס';
...
$string['delete'] = 'מחק';
$string['deleteablock'] = 'מחק משבצת';
$string['deleteall'] = 'מחק הכל';
$string['deleteallcannotundo'] = 'מחיקת קטגוריה וכל הקורסים לא ניתן לבטל לאחר ביצוע פעולה זו.';
...
$string['downloadall'] = 'הורד הכל';
$string['downloadexcel'] = 'שמירה כקובץ Excel';
$string['downloadfile'] = 'הורד קובץ';
...
$string['duplicateconfirm'] = 'האם הינך בטוח כי ברצונך לשכפל את {$a->modtype} \'{$a->modname}\' ?';
$string['duplicatecontcourse'] = 'בחזרה לקורס';
$string['duplicatecontedit'] = 'עריכת ההעתק החדש';
$string['duplicatesuccess'] = '{$a->modtype} \'{$a->modname}\'  שוכפל בהצלחה';
...
$string['edhelpfontlist'] = 'הגדר את הגופנים בהם השתמשו בעורכי התפריט הנפתח.';
...
$string['editmyprofile'] = 'עריכת מאפיינים';
...
$string['force'] = 'אלץ';
$string['forcedmode'] = 'אלץ מצב';
$string['forcedmodeinbrackets'] = '{$a} (מצב מוכרח)';
...
<br />
תוכנית זאת היא תוכנה חופשית: ברשותכם להפיץ אותה ווכמו כן גם לשנותה כפוף לתנאים של הרשיון הציבורי הכוללני ( GNU General Public License) כפי שפורסמו על ידי קרן התוכנה החופשית (Free Software Foundation) במהדורה 3 של הרישיון או (להחלטתכם) כל מהדורה מאוחרת יותר.
<br />
התוכנית מופצת בתקווה שהיא תהיה שימושית אולם ללא כל אחריות; אפילו ללא האחריות המרומזת של סחירות או התאמה למטרה מסוימת.
<br /<
ראו את המידע של רשיון מוודל לפרטים מלאים ב:
...
$string['groupmodeforce'] = 'אלץ מצב חלוקה לקבוצות';
...
<p>לפי ברירת המחדל, יש איזור קטן שמופיע (באופן מכווץ ולרוב באפור), כדי לציין מקום בו יש חלק נסתר, למרות שעדיין אי אפשר לראות את הפעילויות והטקסטים הנסתרים. הדבר מועיל במיוחד בתצורה השבועית, כדי לסמן באופן מאוד ברור שבועות שלא מתקיימים בהם שיעורים.
</p>
...
$string['hideshowblocks'] = 'הסתר או גלה משבצות';
$string['hidetopicfromothers'] = 'הסתר נושא מאחרים';
$string['hideweekfromothers'] = 'הסתר שבוע מאחרים';
$string['hits'] = 'תוסינכ';
$string['hitsoncourse'] = 'ןלהלש המישרבש תכרעמב שמתשמל תוסינכ';
$string['hitsoncoursetoday'] = 'ןלהלש המישרבש תכרעמב שמתשמל תוימוי תוסינכ';
$string['home'] = 'ראשי';
$string['hour'] = 'שעה';
$string['hours'] = 'שעות';
...
$string['htmleditordisabled'] = 'בפרופיל המשתמש שלך מנעת את עורך דף התוכן המעוצב';
...
$string['interestslist'] = 'רשימת תחומי עניין (מופרדים בסימן פסיק)';
...
$string['local'] = 'מקומי';
$string['localplugindeleteconfirm'] = 'אתה עומד למחוק לחלוטין את התוסף \'{$a}\'. פעולה זו תמחוק לחלוטין את כל מה שקשור לתוסף זה בבסיס הנתונים. האם אתה בטוח שאתה רוצה לעשות זאת?';
$string['localplugins'] = 'תוספות מקומיות';
$string['localpluginsmanage'] = 'נהל תוספות מקומיות';
...
$string['loginusing'] = 'גישה למערכת מחייבת זיהוי על בסיס שם משתמש וסיסמה';
$string['logout'] = 'התנתק';
...
<p> ההגדרה הזו קובעת את גודל הקובץ המירבי אותו יכולים הסטודנטים בקורס להעלות, כמובן שהדבר מוגבל על ידי הגדרת הרוחב של האתר, אותה קבע המנהל.
</p>

<p> אפשרי להגביל את הגודל הזה עוד יותר, דרך ההגדרות שנמצאות בכל מודול פעילות.
...
$string['messageselect'] = 'בחר משתמש זה כנמען דוא"ל';
...
$string['movefilestohere'] = 'הסט קבצים לכאן';
...
$string['moveselectedcoursesto'] = 'הסט הקורסים הנבחרים ל...';
$string['movetoanotherfolder'] = 'הסט לתיקייה אחרת';
...
<p>פורום מיוחד בשם "חדשות" מופיע בקורסים בעלי תצורת ה"נושאי" וה"שבועי". זהו מקום טוב לפרסם הודעות שמיועדות לכלל הסטודנטים. (כל הסטודנטים רשומים לפורום הזה על פי ברירת מחדל, ולכן גם יקבלו את ההודעות שלכם בדואר אלקטרוני).
</p>

<p>ההגדרה הזו קובעת את מספר הפריטים העדכניים אשר יופיעו בצידו הימני של עמוד הבית של הקורס שלכם, בתוך "קופסאת" חדשות.
</p>

<p>אם אתם קובעים "0 פרטי חדשות", אז אפילו קופסאת החדשות לא תופיע.
</p>';
...
$string['notifyloginfailuresmessageend'] = 'תוכל לעיין ביומני מעקב אלו ב: {$a}/course/report/log/index.php?id=1&amp;chooselog=1&amp;modid=site_errors';
...
$string['order'] = 'סדר';
$string['orphanedactivities'] = 'פעילויות יתומות';
$string['other'] = 'אחר';
$string['outline'] = 'סקירה';
$string['outlinereport'] = 'דוח מצומצם';
$string['page'] = 'עמוד';
...
$string['questionsinthequestionbank'] = 'שאלות במאגר השאלות';
...
$string['resourcedisplaydownload'] = 'אלץ הורדה';
...
$string['resourcedisplaypopup'] = 'בחלון הקופץ';
...
$string['returntooriginaluser'] = 'חזור ל-{$a\'}';
$string['revert'] = 'לחזור';
$string['role'] = 'תפקיד';
...
$string['savecomment'] = 'שמור את ההערה';
$string['savedat'] = 'נשמר ב:';
$string['savepreferences'] = 'שמור העדפות';
$string['saveto'] = 'שמור ב';
$string['scale'] = 'מדרגת הערכה';
$string['scale_help'] = '<p align="center"><b>סולמות (ציונים)</b></p>

<p>בידי המורים ניתנת האפשרות ליצור סולמות חדשים מותאמים אישית בהם ניתן להשתמש בקורס בכל פעילויות מתן ציון שהן.
</p>

<p>על שם הסולם להיות משפט או ביטוי שמזהה אותו במדויק: השם יופיע ברשימות בחירה של סולמות ובנוסף לכך על כפתורי עזרה הרגישים להקשרים.
</p>
...
<p>לבסוף, באתר שלכם יכולים להופיע מספר סולמות "סטנדרטיים" שהוגדרו על ידי מנהל המערכת שלכם. אלו יהיו זמינים בכל הקורסים.
</p>';
...
$string['scalestandard'] = 'סולם מערכתי';
$string['scalestandard_help'] = '<p>סולם רגיל הינו סולם אשר זמין לרוחב כל האתר עבור כל הקורסים.</p>';
...
$string['screenreaderuse_help'] = 'אם מוגדר כ"כן" , יסופק ממשק נגיש מבקומות שונים כמו צ\'אט';
...
$string['secs'] = 'שניות';
$string['section'] = 'קטע';
$string['sectionname'] = 'שם מדור';
$string['sections'] = 'קטעים';
$string['sectionusedefaultname'] = 'השתמש בברירת המחדל של שם המדור';
$string['seealsostats'] = 'ראה גם: סטטיסטיקות';
$string['select'] = 'בחר';
$string['selectacountry'] = 'בחר ארץ';
$string['selectall'] = 'בחר הכל';
$string['selectamodule'] = 'אנא בחר במודול פעילות כלשהי';
$string['selectaregion'] = 'בחר אזור';
$string['selectdefault'] = 'בחירת ברירת מחדל';
$string['selectedfile'] = 'קובף שנבחר';
$string['selectednowmove'] = '{$a} קבצים נבחרו להעברה. עכשיו לך ליעד ולחץ על \'הסט קבצים לפה\'';
...
$string['showcommentsnonjs'] = 'הראה הערות';
$string['showdescription'] = 'הצגת ההנחייה בעמוד הראשי של הקורס';
$string['showdescription_help'] = 'אם מאופשר, התיאור/הקדמה מעל תוצג בעמוד הקורס מייד מתחת לקישור של המשאב/פעילות.';
$string['showgrades'] = 'הראה את יומן הציונים לתלמידים';
$string['showgrades_help'] = '<p align="center"><b>ציונים</b></p>

<p>הרבה מהפעילויות מאפשרות קביעה של ציונים.
</p>

<p>לפי ברירת המחדל, את כל הציונים במהלך הקורס ניתן לראות בעמוד הציונים, אליו אפשר להגיע מהעמוד הראשי של הקורס.
</p>

<p>אם מורים לא מעוניינים להשתמש בציונים בקורס, או שהם פשוט רוצים להסתיר את הציונים מעיני הסטודנטים, הם יכולים לבטל את אופציית הצגת הציונים בהגדרות הקורס. הדבר לא מונע מפעילויות אינדווידואליות לקבוע או לעשות שימוש בציונים, אלא רק מבטל את הצגתם בפני הסטודנטים.
</p>';
...
$string['showtopicfromothers'] = 'הצג את הנושא';
$string['showweekfromothers'] = 'הצג את השבוע';
$string['since'] = 'מאז';
...
$string['sitelegacyfiles'] = 'קבצי המערכת כפי שנוהלו במהדורות קודמות';
...
$string['sortbyx'] = 'מיין על ידי {$a} עולה';
$string['sortbyxreverse'] = 'מיין על ידי {$a} יורד';
...
$string['summary_help'] = '<p align="center"><b>סיכומים שבועייםנושאים</b></p>

<p>סיכום נושאי הוא טקסט מאוד קצר שמיועד להכין את הסטודנטים לפעילויות שיופיעו בתוך נושא (או שבוע) זה.
</p>

<p>על כל סיכום להיות מאוד קצר, זאת כדי שעמוד הקורס לא ייהפך לארוך מדי.
</p>
...
$string['textformat'] = 'תסדיר טקסט פשוט (CSV)';
$string['thanks'] = 'תודה';
...
$string['to'] = 'עד תאריך';
$string['tocreatenewaccount'] = 'דלג ליצירת חשבון ידש';
$string['today'] = 'היום';
...
$string['toomanyuserstoshow'] = 'עותר מדי משתמשים ({$a}) בכדי להראותם';
...
$string['userselectorautoselectunique'] = 'אם משתמש אחד תואם לחיפוש, בחר אותו אוטומטית';
$string['userselectorpreserveselected'] = 'שמירת משתמשים שנבחרו, אפילו אם הם לא תואמים יותר את החיפוש';
$string['userselectorsearchanywhere'] = 'מצא את תווי החיפוש במקום כלשהוא בשמו של המשתמש';
...
$string['usetheme'] = 'השתמש בערכת נושא';
$string['usingexistingcourse'] = 'משתמש בקורס קיים';
$string['valuealreadyused'] = 'ערך זה כבר מצוי במערכת';
$string['version'] = 'גירסה';
$string['view'] = 'נצפה';
$string['viewallcourses'] = 'צפיה בכל הקורסים';
$string['viewallcoursescategories'] = 'צפיה בכל הקורסים והקטגוריות';
$string['viewfileinpopup'] = 'צפיה בקובץ ובחלון הקופץ';
...
$string['virusfoundlater'] = 'קובץ שהעלת בתאריך {$a->date} עם שם הקובץ {$a->filename} בקורס {$a->course} נמצא מאז נגוע בוירוס. הינה סיכום מאורעות קובץ זה: {$a->action} אם זאת הייתה עבודת הגשה, תוכל להגיש אותה שנית כך שהמורה שלך יראה אותה. If this was submitted work, you may want to resubmit it so that your tutor can see it';
...
$string['yourwordforx'] = 'המילה שלך עבור \'{$a}\'';
