...
/**
 * Strings for component 'auth_radius', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_radius
...
$string['auth_radiustype'] = 'בחר סכימה לאימות לשימוש עם שרת ה- RADIUS ';
$string['auth_radiustypechapmd5'] = 'CHAP MD5';
$string['auth_radiustype_key'] = 'אימות';
$string['auth_radiustypemschapv1'] = 'גרסת Microsoft CHAP 1';
$string['auth_radiustypemschapv2'] = 'גרסת Microsoft CHAP version 2';
$string['auth_radiustypepap'] = 'PAP';
$string['pluginname'] = 'השתמש בשרת RADIUS';
