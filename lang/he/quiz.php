...
/**
 * Strings for component 'quiz', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   quiz
...
$string['accessnoticesheader'] = 'ניתן לצפות בבוחן זה, אך זהו היה נסיון מענה אמיתי היית נחסם מהסיבות הבאות:';
$string['action'] = 'פעולה';
$string['adaptive'] = 'מצב מסתגל';
$string['adaptive_help'] = 'אם פעיל, תאופשרנה תגובות מרובות בעת אותו מענה לבוחן. לדוגמא, אם תגובה מסומנת כשגויה, הסטודנט יוכל לענות על שוב מיידית. הדבר תלוי בבהגדרת יישום הקנסות , קנס בדרך-כלל ימומש עבור כל נסיון שגוי.';
$string['addaquestion'] = 'הוספת שאלה...';
$string['addarandomquestion'] = 'הוספת שאלה אקראית...';
$string['addarandomquestion_help'] = 'כאשר מתווספת שאלה אקראית, תוצאותיה נראות בשאלת שנבחרה בצורה אקראית מהסיווג אשר מוכנס לבוחן. משמעות הדבר  היא כי סטודנטים שונים יקבלו שאלות שונות כיביכול, וכאשר הבוחן מותיר נסיונות מרובים , כל נסיון יכיל בחירת שאלות חדשה כיביכול.';
$string['adddescriptionlabel'] = 'הוסף תיאור/תוית';
...
$string['addnewgroupoverride'] = 'הוסף הגדרות קבוצה';
$string['addnewpagesafterselected'] = 'הוסף דפים חדשים לאחר שאלות נבחרות';
$string['addnewquestionsqbank'] = 'הוסף שאלות לקטגוריה
{$a->catname}: {$a->link}';
$string['addnewuseroverride'] = 'הוסף הגדרות משתמש';
$string['addpagehere'] = 'הוסף דף במקום זה';
...
$string['attemptsonly'] = 'הצג רק את התלמידים שניסו לענות על בחנים.';
$string['attemptstillinprogress'] = 'נסיונון עדיין בתהליך';
...
$string['bothattempts'] = 'הצג את התלמידים שניסו לענות על הבוחן בנוסף לתלמידים שלא ניסו.';
$string['browsersecurity'] = 'אבטחת דפדפן';
$string['browsersecurity_help'] = 'אם הגדרת  "חלון קופץ במסך מלא עם אבטחת JavaScript" נבחרה

* הבוחן יתחיל רק אם לסטודנט יש דפדפן התומך ב- JavaScript.
*הבוחן יופיע בחלוץ קופץ עם עם מסך מלא התופס את כל מסך המחשב ומכסה את החלונות האחרים. בנוסף לא יהיה לחלון זה בר ניווט.
* לסטודנטים לא תתאפשר יכולת "העתק - הדבק" ככל שניתן.';
...
$string['cannoteditafterattempts'] = 'אינך יכול להוסיף או להסיר שאלות מכיוון שקיימים נסיונות מענה. {$a}';
$string['cannotfindprevattempt'] = 'אין אפשרות למצוא את הניסיון הקודם בכדי לבנות עליןו.';
...
$string['cannotreviewopen'] = 'אין ביכולתך לבדוק  ניסיון זה , משום שהוא עדין פתוח.';
...
$string['configdelay1'] = 'אם תבחר במרווח זמן, הסטודנט יצטרך להמתין  זמן זה לפני שיוכל להתחיל לענות על הנסיון הראשון שלו.';
$string['configdelay1st2nd'] = 'אם תבחר במרווח זמן, הסטודנט לא יוכל להתחיל בנסיון המענה השני שלו עד שזמן זה יחלוף מהסיום של המענה הראשון.';
$string['configdelay2'] = 'אם תבחר במרווח זמן, הסטודנט יצטרך להמתין זמן זה לפני שיוכל לענות על הנסיון השלישי שלו או יותר.';
$string['configdelaylater'] = 'אם תבחר במרווח זמן, הסטודנט לא יוכל להתחיל את נסיון המענה השלישי ו הרביעי שלו וכן הלאה..עד שהזמן יחלוף מרגע המענה על הנסיון האחרון.';
$string['configeachattemptbuildsonthelast'] = 'אם מאופשרים נסיונות מענה מרובים כל נסיון חדש יכלול את התוצאות של הנסיון הקודם.';
$string['configgrademethod'] = 'כאשר נסיונות מרובים מאופשרים, איזו שיטה לבחור בכדי לחשב את הציון הסופי של בוחן זה.';
$string['configintro'] = 'הערכים שיוגדרו כאן מגדירים את ערכי ברירת המחדל שישתמשו בהם בהגדרות של יצירת בוחן חדש. ניתן להגדיר אלו הגדרות בוחן נחשבות מתקדמות.';
$string['configmaximumgrade'] = 'ציון ברירת המחדל שציון הבוחן שודרג אליו חורג מסף ציונו המירבי';
$string['confignewpageevery'] = 'כאשר מוסיפים שאלות לבוחן רווחים התווספו באופן אוטומטי לפי ההגדרות שיבחרו.';
$string['configpenaltyscheme'] = 'הפחתת קנס לכל תגובה שגויה במצב מסתגל.';
$string['configpopup'] = 'הכרח את נסיון המענה להיפתח בחלון קופץ והשתמש בקוד JavaScript  למניעת פעולותכמו העתקה והדבקה, במהלך נסיונות מענה הבוחן';
...
$string['configreviewoptions'] = 'אפשרויות אלו שולטות איזה מידע המשתמשים יוכלו לראות כאשר הם צופים בנסיון מענה הבוחן או בעת צפייה בדוח הבוחן';
$string['configshowblocks'] = 'הצג משבצות במהלך נסיונון מענה הבוחן';
$string['configshowuserpicture'] = 'הצג את תמונות המשתמשים במסך במהלך נסיונות המענה';
$string['configshufflequestions'] = 'אם תאפשר הגדרה זו , סדר השאלות בבוחן יעורבב באופן אקראי בכל פעם שסטודנט ניגש לענות על בוחן';
$string['configshufflewithin'] = 'אם תאפשר הגדרה זו, החלק שיוצר את השאלות האישיות יעורבב באופן אקראי בכל פעם שהסטודנט  מתחיל  לענות על הבוחן, סיפוק אפשרות זו מאופשר גם בהגדרות הבוחן.';
...
$string['configurerandomquestion'] = 'הגדר את השאלה';
$string['confirmclose'] = 'אתה עומד להגיש באופן סופי את ניסיון מענה זה. מרגע שסגרת את ניסיון המענה לא תוכל לשנות את תשובותיך.';
...
$string['decimalplaces_help'] = '<p align="center"><b>ספרות עשרוניות</b></p>

<p>על ידי שימוש בהגדרה זו תוכלו לבחור כמה ספרות יופיעו לאחר הנקודה העשרונית בתצוגת תוצאות או ציוני הסטודנטים. למשל, אם תבחרו ב-\'0\', הדבר אומר שהציונים שיוצגו יועגלו למספרים שלמים.
</p><p>
...
$string['editingquiz_help'] = 'כאשר יוצרים בוחן , הרעיונות המרכזיים הם:

* הבוחן יכלול שאלות על-פני עמוד אחד או יותר.
* מאגר השאלות שמכיל העתקים של שאלות יאורגן בקטגוריות .
* שאלות אקראיות - סטודנט יקבל שאלות שונות בכל פעם שיגת לענות על הבוחן, וסטודנטים שונים יקבלו שאלות שונות.';
$string['editoverride'] = 'עקיפת עריכה';
$string['editqcats'] = 'עריכת קטגוריות של שאלות';
$string['editquestions'] = 'ערוך שאלות';
$string['editquiz'] = 'עריכת בוחן';
...
$string['emailconfirmsubject'] = 'אישור הגשות הבוחן: {$a->quizname}';
...
$string['errorunexpectedevent'] = 'קוד אירוע לא מתוכנן  {$a->event}  נמצא בשאלה {$a->questionid}  בנסיון מענה
{$a->attemptid}.';
...
$string['inactiveoverridehelp'] = '* לסטודנט לא קיימת קבוצה או התפקיד מתאים בכדי לנסון ולענות על הבוחן';
...
$string['invalidoverrideid'] = 'ID נעקף שגוי';
...
$string['modulename_help'] = 'רכיב בוחן זה מאפשר למורה לעצב ולהגדיר את הבחנים בהסתמך על בחירות מרובות, שאלת "נכון , לא נכון" , התאמה  וסוגי שאלות אחרים. כל נסיון מענה מסומן באופן אוטומטי, והמורה יכול לבחור האם לתת משוב אוו להציג את התשובות הנכונות.';
...
$string['nogradewarning'] = 'לא ניתן ציון לבוחן זה. לא תוכל להגדיר משוב כולל אשר שונה מהציון.';
$string['nomoreattempts'] = 'אין באפשרותך לבצע ניסיונות מענה נוספים עבור בוחן זה.';
$string['none'] = 'ללא';
$string['noopen'] = 'אין תאריך התחלה';
$string['nooverridedata'] = 'עליך לעקוף הגדרה אחת מהגדרות הבוחן.';
...
$string['noreviewattempt'] = 'אין לך הרשאה לצפות בנסיון מענה זה';
...
<p>המשוב הכולל הוא טקסט כלשהוא שמוצג לסטודנט לאחר שהוא סיים נסיון לענות על הבוחן. ניתן לתלות את הטקסט שיוצג סטודנט בתוצאה שהוא קיבל.
</p>
...
<p>אז, לסטודנטים שקיבלו תוצאה בין 100% ל-40% תוצג ההודעה "טוב מאוד" ובפני הסטודנטים שקיבלו תוצאה בין 39.99% ל-0% תוצג ההודעה השניה. כלומר, גבולות הציון מגדירים את הטווחים של הציונים וכל מחרוזת של משוב תוצג לתוצאות שנמצאות בטווח המתאים.
</p>
...
$string['override'] = 'עקיפה';
$string['overridedeletegroupsure'] = 'האם אתה בטוח כי ברצונך למחוק את העקיפה לקבוצה {$a}?';
$string['overridedeleteusersure'] = 'האם אתה בטוח כי ברצונך למחוק את העקיפה למשתמש {$a}?';
$string['overridegroup'] = 'הגדרות קבוצה';
$string['overridegroupeventname'] = '{$a->quiz} - {$a->group}';
$string['overrides'] = 'עקיפות';
$string['overrideuser'] = 'הגדרות למשתמש';
$string['overrideusereventname'] = '{$a->quiz} - עקיפה';
...
$string['questionbankcontents'] = 'תוכני מאגר השאלות';
...
$string['randomnosubcat'] = 'שאלות אך ורק מהקטגוריה ולא מקטגוריות המשנה.';
$string['randomquestionusinganewcategory'] = 'שאלה אקראית משימוש בקטגוריה חדשה';
$string['randomwithsubcat'] = 'שאלות מקטגוריהזו ומקטגוריות המשנה.';
...
$string['reviewattempt'] = 'סקירת נסיונות המענה';
...
<p>מיד לאחר נסיון פרושו, תוך שתי דקות של הנסיון מסתיים  ע"י לחיצת המשתמש על "הגש הכל וסיים".</p>
...
$string['saveattemptfailed'] = 'נכשל בנסיון לשמור את נסיון מענה הבוחן';
...
$string['saveoverrideandstay'] = 'שמור והכנס עקיפה חדשה';
...
$string['selectquestiontype'] = '-- בחר את סוג השאלה --';
...
$string['showblocks'] = 'הצג משבצות במהלך נסיונות מענה הבוחן';
$string['showblocks_help'] = 'אם מסומן \'כן\' משבצות רגילות יוצגו במהלך נסיונות מענה הבוחן';
$string['showbreaks'] = 'הצג מעברי דפים';
$string['showcategorycontents'] = 'הצד תכני הקטגוריה
{$a->arrow}';
$string['showcorrectanswer'] = 'האם יש להציג בזמן המשוב את התשובות הנכונות?';
$string['showdetailedmarks'] = 'הצג את פרטי הניקוד';
$string['showeachpage'] = 'הצג דף אחת בכל פעם';
...
$string['shuffledrandomly'] = 'ערבב אקראית';
...
$string['shufflewithin_help'] = '<p align="center"><b>ערבב בתוך השאלות</b></p>
...
$string['submitallandfinish'] = 'הגש הכל וסיים';
...
<p>אם אתם מפרטים הגבלת זמן, אז מספר דברים נעשים כדי לנסות ולהבטיח שהבחנים נסתיימים ומושלמים באותה מסגרת זמן:
</p>
...
$string['totalpointsx'] = 'סך-כל הציונים: {$a}';
...
$string['useroverrides'] = 'עקיפות המשתמש';
