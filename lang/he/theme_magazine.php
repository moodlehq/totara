...
/**
 * Strings for component 'theme_magazine', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['background'] = 'רקע';
$string['backgrounddesc'] = 'שנה את תמונת הרקע על ידי רישום ה-URL לתמונה החדשה (למשל: http://www.somesite/mybackground.jpg).';
$string['blockcolor'] = 'צבע תיבה';
$string['blockcolordesc'] = 'בעבור צבע הגופן של כותרת התיבה.';
...
$string['configtitle'] = 'ערכת נושא Magazine';
$string['forumback'] = 'רקע הפורום ';
$string['forumbackdesc'] = 'הגדרת צבע הרקע של נושאי פורום';
$string['headingcolor'] = 'צבע הכותרת';
$string['headingcolordesc'] = 'זהו צבע הכותרת לכותרות גדולות (הודעות האתר, הקורס שלי) וכן כותרות אחרות.';
$string['linkcolor'] = 'קישור';
$string['linkcolordesc'] = 'הגדרת צבע הקישור בערכה, השתמש בקוד ה-hex של HTML.';
$string['linkhover'] = 'קישור מרחף';
$string['linkhoverdesc'] = 'הגדרת צבע הקישור (בעת ריחוף) בערכה,  השתמש בקוד ה-hex של HTML.';
$string['logo'] = 'לוגו';
$string['logodesc'] = 'שנה את הלוגו של ערכה זאת על ידי רישום URL חדש. (למשל: http://www.somesite/animage.png). ערך ברירת-המחדל של הלוגו היא 300pxברוחב ו-80px בגובה. PNG שקוף יהיה הבחירה הטובה ביותר.';
$string['maincolor'] = 'צבע עיקרי';
$string['maincoloraccent'] = 'הדגשת צבע עיקרי';
$string['maincoloraccentdesc'] = 'צבע הדגשה כהה עבור סרגל צדדי וגבולות הכותרת. צריך להיות כהה במקצת מהצבע הראשי.';
$string['maincolordesc'] = 'הגדרות קוד ה-hex של צבע הכותרת, סרגל צדדי ואזורים אחרים. יפה במיוחד עם צבע שחור או צבע רווי.';
