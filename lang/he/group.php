...
/**
 * Strings for component 'group', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   group
...
$string['groupmodeforce'] = 'אלץ מצב קבוצה';
$string['groupmodeforce_help'] = 'אם מצב הקבוצה מוכרח, מצב הקבוצה בקורס תקף לכל פעילות בקורס. אין התחשבות  בהגדרות מצב הקבוצה בכל פעילות.';
$string['groupmode_help'] = '<p align="center"><b>מצב קבוצה</b></p>

<p>מצב הקבוצה יכול להיות כל אחד משלושת הרמות הבאות:
   <ul>
      <li>אין קבוצות - אין תת-קבוצות, כולם חלק מאותה הקהילה.</li>
      <li>קבוצות נפרדות - כל קבוצה יכולה לראות רק את הקבוצה שלה, אחרים הם בלתי נראים.</li>
      <li>קבוצות נראות - כל קבוצה עובדת במסגרת הקבוצה שלה, אבל יכולה לראות גם קבוצות אחרות.</li>
   </ul>
</p>
...
<dl>
   ...
   <dd>ניתן להגדיר מצב קבוצה פרטנית לכל פעילות שתומכת בקבוצות. אם הקורס נקבע ל"<a href="help.php?module=moodle&file=groupmodeforce.html">אלץ מצב קבוצה</a>"
...
$string['potentialmembs'] = 'חברים זמינים';
$string['printerfriendly'] = 'תצוגת קבוצות ידידותית להדפסה';
$string['random'] = 'אקראי';
$string['removefromgroup'] = 'הסר משתמש מקבוצה {$a}';
