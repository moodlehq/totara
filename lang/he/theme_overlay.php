...
/**
 * Strings for component 'theme_overlay', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['configtitle'] = 'הגדרות Overlay';
$string['customcss'] = 'CSS מותאם';
$string['customcssdesc'] = 'כל CSS שתוסיף כאן יוסף לכל דף ויאפשר לך לבצע התאמה נוחה לערכה זאת';
$string['footertext'] = 'Footertext';
$string['footertextdesc'] = 'הגדרהערת שוליים או טקסט שוליים';
$string['headercolor'] = 'צבע הכותרת העליונה';
$string['headercolordesc'] = 'צבע הרקע של הכותרת העליונה';
$string['linkcolor'] = 'צבע הקישורית';
$string['linkcolordesc'] = 'הגדרת צבע הקישורית בערכה זאת';
