...
/**
 * Strings for component 'block_rss_client', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['clientshowchannellinklabel'] = 'האם יש להציג קישור לאתר המקורי (קישור לערוץ)? שים לב שאם לא סופק קישור בהזנת החדשות אז לא יוצג אף קישור:';
$string['clientshowimagelabel'] = 'הצג את תמונת הערוץ, אם היא זמינה:';
$string['configblock'] = 'הגדר את משבצת־ניהול זו';
$string['couldnotfindfeed'] = 'לא נמצאה הזנה עם מזהה זה';
$string['customtitlelabel'] = 'כותרת מותאמת אישית (תוכל להשאיר שדה זה ריק כדי להשתמש בכותרת המסופקת ע"י ההזנה):';
$string['deletefeedconfirm'] = 'האם אתה בטוח ברצונך למחוק הזנה זו?';
$string['disabledrssfeeds'] = 'הזנות RSS אינן מאופשרות';
$string['displaydescriptionlabel'] = 'האם להציג את התיאור של כל קישור?';
$string['editafeed'] = 'עריכת הזנה';
$string['editfeeds'] = 'ערוך, הרשם כמנוי או בטל רישום להזנות RSS/Atom';
...
$string['feedsconfigurenewinstance'] = 'לחץ כאן להגדרת משבצת־ניהול זו להציג הזנות RSS.';
$string['feedsconfigurenewinstance2'] = 'לחץ על צלמית העריכה הנמצאת בחלק העליון של הגדרת  משבצת זו להצגת הזנות RSS';
$string['feedstitle'] = 'הזנות RSS חיצוניות';
$string['feedupdated'] = 'הזנת החדשות עודכנה';
$string['feedurl'] = 'כתובת URL של ההזנה';
...
$string['pluginname'] = 'תצוגת הזנת RSS חיצונית';
$string['remotenewsfeed'] = 'הזנת חדשות חיצונית';
$string['rss_client:createprivatefeeds'] = 'צור הזנות RSS פרטיות';
$string['rss_client:createsharedfeeds'] = 'צור הזנות RSS משותפות';
$string['rss_client:manageanyfeeds'] = 'נהל כל הזנת RSS שהיא';
$string['rss_client:manageownfeeds'] = 'נהל את הזנת ה-RSS שלי';
$string['seeallfeeds'] = 'צפה בכל ההזנות';
$string['sharedfeed'] = 'שיתוף הזנות ברמת כל הקורסים באתר';
$string['shownumentrieslabel'] = 'מספר הרשומות המירבי שיוצג בכל משבצת .';
$string['submitters'] = 'מי יורשה להגדיר הזנות RSS חדשות? הזנות מוגדרות זמינות בכל דף באתר שלך.';
$string['submitters2'] = 'מגישים';
$string['timeout'] = 'תפוגת זמן משבצת־ניהול RSS';
