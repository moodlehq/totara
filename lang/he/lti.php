...
/**
 * Strings for component 'lti', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   lti
...
$string['filterconfig'] = 'ניהול רכיב חיצוני (LTI)';
$string['filtername'] = 'רכיב חיצוני (LTI)';
$string['icon_url_help'] = 'הכתובת של הצלמית מאפשרת לעדכן את הצלמית שמוצגת ברשימת הקורסים עבור פעילות זו.
במקום לשתמש בצלמית ברירת המחדל של LTI , צלמית שמעבירה את סוג הפעילות שאותה ניתן לציין.';
