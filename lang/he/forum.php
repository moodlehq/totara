...
/**
 * Strings for component 'forum', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   forum
...
$string['blockafter_help'] = 'הרעיון שעומד מאחורי ניהול הפירסומים הוא מאוד פשוט. בפני המשתמשים תיחסם האפשרות לפרסם הודעות חדשות בפורום לאחר שהם יעברו מכסה של כמות פרסומים כלשהיא בתקופת זמן מסויימת. ככל שהם יתקרבו לאותה מכסה, המשתמשים יקבלו אזהרה על כך שהם מתקרבים לסף הפירסומים המותר.

קביעה של סף האזהרה ל-0, תמנע את האזהרות. קביעה של סף החסימה ל-0, תנטרל את החסימה. אם החסימה מנוטרלת, האזהרות תנוטרלנה גם הן באופן אוטומטי.

אף אחת מההגדרות הללו לא משפיעה על הפירסומים של המורים.';
$string['blockperiod'] = 'תקופת זמן עד לחסימה';
$string['blockperiod_help'] = 'הרעיון שעומד מאחורי ניהול הפירסומים הוא מאוד פשוט. בפני המשתמשים תיחסם האפשרות לפרסם הודעות חדשות בפורום לאחר שהם יעברו מכסה של כמות פרסומים כלשהיא בתקופת זמן מסויימת. ככל שהם יתקרבו לאותה מכסה, המשתמשים יקבלו אזהרה על כך שהם מתקרבים לסף הפירסומים המותר.

קביעה של סף האזהרה ל-0, תמנע את האזהרות. קביעה של סף החסימה ל-0, תמנע את החסימה. אם החסימה מנוטרלת, האזהרות תנוטרלנה גם הן באופן אוטומטי.
...
$string['cannotdeleteforummodule'] = 'אינך יכול למחוק את רכיב הפורום.';
...
$string['cannotfindparentpost'] = 'לא ניתן היה למצוא את פרסום ה-אב העליון {$a}';
...
$string['displayend_help'] = 'אתם יכולים לבחור אם הפירסום שלכם בפורום יוצג החל מתאריך מסויים, עד לתאריך מסויים, או רק לתקופת זמן מוגבלת.

כדי להפעיל את תאריך התחלה ואו סיום התצוגה, בטלו את הבחירה באפשרות(יות) המונעת (מניעה - Disable).
...
$string['displaystart_help'] = 'אתם יכולים לבחור אם הפירסום שלכם בפורום יוצג החל מתאריך מסויים, עד לתאריך מסויים, או רק לתקופת זמן מוגבלת.
...
$string['forumbodyhidden'] = 'אינך יכול לראות את תוכן התגובה הזו, כנראה מפני שלא פירסמת תגובה בעצמך בדיון זה או שזמן עריכת ההודעה פג תוקף.';
$string['forumintro'] = 'הנחייה לפורום';
...
$string['forumtype_help'] = 'ישנם מספר סוגי פורום שונים שתוכלו לבחור מהם:

דיון יחיד - זהו נושא יחיד, המוצג כולו באותו העמוד. אפשרות זו יעילה לדיונים קצרים וממוקדים.

פורום רגיל לשימוש כללי - זהו פורום פתוח, בו כל אחד יכול לפתוח בנושא חדש לדיון, בכל עת. זהו הפורום הטוב ביותר לשימוש-כללי, לכל מטרה שהיא.

כל אדם מפרסם דיון אחד - כל אדם יכול לפרסם בדיוק נושא אחד לדיון (אך כולם יכולים להגיב אליו). האפשרות הזו יעילה כשאתם רוצים שכל סטודנט יתחיל בדיון על, למשל, המחשבות שלו לגבי נושא השבוע, ושכל שאר הסטודנטים יגיבו לכך.

פורום "כתיבת תשובה נדרשת לצפיה בדיון" - פורום זה דורש מהסטודנטים לפרסם את נקודות המבט שלהם לפני שהם רואים את תוכן התגובות של שאר חבריהם לספסל הלימודים. לאחר פירסום התגובה  הראשונית, הסטודנטים יכולים לראות ולהגיב לפירסומים של אחרים. תכונה זו מאפשרת הזדמנות פירסום ראשוני שווה לכל התלמידים, ובכך מעודדת חשיבה מקורית ועצמאית.

(פיתוחים נוספים מתוכננים בגירסאות עתידיות של מוודל.)';
...
$string['invalidparentpostid'] = 'מספר זיהוי פרשום האב שגוי';
...
$string['maxattachmentsize_help'] = 'ניתן להגביל את הגודל של הקבצים שניתן לצרף להודעות פורום, את הגודל יכול לבחור האדם שהגדיר את הפורום.

לפעמים ניתן להעלות קובץ שהוא גדול יותר מהגודל המורשה, אבל הקובץ לא יישמר על השרת ובפניכם תופיע הודעת שגיאה.';
...
$string['modulename_help'] = 'פעילות זו יכולה להיות בעלת החשיבות הגדולה ביותר - כאן נערכים מרבית הדיונים. את הפורומים ניתן לבנות בדרכים שונות, וניתן לכלול בהם אפשרות שכל הקבוצה תתן דירוג לכל פירסום.

את הפירסומים ניתן לראות במגוון תסדירים, וניתן לצרף אליהם קבצים. הירשמות לפורום מבטיחה כי המשתתפים יקבלו לדואר האלקטרוני שלהם עותקים של פירסומים חדשים בפורום. המורה יכול לכפות הרשמה על כולם, אם הוא רוצה בכך.';
...
$string['namenews_help'] = 'משבצת  "החדשות האחרונות ביותר" יציג דיונים שארעו לאחרונה בפורום מיוחד זה (אפילו אם תשנו את שמו). מסיבה זו, במידה ואתם משתמשים במשבצת  החדשות האחרונות ביותר, מוודל ייצר מחדש את פורום זה באופן אוטומטי.';
...
$string['overviewnumpostssince'] = 'ההודעות פורסמו מאז התחברות אחרונה{$a}';
...
$string['rssarticles_help'] = 'אפשרות זו מאפשרת לכם לבחור את מספר המאמרים (טקסטים שנשלחו לקבוצות דיון) שאתם רוצים לכלול בתוך הזנת ה-RSS.
...
$string['rsstype_help'] = 'אפשרות זו מאפשרת לכם להפעיל הזנות RSS לפורום זה.

אתם יכולים לבחור בין שני סוגי פורומים:

* דיונים: על ידי שימוש בסוג זה, ההזנות שנוצרות יכילו בתוכן דיונים חדשים בפורום ביחד עם הפירסום הראשוני שלהם.

* פירסומים: על ידי שימוש בסוג זה, ההזנות שנוצרות יכילו בתוכן כל פירסום חדש בפורום.';
$string['search'] = 'חיפוש';
...
$string['subscribenone'] = 'ביטול מנוי של כולם לפורום  (ביטול קבלת עדכונים לדוא"ל)';
...
כשאדם נרשם לפורום, הדבר אומר שישלחו אליו בדואר אלקטרוני עותקים של כל פירסום בפורום.

על פי רוב, אנשים יכולים לבחור אם להירשם לפורום או לא.

אך אם המורה מחליט לכפות הרשמה לפורום מסויים, אז אפשרות הבחירה נלקחת מהסטודנטים, וכל אחד בכיתה יקבל עותקים לדואר האלקטרוני שלו.

אפשרות זו יעילה במיוחד בפורום החדשות, ובפורומים בתחילת הקורס (לפני שכולם הבינו איך הם יכולים להירשם לפורומים בעצמם).';
$string['subscriptionauto'] = 'מנוי אוטומטי';
$string['subscriptiondisabled'] = 'מנוי אינו מאופשר';
$string['subscriptionforced'] = 'מנוי מאולץ';
$string['subscriptionmode'] = 'מצב המנוי';
$string['subscriptionmode_help'] = 'כשאדם נרשם לפורום, הדבר אומר כי ישלחו אליו בדואר אלקטרוני עותקים של כל פירסום בפורום. (הודעות הדוא"ל נשלחות בערך כ דקות לאחר שהפירסום נכתב בראשונה.)

ישנם 4 אפשרויות למצב רישום לפורום:
*מנוי ניתן לבחירה (אפשרי) - לרוב, הסטודנטים יכולים לבחור אם להירשם לפורום או לא על פי רצונם. 
*מנוי מאולץ - אפשרות זו תאלץ את ההרשמה של הסטודנטים לפורום באופן אוטומטי (אפילו אלו שנרשמים לקורס בזמן מאוחר יותר) ללא התערבותם.
*מנוי אוטומטי- האפשרות הזו רושמת את הסטודנטים לפורום באופן אוטומטי בתחילתו של הקורס ולאחר מכן הסטודנטים יכולים לבחור אם להסיר עצמם מהרישום של הפורום בכל זמן שירצו.
*מנוי אינו מאופשר- לא תתאפשר הרשמה לפורום לצורך קבלת הודעות דוא"ל';
...
$string['trackingtype_help'] = 'אם \'קרא מעקב\' עבור פורום הוא מאופשר, משתמשים יכולים לעקוב, לקרוא ולא לקרוא הודעות (פרסומים) בפורומים ובדיונים. המורה (מרצה) יכול להכריח את סוג המעקב בפורום ע"י הגדרות אלו.

קיימות שלוש בחירות להגדרה זו:

* אופציונלית (ברירת מחדל): סטודנטים יכולים להפעיללכבות את המעקב בפורום ע"י שיקול דעתם.
* פעיל: המעקב תמיד פעיל (מאופשר)
* כבוי: המעקב תמיד כבוי (מנוטרל)';
...
$string['unsubscribe'] = 'ביטול מנוי לפורום (ביטול קבלת עדכונים לדוא"ל)';
$string['unsubscribeall'] = 'ביטול מנויים מכל הפורומים  (ביטול קבלת עדכונים לדוא"ל)';
$string['unsubscribeallconfirm'] = 'אתה מנוי ל {$a} פורומים כעת.
האם אתה אכן רוצה לבטל את המנויים מכל הפורומים ולמנוע את מנוי האוטומטי?';
$string['unsubscribealldone'] = 'כל מנויי הפורומים שלך הוסרו, אתה עשוי לקבל הודעות מפורומים עם מנוי ש"אולץ". אם אין ברצונך לקבל כל דוא"לים משרת זה, גש לעריכת הפרופיל שלך ומנע את כתובת הדוא"ל שלך.';
$string['unsubscribeallempty'] = 'מצטערים, אינך מנוי לאף פורום. אם אינך רוצה לקבל כלל דוא"לים משרת זה, גש לעריכת הפרופיל שלך ומנע את כתובת הדוא"ל שלך.';
...
$string['warnafter_help'] = 'הרעיון שעומד מאחורי ניהול הפירסומים הוא מאוד פשוט. בפני המשתמשים תיחסם האפשרות לפרסם הודעות חדשות בפורום לאחר שהם יעברו מכסה של כמות פרסומים כלשהיא בתקופת זמן מסויימת. ככל שהם יתקרבו לאותה מכסה, המשתמשים יקבלו אזהרה על כך שהם מתקרבים לסף הפירסומים המותר.
