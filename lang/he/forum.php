...
$string['blockafter_help'] = '<p align="center"><b>פורומים בהם מנהלים את הפירסומים</b></p>
...
<p>קביעה של סף האזהרה ל-0, תמנע את האזהרות. קביעה של סף החסימה ל-0, תנטרל את החסימה. אם החסימה מנוטרלת, האזהרות תנוטרלנה גם הן באופן אוטומטי.</p>
...
$string['blockperiod_help'] = '<p align="center"><b>פורומים בהם מנהלים את הפירסומים</b></p>

<p>הרעיון שעומד מאחורי ניהול הפירסומים הוא מאוד פשוט. בפני המשתמשים תיחסם האפשרות לפרסם הודעות חדשות בפורום לאחר שהם יעברו מכסה של כמות פרסומים כלשהיא בתקופת זמן מסויימת. ככל שהם יתקרבו לאותה מכסה, המשתמשים יקבלו אזהרה על כך שהם מתקרבים לסף הפירסומים המותר.</p>

<p>קביעה של סף האזהרה ל-0, תמנע את האזהרות. קביעה של סף החסימה ל-0, תמנע את החסימה. אם החסימה מנוטרלת, האזהרות תנוטרלנה גם הן באופן אוטומטי.</p>
...
$string['modulename_help'] = '<p><img alt="" src="<?php echo $CFG->wwwroot?>/mod/forum/icon.gif" /> <b>פורומים</b></p>
<div class="indent">

פעילות זו יכולה להיות בעלת החשיבות הגדולה ביותר - כאן נערכים מרבית הדיונים. את הפורומים ניתן לבנות בדרכים שונות, וניתן לכלול בהם אפשרות שכל הקבוצה תתן דירוג לכל פירסום.
...
<p>משבצת  "החדשות האחרונות ביותר" יציג דיונים שארעו לאחרונה בפורום מיוחד זה (אפילו אם תשנו את שמו). מסיבה זו, במידה ואתם משתמשים במשבצת  החדשות האחרונות ביותר, מוודל ייצר מחדש את פורום זה באופן אוטומטי.
...
$string['trackingtype_help'] = '<p>אם \'קרא מעקב\' עבור פורום הוא מאופשר, משתמשים יכולים לעקוב, לקרוא ולא לקרוא הודעות (פרסומים) בפורומים ובדיונים. המורה (מרצה) יכול להכריח את סוג המעקב בפורום ע"י הגדרות אלו.</p>

<p>קיימות שלוש בחירות להגדרה זו:</p>
<ul>
<li> אופציונלית (ברירת מחדל): סטודנטים יכולים להפעיללכבות את המעקב בפורום ע"י שיקול דעתם.</li>
<li>פעיל: המעקב תמיד פעיל (מאופשר)</li>
<li>כבוי: המעקב תמיד כבוי (מנוטרל)</li>
</ul>';
