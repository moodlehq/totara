...
/**
 * Strings for component 'auth_db', language 'he', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbdeleteuser'] = 'משתמש מחוק {$a->id} מספר זיהוי {$a->name}';
...
$string['auth_dbinsertuser'] = 'משתמש משובץ {$a->name} מספר זיהוי {$a->id}';
...
$string['auth_dbreviveduser'] = 'משתמש שהוקם מחדש {$a->name} מספר זיהוי {$a->id}';
...
$string['auth_dbsuspenduser'] = 'משתמש מושהה {$a->name} מספר זיהוי {$a->id}';
...
$string['auth_dbupdatinguser'] = 'מעדכן משתמש {$a->name} מספר זיהוי {$a->id}';
...
$string['pluginname'] = 'השתמש בבסיס נתונים חיצוני';
