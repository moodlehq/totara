...
/**
 * Strings for component 'repository_upload', language 'he', branch 'MOODLE_22_STABLE'
 *
...
המירבי שלו אשר הוגדרה בטופס ההגדרה.';
$string['upload_error_ini_size'] = 'הקובץ המועלה הגיע ל מכסה המירבית שהוצאה לו - upload_max_filesize בקובץ ה-PHP.ini';
