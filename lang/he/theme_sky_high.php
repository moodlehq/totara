...
/**
 * Strings for component 'theme_sky_high', language 'he', branch 'MOODLE_22_STABLE'
 *
...
$string['configtitle'] = 'הגדרות Sky High';
$string['customcss'] = 'CSS מותאם';
$string['customcssdesc'] = 'כל CSS שתוסיף כאן התווסף לכל דף ויאפשר לך לבצע התאמה נוחה לערכה זאת.';
$string['footnote'] = 'הערת שוליים';
$string['footnotedesc'] = 'התוכן של אזור טקסט זה יוצג בשוליים של כל דף.';
$string['logo'] = 'לוגו';
$string['logodesc'] = 'הכנס את ה-URL לתמונה שתשמש כלוגו לאתר זה. חובה שיהיה:  http://www.yoursite.com/path/to/logo.png. גובהו של הלוגו חייב להות 50px.';
$string['pluginname'] = 'Sky High';
$string['region-side-post'] = 'ימין';
$string['region-side-pre'] = 'שמאל';
$string['regionwidth'] = 'רוחב עמודה';
$string['regionwidthdesc'] = 'זה מציב את הרוחב של שני אזורים היוצרים את העמודות הימניות והשמאליות.';
$string['tagline'] = 'שורה קצרה';
$string['taglinedesc'] = 'התוכן של אזור זה יוצג מתחת לשם האתר על דף הבית';
