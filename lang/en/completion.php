...
$string['err_nograde']='A course grade requirement has not been set for this course. To enable this criteria type you must set a required grade.';
...
$string['err_settingslocked']='One or more students have already completed a criteria so the settings have been locked. You do not currently have permission to unlock these settings, please contact your site administrator.';
$string['err_settingsunlockable']='One or more students have already completed a criteria so the settings have been locked. Unlocking the completion criteria settings will delete any existing user data and may cause confusion.';
