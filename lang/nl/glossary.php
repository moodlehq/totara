...
/**
 * Strings for component 'glossary', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   glossary
...
$string['modulename_help'] = 'Met de woordenlijstmodule kun je deelnemers een lijst van definities laten maken en onderhouden, zoals een woordenboek. Woordenlijstitems kunnen automatisch gelinkt worden telkens wanneer het woord ergens in de cursus verschijnt.';
