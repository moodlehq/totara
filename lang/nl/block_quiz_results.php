...
/**
 * Strings for component 'block_quiz_results', language 'nl', branch 'MOODLE_22_STABLE'
 *
...
$string['config_show_best'] = 'Hoeveel van de hoogste reslutaten zouden moeten getoond worden (0 om uit te schakelen)?';
$string['config_show_worst'] = 'Hoeveel van de laagste reslutaten zouden moeten getoond worden (0 om uit te schakelen)?';
