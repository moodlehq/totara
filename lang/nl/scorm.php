...
/**
 * Strings for component 'scorm', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   scorm
...
$string['displayattemptstatus_help'] = 'Indien ingeschakeld zullen beoordelingen en cijfers voor pogingen getoond worden op de SCORM beschrijvingspagina.';
...
$string['displaycoursestructuredesc'] = 'Deze instelling regelt de standaardinstelling voor het tonen van de cursusstructuur op de startpagina';
...
$string['forcecompleted_help'] = 'Indien ingeschakeld wordt de status van de huidige poging naar voltooid gezet. Deze instelling is enkel toepasbaar op SCORM 1.2-pakketten. Dit is nuttig als het SCORM-pakket het opnieuw bekijken van een poging niet correct doet in nalezen of bladermodus of wanneer het pakket fout de voltooidstatus weergeert.';
...
$string['interactionsscoremax'] = 'Maximumwaarde in het bereik van de ruwe score';
...
$string['modulename_help'] = 'SCORM en AICC zijn een verzameling specificaties die samenwerking, toegankelijkheid en herbruikbaarheid van webgebaseerde leerobjecten mogelijk maken. De SCORM/AICC-module maakt het mogelijk om SCORM/AICC-pakketten te gebruiken in een cursus.';
...
$string['optionsadv_desc'] = 'Indien ingeschakeld zullen de vensteropties als geavanceerde opties aangeduid worden op het formulier';
...
$string['pluginadministration'] = 'SCORM/AICC-beheer';
...
$string['popupsblocked'] = 'Blijkbaar zijn popupvensters geblokkeerd, waardoor deze scorm-module niet kan afspelen. Controleer je browserinstellingen voor je verder gaat.';
