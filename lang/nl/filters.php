...
/**
 * Strings for component 'filters', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   filters
...
$string['includesubcategories'] = 'Subcategorieën opnemen?';
...
$string['isgreaterorequalto'] = 'is groter dan of gelijk aan';
$string['isgreaterthan'] = 'is groter dan';
$string['islessthan'] = 'is kleiner dan';
$string['islessthanorequalto'] = 'is kleiner dan of gelijk aan';
$string['isnotdefined'] = 'is niet gedefinieerd';
$string['isnotequalto'] = 'is niet gelijk aan';
$string['matchesallselected'] = 'komt overeen met alle';
$string['matchesanyselected'] = 'komt overeen met één van';
