...
/**
 * Strings for component 'rating', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   rating
...
$string['aggregatemin'] = 'Minimum beoordeling';
...
* Het aantal beoordelingen - Het aantal beoordeelde items wordt het eindcijfer. Merk op dat het totaal aantal niet hoger kan zijn dan het maximum cijfer voor de activiteit.
