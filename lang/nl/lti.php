...
/**
 * Strings for component 'lti', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   lti
...
* **Nieuw venster** - De tool opent in een nieuw venster, en neemt de volledige ruimte in. Afhankelijk van de browser zal het openen in een nieuwe tab of in een popup venster. De kans bestaat dat browsers het openen van een nieuw venster zullen verhinderen.';
...
$string['enableemailnotification'] = 'Verstuur emails met meldingen';
...
$string['id'] = 'id';
$string['imsroleadmin'] = 'Instructeur, beheerder';
$string['imsroleinstructor'] = 'Instructeur';
$string['imsrolelearner'] = 'Leerling';
...
$string['lti_launch_error_unsigned_help'] = 'Deze fout is waarschijnlijk het resultaat van een ontbrekende consumentensleutel en gedeeld geheim voor de tool provider.
Indien je een consumentensleutel en een gedeeld geheim hebt, kun je deze invoeren wanneer je de externe tool instantie bewerkt (zorg ervoor dat de geadvanceerde opties zichtbaar zijn).
Een andere mogelijkheid is om [hier] ({$a->course_tool_editor}) een tool provider configuratie op cursus niveau aan te maken.';
...
$string['modulename_help'] = 'Externe tools laten Moodle gebruikers toe om om te gaan met leermiddelen en activiteiten op andere websites. Een externe tool kan bijvoorbeeld toegang verlenen tot een nieuw activiteitstype of leermiddel van een uitgever.
Om een externe tool instantie in te stellen is een tool provider vereist die LTI (Learning Tools Interoperability) ondersteunt.
Indien je een tool provider aantreft die LTI ondersteunt, dan moet deze instructies kunnen geven over de manier waarop de externe tool instantie best wordt geconfigureerd. Verder zullen ook de tool types die door de site beheerder werden geconfigureerd, beschikbaar zijn voor gebruik.
Externe tools verschillen van URL bronnen op een aantal manieren:
* **Omgevingsbewust** - Externe tools hebben toegang tot informatie over de gebruiker die de tool lanceert, zoals institutie, cursus, naam, en andere gegevens.
* **Diepe integratie** - Externe tools ondersteunen het lezen, bewerken en verwijderen van cijfers die verband houden met de activiteitsinstantie. Aanvullende integratiepunten zijn voorzien voor toekomstige versies.
* **Veiligheid** - Externe tool configuraties scheppen een vertrouwensrelatie tussen Moodle en de tool provider, waardoor een veilige communicatie ontstaat tussen hen.';
...
$string['setdefault'] = 'Zet een standaardwaarede voor de leraar bij delegatie.';
$string['setupbox'] = 'LTI Tool instellingenbox';
