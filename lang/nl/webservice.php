...
/**
 * Strings for component 'webservice', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   webservice
...
$string['accesstofunctionnotallowed'] = 'Toegang tot de functie {$a}() is niet toegestaan. Controleer of de service die de functie bevat is ingeschakeld; In de service instellingen: als de service beperkt is, controleer dan of de gebruiker in de lijst staat. Kijk ook naar IP beperking of dat de service een bepaalde mogelijkheid vereist.';
...
$string['createtokenforuserauto'] = 'Maak automatisch een token voor een gebruiker';
...
$string['enabledirectdownload'] = 'Webservice bestanden downloaden moet ingeschakeld zijn in de externe service instellingen.';
...
$string['invalidtokensession'] = 'Ongeldig sessiegebaseerd token - sessie niet gevonden of verlopen';
$string['iprestriction'] = 'IP beperking';
$string['iprestriction_help'] = 'De gebruiker zal de webservice moeten aanspreken vanaf de IP\'s in de lijst.';
$string['key'] = 'Sleutel';
...
$string['protocolnotallowed'] = 'Je hebt het recht niet om het {$a} protocol te gebruiken (ontbrekende mogelijkheid: webservice/{$a}:use)';
...
$string['wsauthmissing'] = 'De webservice authenticatieplugin ontbreekt.';
$string['wsauthnotenabled'] = 'De webservice authenticatieplugin is uitgeschakeld.';
