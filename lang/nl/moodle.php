...
/**
 * Strings for component 'moodle', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['availability_help'] = 'Deze instelling bepaalt wanneer een cursus verschijnt in de cursuslijst. Behalve leraren en beheerders hebben gebruikers geen toegang tot deze cursus.';
...
$string['backuptakealook'] = 'Controleer je backuplogs op:
{$a}';
$string['backupuserfileshelp'] = 'Selecteer als je gebruikersbestanden in de backup wil';
$string['backupversion'] = 'Backup-versie';
$string['block'] = 'Blok';
...
$string['duplicatenosupport'] = '\'{$a->modname}\' activiteit kon niet gekopieerd worden want de {$a->modtype} ondersteunt backup en terugzetten niet.';
...
$string['forcedmodeinbrackets'] = '{$a} (verplichte modus)';
...
$string['hidetopicfromothers'] = 'Verberg onderwerp';
$string['hideweekfromothers'] = 'Verberg week';
$string['hits'] = 'Hits';
...
$string['local'] = 'Lokaal';
$string['localplugindeleteconfirm'] = 'Je gaat de locale plugin \'{$a}\' volledig verwijderen. Dit zal alles wat met deze plugin geassocieerd is uit de databank verwijderen. Ben je er zeker van dat je dit wil doen?';
...
$string['maxfilesize'] = 'Maximum grootte voor nieuwe bestanden: {$a}';
...
$string['messageprovider:backup'] = 'Backupmeldingen';
...
$string['myfiles'] = 'Mijn privé-bestanden';
$string['myfilesmanage'] = 'Beheer mijn privé-bestanden';
...
$string['passwordforgotteninstructions2'] = 'Stuur je gebruikersnaam of je e-mailadres in om je wachtwoord te resetten. Als we je kunnen vinden in de databank, dan zal eer een e-mail naar je verstuurd worden met instructies hoe je terug kunt aanmelden.';
...
$string['restorecannotassignroles'] = 'Het proces dat de backup terugzet moet rollen toewijzen en jij hebt daar niet het recht toe';
$string['restorecannotcreateorassignroles'] = 'Het proces dat de backup terugzet moet rollen maken of toewijzen en jij hebt daar niet het recht toe';
...
$string['restorecannotoverrideperms'] = 'Het proces dat de backup terugzet moet rollen overschrijven en jij hebt daar niet het recht toe';
...
$string['screenreaderuse_help'] = 'Indien je hier ja kiest, zal op verschillende plaatsen een meer toegankelijke interface getoond worden, bijvoorbeeld in chat.';
...
$string['showtopicfromothers'] = 'Toon onderwerp';
$string['showweekfromothers'] = 'Toon week';
$string['since'] = 'Sinds';
