...
/**
 * Strings for component 'role', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   role
...
$string['backup:anonymise'] = 'Maak gebruikersgegevens anoniem tijdens een backup';
$string['backup:backupactivity'] = 'Backup activiteiten';
$string['backup:backupcourse'] = 'Backup cursussen';
$string['backup:backupsection'] = 'Backup secties';
$string['backup:backuptargethub'] = 'Backup voor hub';
$string['backup:backuptargetimport'] = 'Backup voor import';
$string['backup:configure'] = 'Configureer backup-opties';
$string['backup:downloadfile'] = 'Download bestanden van backupzone';
...
$string['confirmunassign'] = 'Wil echt deze rol van deze gebruiker verwijderen?';
...
$string['highlightedcellsshowdefault'] = 'De geselecteerde rechten in onderstaande tabel zijn de standaardrecten voor het hierboven geselecteerde rolarchetype.';
...
$string['my:configsyspages'] = 'Configureer systeemsjablonen voor Mijn Moodle-pagina\'s';
$string['my:manageblocks'] = 'Blokken op Mijn Moodle pagina beheren';
...
$string['restore:uploadfile'] = 'Bestanden uploaden naar backupzone\'s';
