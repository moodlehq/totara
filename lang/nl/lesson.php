...
/**
 * Strings for component 'lesson', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   lesson
...
$string['configmaxanswers'] = 'Standaard maximum aantal antwoorden per pagina';
$string['configmaxhighscores'] = 'Te tonen aantal hoogste scores';
$string['configmediaclose'] = 'Toont een sluit-knop als deel van de popup waarin het gelinkte mediabestand getoond wordt';
$string['configmediaheight'] = 'Instelling voor de hoogte van de popup voor het gelinkte mediabestand';
$string['configmediawidth'] = 'Instelling voor de breedte van de popup voor het gelinkte mediabestand';
...
$string['maximumnumberofattempts_help'] = 'Deze waarde bepaalt het maximum aantal pogingen die een leerling krijgt om een vraag te beantwoorden. Indien het maximum wordt bereikt na telkens opnieuw een foutief antwoord, dan wordt de volgende pagina van de les getoond.';
...
$string['youshouldview'] = 'Je moet een antwoord geven op minimum: {$a}';
