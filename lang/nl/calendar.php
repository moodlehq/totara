...
/**
 * Strings for component 'calendar', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   calendar
...
$string['pref_lookahead_help'] = 'Dit stelt het (maximum) aantal dagen in de toekomst in dat een gebeurtenis moet beginnen om opgenomen te worden als een aankomende gebeurtenis. Gebeurtenissen die na deze tijdsspanne starten zullen niet als aankomende gebeurtenis getoond worden. Merk op dat **er geen garantie is** dat alle gebeurtenissen die in dit tijdsframe starten getoond worden: als er teveel zijn (meer dan de instelling Maximum aantal aankomende gebeurtenissen) dan zullen de gebeurtenissen het verst in de toekomst niet getoond worden.';
$string['pref_maxevents'] = 'maximumaantal getoonde activiteiten';
$string['pref_maxevents_help'] = 'Dit stelt het maximum aantal aankomende gebeurtenissen in die getoond kunnen worden. Als je een groot aantal hier kiest, dan is het mogelijk dat de aankomende gebeurtenissen een grote plaats innemen op je scherm.';
