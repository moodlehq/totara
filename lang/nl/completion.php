...
/**
 * Strings for component 'completion', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   completion
...
$string['addcourseprerequisite'] = 'Voeg cursusvereiste toe';
$string['afterspecifieddate'] = 'Na opgegeven datum';
...
$string['completiononunenrolment'] = 'Voltooien bij aanmelding';
$string['completionsettingslocked'] = 'Instellingen voor voltooien geblokkeerd';
$string['completionstartonenrol'] = 'Het volgen van voltooide taken begint bij aanmelding';
$string['completionstartonenrolhelp'] = 'Begin met het volgen van de vooruitgang van een leerling door een cursus onmiddellijk na de aanmelding in de cursus';
...
$string['courseprerequisites'] = 'Cursusvereisten';
...
$string['coursesavailableexplaination'] = 'De criteria voor het voltooien van een cursus moeten ingesteld zijn om in deze lijst te verschijnen.';
$string['criteria'] = 'Criteria';
$string['criteriagradenote'] = 'Merk op dat het updaten van het vereiste cijfer hier het huidige cijfer voor het slagen in de cursus niet zal aanpassen.';
...
$string['days'] = 'Dagen';
$string['daysafterenrolment'] = 'Dagen na aanmelding';
$string['deletecoursecompletiondata'] = 'Verwijder gegevens voor voltooien cursus';
...
$string['durationafterenrolment'] = 'Duur na aanmelding';
...
$string['enrolmentduration'] = 'Overblijvende dagen';
...
$string['err_noroles'] = 'Er zijn geen rollen met de mogelijkheid \'moodle/course:markcomplete\' in deze cursus. Je kunt dit criteriumtype inschakelen door deze mogelijkheid aan de rol(len) toe te voegen.';
...
$string['graderequired'] = 'Vereist cijfer';
$string['gradexrequired'] = '{$a} vereist';
$string['inprogress'] = 'Bezig';
$string['manualcompletionby'] = 'Manueel voltooid door';
...
$string['overallcriteriaaggregation'] = 'Algemeen criteriumtype aggregatie';
$string['pending'] = 'Bezig';
$string['periodpostenrolment'] = 'Periode na aanmelding';
$string['prerequisites'] = 'Vereisten';
$string['prerequisitescompleted'] = 'Vereisten voltooid';
