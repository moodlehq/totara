...
/**
 * Strings for component 'editor_tinymce', language 'nl', branch 'MOODLE_22_STABLE'
 *
...
$string['advanced:bullist_desc'] = 'Opsommingstekens';
...
$string['advanced:hr_desc'] = 'Scheidingslijn invoegen';
...
$string['advanced:numlist_desc'] = 'Nummering';
...
$string['advanced:toolbar_focus'] = 'Spring naar werkbalk - Alt+Q, Spring naar tekst - Alt-Z, Spring naar elementpad - Alt-X';
...
$string['advanced:visualaid_desc'] = 'Hulplijnen weergeven';
...
$string['advanced_dlg:charmap_title'] = 'Symbolen';
$string['advanced_dlg:code_title'] = 'HTML Bron';
...
$string['advhr:advhr_desc'] = 'Scheidingslijn';
...
$string['advlink_dlg:is_email'] = 'De ingevoerde URL lijkt op een e-mailadres. Wilt u de vereiste mailto: tekst voorvoegen?';
$string['advlink_dlg:is_external'] = 'De ingevoerde URL lijkt op een externe link. Wilt u de vereiste http:// tekst voorvoegen?';
...
$string['advlink_dlg:popup_props'] = 'Popup eigenschappen';
...
$string['advlink_dlg:target_parent'] = 'In bovenliggend venster / frame openen';
$string['advlink_dlg:target_same'] = 'In dit venster / frame openen';
...
$string['common:browseimage'] = 'Zoek of upload een afbeelding...';
$string['common:browsemedia'] = 'Zoek of upload een geluid, video, applet, ...';
...
$string['common:popup_blocked'] = 'U zult uw popup-blocker tijdelijk moeten uitschakelen voor deze website om gebruik te kunnen maken van alle functies van deze teksteditor.';
...
$string['dragmath:dragmath_desc'] = 'Vergelijking invoegen';
$string['dragmath:dragmath_javaneeded'] = 'Om deze pagina te gebruiken heb je een browser met Java-ondersteuning nodig. Download de meest recente Java plugin van {$a}';
$string['dragmath:dragmath_title'] = 'DragMath vergelijkingseditor';
...
$string['fullscreen:desc'] = 'Volledig scherm';
...
$string['media_dlg:filename'] = 'Bestandsnaam';
$string['media_dlg:flash_options'] = 'Flash opties';
$string['media_dlg:flashvars'] = 'Variabelen';
$string['media_dlg:flv_autostart'] = 'Automatisch afspelen';
$string['media_dlg:flv_buffer'] = 'Buffer';
$string['media_dlg:flv_defaultvolume'] = 'Standaard volume';
$string['media_dlg:flv_hiddengui'] = 'GUI verbergen';
$string['media_dlg:flv_jscallback'] = 'JS Callback';
$string['media_dlg:flv_loop'] = 'Herhalen';
$string['media_dlg:flv_options'] = 'Flash video-opties';
$string['media_dlg:flv_scalemode'] = 'Schaalmodus';
$string['media_dlg:flv_showscalemodes'] = 'Schaalmodus weergeven';
$string['media_dlg:flv_smoothvideo'] = 'Soepele video';
$string['media_dlg:flv_startimage'] = 'Startafbeelding';
$string['media_dlg:flv_starttime'] = 'Starttijd';
...
$string['media_dlg:qt_stream_warn'] = 'Gestreamde RTSP bronnen dienen op het tabblad geavanceerd bij Quicktime bron te worden opgegeven.
De niet-gestreamde versie kan dan bij het tabblad algemeen worden opgegeven.';
$string['media_dlg:qtsrc'] = 'Quicktime bron';
$string['media_dlg:qtsrcchokespeed'] = 'Chokesnelheid';
$string['media_dlg:quality'] = 'Kwaliteit';
$string['media_dlg:rate'] = 'Snelheid';
$string['media_dlg:rmp_options'] = 'Real mediaspeler opties';
...
$string['media_dlg:swstretchstyle'] = 'Schaal';
...
$string['pagebreak:desc'] = 'Pagina-einde invoegen';
$string['paste:paste_text_desc'] = 'Als platte tekst plakken';
$string['paste:paste_word_desc'] = 'Vanuit Word plakken';
$string['paste:plaintext_mode'] = 'Plakken is nu in plattetekstmoduse. Klik nog een keer om terug te gaan naar normaal plakken.';
$string['paste:plaintext_mode_sticky'] = 'Plakken is nu in plattetekstmodus. Klik nog een keer om terug te gaan naar normaal plakken. Nadat u iets plakt, keert u terug naar normaal plakken.';
$string['paste:selectall_desc'] = 'Alles selecteren';
$string['paste_dlg:text_linebreaks'] = 'Regelafbreking bewaren';
$string['paste_dlg:text_title'] = 'Gebruik Ctrl+V om tekst in het venster te plakken.';
$string['paste_dlg:word_title'] = 'Gebruik Ctrl+V om tekst in het venster te plakken.';
...
$string['searchreplace_dlg:allreplaced'] = 'Alle instanties van de zoekterm zijn vervangen.';
...
$string['spellchecker:desc'] = 'Spellingcontrole';
...
$string['style_dlg:text_underline'] = 'Onderstrepen';
...
$string['table:desc'] = 'Nieuwe tabel invoegen';
...
$string['table_dlg:cellspacing'] = 'Ruimte om cel';
...
$string['visualchars:desc'] = 'Zichtbare symbolen';
...
$string['xhtmlxtras_dlg:fieldset_events_tab'] = 'Element Gebeurtenissen';
...
$string['xhtmlxtras_dlg:title_abbr_element'] = 'Afkorting';
$string['xhtmlxtras_dlg:title_acronym_element'] = 'Synoniem';
$string['xhtmlxtras_dlg:title_cite_element'] = 'Citaat';
$string['xhtmlxtras_dlg:title_del_element'] = 'Verwijderingselement';
$string['xhtmlxtras_dlg:title_ins_element'] = 'Invoegingselement';
