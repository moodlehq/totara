...
/**
 * Strings for component 'quiz', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   quiz
...
* Zal de test in een volledig scherm popup verschijnen dat alle andere schermen bedekt en geen navigatiecontrole heeft.
...
$string['configpopup'] = 'Dwing de testpoging in een popup-venster en gebruik javascript truukjes om kopiëren, plakken en dergelijke te verhinderen tijdens testen.';
...
$string['emailnotifysmall'] = '{$a->studentname} heeft {$a->quizname} voltooid';
...
$string['modulename_help'] = 'Met de testmodule kan de leraar een set testen ontwerpen die bestaan uit meerkeuze, waar/onwaar, koppel en andere vragentypes. Elke poging wordt automatisch beoordeeld en de leraar kan kiezen of die feedback geeft en/of juiste antwoorden toont.';
...
$string['showinsecurepopup'] = 'Gebruik een \'veilig\' popupvenster voor pogingen';
...
$string['totalpointsx'] = 'Totaalcijfer: {$a}';
...
$string['updatingthegradebook'] = 'Cijferboek updaten';
$string['upgradesure'] = '<div>Vooral de testmodule zal ingrijpende wijzigingen aanbrengen aan de tabellen. Deze upgrade is nog onvoldoende getest. Het is echt noodzakelijk dat je eerst een backup van je databank  maakt voor je verder gaat.</div>';
...
$string['warningmissingtype'] = '<b>Dit vraagtype is nog niet geïnstalleerd op je Moodleserver.<br />Verwittig je Moodle beheerder.</b>';
