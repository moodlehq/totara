...
/**
 * Strings for component 'enrol_database', language 'nl', branch 'MOODLE_22_STABLE'
 *
...
$string['dbhost_desc'] = 'Type databankserver, IP-adres of hostnaam';
...
$string['newcoursecategory'] = 'Veld voor nieuwe cursuscategorie ID';
