...
/**
 * Strings for component 'backup', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   backup
...
$string['autoactivedescription'] = 'Kies om al dan niet automatische backups te doen. Als manueel is geselecteerd, dan zullen automatische backups enkel mogelijk zijn met het automatische backups Command Line Interface script. Dit kan dan manueel gedaan worden via de command line of via cron.';
...
$string['automatedbackupschedulehelp'] = 'Dagen van de week om automatische backups uit te voeren';
$string['automatedbackupsinactive'] = 'Automatische backups zijn niet ingeschakeled door de site-beheerder.';
$string['automatedbackupstatus'] = 'Status van geplande backup';
$string['automatedsettings'] = 'Instellingen geplande backup';
$string['automatedsetup'] = 'Instellingen automatische backup';
$string['automatedstorage'] = 'Opslag automatische backup';
$string['automatedstoragehelp'] = 'Kies de plaats waar automatische backups terecht moeten komen.';
$string['backupactivity'] = 'Backup activiteit: {$a}';
$string['backupcourse'] = 'Backup cursus: {$a}';
...
$string['backupdetails'] = 'Backupdetails';
$string['backupdetailsnonstandardinfo'] = 'Het gekozen bestand is geen standaard Moodle backup bestand. Het terugzetproces zal proberen het bestand in standaard moodleformaat om te zetten en het dan terug te zetten.';
...
$string['backupsection'] = 'Backup cursussectie: {$a}';
$string['backupsettings'] = 'Backupinstellingen';
...
$string['backupstage4action'] = 'Backup starten';
...
$string['backupversion'] = 'Backupversie';
$string['cannotfindassignablerole'] = 'De {$a} rol in het backupbestand kan niet gekoppeld worden aan één van de rollen die je mag toewijzen.';
$string['choosefilefromactivitybackup'] = 'Backupzone voor activiteiten';
$string['choosefilefromactivitybackup_help'] = 'Wanneer backupactiviteiten standaard instellingen gebruiken, dan zullen de bestanden hier bewaard worden';
$string['choosefilefromautomatedbackup'] = 'Automatische backups';
$string['choosefilefromautomatedbackup_help'] = 'Bevat automatisch gegenereerde backups';
$string['choosefilefromcoursebackup'] = 'Cursus backup zone';
$string['choosefilefromcoursebackup_help'] = 'Als je backups maakt van cursussen met de standaardinstellingen, dan zullen de backupbestanden hier bewaard worden.';
$string['choosefilefromuserbackup'] = 'Private backupzone';
$string['choosefilefromuserbackup_help'] = 'Wanneer je een backup maakt van cursussen met de "Maak gebruikersinfo anoniem"optie ingeschakeld, dan zullen backupbestanden hier bewaard worden';
$string['configgeneralactivities'] = 'Stelt de standaardinstelling  in voor het opnemen van activiteiten in een backup';
...
$string['configgeneralblocks'] = 'Stelt de standaardinstelling  in voor het opnemen van blokken in een backup';
$string['configgeneralcomments'] = 'Stelt de standaardinstelling  in voor het opnemen van commentaren in een backup';
$string['configgeneralfilters'] = 'Stelt de standaardinstelling  in voor het opnemen van filters in een backup';
$string['configgeneralhistories'] = 'Stelt de standaardinstelling  in voor het opnemen van de gebruikersgeschiedenis in een backup';
$string['configgenerallogs'] = 'Indien ingeschakeld zullen logs standaard in alle backups opgenomen worden';
$string['configgeneralroleassignments'] = 'Indien ingeschakeld zullen standaard alle roltoewijzigen opgenomen worden in backups';
$string['configgeneralusers'] = 'Stelt de standaardinstelling  in voor het opnemen van gebruikers in backups';
$string['configgeneraluserscompletion'] = 'Indien ingeschakeld zal de informatie over het voltooien van cursusonderdelen standaard in backups worden opgenomen.';
$string['configloglifetime'] = 'Dit specifiëert hoelang je de backup logs wil bijhouden. Oudere logs dan de hier opgegeven tijd worden automatisch verwijderd. Het wordt aangeraden deze waarde klein te houden, want backup logs kunnen zeer groot worden.';
$string['confirmcancel'] = 'Annuleer backup';
...
$string['currentstage8'] = 'Backup uitvoeren';
$string['dependenciesenforced'] = 'Je instellingen zijn gewijzigd omdat aan sommige afhankelijkheden niet voldaan werd';
$string['enterasearch'] = 'Start een zoekopdracht';
$string['error_block_for_module_not_found'] = 'Verweesde blok instantie (id: {$a->bid}) voor cursus module (id: {$a->mid}) gevonden. Dit blok zal niet gebackuped worden.';
$string['error_course_module_not_found'] = 'Verweesde cursus module  (id: {$a}) gevonden. Deze module zal niet gebackuped worden.';
$string['errorfilenamemustbezip'] = 'De bestandsnaam die je opgeeft moet een ZIP-bestand zijn en de .mbz-extentie hebben';
$string['errorfilenamerequired'] = 'Je moet een geldige bestandsnaam opgeven voor deze backup';
$string['errorinvalidformat'] = 'Onbekend backupformaat';
$string['errorinvalidformatinfo'] = 'Het gekozen bestand is geen geldig Moodle backupbestand en kan niet teruggezet worden.';
$string['errorminbackup20version'] = 'Dit backupbestand is gemaakt met een ontwikkelversie van Moodle backup ({$a->backup}). De minimumvereiste is {$a->min}. Kan niet teruggezet worden.';
$string['errorrestorefrontpage'] = 'Terugzetten over de startpagina is niet toegestaan.';
$string['executionsuccess'] = 'Je backup-bestand is klaar.';
...
$string['generalbackdefaults'] = 'Algemene standaardinstellingen voor backup';
...
$string['generalsettings'] = 'Algemene backupinstellingen';
...
$string['lockedbyconfig'] = 'Deze instelling is geblokkeerd door de standaard backupinstellingen';
...
$string['managefiles'] = 'Beheer backupbestanden';
...
$string['originalwwwroot'] = 'URL van de backup';
$string['previousstage'] = 'Vorige';
$string['qcategory2coursefallback'] = 'De vragencategorie "{$a->name}" die oorspronkelijk op systeem/cursus categorie context in het backup bestand zat, zal in de cursus context gemaakt worden bij het terugzetten.';
$string['qcategorycannotberestored'] = 'De vragencategorie "{$a->name}" kan tijdens het terugzetten niet gemaakt worden';
$string['question2coursefallback'] = 'De vragencategorie "{$a->name}" die oorspronkelijk op systeem/cursus categorie context in het backup bestand zat, zal in de cursus context gemaakt worden bij het terugzetten;';
...
$string['restoretocurrentcourseadding'] = 'Voeg de backup cursus in deze cursus';
...
$string['rootsettings'] = 'Backup-instellingen';
...
$string['sectioninc'] = 'Ingevoegd in backup (geen gebruikersinformatie)';
$string['sectionincanduser'] = 'In backup samen met gebruikersinformatie';
...
$string['storagecourseandexternal'] = 'Cursusbackups in cursusbestandszone en alternatieve map';
$string['storagecourseonly'] = 'Cursusbackups in cursusbestandszone';
$string['storageexternalonly'] = 'Alternatieve map voor automatische backups';
