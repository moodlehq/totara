...
/**
 * Strings for component 'tool_dbtransfer', language 'nl', branch 'MOODLE_22_STABLE'
 *
...
$string['dbexport'] = 'Databank transfer';
$string['dbtransfer'] = 'Databank export';
...
$string['transferdbintro'] = 'Dit script zal de inhoud van de databank naar een andere databank-server.';
