...
/**
 * Strings for component 'enrol_self', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol_self
...
$string['enrolperiod_desc'] = 'Standaard tijdsduur van de geldigheid van de aanmelding (in seconden). Indien 0, dan zal de aanmelding onbeperkt gelden;';
...
$string['maxenrolled_help'] = 'Bepaalt het maximum aantal gebruikers dat zich kunnen aanmelden in de cursus. 0 betekent geen limiet.';
$string['maxenrolledreached'] = 'Maximum aantal gebruikers die zich mogen aanmelden was al bereikt.';
