...
/**
 * Strings for component 'message', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['couldnotfindpreference'] = 'Laden van voorkeur {$a} mislukt. Komt het onderdeel en de naam die je ingaf in message_send() overeen met een rij in message_providers? Message providers moeten aanwezig zijn in de database zodat de gebruikers kunnen instellen hoe ze verwittigd worden bij de ontvangst van berichten.';
...
$string['notpermitted'] = 'Niet toegestaan';
