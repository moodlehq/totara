...
/**
 * Strings for component 'survey', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   survey
...
$string['modulename_help'] = 'De onderzoeksmodule voorziet in drie types onderzoeksinstrumenten voor het beoordelen en stimuleren van leren in online omgevingen. De leraar kan ze gebruiken om gegevens te verzamelen die zullen helpen bij het leren over hun klas en te reflecteren over het eigen lesgeven.';
