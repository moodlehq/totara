...
/**
 * Strings for component 'report_security', language 'nl', branch 'MOODLE_22_STABLE'
 *
...
$string['check_riskbackup_warning'] = '{$a->rolecount} rollen gevonden, {$a->overridecount} overschijvingen en  {$a->usercount} gebruikers met de mogelijkheid gebruikersgegevens te backuppen.';
