...
/**
 * Strings for component 'data', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   data
...
$string['modulename_help'] = 'De databank activiteitsmodule maakt het voor deelnemers mogelijk om gegevensbank te maken, onderhouden en te doorzoeken. De opmaak en structuur ervan is haast grenzeloos, denk aan afbeeldingen, bestanden, URL\'s, getallen, tekst en nog heel wat meer.';
