...
/**
 * Strings for component 'assignment', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   assignment
...
$string['emailstudents'] = 'Email een verwittiging naar alle leerlingen';
...
$string['maxpublishstate'] = 'Maximum zichtbaarheid voor een blogitem voor de indiendatum';
$string['messageprovider:assignment_updates'] = 'Opdracht notities';
