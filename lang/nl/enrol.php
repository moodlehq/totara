...
/**
 * Strings for component 'enrol', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol
...
$string['deleteinstanceconfirm'] = 'Wil je echt de aanmeldingsplugin "{$a->name}" met {$a->users} aangemelde gebruikers verwijderen?';
...
$string['uninstallconfirm'] = 'Je bent bezig met de aanmeldingsplugin \'{$a}\' volledig te verwijderen. Dit zal alles wat geassocieerd is met dit aanmeldingstype uit de databank verwijderen. Ben je er zeker van dat je wil verder gaan?';
