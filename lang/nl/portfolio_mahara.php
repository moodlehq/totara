...
/**
 * Strings for component 'portfolio_mahara', language 'nl', branch 'MOODLE_22_STABLE'
 *
...
$string['err_invalidhost_help'] = 'Deze plugin is fout geconfigureerd en verwijst naar een ongeldige (of verwijderde) MNET host. Deze plugin werkt met Moodle Networking servers met SSO IDP gepubliceerd, SSO_SP en portfolio ingeschreven **en** gepubliceerd.';
...
$string['err_nomnethosts_help'] = 'Deze plugin steunt op Moodle Netwerk peers met SSO IDP gepubliceerd, SSO SP ingeschreven, portfolio services gepubliceerd **en** ingeschreven en ook op de MNet authenticatieplugin. Alle instanties van deze plugin zijn op niet zichtbaar gezet tot aan deze voorwaarden voldaan is. Ze moeten dan manueel terug op zichtbaar gezet worden.';
