...
/**
 * Strings for component 'theme_nimble', language 'nl', branch 'MOODLE_22_STABLE'
 *
...
$string['backgroundcolor'] = 'Achtergrond hoofding';
$string['backgroundcolordesc'] = 'Wijzig de achtergrondkleur van de hoofding';
...
$string['linkhover'] = 'Menu hover kleur';
$string['linkhoverdesc'] = 'Stelt de kleur in van het menu bij hoveren in dit thema. Gebruik HTML hex code.';
$string['pluginname'] = 'Nimble';
$string['region-side-post'] = 'Rechts';
$string['region-side-pre'] = 'Links';
$string['tagline'] = 'Tag-lijn';
$string['taglinedesc'] = 'Laat een tag-lijn verschijnen onder de site-naam op de startpagina';
