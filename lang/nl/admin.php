...
/**
 * Strings for component 'admin', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['assessorroleid'] = 'Rol voor beoordelaar';
...
$string['backup_shortname'] = 'Gebruik de cursusnaam in de bestandsnaam van de backup';
$string['backup_shortnamehelp'] = 'Gebruik de cursusnaam als deel van de bestandsnaam van de backup in de plaats van het cursusID-nummer';
...
$string['blockprotect'] = 'Bescherm tegen verwijderen';
$string['blockprotect_help'] = 'Het geselecteerde blok is beschermd tegen verwijderen uit de site-brede context. Dit wordt vooral gebruikt om het navigatie- en instellingenblok te beschermen, omdat die erg moeilijk zijn om terug te zetten indien ze per ongeluk verwijderd worden.';
...
$string['checksum'] = 'Som controleren';
...
$string['configconvertformat'] = 'Als <i>latex</i>, <i>dvips</i> en <i>convert</i> beschikbaar zijn, dan kunnen de afbeeldingen gemaakt worden met het opgegeven formaat. Anders zal mimeTeX gebruikt worden en dat maakt GIF-afbeeldingen.';
...
$string['configforcelogintotara'] = 'Standaard is deze site alleen beschikbaar voor ingelogde gebruikers. Activeer deze optie om de Startpagina en de lijst met cursussen ook beschikbaar te stellen voor bezoekers die niet zijn ingelogd. Uiteraard blijft de cursusinhoud alleen toegangelijk voor ingelogde gebruikers.';
...
$string['confignavshowallcourses'] = 'Instelling die verzekert dat alle cursussen van de site altijd getoond worden in de navigatie.';
...
$string['configpasswordreuselimit'] = 'Aantal malen dat een wachtwoord moet zijn aangepast voordat een wachtwoord mag worden hergebruikt';
...
$string['configrestrictmodulesfor'] = 'Voor welke cursussen moet <b>ingesteld worden</b> om enkele modules uit te schakelen? Merk op dat deze instelling alleen geldt voor leraren, beheerders zullen nog wel alle activiteiten aan cursussen kunnen toevoegen.';
...
$string['configstatsmaxruntime2'] = 'Het berekenen van statistieken kan voor je server een zeer belastende taak zijn. Specifiëer een maximum tijd dat de server mag werken aan de statistieken van één dag. Het maximum aantal verwerkte dagen per cron cyclus is 31.';
...
$string['configstatsruntimestart'] = 'Op welk tijdstip moet de crontaak die de statistieken verwerk <b>starten</b>? Geef verschillende tijden op als er meerdere Moodles op één fysieke machine staan.';
$string['configstatsuserthreshold'] = 'Deze instelling geeft het minimum aantal aangemelde gebruikers die een cursus moet hebben om in de statistiekenberekeningen opgenomen te worden.';
...
$string['configuserquota'] = 'Het maximum aantal bytes dat een gebruiker kan bewaren in zijn eigen bestandenzone. {$a->bytes} bytes == {$a->displaysize}';
...
$string['cron'] = 'Cron';
$string['cron_execute'] = 'Uitvoeren';
$string['cron_execution_crashed'] = 'Cron uitvoeren mislukt';
$string['cron_execution_running'] = 'Cron wordt uitgevoerd';
$string['cron_execution_status'] = 'Status';
$string['cron_execution_stopped'] = 'Cron is gestopt';
$string['cron_execution_watch'] = 'Uitvoering Cron';
...
$string['cron_kill_mail_fail_notify_msg'] = 'De uitvoering duurde langer dan de maximaal toegestane tijd maar kon niet automatisch worden stopgezet. Controleer de instellingen op de server.';
$string['cron_kill_mail_fail_notify_title'] = 'Let op! Uitvoering niet automatisch gestopt.';
$string['cron_kill_mail_notify_msg'] = 'De uitvoering duurde langer dan de maximaal toegestane tijd en is daarom automatisch stopgezet. Controleer de instellingen op de server.';
$string['cron_kill_mail_notify_title'] = 'Let op! Uitvoering automatisch gestopt.';
$string['cron_max_time'] = 'Maximale uitvoertijd';
$string['cron_max_time_info'] = 'Stel de maximale utivoertijd in uren in. De standaardwaarde is 0, wat betekent dat de cron onbeperkt blijft uitvoeren.';
$string['cron_max_time_kill'] = 'Cron automatisch stoppen';
$string['cron_max_time_kill_info'] = 'Selecteer deze optie om de cron automatisch te stoppen als de maximale uitvoertijd is bereikt. Hiervoor is installatie van Cron Watcher vereist.';
$string['cron_max_time_mail_notify'] = 'Systeembeheerders informeren';
$string['cron_max_time_mail_notify_info'] = 'Selecteer deze optie om systeembeheerders te informeren als de maximale uitvoertijd wordt bereikt. Hiervoor is installatie van Cron Watcher vereist';
$string['cron_max_time_mail_notify_msg'] = 'De maximale uitvoertijd van de Cron is verstreken. Controleer de serverinstellingen.';
$string['cron_max_time_mail_notify_title'] = 'Let op! Cron niet volledig uitgevoerd';
$string['cron_refresh'] = 'Vernieuwen';
$string['cron_settings'] = 'Cron';
$string['cron_status_info'] = 'Status Cron';
$string['cron_terminate'] = 'Beëindigen';
$string['cron_watcher_info'] = 'Cron-bewaking';
...
$string['deletefilterareyousure'] = 'Ben je er zeker van dat je filter \'{$a}\' wil verwijderen';
$string['deletefilterareyousuremessage'] = 'Je gaat filter \'{$a}\' volledig verwijderen. Weet je zeker dat je die van je installatie wil verwijderen?';
$string['deletefilterfiles'] = 'Alle gegevens die met filter \'{$a->filter}\' geassocieerd zijn, zijn uit de databank verwijderd. Om het verwijderen af te ronden (en om te verhinderen dat de filter zichzelf herinstalleerd), moet je nu volgende map van je filter verwijderen: {$a->directory}';
...
$string['deletingfilter'] = 'Filter \'{$a}\' verwijderen';
...
$string['displayerrorsset'] = 'Voor deze site worden foutmeldingen getoond.<br />Deze instelling wordt niet geadviseerd voor productie-sites. <br />Vink <em>Foutmeldingen tonen</em> uit onder <a href="{$a->link}">Server/Debugging</a> in het menu Beheer.';
...
$string['enablecourseajax'] = 'Schakel AJAX cursusbewerken in';
$string['enablecourseajax_desc'] = 'Laat AJAX toe voor het bewerken van cursuspagina\'s. Merk op dat de cursusopmaak en het gebruikte thema AJAX-bewerken moeten ondersteunen en de gebruiker moet AJAX ingeschakeld hebben op zijn profiel.';
...
$string['frontpageitem'] = 'Startpagina-item {$a}';
$string['frontpageitemloggedin'] = 'Startpagina-item {$a} wanneer ingelogd';
...
$string['googlemapkey'] = 'Google Maps API sleutel';
...
$string['learnerroleid'] = 'Rol cursist';
$string['legacyfilesinnewcourses'] = 'Standaard cursusbestanden in nieuwe cursussen';
$string['legacyfilesinnewcourses_help'] = 'Standaard zijn de verouderde cursusbestanden alleen beschikbaar in geüpgraded cursussen. Merk op dat sommige functies zoals backup/terugzetten van afzonderlijke activiteiten niet compatibel zijn met deze instelling.';
...
$string['moodlerelease'] = 'Moodle-release identificeren';
...
$string['mypage'] = 'Standaard Mijn Moodle-pagina';
...
$string['navlinkcoursesections'] = 'Link cursussecties';
$string['navlinkcoursesections_help'] = 'Indien ingeschakeld zullen secties van cursussen getoond worden als links in de navigatie.';
...
$string['numcoursesincombo'] = 'Maximum aantal cursussen in combo lijst';
$string['numcoursesincombo_help'] = 'De combo-lijst werkt niet goed met een groot aantal cursussen. Wanneer het totaal aantal cursussen in de site hoger is dan deze instelling, dan zal een link getoond worden in plaats van te proberen alle cursussen op de startpagina te tonen.';
...
$string['orgname'] = 'Naam organisatie';
$string['orgnamehelp'] = 'De naam van je organisatie';
$string['passwordpolicy'] = 'Wachtwoordbeleid';
$string['passwordreuselimit'] = 'Wachtwoordrotatie beperken';
...
$string['profilevisible_help'] = 'Elk eigen profielveld kan drie mogelijke instellingen hebben voor wie het veld kan zien: onzichtbaar, iedereen of gebruiker. Deze keuze wordt gemaakt door een beheerder die privégegevens van de gebruikers wil bewaren. \'Gebruiker\' wordt meestal gekozen wanneer dat veld gevoelige informatie bevat, terwijl \'iedereen\' gekozen wordt voor andere informatie.';
...
$string['purgecaches'] = 'Alle cache leegmaken';
...
$string['purgecachesfinished'] = 'Alle cache is leeggemaakt.';
...
$string['registrationdisabled'] = 'Niet actief';
$string['registrationenabled'] = 'Actief';
$string['registrationinformation'] = 'Registratiegegevens verzenden';
$string['registrationisdisabled'] = 'Registratie is uitgeschakeld. Het is raadzaam om basisgegevens bij Totara te registeren, zodat Totara ondersteuning kan bieden.<br />Je kunt registratie inschakelen op de pagina <a href="{$a}">Registratie</a>';
$string['registrationisenabled'] = 'Registratie actief';
$string['registrationoutofdate'] = 'Registratiegegevens zijn al enige tijd niet verzonden. Het is belangrijk dat deze gegevens up-to-date zijn.';
...
$string['reportsdeleteconfirm'] = 'Je gaat het volledige rapport \'{$a}\' verwijderen. Dat zal alles in de databank dat verband houdt met deze plugin verwijderen. Ben je er zeker van dat je verder wil doen?';
...
$string['restorernewroleid'] = 'De rol in cursussen van degene die een backup terugzet';
...
$string['sitefullname'] = 'Volledige naam systeem';
$string['sitehasntregistered'] = 'Registratiegegevens zijn al enige tijd niet verzonden. Het is belangrijk dat deze gegevens up-to-date zijn. <a href="{$a}">Klik hier</a> om de cron handmatig uit te voeren.';
$string['siteidentifier'] = 'Code systeem';
...
$string['siteshortname'] = 'Korte naam systeem';
...
$string['techsupportemail'] = 'E-mailadres support';
$string['techsupportemailhelp'] = 'E-mailadres voor systeemondersteuning';
$string['techsupportphone'] = 'Telefoonnummer support';
$string['techsupportphonehelp'] = 'Telefoonnummer voor systeemondersteuning';
$string['themedesignermode'] = 'Thema ontwerpermodus';
$string['themelist'] = 'Thema lijst';
$string['themenoselected'] = 'Geen thema gekozen';
$string['themeresetcaches'] = 'Ongeldige themacache';
...
$string['toolsdeleteconfirm'] = 'U staat op het punt de administratieve tool \'{$a}\' te verwijderen. Dit zal alles alles in de database verwijderen wat gelinkt is aan deze plugin. Bent u zeker dat u wil verdergaan?';
$string['toolsmanage'] = 'Beheer beheertools';
$string['totarabuild'] = 'Totara build';
$string['totararegistration'] = 'Totara-registratie';
$string['totararegistrationinfo'] = '<p>Op deze pagina kunnen de registratiegegevens worden bijgehouden. Als deze gegevens up-to-date zijn, kan Totara passende ondersteuning bieden.</p>\n<p>Deze gegevens worden beveiligd verzonden en vertrouwelijk behandeld</p>';
$string['totararelease'] = 'Totara release';
$string['totaraversion'] = 'Totara versie';
...
$string['upgradesure'] = 'De bestanden op je Moodleserver zijn gewijzigd en je gaat zo dadelijk je server automatisch upgraden naar versie: <br /><br /><strong>{$a}</strong><br /><br />
Als je dit doet, kun je niet meer terug.<br /><br />
Ben je er er zeker van dat je deze server naar die versie wil upgraden?';
...
$string['webserversoftware'] = 'Software op de server';
$string['wwwroot'] = 'Root systeem';
