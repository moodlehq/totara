...
/**
 * Strings for component 'url', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   url
...
$string['popupheight'] = 'Popup-hoogte (in pixels)';
$string['popupheightexplain'] = 'Bepaalt de standaardhoogte van popup-vensters';
$string['popupwidth'] = 'Popup-breedte (in pixels)';
$string['popupwidthexplain'] = 'Bepaalt de standaardbreedte van popup-vensters';
