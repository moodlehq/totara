...
/**
 * Strings for component 'chat', language 'nl', branch 'MOODLE_22_STABLE'
 *
 * @package   chat
...
$string['modulename_help'] = 'Met de chatmodule kunnen deelnemers een real-time synchrone discussie hebben via het internet. Dit is een goede manier om elkaar of het bediscussieerde onderwerp beter te begrijpen - de werkwijze in een chatroom is anders dan in asynchrone forums.';
