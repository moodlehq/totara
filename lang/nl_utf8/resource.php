...
$string['chooseaparameter'] = 'Kies een parameter ...';
...
$string['keepnavigationvisibleno'] = 'Nee';
$string['keepnavigationvisibleyesframe'] = 'Ja, met frame';
$string['keepnavigationvisibleyesobject'] = 'Ja, zonder frame';
...
$string['navigationmenu'] = 'Zijmenu navigatie';
$string['navigationup'] = 'Knop Omhoog';
...
$string['resourcetypeims'] = 'Publiceer een IMS-pakket';
$string['resourcetypelabel'] = 'Label toevoegen';
$string['resourcetyperepository'] = 'Link naar een object uit de bibliotheek';
