...
$string['addcategoryerror'] = 'Categorie toevoegen mislukt';
...
$string['addgradeletter'] = 'Letter toevoegen';
$string['addidnumbers'] = 'Codenummers toevoegen';
$string['additem'] = 'Scoreobject toevoegen';
$string['addoutcome'] = 'Resultaat toevoegen';
$string['addoutcomeitem'] = 'Resultaatobject toevoegen';
$string['addscale'] = 'Schaal toevoegen';
...
$string['aggregationcoefextrahelp'] = 'Bonus voor dit beoordelingsobject tijdens aggregatie';
$string['aggregationcoefextrasum'] = 'Bonus';
$string['aggregationcoefextrasumhelp'] = 'Bonus voor dit beoordelingsobject tijdens aggregatie';
...
$string['aggregationcoefweight'] = 'Weging beoordelingsobject';
$string['aggregationcoefweighthelp'] = 'Weging, toegepast op alle cijfers in dit beoordelingsobject tijdens een aggregatie met andere beoordelingsobjecten.';
...
$string['categorytotalname'] = 'Naam totaal categorietotaal';
...
$string['completeaverage'] = 'Totaal gemiddelde';
...
$string['configaveragesdecimalpoints'] = 'Het aantal te tonen decimalen voor alle gemiddelden (groep of allen) onder een kolom met beoordelingen. Dit kan gewijzigd worden per beoordelingsobject.';
...
$string['configrangesdecimalpoints'] = 'Het aantal te tonen decimalen voor elke reeks, boven een kolom met beoordelingen. Dit kan overschreven worden per beoordelingsobject.';
...
$string['configshowactivityicons'] = 'Toon een icoontje op het rapport naast elk beoordelingsobject dat gelinkt is aan een activiteit.';
$string['configshowaverages'] = 'Toon kolomgemiddeldes op het rapport';
$string['configshowcalculations'] = 'Of er berekeningsicoontjes getoond moeten worden naast elk beoordelingsobject en categorie, tooltips over berekende items en een visuele indicator wanneer een kolom berekend is.';
...
$string['configshowpercentage'] = 'Het percentage van elk beoordelingsobject moet getoond worden.';
...
$string['configshowranges'] = 'Toon een rij met de mogelijke marges voor elk beoordelingsobject in het rapport.';
$string['configshowrank'] = 'Toon een ranglijst voor elk beoordelingsobject';
...
$string['displaylettergrade'] = 'Score in letters tonen';
...
$string['editgradeletters'] = 'Letterscore aanpassen';
...
$string['excludedhelp'] = 'Als -Uitgesloten- is ingeschakeld, dan zal deze beoordeling uitgesloten worden van elke aggregatie door gelijk welk bovenliggend beoordelingsobject of categorie.';
...
$string['generalsettings'] = 'Configuratie';
...
$string['gradecategorysettings'] = 'Categorieën';
...
$string['gradeitemsettings'] = 'Beoordelingsobjecten';
$string['gradeitemsinc'] = 'Te gebruiken beoordelingsobjecten';
...
$string['gradeletters'] = 'Letterscore';
...
$string['items'] = 'Items';
$string['itemsedit'] = 'Beoordelingsobject aanpassen';
...
$string['manualitem'] = 'Manueel beoordelingsobject';
$string['mapfrom'] = 'Koppel van';
$string['mappings'] = 'Beoordelingsobjecten koppelingen';
...
$string['newitem'] = 'Nieuw beoordelingsobject';
...
$string['outcomeidhelp'] = 'De competentie waarvoor dit beoordelingsobject staat.';
...
$string['plusfactorhelp'] = 'Getal dat toegevoegd zal worden aan elke cijfer voor dit beoordelingsobject, nadat de multiplicator is toegepast.';
...
$string['reportsettings'] = 'Rapportage';
...
$string['usedgradeitem'] = 'Gebruikt beoordelingsobject';
