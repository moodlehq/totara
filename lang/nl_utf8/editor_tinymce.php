...
$string['advlink_dlg:classes'] = 'Klasses';
...
$string['common:popup_blocked'] = 'U zult uw popup-blocker tijdelijk moeten uitschakelen voor deze website om gebruik te kunnen maken van alle fucties van deze teksteditor.';
...
$string['emotions_dlg:frown'] = 'Wenkbrouw ophalen';
...
$string['insertdatetime:day_short'] = 'Zo,Ma,Di,Wo,Do,Vr,Zat,Zon';
...
$string['media_dlg:flv_defaultvolume'] = 'Standaard volumne';
...
$string['table_dlg:row_all'] = 'Alle rijen bijweken';
...
$string['template:desc'] = 'Voorgedefineerd sjabloon invoegen';
$string['template_dlg:cdate_format'] = '%%d-%%m-%%Y %%H:%%M:%%S';
$string['template_dlg:day_long'] = 'Zondag,Maandag,Dinsdag,Woensdag,Donderdag,Vrijdag,Zaterdag,Zonday';
$string['template_dlg:day_short'] = 'Zon,Ma,Di,Woe,Do,Vrij,Zat,Zon';
$string['template_dlg:desc'] = 'Voorgedefineerd sjabloon invoegen';
...
$string['template_dlg:warning'] = 'Waarschuwing: het bijwerken van een sjabloon met een andere kan informatie verwijderen.';
...
$string['xhtmlxtras_dlg:title_abbr_element'] = 'Afkoring';
