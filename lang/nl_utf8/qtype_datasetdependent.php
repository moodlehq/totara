...
$string['dataitemdefined'] = 'met $a gedefinieerde numerieke waarden is beschikbaar';
$string['datasetrole'] = 'De jokertekens <strong>{X..}</strong> zullen vervangen worden door een numerieke waarde uit hun dataset';
...
$string['itemscount'] = 'Items<br />Nummer';
...
$string['lastitem(s)'] = 'laatste item(s)';
...
$string['sharedwildcard'] = 'Gedeeld jokerteken';
