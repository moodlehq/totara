...
$string['confirmsubscribe'] = 'Aanmelden voor forum \'{$a}\'?';
$string['confirmunsubscribe'] = 'Afmelden voor forum \'{$a}\'?';
...
$string['alreadyfirstpost'] = 'Dit is al het eerste bericht in de discussie'; // ORPHANED
$string['attachmentnopost'] = 'Je kunt bijlagen niet exporteren zonder post ID'; // ORPHANED
$string['attachments'] = 'Bijlagen'; // ORPHANED
$string['cannotadd'] = 'Kon de discussie niet toevoegen aan dit forum'; // ORPHANED
$string['cannotaddsubscriber'] = 'Kon gebruiker met ID $a niet inschrijven voor het ontvangen van e-mail van dit forum!'; // ORPHANED
$string['cannotaddteacherforumto'] = 'Kon het geconverteerde leraarsforum niet toevoegen aan sectie 0 van de cursus'; // ORPHANED
$string['cannotcreatediscussion'] = 'Kon geen nieuwe discussie starten'; // ORPHANED
$string['cannotcreateinstanceforteacher'] = 'Kon geen nieuwe cursusmodule maken voor het leraarsforum'; // ORPHANED
$string['cannotdeleteforummodule'] = 'Je kan de forummodule niet verwijderen'; // ORPHANED
$string['cannoteditposts'] = 'Je kunt een bericht van andere gebruikers niet wijzigen!'; // ORPHANED
$string['cannotfinddiscussion'] = 'Kon die discussie in dit forum niet vinden'; // ORPHANED
$string['cannotfindfirstpost'] = 'Kon het eerste bericht van dit forum niet vinden'; // ORPHANED
$string['cannotfindorcreateforum'] = 'Kon geen nieuwforum maken of vinden voor deze site'; // ORPHANED
$string['cannotfindparentpost'] = 'Kon top ouder van bericht $a niet vinden'; // ORPHANED
$string['cannotmovefromsingleforum'] = 'Kan de discussie van een eenvoudig enkele discussieforum niet verplaatsen'; // ORPHANED
$string['cannotmovenotvisible'] = 'Forum niet zichtbaar'; // ORPHANED
$string['cannotmovetonotexist'] = 'Je kunt dat forum niet verplaatsen - het bestaat niet!'; // ORPHANED
$string['cannotmovetonotfound'] = 'Doelforum niet gevonden in deze cursus'; // ORPHANED
$string['cannotpurgecachedrss'] = 'Kon de RSS-feeds in de cache voor de bron en/of bestemmingsforums niet verwijderen - controleer je bestandsrechten'; // ORPHANED
$string['cannotremovesubscriber'] = 'Kon gebruiker met ID $a niet uitschrijven voor het ontvangen van e-mail van dit forum!'; // ORPHANED
$string['cannotreply'] = 'Je kunt dit bericht niet beantwoorden'; // ORPHANED
$string['cannotsplit'] = 'Discussies van dit forum kunnen niet gesplitst worden'; // ORPHANED
$string['cannotsubscribe'] = 'Je moet lid van een groep zijn om email van dit forum te kunnen ontvangen.'; // ORPHANED
$string['cannottrack'] = 'Kon het volgen van dit forum niet stoppen'; // ORPHANED
$string['cannotunsubscribe'] = 'Kon er niet voor zorgen dat je van dit forum geen mail meer ontvangt.'; // ORPHANED
$string['cannotupdatepost'] = 'Je kunt dit bericht niet updaten'; // ORPHANED
$string['configmaxattachments'] = 'Standaard maximum aantal bijlagen per bericht'; // ORPHANED
$string['errorwhiledelete'] = 'Er is een fout opgetreden bij het verwijderen van een record'; // ORPHANED
$string['forum:exportdiscussion'] = 'Exporteer de hele discussie'; // ORPHANED
$string['forum:exportownpost'] = 'Exporteer je eigen bericht'; // ORPHANED
$string['forum:exportpost'] = 'Exporteer bericht'; // ORPHANED
$string['forumadministration'] = 'Forumbeheer'; // ORPHANED
$string['invalidaccess'] = 'Deze pagina is niet correct opgevraagd'; // ORPHANED
$string['invaliddiscussionid'] = 'Discussie ID was fout'; // ORPHANED
$string['invalidforumid'] = 'Forum ID was fout'; // ORPHANED
$string['invalidparentpostid'] = 'Ouder bericht ID was fout'; // ORPHANED
$string['invalidpostid'] = 'Post ID $a was fout'; // ORPHANED
$string['maxattachments'] = 'Maximum aantal bijlagen'; // ORPHANED
$string['messageprovider:digests'] = 'Ingeschreven op forum voor verzamelemail'; // ORPHANED
$string['messageprovider:posts'] = 'Ingeschreven op forum voor berichten'; // ORPHANED
$string['mustprovidediscussionorpost'] = 'You moet ofwel een discussie ID of een bericht ID geven om te exporteren'; // ORPHANED
$string['noattachments'] = 'Er zijn geen bijlagen bij dit bericht'; // ORPHANED
$string['noguestrate'] = 'Gasten mogen geen berichten beoordelen'; // ORPHANED
$string['nopermissiontosubscribe'] = 'Je hebt het recht niet te zien wie e-mail van dit forum ontvangt'; // ORPHANED
$string['nopermissiontoview'] = 'Je mag dit bericht niet zien'; // ORPHANED
$string['norate'] = 'Beoordelen van berichten niet toegelaten!'; // ORPHANED
$string['noresult'] = 'Geen beoordelingen voor dit bericht: $a'; // ORPHANED
$string['notexists'] = 'Discussie bestaat niet meer'; // ORPHANED
$string['notinstalled'] = 'De forummodule is niet geïnstalleerd'; // ORPHANED
$string['notpartofdiscussion'] = 'Dit bericht is geen deel van een discussie!'; // ORPHANED
$string['noviewanyrate'] = 'Je kan alleen de beoordelingen zien van berichten die jij gepost hebt'; // ORPHANED
$string['noviewrate'] = 'Je hebt de mogelijkheid niet gekregen om beoordelingen van berichten te bekijken'; // ORPHANED
$string['viewalldiscussions'] = 'Bekijk alle discussies'; // ORPHANED
