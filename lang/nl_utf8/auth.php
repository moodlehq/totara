...
$string['auth_cas_certificate_check'] = 'Kies \"Ja\" om het servercertificaat te valideren.';
$string['auth_cas_certificate_check_key'] = 'Servervalidatie';
$string['auth_cas_certificate_path'] = 'Pad naar het CA Chain-bestand (PEM-formaat) om het servercertificaat te valideren';
$string['auth_cas_certificate_path_empty'] = 'Vul het pad naar het certificaat in om Servervalidatie in te kunnen schakelen.';
$string['auth_cas_certificate_path_key'] = 'Pad naar certificaat';
...
$string['auth_passchangedays'] = 'Geldigheid wachtwoord (dagen)';
$string['auth_passchangedayshelp'] = 'Kies het maximum aantal dagen dat de gebruiker hetzelfde wachtwoord kan gebruiken';
$string['auth_passexpiration'] = 'Geldigheid wachtwoord';
$string['auth_passexpirationhelp'] = 'Het is mogelijk om af te dwingen dat het wachtwoord wordt aangepast als wanneer de geldigheid is verstreken.';
$string['auth_passexpirationwarning'] = 'Waarschuwing wachtwoord aanpassen (dagen)';
$string['auth_passexpirationwarninghelp'] = 'Kies het aantal dagen voor de gedwongen aanpassing waarop de gebruiker een waarschuwing ontvangt over de verplichte aanpassing van het wachtwoord.';
...
$string['authforcedchangeinstructions'] = 'Toelichting voor gebruikers wiens wachtwoord is verlopen. Deze gebruikers worden gedwongen een nieuw wachtwoord te kiezen.';
...
$string['errorminpasswordthreeoffour'] = 'Het wachtwoord moet voldoen aan drie van deze vier criteria:';
...
$string['forcedchangeinstructions'] = 'Toelichting wachtwoord aanpassen';
