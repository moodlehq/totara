...
$string['accounts'] = 'Gebruikeraccounts';
...
$string['blocksettings'] = 'Aanpassen';
...
$string['configallowassign'] = 'Vink achter elke rol aan welke rollen men mag toewijzen aan andere gebruikers.';
...
$string['configallowoverride'] = 'Vink achter elke rol aan voor welke rollen men uitzonderingen mag instellen.';
$string['configallowoverride2'] = 'Vink achter elke rol aan voor welke rollen men uitzonderingen mag instellen. Hiervoor moet men de capaciteit moodle/role:override of moodle/role:safeoverride zijn toegekend.';
...
$string['configallowthemechangeonurl'] = 'Als je deze instelling inschakeld, dan kan het thema gewijzigd worden door theme={themname}&amp;sesskey={sesskey} aan gelijk welke Moodle-URL toe te voegen.';
...
$string['configdebugstringids'] = 'Deze optie is ontworpen om vertalers te helpen. Het taalbestand en de string-ID wordt getoond naast elke string die opgehaald wordt. (Het wijzigen van deze instelling heeft pas effect op de volgende pagina die je laadt.)';
...
$string['configenableglobalsearch'] = 'Hiermee wordt het mogelijk om de gehele site te doorzoeken, zowel in bronnen als in activiteiten. Deze functie is niet compatibel met PHP4.';
...
$string['configproxypassword'] = 'Wachtwoord nodig om door een proxy op het internet te komen, leeg indien geen wachtwoord (PHP cURL extensie nodig).';
$string['configproxyport'] = 'Als deze server een proxyserver gebruikt, zet dan hier de gebruikte poort.';
$string['configproxytype'] = 'Type web proxy (PHP5 en cURL extensie nodig voor SOCKS5 ondersteuning).';
$string['configproxyuser'] = 'Gebruikersnaam nodig om door een proxy op het internet te komen, leeg indien geen wachtwoord (PHP cURL extensie nodig).';
...
$string['ctyperecommended'] = 'Het installeren van de optionele ctype PHP extensie is aanbevolen om de performantie van de site te verhogen, vooral als op je site niet-latijnse talen gebruikt worden.';
$string['ctyperequired'] = 'De ctype PHP-extensie is nu vereist in Moodle om de performantie te verhogen en om multi-talencompatibiliteit mogelijk te maken.';
...
$string['edithelpdocs'] = 'Helpteksten aanpassen';
...
$string['editstrings'] = 'Teksten aanpassen';
...
$string['enableglobalsearch'] = 'Zoeken in site beschikbaar stellen';
...
$string['filtersettings'] = 'Aanpassen';
...
$string['frontpagequestions'] = 'Vragen';
$string['frontpagerestore'] = 'Herstellen';
$string['frontpageroles'] = 'Rollen';
$string['frontpagesettings'] = 'Aanpassen';
$string['fullnamedisplay'] = 'Volledige naam opmaak';
$string['gdrecommended'] = 'De GD-extensie wordt gebruikt voor de conversie van afbeeldingen. Sommige mogelijkeden, zoals afbeeldingen in gebruikersprofielen zullen zonder GD niet werken.';
...
$string['iconvrequired'] = 'Het installeren van de ICONV-extensie is vereist.';
$string['ignore'] = 'Negeren';
...
$string['importtimezones'] = 'Tijdzones controleren';
...
$string['intlrecommended'] = 'De Intl-extensie wordt gebruikt om internationale ondersteuning te verbeteren, zoals gelokaliseerd sorteren.';
...
$string['langpackmaintaining'] = 'Aanpassen';
...
$string['languagesettings'] = 'Configuratie';
...
$string['locationsettings'] = 'Aanpassen';
$string['log'] = 'Logs';
...
$string['mediapluginogg'] = 'Filter .ogg inschakelen';
$string['mediapluginogv'] = 'Filter .ogv inschakelen';
...
$string['modsettings'] = 'Aanpassen';
$string['modulesecurity'] = 'Activiteiten';
...
$string['notifications'] = 'Notificaties';
...
$string['optionalsubsystems'] = 'Optionele subsystemen';
...
$string['php533warning'] = 'PHP 5.3.3 of nieuwer is aanbevolen';
...
$string['purgecachesfinished'] = 'Elk cache is geleegd.';
...
$string['simplexmlrequired'] = 'De SimpleXML PHP-extensie is nu vereist voor Moodle.';
...
$string['soaprecommended'] = 'Het installeren van de optionele Soap-extensie is nuttig voor webservices en sommige modules uit contrib.';
$string['spamcleaner'] = 'Spam opkuisen';
$string['splrequired'] = 'De extensie SPL PHP is nu vereist voor Totara.';
...
$string['stickyblocks'] = 'Permanente blokken';
...
$string['tokenizerrecommended'] = 'Het installeren van de optionnele PHP Tokenizer-extensie wordt aangeraden -- het verbetert de Moodle Networking functionnaliteit';
...
$string['updatetimezones'] = 'Tijdzones controleren';
...
$string['uploadpictures'] = 'Profielfoto\'s';
...
$string['useraccountupdated'] = 'Gebruiker aangepast';
$string['userbulk'] = 'Aanpassen in bulk';
$string['userdeleted'] = 'Gebruiker verwijderd';
$string['userlist'] = 'Aanpassen';
$string['userpolicies'] = 'Configuratie';
...
$string['webproxyinfo'] = 'Vul onderstaande opties in als je Moodle server niet rechtstreeks op internet kan. Internettoegang is nodig voor de download van geografische informatie, taalpakketten, RSS-feeds, tijdzones enz.<br /><em>Je kunt best de PHP cURL extensie installeren.</em>';
...
$string['xmlrpcrecommended'] = 'Het installeren van de optionele XMLRPC-extensie is nuttig voor de werking van Moodle Netwerk';
$string['xmlstrictheaders'] = 'XML strict headers';
$string['ziprequired'] = 'De ZIP-PHP-extensie is nu vereist voor Moodle. Info-ZIP en PclZip worden niet meer gebruikt.';
