...
$string['type'] = 'Type';
$string['uncompleteindexingerror'] = 'Indexering was niet volledig afgewerkt. Herstart de indexering.';
$string['versiontoolow'] = 'Sorry, globaal zoeken vereist PHP 5.0.0 of later (je gebruikt nu versie )';
