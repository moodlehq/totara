...
$string['alertnoselectedtext'] = 'Eerst tekst selecteren!';
$string['alignment'] = 'Uitlijning';
$string['alternatetext'] = 'Alternatieve tekst';
$string['anchorhelp'] = 'Dit plaatst alleen een anker. De link moet nog worden toegevoegd.';
...
$string['clean'] = 'Eenvoudige HTML';
$string['close'] = 'Sluiten';
$string['closeafterreplace'] = 'Na vervangen sluiten';
$string['cols'] = 'Kolommen';
$string['copy'] = 'Kopiëren';
$string['createanchor'] = 'Anker toevoegen';
$string['createfolder'] = 'Map toevoegen';
$string['createlink'] = 'Hyperlink toevoegen';
$string['cut'] = 'Knippen';
...
$string['enterurlfirst'] = 'Vul eerst een URL in';
$string['filebrowser'] = 'Bladeren in bestanden';
$string['findwhat'] = 'Zoeken';
...
$string['inserthorizontalrule'] = 'Horizontale liniaal';
$string['insertimage'] = 'Afbeelding invoegen';
$string['insertlink'] = 'Link toevoegen';
$string['insertorderedlist'] = 'Nummering';
$string['insertsmile'] = 'Emoticon toevoegen';
$string['inserttable'] = 'Tabel toevoegen';
$string['insertunorderedlist'] = 'Opsommingstekens';
...
$string['minimize'] = 'Editor mimimaliseren';
$string['move'] = 'Verplaatsen';
$string['multi'] = 'Meerdere';
$string['mustenterurl'] = 'Vul de URL in';
$string['nolink'] = 'Automatisch linken voorkomen';
...
$string['popupeditor'] = 'Editor vergroten';
...
$string['showhelp'] = 'Toelichting';
$string['size'] = 'Grootte';
$string['spacing'] = 'Afstand';
$string['spellcheck'] = 'Spelling controleren';
$string['strikethrough'] = 'Doorhalen';
$string['subscript'] = 'Subscript';
$string['superscript'] = 'Superscript';
$string['textindicator'] = 'Huidige stijl';
$string['textmode'] = 'Je bent in TEKSTMODUS. Gebruik de [<>]-knop om terug om te schakelen naar WYSIWYG.';
