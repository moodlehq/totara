...
$string['backtoallframeworks'] = 'Back to all position frameworks';
...
- The \"$a\" position';
$string['deletecheckwithchildren'] = 'Are you sure you want to delete the position \"$a->itemname\" and its $a->children_string?
<br /><br />
This will remove the following data: <br />
...
$string['deleteincludexcustomfields'] = '- $a custom field records';
$string['deleteincludexposassignments'] = '- $a assignment to this position (user\'s assigned to this position will be unassigned)';
$string['deleteincludexlinkedcompetencies'] = '- $a links to competencies';
...
$string['error:deleteassignedcompetency'] = 'Error unassigning competency from this position';
...
$string['addedframework'] = 'The position framework \"{$a}\" has been added';
$string['deletedframework'] = 'The position framework \"{$a}\" and its data have been completely deleted';
$string['updatedframework'] = 'The position framework \"{$a}\" has been updated';
...
$string['missingname'] = 'Missing position name';
$string['missingnameframework'] = 'Missing position framework name';
$string['missingnametype'] = 'Missing position type name';
...
$string['deletedtype'] = 'The position type \"{$a}\" has been completely deleted';
$string['updatetype'] = 'The position type \"{$a}\" has been updated';
$string['error:updatetype'] = 'Error updating position type \"{$a}\"';
$string['createtype'] = 'The position type \"{$a}\" has been created';
$string['error:createtype'] = 'Error creating position type \"{$a}\"';
$string['error:deletedtype'] = 'Error deleting position type \"{$a}\".';
$string['type'] = 'Type';
$string['types'] = 'Types';
