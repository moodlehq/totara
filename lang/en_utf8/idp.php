...
$string['error:plannotempty'] = 'You can only delete empty plans which have never been submitted.';
...
$string['emptyplan'] = 'This IDP is empty.';
...
$string['to'] = 'to';
$string['traineesummarytitle'] = '$a\'s IDPs';
