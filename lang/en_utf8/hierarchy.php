...
$string['error:noreorderscaleinuse'] = 'You cannot reorder a scale that is in use. To reorder this scale, it must not be assigned to any framework which contains at least one competency.';
$string['error:nodeletescalevalueinuse'] = 'You cannot delete a scale value from a scale that is in use. To delete this scale value, the scale must not be assigned to any framework which contains at least one competency.';
