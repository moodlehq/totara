...
$string['completionstartonenrol']='Completion start on enrol';
$string['completionstartonenrolhelp']='Mark a user as \"started\" in course completion on course enrolment';
