...
$string['cfgwwwrootwarning'] = 'You have defined &#36;CFG->wwwroot incorrectly in your config.php file. It does not match the URL you are using to access this page. Please correct it or your Totara installation will not behave correctly.';
$string['cfgwwwrootslashwarning'] = 'You have defined &#36;CFG->wwwroot incorrectly in your config.php file. You have included a \'/\' character at the end. Please remove it or your Totara installation will not behave correctly.';
...
$string['configframename'] = 'If you are embedding Totara within a web frame, then put the name of this frame here.  Otherwise this value should remain as \'_top\'';
...
$string['configsmtphosts'] = 'Give the full name of one or more local SMTP servers that Totara should use to send mail (eg \'mail.a.com\' or \'mail.a.com;mail.b.com\'). To specify a non-default port (i.e other than port 25), you can use the [server]:[port] syntax (eg \'mail.a.com:587\'. If you leave it blank, Totara will use the PHP default method of sending mail.';
...
$string['configunzip'] = 'Indicate the location of your unzip program (Unix only, optional).  If specified, this will be used to unpack zip archives on the server.  If you leave this blank, then Totara will use internal routines.';
...
$string['configzip'] = 'Indicate the location of your zip program (Unix only, optional).  If specified, this will be used to create zip archives on the server.  If you leave this blank, then Totara will use internal routines.';
...
$string['debugdeveloper'] = 'DEVELOPER: extra Totara debug messages for developers';
...
$string['iplookupinfo'] = '
By default Totara uses the free online NetGeo (The Internet Geographic Database) server to lookup location of IP addresses, unfortunately this database is not maintained anymore and may return <em>wildly incorrect</em> data.
