...
$string['backtoallframeworks'] = 'Back to all organisation frameworks';
...
- The \"$a\" organisation';
$string['deletecheckwithchildren'] = 'Are you sure you want to delete the organisation \"$a->itemname\" and its $a->children_string?
<br /><br />
This will remove the following data: <br />
- The \"$a->itemname\" organisation and its $a->childcount $a->children_string';
$string['deletemulticheckwithchildren'] = 'Are you sure you want to delete $a->num organisation(s) and $a->childcount $a->children_string?
<br /><br />
This will remove the following data: <br />
- The $a->num organisation(s) and $a->childcount $a->children_string';
$string['deleteincludexcustomfields'] = '- $a custom field record(s)';
$string['deleteincludexposassignments'] = '- $a assignment(s) to this organisation (user\'s assigned to this organisation will be unassigned)';
$string['deleteincludexlinkedcompetencies'] = '- $a link(s) to competencies';
...
$string['addedframework'] = 'The organisation framework \"{$a}\" has been added';
$string['deletedframework'] = 'The organisation framework \"{$a}\" and its data have been completely deleted';
$string['updatedframework'] = 'The organisation framework \"{$a}\" has been updated';
...
$string['missingname'] = 'Missing organisation name';
$string['missingnameframework'] = 'Missing organisation framework name';
$string['missingnametype'] = 'Missing organisation type name';
...
$string['error:deleteassignedcompetency'] = 'Error unassigning competency from this organisation';
...
$string['deletedtype'] = 'The organisation type \"{$a}\" has been completely deleted';
$string['updatetype'] = 'The organisation type \"{$a}\" has been updated';
$string['error:updatetype'] = 'Error updating organisation type \"{$a}\"';
$string['createtype'] = 'The organisation type \"{$a}\" has been created';
$string['error:createtype'] = 'Error creating organisation type \"{$a}\"';
$string['error:deletedtype'] = 'Error deleting organisation type \"{$a}\".';
$string['type'] = 'Type';
$string['types'] = 'Types';
...
$string['notypes'] = 'No organisation types';
