...
$string['local:manageroverview'] = 'View a manager\'s overview page';
$string['local:managerownoverview'] = 'View own manager overview page';
...
$string['reportnotdeleted'] = 'Report could not be deleted';
...
// Help Buttons
$string['help:reportbuilderfullname'] = 'Report Title';
$string['help:reportbuildershortname'] = 'Report Unique Name';
$string['help:reportbuildersource'] = 'Report Source';
$string['help:reportbuilderhidden'] = 'Hide in Report Manager';
$string['help:reportbuilderrestrictionoptions'] = 'Display records for';
