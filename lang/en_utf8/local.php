...
$string['noteammembers'] = 'You do not currently have any team members. If this is wrong, get staff to set their Manager (On the positions tab of their user profile). You may need an administrator to do it.';
