...
/**
 * Strings for component 'lti', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   lti
...
$string['id'] = 'ID';
$string['imsroleadmin'] = 'Instructeur,Administrateur';
$string['imsroleinstructor'] = 'Instructeur';
$string['imsrolelearner'] = 'Participant';
...
$string['lti_launch_error_unsigned_help'] = 'Cette erreur est vraisemblablement le résultat du manque de la clef client et du secret partagé pour ce fournisseur d\'outil.
Si vous êtes en possession de la clef utilisateur et du secret partagé, veuillez les saisir lors de la mise en place de l\'instance de l\'outil externe (assurez-vous que les réglages avancés sont affichés).
AutreSinonment, vous pouvez [créer une configuration\] ({$a->course_tool_editor}) du fournisseur d\'outil au niveau du cours.';
...
$string['send'] = 'Envoyer';
$string['setdefault'] = 'Définir une valeur par défaut pour l\'enseignant en cas de délégation';
$string['setupbox'] = 'Boîte de configuration de l\'outil LTI';
...
| **URL de base** | **Correspond à** |
||
| outil.fr | outil.fr, outil.fr/quiz, outil.fr/quiz/quiz.php?id=10, www.outil.fr/quiz |
| www.outil.fr/quiz | outil.fr/quiz, outil.fr/quiz/take.php?id=10, www.outil.fr/quiz |
| quiz.outil.fr | quiz.outil.fr, quiz.outil.fr/take.php?id=10 |
