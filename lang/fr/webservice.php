...
/**
 * Strings for component 'webservice', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   webservice
...
$string['accesstofunctionnotallowed'] = 'L\'accès à la fonction {$a}() n\'est pas autorisé. Veuillez vérifier que le service fournissant cette fonction est bien activé. Dans les réglages du service, si le service comprend des restrictions d\'accès, vérifiez que l\'utilisateur figure dans la liste. Vérifiez également s\'il y a une restriction par adresse IP ou si le service requiert une capacité particulière.';
...
$string['cannotcreatetoken'] = 'Pas de permission pour créer un jeton de service web pour le service {$a}.';
...
$string['createtokenforuserauto'] = 'Créer automatiquement un jeton pour l\'utilisateur';
...
$string['enabledirectdownload'] = 'Le téléchargement de fichiers par service web doit être activé dans les réglages du service externe';
...
$string['invalidtokensession'] = 'Session invalide (jeton). La session n\'a pas été trouvée ou est échue';
...
$string['protocolnotallowed'] = 'Vous n\'êtes pas autorisé à utiliser le protocole {$a} (capacité manquante : webservice/{$a}:use)';
...
$string['restrictedusers_help'] = 'Ce réglage détermine si tous les utilisateurs ayant la permission de créer un jeton de services web peuvent générer un jeton pour ce service depuis leur page de clefs de sécurité ou si seuls les utilisateurs explicitement autorisés le peuvent.';
...
$string['wsauthmissing'] = 'Le plugin d\'authentification du service web est manquant.';
$string['wsauthnotenabled'] = 'Le plugin d\'authentification du service web est désactivé.';
