...
/**
 * Strings for component 'admin', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['assessorroleid'] = 'Rôle de l\'assesseur';
...
$string['backup_shortnamehelp'] = 'Utiliser le nom du cours dans le nom du fichier de sauvegarde, au lieu du numéro identifiant le cours.';
...
$string['configpasswordreuselimit'] = 'Le nombre de fois qu\'un utilisateur doit modifier son mot de passe avant de pouvoir en réutiliser un.';
...
$string['coursecount'] = 'Nombre de cours sur le site';
$string['courselistshortnames'] = 'Afficher les noms de cours étendus';
$string['courselistshortnames_desc'] = 'Lorsque ce réglage est activé, lors de l\'affichage des listes de cours ou des cours sur les pages d\'administration, le nom abrégé des cours est affiché en plus du nom complet du cours. En fait, l\'affichage utilise la chaîne de caractères « courseextendednamedisplay ». Il vous est donc possible de modifier l\'affichage à votre guise en modifiant le paquetage de langue.';
...
$string['cron'] = 'Cron';
$string['cron_execute'] = 'Exécuter';
$string['cron_execution_crashed'] = 'Crash du Cron';
$string['cron_execution_running'] = 'Le cron est en cours d\'exécution';
$string['cron_execution_status'] = 'Statut';
$string['cron_execution_stopped'] = 'Le Cron est arrêté';
$string['cron_execution_watch'] = 'Exécution du Cron';
...
$string['cron_kill_mail_fail_notify_msg'] = 'L\'exécution du Cron a pris plus de temps que le temps d\'exécution maximal et l\'arrêt automatique a échoué ! Veuillez vérifier les paramètres de votre serveur.';
$string['cron_kill_mail_fail_notify_title'] = 'Avertissement : l\'exécution du cron n\'a pas pu être arrêtée automatiquement !';
$string['cron_kill_mail_notify_msg'] = 'L\'exécution du Cron a pris plus de temps que le temps d\'exécution maximal est a été arrêté ! Veuillez vérifier vos paramètres serveur.';
$string['cron_kill_mail_notify_title'] = 'Avertissement : l\'exécution du cron a été arrêtée automatiquement';
$string['cron_max_time'] = 'Temps d\'exécution maximum';
$string['cron_max_time_info'] = 'Spécifie le temps d\'exécution maximum alloué au cron en heures. La valeur par défaut est 0 se qui signifie aucune limite de temps.';
$string['cron_max_time_kill'] = 'Arrête le cron automatiquement';
$string['cron_max_time_kill_info'] = 'Si coché le processus de surveillance arrêtera le cron si son exécution dépasse le temps maximal. Vous devez configurer l\'observateur de processus pour que cela fonctionne.';
$string['cron_max_time_mail_notify'] = 'Notifier l\'admin';
$string['cron_max_time_mail_notify_info'] = 'Si coché le système notifiera l\'admin en lui envoyant en e-mail si le temps d\'exécution du cron dépasse le temps maximal. Vous devez configurer l\'observateur de processus pour que cela fonctionne.';
$string['cron_max_time_mail_notify_msg'] = 'L\'exécution du cron prend plus de temps que spécifié ! Veuillez vérifier les paramètres de votre serveur.';
$string['cron_max_time_mail_notify_title'] = 'Avertissement : l\'exécution du cron dépasse le temps maximal';
$string['cron_refresh'] = 'Rafraîchir statut';
$string['cron_settings'] = 'Cron';
$string['cron_status_info'] = 'Statut d\'exécution du Cron';
$string['cron_terminate'] = 'Arrêter';
$string['cron_watcher_info'] = 'Observateur du Cron';
...
$string['displayerrorsset'] = 'Le site est configuré pour afficher les occurences d\'erreur. <br />Ce paramètre n\'est pas conseillé pour les sites en production. <br />Décochez <em>Afficher les messages de debug</em> dans le bloc paramètres admin de la section <a href="{$a->link}">Serveur/Debug</a>.';
...
$string['frontpageitem'] = 'Élément {$a} de la page d\'accueil';
$string['frontpageitemloggedin'] = 'Élément {$a} de la page d\'accueil une fois connecté';
...
$string['learnerroleid'] = 'Rôle pour l\'apprenti';
...
$string['managerroleid'] = 'Rôle du manager';
...
$string['moodlerelease'] = 'Identifiant de release Moodle';
...
$string['navlinkcoursesections'] = 'Lier les sections du cours';
$string['navlinkcoursesections_help'] = 'Si ce réglage est activé, les sections du cours seront affichés sous forme de liens dans la navigation';
...
$string['orgname'] = 'Nom de l\'organisation';
$string['orgnamehelp'] = 'Le nom de votre organisation';
...
$string['registrationdisabled'] = 'Désactivé';
$string['registrationenabled'] = 'Activé';
$string['registrationinformation'] = 'Les informations d\'enregistrement à envoyer.';
$string['registrationisdisabled'] = 'L\'enregistrement est désactivé. Configurer votre site pour enregistrer des informations de base est conseillé pour vous assister lors de la résolution de problèmes pour tous problèmes que vous pourriez rencontrer.<br />\nVous pouvez activer l\'enregistrement sur la <a href="{$a}">page de configuration de l\'enregistrement</a>';
$string['registrationisenabled'] = 'L\'enregistrement est activé';
$string['registrationoutofdate'] = 'Les informations d\'enregistrement n\'ont pas été mises à jours sur une longue période de temps. Les informations d\'enregistrement doivent être gardées à jour pour vous assister en cas de problème. Assurez-vous que votre serveur à un accès illimité pour faire des requêtes https vers register.totaralms.com';
...
$string['reportsdeleteconfirm'] = 'Vous êtes sur le point de supprimer le rapport « {$a} ». Cela aura pour conséquence la suppression dans la base de données de tout ce qui est associé avec ce plugin. Voulez-vous vraiment continuer ?';
...
$string['restorernewroleid_help'] = 'Si l\'utilisateur qui restaure un cours n\'a pas la permission de gérer le cours nouvellement restauré, il est au besoin automatiquement inscrit au cours et ce rôle lui est attribué. Choisir « Aucun » si vous ne voulez pas que les utilisateurs qui restaurent des cours puissent gérer les cours restaurés.';
...
$string['sitehasntregistered'] = 'Le site n\'est pas encore enregistré avec Totara. Enregistrer des informations de base avec Totara est conseillé pour vous aider en cas de problème future. Assurez-vous que votre serveur est configuré pour faire des requêtes https vers register.totaralms.com et que cron Moodle est activé. Vous pouvez l\'exécuter manuellement en <a href="{$a}">cliquant ici</a>';
$string['siteidentifier'] = 'Identifiant du site';
...
$string['techsupportemail'] = 'E-mail du support technique';
$string['techsupportemailhelp'] = 'L\'adresse e-mail de personnes gérant les problèmes techniques liés à l\'hébergement.';
$string['techsupportphone'] = 'Numéro de téléphone du support technique';
$string['techsupportphonehelp'] = 'Le numéro de téléphonne de personnes gérant les problèmes techniques liés à l\'hébergement. (inclure code pays)';
...
$string['toolsdeleteconfirm'] = 'Vous êtes sur le point de supprimer l\'outil d\'administration « {$a} ». Cette action détruira complètement de la base de données tout ce qui est en lien avec ce plugin. Voulez-vous vraiment continuer ?';
$string['toolsmanage'] = 'Gérer les outils d\'administration';
$string['totarabuild'] = 'Numéro de version Totara';
$string['totararegistration'] = 'Enregistrement Totara';
$string['totararegistrationinfo'] = '<p>Cette page configure les modifications d\'enregistrement envoyées à totaralms.com.\nCes mises à jour permettent à Totara de savoir quelle version de Totaralms vous utilisez et les logiciels de support que vous exécutez. Ces informations aideront Totara à vous aider en cas de problème.</p>\n<p>Ces informations seront transmises de façon sûre et gardées privées.</p>';
$string['totararelease'] = 'Identifiant de release Totara';
$string['totaraversion'] = 'Numéro de version Totara';
...
$string['usercount'] = 'Nombre d\'utilisateurs du site';
...
$string['webserversoftware'] = 'Indentifiant logiciel du serveur web';
$string['wwwroot'] = 'Racine www du site';
