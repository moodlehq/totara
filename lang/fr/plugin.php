...
/**
 * Strings for component 'plugin', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   plugin
...
$string['nonehighlighted'] = 'Aucun plugin ne requiert votre attention durant cette mise à jour';
...
$string['somehighlighted'] = 'Nombre de plugins requérant votre attention durant cette mise à jour : {$a}';
...
$string['status_uptodate'] = 'À jour';
$string['systemname'] = 'Indentifiant';
...
$string['type_enrol_plural'] = 'Méthode d\'inscription';
...
$string['type_message'] = 'Processeur de messagerie';
$string['type_message_plural'] = 'Processeurs de messagerie';
...
$string['type_plagiarism'] = 'Prévention du plagiat';
