 ...
 *
 * Strings for component 'totara_customfield', language 'fr', branch 'totara-2.2'
 * @package totara
...
$string['customfieldcategories_help'] = 'Les **Catégories de champs personnalisés** vous permettent de configurer des catégories personnalisées pour conserver des champs personnalisés sur un niveau de profondeur.
...
$string['customfieldcategory_help'] = 'Une **Catégorie** est créée pour grouper ensemble les champs personnalisés additionnels sur une page, par exemple pour une page de compétence, de poste ou d\'organisation.';
$string['customfieldcategoryname_help'] = 'Le **Nom de la catégorie du champ personnalisé** vous aide à grouper les types de champs personnalisés dont vous avez besoin et doivent être uniques sur le niveau de profondeur sur lequel vous travaillez.
Entrez le nom et cliquez sur **Enregistrer les modifications**.';
$string['customfieldcolumnstextarea_help'] = 'Les **Colonnes** définissent la largeur du champ disponible.';
$string['customfielddefaultdatacheckbox_help'] = 'Si Oui la case à cocher personnalisée sera cochée par défaut.
Si Non la case à cocher personnalisée ne sera pas cochée par défaut.';
$string['customfielddefaultdatamenu_help'] = 'Réglez la valeur par défaut qui apparaîtra dans le menu déroulant. La valeur par défaut doit apparaître dans le menu d\'options du dessus.
Laisser vide si aucune valeur par défaut n\'est requise.';
$string['customfielddefaultdatatext_help'] = 'La valeur par défaut est le texte qui apparaîtra dans le champ texte par défaut.
Laisser ce champ vide si aucun texte par défaut n\'est requis.';
$string['customfielddefaultdatatextarea_help'] = 'La valeur par défaut est le texte qui apparaîtra dans le champ texte par défaut.
Laisser vide si aucun texte par défaut n\'est requis.';
$string['customfieldfieldsizetext_help'] = 'La taille d\'affichage règle le nombre de caractères affichés dans le champ texte.';
$string['customfieldforceunique_help'] = 'Si Oui le champ personnalisé n\'acceptera qu\'une valeur unique. Si une valeur dupliquée est entrée, un message d\'erreur sera affiché lors de l\'enregistrement.
Si Non toute valeur sera acceptée pour ce champ personnalisé.';
$string['customfieldfullname_help'] = 'Le nom complet du champ personnalisé est son titre complet.';
$string['customfieldhidden_help'] = 'Si Oui le champ personnalisé ne sera pas visible sur la page des paramètres ou à tout autre endroit où il aurait été affiché. Si Non le champ peersonnalisé sera visible.';
$string['customfieldlocked_help'] = 'Si Oui le champ personnalisé n\'affichera que les informations enregistrées lors de sa création. Ce champ ne peut être modifié.';
$string['customfieldmaxlengthtext_help'] = 'La longueur maximale en caractères que le champ texte acceptera.';
$string['customfieldmenuoptions_help'] = 'Entrez les options du menu qui apparaîtront dans le menu déroulant.
N\'entrez qu\'une option par ligne.';
$string['customfieldrequired'] = 'Est-ce que le champ est obligatoire?';
$string['customfieldrequired_help'] = 'Si Oui, le champ sera obligatoire lors de la création d\'objets sur ce niveau de profondeur.
Si Non, le champ sera optionnel lors de la création d\'objets sur ce niveau de profondeur.';
$string['customfieldrowstextarea_help'] = 'Règle la hauteur du champ texte qui sera disponible (nombre de lignes).';
$string['customfields'] = 'Champs personnalisés';
$string['customfieldshortname_help'] = 'Le nom abrégé du champ personnalisé est le nom abrégé du champ personnalisé utilisé pour l\'affichage.
