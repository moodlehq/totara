...
/**
 * Strings for component 'moodle', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['availability_help'] = 'Cette option détermine si le cours apparaît ou non dans la liste des cours. Si le cours n\'est pas disponible, seuls les enseignants de ce cours et les administrateurs peuvent y entrer.';
...
$string['forcedmodeinbrackets'] = '{$a} (mode imposé)';
...
$string['formattext'] = 'Format Totara';
...
$string['hideweekfromothers'] = 'Cacher la semaine';
...
$string['local'] = 'Local';
$string['localplugindeleteconfirm'] = 'Vous allez supprimer le plugin local « {$a} ». Cette opération supprimera de la base de données tout ce qui est en lien avec ce plugin. Voulez-vous vraiment continuer ?';
...
$string['showweekfromothers'] = 'Afficher la semaine';
$string['since'] = 'Depuis';
