...
/**
 * Strings for component 'editor_tinymce', language 'fr', branch 'MOODLE_22_STABLE'
 *
...
$string['advanced:blockquote'] = 'Bloc de citation';
...
$string['advanced:charmap_desc'] = 'Insérer des caractères spéciaux';
...
$string['advanced:hr_desc'] = 'Insérer un trait horizontal';
...
$string['advanced:toolbar_focus'] = 'Atteindre les boutons de l\'éditeur - Alt+Q, Aller à l\'éditeur - Alt-Z, Aller au chemin de l\'élément - Alt-X';
...
$string['advhr:advhr_desc'] = 'Insérer un trait horizontal';
...
$string['advimage_dlg:missing_alt'] = 'Êtes-vous sûr de vouloir continuer sans définir de description pour l\'image ? Sans elle, l\'image peut ne pas être accessible à certains utilisateurs handicapés, ceux utilisant un navigateur texte ou ceux qui naviguent sans affichage des images.';
...
$string['autosave:warning_message'] = 'Si vous restaurez le contenu sauvé, vous perdrez le contenu qui est actuellement dans l\'éditeur.

Êtes-vous sûr de vouloir restaurer le contenu sauvé ?';
$string['common:apply'] = 'Appliquer';
$string['common:browse'] = 'parcourir';
$string['common:browseimage'] = 'Chercher ou déposer une image...';
$string['common:browsemedia'] = 'Chercher ou déposer un son, une vidéo ou une applet...';
$string['common:cancel'] = 'Annuler';
$string['common:class_name'] = 'Classe';
$string['common:clipboard_msg'] = 'Les fonctions Copier/Couper/Coller ne sont pas valables sur Mozilla et Firefox.
Souhaitez-vous avoir plus d\'informations sur ce sujet ?';
...
$string['media:desc'] = 'Insérer / éditer un média incorporé';
...
$string['media_dlg:filename'] = 'Nom de fichier';
...
$string['media_dlg:qt_stream_warn'] = 'Les ressources rtsp en streaming doivent être ajoutées au champ « Source QT » dans l\'onglet avancé.
...
$string['pagebreak:desc'] = 'Insérer un saut de page.';
$string['paste:paste_text_desc'] = 'Coller comme texte brut';
$string['paste:paste_word_desc'] = 'Coller un texte créé sous Word';
$string['paste:plaintext_mode'] = 'Le collage est actuellement en mode texte non formaté. Cliquez à nouveau pour revenir en mode de collage ordinaire.';
$string['paste:plaintext_mode_sticky'] = 'Le collage est actuellement en mode texte non formaté. Cliquez à nouveau pour revenir en mode de collage ordinaire. Après avoir collé quelque chose, vous retournerez en mode de collage ordinaire.';
...
$string['style_dlg:title'] = 'Éditer la feuille de style';
...
$string['table:del'] = 'Effacer le tableau';
$string['table:delete_col_desc'] = 'Effacer la colonne';
...
$string['table_dlg:cellspacing'] = 'Espacement entre les cellules';
...
$string['table_dlg:thead'] = 'En-têtes de tableau';
$string['table_dlg:title'] = 'Insérer / modifier un tableau';
...
$string['xhtmlxtras_dlg:attribs_title'] = 'Insérer / éditer les attributs';
