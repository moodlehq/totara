...
/**
 * Strings for component 'chat', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   chat
...
$string['modulename_help'] = 'Le module Chat permet aux participants d\'avoir une discussion synchrone en temps réel via le web. C\'est une façon utile de comprendre les autres, ainsi que le sujet de la discussion. L\'utilisation du chat est très différente de celle des forums (discussion asynchrone).';
