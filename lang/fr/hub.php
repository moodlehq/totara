...
/**
 * Strings for component 'hub', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   hub
...
$string['advertisepublication_help'] = 'La publication de votre cours sur un serveur d\'échanges permet à d\'autres personnes de le retrouver et de venir s\'y inscrire sur ce serveur.';
$string['all'] = 'Tout';
...
$string['cannotsearchcommunity'] = 'Désolé, vous n\'avez pas les permissions pour voir cette page';
...
$string['contactable_help'] = 'Si oui, le serveur d\'échange affichera votre adresse de courriel.';
...
$string['courseshortname_help'] = 'Saisissez un nom abrégé pour votre cours. Ce nom ne doit pas être unique.';
...
$string['deletescreenshots_help'] = 'Supprimer toutes les copies d\'écrans déposés.';
...
$string['errorunpublishcourses'] = 'En raison d\'une erreur, les cours n\'ont pas pu être supprimé du server d\'échanges. Réessayez plus tard ou contactez l\'administrateur du serveur d\'échanges.';
...
$string['geolocation'] = 'Géolocation';
...
$string['moodleorgregistrationdetail'] = 'Le serveur d\'échanges principal de la communauté est appelé MOOCH, et son adresse est hub.moodle.org. En enregistrant votre site sur MOOCH, vous contribuerez à la collecte de statistiques sur la communauté mondiale de Moodle. Vous pouvez également vous inscrire ainsi à une liste de distribution à faible volume fournissant des notifications de correctifs de sécurité et de nouvelles versions de Moodle.';
$string['moodleorgregistrationdetail2'] = 'Cette option vous permet d\'enregistrer votre site Moodle sur MOOCH, à l\'adresse hub.moodle.org. L\'enregistrement est gratuit. Le principal avantage de l\'enregistrement est l\'abonnement à une liste de diffusion à faible volume, utilisée pour fournir d\'importantes notifications, telle que des alertes de sécurité et des nouvelles versions de Moodle.
Par défaut, vos informations sont tenues confidentielles et ne seront ni vendues, ni transmises à quiconque. L\'unique but de la récolte de ces informations est de pouvoir fournir de l\'assistance et de construire une image statistique de la communauté des utilisateurs de Moodle dans sa globalité. Si vous le désirez, vous pouvez autoriser la publication du nom de votre site, de votre pays et l\'URL de votre Moodle sur la liste publique des sites Moodle. Les nouveaux enregistrements sont vérifiés manuellement avant d\'être ajoutés à la liste, mais une fois votre site ajouté, vous pouvez mettre à jour votre enregistrement (et votre entrée dans la liste publique) n\'importe quand.';
...
$string['publishonmoodleorg'] = 'Publier sur MOOCH';
...
$string['registeredon'] = 'Enregistré sur';
$string['registeredsites'] = 'Sites enregistrés';
$string['registeron'] = 'Enregistrer votre site';
$string['registeronmoodleorg'] = 'Enregistrer sur Moodle.org (MOOCH)';
$string['registeronspecifichub'] = 'Enregistrer sur un serveur d\'échanges spécifique';
...
$string['shareonmoodleorg'] = 'Déposer ce cours vers MOOCH';
...
$string['specifichub'] = 'Serveur d\'échanges spécifique';
