...
/**
 * Strings for component 'tool_customlang', language 'fr', branch 'MOODLE_22_STABLE'
 *
...
$string['customlang:view'] = 'Modifier les chaînes de caractères locales';
$string['filter'] = 'Filtrer les chaînes';
$string['filtercomponent'] = 'Afficher les chaînes de ces composants';
$string['filtercustomized'] = 'Chaînes modifiées seulement';
