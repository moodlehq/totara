...
/**
 * Strings for component 'repository', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   repository
...
$string['errorpostmaxsize'] = 'La taille du fichier déposé pourrait être plus grande que la directive max_post_size de php.ini.';
