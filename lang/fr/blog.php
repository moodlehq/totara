...
/**
 * Strings for component 'blog', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   blog
...
$string['nopermissionstodeleteentry'] = 'Vous n\'avez pas les autorisations requises pour supprimer cet article de blog';
