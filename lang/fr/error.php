...
/**
 * Strings for component 'error', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   error
...
$string['detectedbrokenplugin'] = 'Le plugin « {$a} » est défectueux ou incompatible. Impossible de continuer.';
...
$string['invaliddatarootpermissions'] = 'Des permissions non valides ont été détectées dans le dossier $CFG->dataroot. Il est impératif que l\'administrateur corrige ces permissions.';
...
$string['nopermissiontoupdatecalendar'] = 'Vous n\'avez pas les permissions de modifier un événement de calendrier';
