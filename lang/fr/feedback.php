...
/**
 * Strings for component 'feedback', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   feedback
...
$string['modulename_help'] = 'Le module feedback permet de créer des questionnaires personnalisés.';
