...
/**
 * Strings for component 'cohort', language 'fr', branch 'MOODLE_22_STABLE'
 *
 * @package   cohort
...
$string['cohort:assign'] = 'Ajouter des membres à la cohorte';
$string['cohort:manage'] = 'Gérer les cohortes';
$string['cohort:view'] = 'Utiliser les cohortes et voir leurs membres';
