...
/**
 * Strings for component 'repository_recent', language 'fr', branch 'MOODLE_22_STABLE'
 *
...
$string['recent:view'] = 'Voir le plugin de dépôt Fichiers récents';
$string['recentfilesnumber'] = 'Nombre de fichiers récent';
