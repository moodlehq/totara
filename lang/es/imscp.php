...
/**
 * Strings for component 'imscp', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   imscp
...
$string['modulename_help'] = 'Un paquete de contenidos IMS permite mostrar dentro del curso paquetes de contenidos creados conforme a la especificación **IMS Content Packaging**.';
