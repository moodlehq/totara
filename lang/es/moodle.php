...
$string['notifyloginfailuresmessageend'] = 'Puede ver estos registros en {$a}/report/log/index.php?id=1&amp;chooselog=1&amp;modid=site_errors.';
...
$string['pictureofuser'] = 'Usar imagen';
