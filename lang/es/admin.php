...
/**
 * Strings for component 'admin', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['backup_shortname'] = 'Usar el nombre del curso en el nombre del archvio de copia de seguridad';
$string['backup_shortnamehelp'] = 'Usar el nombre del curso como parte del nombre del archvio de copia de seguridad';
...
$string['cliupgradenoneed'] = 'No se necesita actualización para la versión {$a} instalada. Gracias por comprobarlo.';
...
$string['configrecaptchaprivatekey'] = 'Cadena de caracteres usada para comunicarse entre su servidor Moodle y el servidor recaptcha.net. Obtenga una para este sitio visitando http://www.google.com/recaptcha';
...
$string['configuseexternalyui'] = 'En lugar de usar archivos locales, usar archivos disponibles en línea en servidores Yahoo‘s. ADVERTENCIA: Esto requiere una conexión de internet; de otro modo, AJAX no funcionará en el sitio. Este parámetro no es compatible con sitios usuando https.';
...
$string['courselistshortnames'] = 'Mostrar nombres cortos';
$string['courselistshortnames_desc'] = 'Mostrar tanto los nombres largos como los cortos cuando se muestre la lista de cursos.';
...
$string['forceloginforprofileimage'] = 'Forzar a los usuarios a acceder a la plataforma para ver las imágenes del perfil del usuario';
$string['forceloginforprofileimage_help'] = 'Si está habilitado, los usuarios deben acceder a la plataforma para ver las imágenes del perfil, además, la imagen del usuario por defecto será utilizada en todas las notificaciones por correo electrónico.';
...
$string['loginpasswordautocomplete'] = 'Impedir que se complete la contraseña en el formulario de entrada.';
$string['loginpasswordautocomplete_help'] = 'Deshabilitado permitirá a los usuarios guardar su contraseña de la cuenta en su navegador. Activado dará como resultado que en su sitio ya no se seguirán las reglas XHTML de validación estricta.';
...
$string['navlinkcoursesections'] = 'Enlace a las secciones del curso';
$string['navlinkcoursesections_help'] = 'Si está habilitado las secciones del curso se mostrarán como enlaces dentro de la navegación.';
...
$string['profilecreatenewfield'] = 'Creando un nuevo campo de perfil \'{$a}\' profile field';
...
$string['profilevisible_help'] = 'Se puede asignar a cada campo personalizado uno de tres ajustes de visibilidad: invisible, a todo el mundo y usuario. El ajuste \'invisible\' normalmente es decidido por un administrador que quiere mantener la privacidad de los datos de los usuarios. El ajuste \'usuario\' es seleccionado normalmente para un campo que contiene información delicada, en tanto que la opción \'todo el mundo\' puede usarse para cualquier tipo de información.';
...
$string['selectdevice'] = 'Seleccione dispositivo';
$string['selecttheme'] = 'Seleccione tema para el dispositivo {$a}';
...
Nota: El acceso de usuarios no registrados pueden evitarse \'forzando a los usuarios a identificarse\'.';
...
$string['spelllanguagelist'] = 'Lista de idiomas del corrector';
...
$string['unsettheme'] = 'Tema no definido';
...
$string['userlist'] = 'Consultar lista de usuarios';
