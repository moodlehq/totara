...
/**
 * Strings for component 'portfolio', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   portfolio
...
$string['exportexpireddesc'] = 'Ha intentado repetir la exportación de cierta información o iniciar una exportación vacía. Para hacerlo correctamente debe volver atrñás, a la situación original y volver a empezar. A veces, esto ocurre si se utiliza el botón Atrás después de que se haya finalizado una exportación, o al marcar una URL inválida.';
