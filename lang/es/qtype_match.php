...
/**
 * Strings for component 'qtype_match', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   qtype_match
...
$string['pleaseananswerallparts'] = 'Por favor, responda a todas las partes de al pregunta';
