...
/**
 * Strings for component 'workshopallocation_random', language 'es', branch 'MOODLE_22_STABLE'
 *
...
$string['nogroupusers'] = '<p>Advertencia: si el taller está en modo \'grupos visibles\' o \'grupos separados\', entonces los usuarios DEBEN formar parte de al menos un grupo para poder asignárseles evaluaciones por iguales. Los usuarios que no formen parte de un grupo pueden con todo recibir nuevas autoevaluaciones o evaluaciones existentes eliminadas.</p>
<p>Estos usuarios no forman parte actualmente de ningún grupo: {$a}</p>';
...
$string['resultnomorepeers'] = 'No existen más iguales disponibles';
$string['resultnomorepeersingroup'] = 'No existen más iguales disponibles en este grupo separado';
$string['resultnotenoughpeers'] = 'No existen suficientes iguales disponibles';
$string['resultnumperauthor'] = 'Intentando asignar {$a} revisión(es) por autor';
$string['resultnumperreviewer'] = 'Intentando asignar {$a} revisión(es) por revisor';
