...
/**
 * Strings for component 'webservice', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   webservice
...
$string['requiredcapability_help'] = 'Si se activa, sólo los usuarios con los permisos requeridos pueden acceder al servicio.';
