...
/**
 * Strings for component 'qbehaviour_deferredcbm', language 'es', branch 'MOODLE_22_STABLE'
 *
...
$string['certainty1'] = 'Alguno (menos del 67%)';
$string['certainty2'] = 'Bastante (más del 67%)';
$string['certainty3'] = 'Mucho (más del 80%)';
$string['howcertainareyou'] = '¿Qué grado de certeza tiene? {$a}';
