...
/**
 * Strings for component 'enrol_flatfile', language 'es', branch 'MOODLE_22_STABLE'
 *
...
$string['pluginname_desc'] = 'Este método busca y procesar un archivo de texto con un formato especial en la ubicación que usted especifique. El archivo es un archivo separado por comas que tiene cuatro o seis campos por línea:
