...
/**
 * Strings for component 'url', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   url
...
$string['parametersheader_help'] = 'Algunas variables internas de Moodle pueden añadirse automáticamente a la URL. Escriba el nombre de cada parámetro dentro de cada caja de texto y seleccione la variable que corresponda.';
