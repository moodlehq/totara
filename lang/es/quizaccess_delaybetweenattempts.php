...
/**
 * Strings for component 'quizaccess_delaybetweenattempts', language 'es', branch 'MOODLE_22_STABLE'
 *
...
$string['pluginname'] = 'Regla de tiempo de retraso entre intentos de pregunta';
