...
/**
 * Strings for component 'backup', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   backup
...
$string['confirmnewcoursecontinue'] = 'Aviso de nuevo curso';
$string['confirmnewcoursecontinuequestion'] = 'El proceso de restauración creará un curso (oculto) de forma temporal. Para cancerlar la restauración pulse el botón cancelar. No cierre el navegador durante el proceso de restauración.';
...
$string['generalsettings'] = 'Configuración general de la copia de seguridad';
...
$string['setting_keep_groups_and_groupings'] = 'Mantener los grupos y agrupamientos actuales';
