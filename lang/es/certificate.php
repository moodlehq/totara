...
/**
 * Strings for component 'certificate', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   certificate
...
$string['certificatetype_help'] = 'Aca es donde se determina la dispoción y forma del Certificado. El tipo de carpeta incluye 4 certificados por default:
...
{$a->url}';
$string['emailteachermailhtml'] = '{$a->student} ha recibido su sertificado: \'<i>{$a->certificate}</i>\'
para {$a->course}.
