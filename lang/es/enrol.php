...
/**
 * Strings for component 'enrol', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol
...
$string['defaultenrol'] = 'Agregar opción a los cursos nuevos';
$string['defaultenrol_desc'] = 'Se añade este conector a todos los cursos nuevos, por defecto';
