...
/**
 * Strings for component 'qtype_calculatedsimple', language 'es', branch 'MOODLE_22_STABLE'
 *
...
$string['willconverttocalculated'] = 'Si se activa, <strong>Guardar como nueva pregunta</strong> se guardará como una nueva pregunta calculada';
