...
/**
 * Strings for component 'message', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['defaultmessageoutputs'] = 'Salidas de mensajes por defecto';
...
$string['disableall'] = 'Deshabilitadas las notificaciones temporalmente';
$string['disableall_help'] = 'Se han deshabilitado temporalmente todas las notificaciones excepto aquellas marcadas como "Obligatorias" por el administrador del sitio.';
...
$string['errortranslatingdefault'] = 'Error al interpretar la configuación por defecto prevista por la extensión, en su lugar se utilizarán los valores predeterminados del sistema.';
$string['forced'] = 'Obligatorias';
...
$string['managemessageoutputs'] = 'Gestionar salida de mensajes';
...
$string['messageoutputs'] = 'Salida de mensajes';
...
$string['outputdoesnotexist'] = 'No existe mensaje de salida';
...
$string['sendingviawhen'] = 'Enviando "{$a->provider}" via "{$a->processor}" cuando el estado es {$a->state}';
...
$string['touserdoesntexist'] = 'No puede enviar un mensjae a un ID de usuario ({$a}) que no existe';
