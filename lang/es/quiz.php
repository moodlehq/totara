...
/**
 * Strings for component 'quiz', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   quiz
...
$string['filloutnumericalanswer'] = 'Proporcione al menos una respuesta posible y una tolerancia. La primera respuesta que encaje se usará para determinar la calificación y la retroalimentación. Si proporciona algún tipo de retroalimentación sin respuesta al final, se mostrará a los estudiantes cuya respuesta correcta no corresponda con ninguna de las demás respuestas.';
$string['filloutoneanswer'] = 'Debe llenar al menos una respuesta posible. Las respuestas en blanco no serán utilizadas.

El asterisco \'*\' puede usarse como un comodín que sustituye a cualquier caracter. La primera respuesta que encaje se utilizará para determinar la calificación y la retroalimentación';
...
$string['updatingatttemptgrades'] = 'Actualizando calificaciones de intenteos';
$string['updatingfinalgrades'] = 'Actualizando calificaciones finales';
$string['updatingthegradebook'] = 'Actualizando ellibro de calificaciones';
