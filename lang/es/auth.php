...
/**
 * Strings for component 'auth', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   auth
...
$string['suspended_help'] = 'Las cuentas de usuario suspendidas no pueden acceder o utilizar los servicios web, además cualquier mensaje saliente es descartado';
