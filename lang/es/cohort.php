...
/**
 * Strings for component 'cohort', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   cohort
...
$string['bulkadd'] = 'Agregar a cohorte';
...
$string['removeuserwarning'] = 'Quitar usuarios de una cohorte puede resultar en la desmatriculación de usuarios de múltiples cursos, lo que incluye la eliminación de las configuraciones de usuario, las calificaciones, la pertenencia a grupos y otra información de usuario de los cursos afectados.';
...
$string['useradded'] = 'Usuario agregado a la cohorte "{$a}"';
