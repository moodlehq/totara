...
* Para información sobre cómo subir módulos Qedoc, ver la documentación Qedoc: Uploading\_modules {http://www.qedoc.org/en/index.php?title=Uploading\_modules}';
...
: el contenido pasa por filtros que detectan enlaces, imágenes, sonidos y videos que se especifican usando una notación entre corchetes. La notación con corchetes tiene la siguiente sintaxis: \`[url player width height options]\`
**URL**
