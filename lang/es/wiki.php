...
/**
 * Strings for component 'wiki', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   wiki
...
$string['cannotmanagefiles'] = 'Usted no tiene per';
$string['cannotviewfiles'] = 'No tiene permiso para ver los archivos wiki';
...
$string['deletecommentcheck'] = 'Borrar comentario';
$string['deletecommentcheckfull'] = '¿Está seguro que quiere borrar el comentario?';
$string['deletedbegins'] = 'Comienzo de eliminadas';
$string['deletedends'] = 'Fin de eliminadas';
$string['deleteupload'] = 'Eliminar';
$string['deleteversions'] = 'Borrar versiones de página';
...
$string['editfiles'] = 'Editar archivos wiki';
...
$string['html'] = 'HTML';
$string['incorrectdeleteversions'] = 'Las versiones de pagina propuestas para ser eliminadas son incorrectas';
$string['individualpagedoesnotexist'] = 'La página individual wiki no existe';
$string['insertcomment'] = 'Insertar comentario';
$string['insertimage'] = 'Inserte una imagen...';
$string['insertimage_help'] = 'Esta lista desplegable insertará una imagen en el editor wiki. Si necesita añadir más imágenes a la wiki, use el botón "Archivos"';
...
$string['listorphan'] = 'Listar huérfanas';
...
$string['page-mod-wiki-comments'] = 'Módulo wiki página de comentarios';
$string['page-mod-wiki-history'] = 'Página de historial de la wiki';
...
$string['wiki:managefiles'] = 'Gestionar archivos wiki';
...
$string['wikifiles'] = 'Archivos wiki';
