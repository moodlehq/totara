...
/**
 * Strings for component 'glossary', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   glossary
...
$string['defaultapproval_help'] = 'Si se establece en No, las entradas requieren la aprobación de un profesor antes de que sean visibles por todos.';
...
$string['notapproved'] = 'la entrada del glosario no ha sido aún aprovada';
