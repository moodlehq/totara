...
/**
 * Strings for component 'lesson', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   lesson
...
$string['actionaftercorrectanswer_help'] = 'La acción normal es seguir el salto de página tal como se ha especificado en la respuesta.
En la mayoría de los casos se mostrará la página siguiente de la lección. Se conduce al
estudiante a través de la lección siguiendo un camino lógico desde el principio hasta el final.
Sin embargo, el módulo Lección puede también usarse como si fuera una tarea a base de *tarjetas* (*flash-cards*).
...
un conjunto de *fichas* que se muestran unas junto a otras sin ajustarse a un orden
particular.
Esta opción permite dos variantes muy similares al comportamiento de las tarjetas. La opción
...
aparecido antes, pero sólo si ha contestado erróneamente a la pregunta asociada.
En las lecciones a base de tarjetas el profesor puede decidir si utiliza bien todas las páginas/tarjeta
de la lección o sólo un subconjunto aleatorio. Esto se lleva a cabo a través del parámetro " Número
de Páginas (Tarjetas) a mostrar".';
$string['actions'] = 'Acciones';
$string['activitylink'] = 'Enlace a una actividad';
$string['activitylink_help'] = 'El menú emergente contiene todas las actividades del curso. Si se selecciona una de ellas, al final de la lección aparecerá un enlace a dicha actividad.';
...
$string['casesensitive_help'] = 'Algunos tipos de pregunta tienen una opción que se activa con un clic en cuadro de verificación. Los tipos de la pregunta y el significado de las opciones son detallados abajo.
1.**Elección múltiple** Es una variante de las preguntas de Opción
Múltiple llamada de **"Elección múltiple y respuestas múltiples"**. Si escoge esta opción en la pregunta entonces requieren que el estudiante seleccione todas las respuestas correctas del conjunto de respuestas. La pregunta puede o no decir al estudiante \*cuántas\* respuestas correctas existen. Por ejemplo "¿Cuáles han sido presidentes de
...
$string['continuetonextpage'] = 'Continuar a la página siguiente';
...
$string['customscoring_help'] = 'Esta opción le permite asignar un valor numérico a cada respuesta. Las respuestas
...
si bien usted puede cambiar esto después de importarlas.';
...
$string['dependencyon_help'] = 'Esta opción permite que la lección actual dependa del rendimiento de los estudiantes en otra lección del mismo curso. Si no alcanza el rendimiento exigido, el estudiante no podrá acceder a esta lección.
Las condiciones de la dependencia incluyen:
\* **|Tiempo empleado:** el estudiante debe emplear en la lección el tiempo que aquí se señale.
\* **|Completa:** el estudiante debe completar la lección.
\* **|Calificación superior a:** el estudiante debe alcanzar en la lección una calificación superior a la especificada en esta opción.
...
$string['displaydefaultfeedback_help'] = '**Mostrar retroalimentación por defecto**
...
$string['displayleftmenu_help'] = 'Esta opción muestra una lista de las páginas (tablas de ramas) de la lección. Las
...
$string['essayemailmessage2'] = '<p>Ensayo:<blockquote>{$a->question}</blockquote></p><p>Su respuesta:<blockquote><em>{$a->response}</em></blockquote></p><p>{$a->comment} del profesor:<blockquote><em>{$a->comment}</em></blockquote></p><p>Usted ha recibido {$a->earned} sobre un total de {$a->outof} en esta pregunta de ensayo.</p><p>Su calificación en la lección ha cambiado a {$a->newgrade}%.</p>';
...
$string['handlingofretakes_help'] = 'Cuando se permite a los estudiantes retomar o repetir la lección, esta opción
permite elegir al profesor la clase de calificación final del alumno, por ejemplo, en
la página de calificaciones. Puede ser la **media**, la **primera** o la
...
$string['importppt_help'] = 'FORMA DE USARLO
Todas las diapositivas PowerPoint se importan como Tablas de Rama con las respuestas Anterior y Siguente.

1.Abra su presentación PowerPoint.
2.Guárdela como Página Web (sin opciones especiales)
3.El resultado del paso 3 debería ser un archivo HTML y una carpeta con todas las diapositivas convertidas a páginas web.
COMPRIMA sólo LA CARPETA.
4.Vaya a su sitio Moodle y agrege una nueva lección.
5.Tras haber guardado los ajustes de la lección, usted debería ver 4 opciones bajo "¿Qué desea hacer primero?" Haga clic en "Importar PowerPoint"
6.Use el botón "Navegar..." para encontrar el archivo ZIP to find your zip hecho en el paso 3. Haga clic a continuación en "Subir este archivo"
7.ISi todo ha ido bien, la próxima pantalla mostrará el botón Continuar.


Si la presentación en PowerPoint contenía imágenes, deberán haber sido guardadas como archivos del curso en moddata/XY donde X es el nombre de la lección e Y es un número (normalmente 0). Asimismo, durante el proceso de importación, se crearán archivos en el directorio de datos de Moodle, dentro de temp/lesson. Estos archivos por el momento no son eliminados por import.php.
 ';
$string['importquestions'] = 'Importar preguntas';
$string['importquestions_help'] = 'Esta función permite importar preguntas de archivos de texto, subidos mediante un formulario.
...
insertándolas como \_\_\_|\_\_ . Se pueden mezclar Varios tipos de preguntas en un solo archivo del texto, y este formato también permite líneas comentarios, los nombres de la pregunta, retroalimentación y los porcentaje-peso (ponderar) calificaciones. Veamos algunos ejemplos:
...
[Más información sobre el formato "GIFT"] (help.php?file=formatgift.html&module=quiz)

**Aiken**
El formato Aiken es una manera simple de crear preguntas de opción múltiple usando un
formato de fácil lectura. Un ejemplo del formato:
...
[Más información sobre el formato "Aiken"] (help.php?file=formataiken.html&module=quiz)
...
[Más información sobre el formato "Llenar el hueco"] (help.php?file=formatmissingword.html&module=quiz)
...
Se le llama así en honor a una empresa que impulsó el desarrollo de muchas
...
[Más información sobre el formato "Blackboard"] (help.php?file=formatblackboard.html&module=quiz)

**Course Test Manager**
Este módulo puede importar las preguntas guardadas en una banco de preguntas de Course Test Manager. Tenemos varias formas de acceder al banco de preguntas en formato
Access de Microsoft, dependiendo si Moodle está funcionando en un servidor de Windows o de Linux:
Desde Windows debemos subir la base de datos como cualquier otro archivo para importar sus datos.
Desde Linux, debemos instalar el software ODBC Socket Server, que utiliza XML para transferir datos a
Moodle desde el servidor Linux.
Por favor, lea todo el archivo de ayuda antes de importar este tipo de formato.

[Más información sobre el formato "CTM"](help.php?file=formatctm.html&module=quiz)
...
[Más información sobre el formato "Personal"](help.php?file=formatcustom.html&module=quiz)
...
$string['invalidid'] = 'Ningún ID de módulo de curso o ID de lección se aprobó';
$string['invalidlessonid'] = 'La ID de la lección es incorrecta';
$string['invalidpageid'] = 'ID de página no válida';
$string['jump'] = 'Saltar';
$string['jumps'] = 'Saltos';
$string['jumps_help'] = 'Cada respuesta tiene un salto de página hacia un enlace. Cuando se elige una
...
absoluto o relativo. Los enlaces relativos son **Esta página **y **Siguiente página**. **Esta página** significa que el estudiante ve la misma página otra vez. La **Siguiente página **muestra la página que le sigue en el orden lógico de las páginas. Un enlace Absoluto se determina eligiendo el título de la página.
...
$string['maxgrade_help'] = 'Este valor determina la máxima calificación que se puede obtener con la
...
$string['maximumnumberofanswersbranches_help'] = 'Este valor determina máximo número de respuestas que usará el profesor. El
valor por defecto es 4. Si una lección solo utilizará preguntas de VERDADERO o
FALSO podemos asignarle el valor de 2.
Este valor también se usa para asignar el máximo número de capítulos que se
usarán en la lección.
Puede editar, de forma segura, este valor en las lecciones ya creadas. De hecho,
...
$string['maximumnumberofattempts_help'] = 'Este valor determina el número máximo de intentos que tienen los estudiantes para responder **cualquiera** de las preguntas de una lección. En los casos de preguntas que no tienes respuestas, por ejemplo preguntas cortas o numéricas, este valor indica el número de veces que puede responder antes de que lo envíe a la siguiente página de la lección.
El valor por defecto es 5. Valores bajos pueden desalentar al estudiante antes de resolver la pregunta. Valores altos pueden producir
frustración.
...
$string['mediafile_help'] = 'Esta opción crea una ventana emergente al comienzo de la lección a un archivo (e.g., mp3) o página web. Asimismo, en cada página de la lección aparecerá un enlace que abre de nuevo la ventana emergente si fuera necesario.
...
$string['modattempts_help'] = 'Esta opción permite al estudiante volver atrás para cambiar sus respuestas.';
...
$string['modulename_help'] = '**Lección**
...
la estructura del material que se está presentando.';
...
$string['multianswer_help'] = 'Algunos tipos de pregunta tienen una opción que se activa con un clic en cuadro de verificación. Los tipos de la pregunta y el significado de las opciones son detallados abajo.
1.**Elección múltiple** Es una variante de las preguntas de Opción
Múltiple llamada de **"Elección múltiple y respuestas múltiples"**. Si escoge esta opción en la pregunta entonces requieren que el estudiante seleccione todas las respuestas correctas del conjunto de respuestas. La pregunta puede o no decir al estudiante \*cuántas\* respuestas correctas existen. Por ejemplo "¿Cuáles han sido presidentes de
EE.UU.?", o "Seleccione a dos presidentes de EE.UU. de la siguiente lista.". El número de respuestas correctas pueden ser de **una** hasta todas las opciones. (Una pregunta de Elección múltiples y respuestas múltiples con una respuesta correcta **es** diferente de una pregunta de Opción Múltiple pues la primera permite al estudiante la posibilidad de elegir más de una respuesta mientras que la última no lo permite.)
2.**Respuesta corta** Por defecto, en las comparaciones no se tiene en cuenta si el texto está mayúsculas o minúsculas. Si se selecciona Opción de pregunta las comparaciones tiene en cuenta si el texto está en mayúsculas o minúsculas.
...
$string['numberofpagestoshow_help'] = 'Este valor se usa solamente en las lecciones de tipo Tarjeta (*Flash Card*). Su
...
el final de la lección y se muestra la calificación obtenida por el estudiante.
Si el valor que se asigna es superior al número de páginas de la lección se
mostrarán todas las páginas.';
...
$string['ongoing_help'] = 'Cuando se activa esta opción, cada página mostrará los puntos que el estudiante ha obtenido del total de puntos posible. Por ejemplo, si un estudiante ha contestado correctamente cuatro preguntas de 5 puntos y ha fallado una pregunta, la puntuación provisional será de 15/20 puntos.';
...
$string['practice_help'] = 'Las lecciones de práctica no se mostrarán en el libro de calificaciones.';
...
$string['progressbar_help'] = 'Muestra una barra de progreso al final de la lección.
Por el momento, la barra de progreso tiene más precisión cuando las lecciones son lineales.
...
Nota: los estilos por defecto de la barra de progreso no impresionan ;) Todos los estilos (e.g.: colores, imágenes de fondo, etc.)
...
$string['progresscompleted'] = 'Ha completado el {$a}% de la lección';
...
$string['retakesallowed_help'] = 'Esta opción determina si los alumnos pueden tomar una lección más de una vez.
...
Cuando a los alumnos se les permite repetir la lección, la **calificación** que aparece
en la página Calificaciones corresponde bien al **promedio** de calificaciones, bien al **mejor** resultado obtenido en las repeticiones.
...
La opción por defecto es **Sí**, lo que significa que los alumnos pueden retomar la lección. Se
espera que sólo bajo condiciones excepcionales se seleccione la opción **No**.';
$string['returnto'] = '{$a}';
...
$string['slideshow_help'] = 'Esta opción permite mostrar la lección como una sesión de diapositivas, con una
...
$string['usepassword_help'] = 'Si se selecciona esta opción, el estudiante no podrá acceder a la lección a menos que escriba la contraseña.';
