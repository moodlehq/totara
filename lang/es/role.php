...
/**
 * Strings for component 'role', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   role
...
$string['advancedoverride'] = 'Modificación avanzada de rol';
$string['allow'] = 'Permitir';
$string['allowassign'] = 'Permitir asignar roles';
$string['allowed'] = 'Permitido';
$string['allowoverride'] = 'Permitir modificar roles';
...
$string['grade:managegradingforms'] = 'Gestionar métodos de calificación avanzada';
...
$string['grade:managesharedforms'] = 'Gestionar plantillas de formularios de calificación avanzada';
$string['grade:override'] = 'Pasar calificaciones por alto';
$string['grade:sharegradingforms'] = 'Publicar (compartir) formularios de calificación avanzada como plantillas';
...
$string['highlightedcellsshowdefault'] = 'Los permisos seleccionados en la tabla siguiente son los permisos por defecto del rol arquetipo seleccionado arriba';
...
$string['mainadminset'] = 'Determinar administrdor principal';
...
$string['roleallowinfo'] = 'Seleccionar un rol para añadir a la lista de roles permitidos en el contexto {$a->context}, capability {$a->cap}:';
...
$string['site:viewuseridentity'] = 'Ver la identidad completa de los usuarios en las listas';
...
$string['webservice:createmobiletoken'] = 'Crear un \'token web services\' para acceso móvil.';
