...
$string['auth_cas_certificate_check'] = 'Impostare a SI se si desidera convalidare il certificato del server';
$string['auth_cas_certificate_check_key'] = 'Convalida server';
$string['auth_cas_certificate_path'] = 'Percorso al file di catena CA (formato PEM) per la convalida del certificato del server';
$string['auth_cas_certificate_path_empty'] = 'Se si attiva la convalida del server, occorre specificare un percorso del certificato';
...
$string['auth_passchangedays'] = 'Periodo di scadenza della password (giorni)';
$string['auth_passchangedayshelp'] = 'Il numero massimo di giorni in cui l\'utente è autorizzato a mantenere la stessa password';
$string['auth_passexpiration'] = 'Scadenza della password';
$string['auth_passexpirationhelp'] = 'Specificare se le modifiche della password devono essere forzate una volta superato il periodo di scadenza della password specificato';
$string['auth_passexpirationwarning'] = 'Avviso di modifica della password (giorni)';
$string['auth_passexpirationwarninghelp'] = 'Il numero di giorni che precedono la modifica forzata della password in cui l\'utente è notificato della modifica forzata pendente.';
...
$string['errorminpasswordthreeoffour'] = 'La password deve soddisfare tre dei quattro seguenti criteri:';
...
$string['forcedchangeinstructions'] = 'Istruzioni di modifica forzata';
