...
$string['installreflectionfunctionerror'] = 'Errore nel codice! E\' fallita l\'intropsezione MNET per la funaizine \'$a->method\' nel file \'$a->class\'. Per comodità ecco il messaggio di errore originale:  \'$a->error\'';
...
$string['notenoughidpinfo'] = 'Ci dispiace, ma il tuo identity provider non ci sta fornendo le informazioni necessarie per creare o aggiornar eil tuo account locale.';
$string['notinxmlrpcserver'] = 'Tentativo di accesso al client MNET remoto, al di fuori dell\'eleaborazione XMRPC del server';
...
$string['notpermittedtojumpas'] = 'Impossibile avviare una sessione in remoto quando si è registrati come un altro utente.';
...
$string['testclient'] = 'Test client Moodle Network';
