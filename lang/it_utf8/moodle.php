...
$string['backtoallcategories'] = 'Torna a tutte le categorie';
$string['backtoallcourses'] = 'Torna a tutti i corsi';
$string['backtoallprograms'] = 'Torna a tutti i programmi';
...
$string['badcontext'] = 'Contesto errato';
$string['block'] = 'Blocco';
...
$string['categorys'] = 'Categorie di corso';
...
$string['commentsrequirelogin'] = 'Occorre accedere per visualizzare i commenti';
...
$string['coursecompletiondata'] = 'Data di completamento del corso';
$string['coursecompletions'] = 'Completamenti di corsi';
...
$string['courseenrolend'] = 'Termine delle iscrizioni al corso';
$string['courseenrolenddate'] = 'Data di termine delle iscrizione al corso';
$string['courseenrolstart'] = 'Apertura delle iscrizioni al corso';
...
$string['coursehelpenrollable'] = 'Definisce se gli studenti possono iscriversi spontaneamente al corso utilizzando il plugin di default per l\'auto-iscrizione ai corsi.';
$string['coursehelpenrolmentkey'] = 'Per iscriversi al corso gli utenti dovranno essere in possesso della chiave di iscrizione qui definita.';
$string['coursehelpenrolmentplugins'] = 'Il plugin di default per le iscrizioni spontanee';
$string['coursehelpexpirynotifystudents'] = 'Se è stata stabilita una durata per l\'iscrizione al corso, tramite questa impostazione gli Studenti saranno avvertiti via email quando la stanno per raggiungere il termine della propria iscrizione.';
$string['coursehelpexpirythreshold'] = 'Se è stata stabilita una durata per l\'iscrizione al corso, tramite questa impostazione è possibile indicare quanti giorni prima della scadenza sarà inviata la notifica via email.';
...
$string['coursehelpnotify'] = 'Se è stata stabilita una durata per l\'iscrizione al corso, tramite questa impostazione i Docenti saranno avvertiti via email quando uno studente sta per raggiungere il termine della propria iscrizione.';
...
$string['coursesinthiscategory'] = 'Corsi in questa categoria ({$a})';
...
$string['creatingcompetencyevidencedata'] = 'Creazione dati di prova delle competenze';
$string['creatingconditionalavailabilitydata'] = 'Creazione dati di disponibilità condizionale';
$string['creatingcoursecompletiondata'] = 'Creazione data di completamento del corso';
...
$string['databasechecking11'] = 'Aggiornamento del database di Totara in corso...';
$string['databasecompare'] = 'Da:<br /><br /> $a->oldversion<br /><br /> A:<br /><br /> $a->newversion';
...
$string['displaylanguagepanel'] = 'Visualizza riquadro della lingua';
...
$string['editortoggle'] = 'Attiva/disattiva modalità di modifica del testo';
...
$string['enroldetails'] = 'Con dettagli sul ruolo';
...
$string['legacythemeinuse'] = 'Questo sito è stato visualizzato in modalità di compatibilità perché il browser non è aggiornato.';
...
$string['manageruser'] = 'Utente manager';
$string['manageruserdescription'] = 'I manager possono gestire gli altri utenti.';
...
$string['morethanonerecordinfetch'] = 'Errore: più d un record restituito (tabella \'$a\')';
...
$string['nocategoriesfound'] = 'Non sono state trovate categorie con le parole \'$a\'';
...
$string['noprogramsfound'] = 'Non sono stati trovati programmi con le parole \'$a\'';
...
$string['passwordreused'] = 'Questa password è stata usata in precedenza e non può essere riutilizzata';
...
$string['searchresultsinx'] = 'Cerca risultati in {$a}';
...
$string['showcommentsnonjs'] = 'Mostra commenti';
...
$string['showtopicfromothers'] = 'Mostra l\'argomento agli altri';
$string['showweekfromothers'] = 'Mostra la settimana agli altri';
$string['since'] = 'Dal';
...
$string['usercurrentsettings'] = 'Il mio profilo';
...
$string['writingcompetencyevidenceinfo'] = 'Scrittura informazioni di attestato delle competenze';
