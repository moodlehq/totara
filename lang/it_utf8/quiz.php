...
$string['accessnoticesheader'] = 'Si può vedere l\'anteprima del quiz, ma se c\'è stato un vero tentativo, questo sarà impedito perché:';
...
$string['attempterror'] = 'Non puoi provare questo quiz in questo momento perché: $a';
...
$string['cannotfindprevattempt'] = 'Il tentativo precedente da cui partire non può essere trovato.';
...
$string['cannotinsertrandomquestion'] = 'Una nuova domanda a caso non può essere inserita!';
$string['cannotloadquestion'] = 'Le opzioni di domanda non possono essere caricate';
...
$string['cannotreviewopen'] = 'Impossibile rivedere il tentativo, in quanto ancora aperto.';
$string['cannotsavelayout'] = 'Non è stato possibile salvare l\'impaginazione';
$string['cannotsavenumberofquestion'] = 'Il numero di domande per pagina non può essere salvato';
$string['cannotsavequestion'] = 'L\'elenco domande non può essere salvato';
$string['cannotsetgrade'] = 'Un nuovo voto massimo per il quiz non può essere impostato';
...
$string['configadaptive'] = 'Se si sceglie SI per questa opzione, lo studente avrà la possibilità di rispondere più volte a una domanda anche all\'interno dello stesso tentativo di risposta al quiz.';
...
$string['configdelay1'] = 'Se si imposta questo ritardo, lo studente deve aspettare il tempo definito prima di riprovare a rispondere al quiz dopo il primo tentativo.';
$string['configdelay1st2nd'] = 'Se si imposta questo ritardo, lo studente non può iniziare il secondo tentativo finché questo tempo non è trascorso dalla fine del primo tentativo';
$string['configdelay2'] = 'Se si imposta questo ritardo, lo studente deve aspettare il tempo definito prima di riprovare a rispondere al quiz la terza volta o le successive.';
...
$string['configpopup'] = 'Usare le possibilità di JavaScripts per limitare la possibilità di copia e incolla, e cose simili, durante l\'esecuzione di un tentativo di risposta.';
...
$string['configshowuserpicture'] = 'Mostra l\'immagine dell\'utente durante i tentativi di risposta.';
$string['configshufflequestions'] = 'Se si abilita questa opzione, l\'ordine delle domande sarà casualmente alterato ad ogni tentativo di risposta da parte dello studente.';
$string['configshufflewithin'] = 'Se si abilita questa opzione, le possibili risposte alternative saranno casualmente alterate ad ogni tentativo di risposta al quiz da parte dello studente, ammesso che questa opzione sia abilitata anche nelle impostazioni delle domande.';
$string['configtimelimit'] = 'Tempo massimo default in minuti per rispondere ai quiz. 0 significa nessun tempo massimo.';
$string['configtimelimitsec'] = 'Tempo massimo default in secondi per rispondere ai quiz. 0 significa nessun tempo massimo.';
...
$string['createcategoryfornewrandomquestion'] = 'Crea una categoria di domande per la nuova domanda casuale';
...
$string['questionbankcontents'] = 'Contenuti Deposito domande';
...
$string['quizadministration'] = 'Gestione Quiz';
...
$string['shufflequestionsselected'] = '* Le domande sono impostate in ordine casuale. Per questo, il pulsante Riordina domande è stato disabilitato. Questo può essere modificato in $a.';
