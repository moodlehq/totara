...
$string['clicktoopen'] = 'Per aprire l\'URL fate click sul link $a';
$string['configdisplayoptions'] = 'Selezionate le opzioni che desiderate rendere disponibili. Le impostazioni già in essere non saranno modificate. Per selezionare più opzioni tenete premuti il tasto CTRL.';
$string['configframesize'] = 'Se si sceglie di mostrare un URL usando i frame, è possibile specificare la dimensione in pixel del frame superiore che conterrà l\'intestazione di pagina con l\'interfaccia di navigazione del sito.';
...
$string['displayselectexplain'] = 'Selezionate il tipo di visualizzazione di default. Tenete presente che i vari tipi di URL potrebbero permettere solo alcuni tipi di visualizzazione.';
...
$string['parameterinfo'] = 'parametro=valore';
