...
$string['deadlineis'] = 'La scadenza &egrave; $a';
...
$string['doubleupload'] = 'Attenzione: questa presentazione &egrave; stata probabilmente inviata due volte. Andate alla pagina di amministrazione, controllate se ci sono due invii da parte di questo utente in un breve arco di tempo. Cancellatene uno dei due prima di proseguire.';
...
$string['mail1'] = 'Il vostro compito \'$a\'  &egrave; stato valutato da';
$string['mail2'] = 'I commenti e il voto possono essere visti nell\'Esercizio \'$a\'';
$string['mail3'] = 'Potete vederlo nel vostro Esercizio';
$string['mail6'] = 'La vostra valutazione dell\'esercizio \'$a\' &egrave; stata revisionata';
...
$string['numberofcriterionelements'] = 'Il numero degli elementi criterio deve essere pi&ugrave; grande di uno.';
...
$string['resubmitnote'] = '* significa che la $a &egrave; autorizzata a rifare l\'invio.<br/> Questo flag pu&ograve; essere dato a ogni invio, basta ri-valutarlo e cliccare<br/> sul  pulsante <b>Autorizza $a al Reinvio</b>.';
...
$string['submissionsnowclosed'] = 'Invii non chiusi - la scadenza per l\'invio &egrave; stata superata.';
