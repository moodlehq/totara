...
$string['allowuserswitchrolestheycantassign'] = 'Consenti agli utenti che non possono attribuire i ruoli di cambiare ruolo';
...
$string['assessorroleid'] = 'Ruolo per il valutatore';
$string['authentication'] = 'Autenticazione';
$string['authsettings'] = 'Gestione autenticazione';
$string['autolang'] = 'Auto-rilevazione della lingua';
...
$string['badwordsconfig'] = 'Inserire l\'elenco personalizzato delle parole da censurare. Separare ciascuna parola con una virgola.';
...
$string['bookmarkalreadyexists'] = 'Questa pagina è già presente nei segnalibri.';
...
$string['cfgwwwrootwarning'] = 'Nel file config.php &#36;CFG->wwwroot è stato definito in modo errato. Non corrisponde all\'URL usato per accedere a questa pagina. Deve essere modificato o si verificheranno errori imprevisti come <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
...
$string['computedfromlogs'] = 'Calcolato dai log a partire da $a';
...
$string['confeditorhidebuttons'] = 'Selezionare i pulsanti che non vanno mostrati nell\'editor HTML';
...
$string['configallowassign'] = 'Tramite la matrice sottostante è possibile autorizzare i ruoli elencati nella colonna verticale a sinistra ad assegnare ad altri utenti uno o più tra i ruoli presenti sulla riga di intestazione';
...
$string['configallowcategorythemes'] = 'Abilitando questa opzione, i temi possono essere impostati a livello di categoria. Questo influenzerà tutte le categorie dipendenti e i relativi corsi a meno che gli stessi non abbiano impostato il proprio tema in modo specificl. ATTENZIONE: L\'abilitazione dei temi di categoria può influenzare le prestazioni.';
...
$string['configallowemailaddresses'] = 'Se si desidera che le e-mail utilizzabili appartengano solo a determinati domini, è possibile elencare i domini autorizzati in questa impostazione, avendo cura di separare i domini tra loro con uno spazio. Le e-mail che non appartengono ai domini elencati non saranno accettate. Per autorizzare anche i sotto domini, elencare il dominio preceduto da e.\'. Ad esempio  <strong>ourcollege.edu.au .gov.au</strong>';
$string['configallowobjectembed'] = 'Come misura di sicurezza standard, gli utenti normali non possono includere oggetti multimediali (come Flash) utilizzando esplicitamente i tag EMBED e OBJECT nei testi HTML (possono sempre utilizzare il filtro Plugin multimediali). Per consentire l\'utilizzo di questi tag, abilitare l\'opzione.';
$string['configallowoverride'] = 'Permette ai ruoli sulla sinistra di modificare i ruoli di ogni colonna';
$string['configallowoverride2'] = 'Tramite la matrice sottostante è possibile autorizzare i ruoli elencati nella colonna verticale a sinistra a modificare i ruoli di altri utenti.<br>Si precisa che queste impostazioni avranno effetto solamente per i ruoli che hanno i privilegi moodle/role:override oppure moodle/role:safeoverride.';
...
$string['configallowunenroll'] = 'Se impostato su \"Si\", gli studenti saranno autorizzati a revocarsi autonomamente da un corso in qualunque momento. In caso contrario non verranno autorizzati a farlo, demandando a docenti e amministratori di farlo.';
$string['configallowuserblockhiding'] = 'Si desidera permettere agli utenti di mostrare/nascondere i blocchi laterali di tutto il sito? <br>Questa funzione -utilizza Javascript e i cookies per ricordare lo stato di ogni blocco, e influenza solo la vista personale dell\'utente.';
...
$string['configallowuserswitchrolestheycantassign'] = 'Per cambiare ruolo gli utenti devono avere il privilegio moodle/role:assign. Abilitando questa impostazione, non occorre avere questo privilegio e i ruoli disponibili nel menu a discesa \"Cambia ruolo in..\" saranno controllati solamente dalle impostazioni della tabella \"Autorizzati ad attribuire ruoli\".
...
$string['configassessorroleid'] = 'Questo è il ruolo da usare per i valutatori in Totara';
$string['configauthenticationplugins'] = 'Nella tabella di sopra è possibile abilitare i plugin di autenticazione ed ordinarli secondo la priorità di esecuzione desiderata.';
...
$string['configbloglevel'] = 'L\'impostazione permette di regolare la visibilità dei blog degli utenti. L\'impostazione regola la visibilità del blog per chi legge i blog degli utenti ma non altera il privilegio degli utenti di scrivere nel proprio blog. Se non desiderati, i blog possono essere disabilitati.';
$string['configcachetext'] = 'Per siti molto ampi o siti che utilizzano filtri di testo, queste impostazioni possono velocizzare molto la navigazione. Le copie dei testi saranno mantenute nella loro forma originale per il tempo specificato qui. Impostazioni con valori di spazio molto ridotto potrebbero provocare un rallentamento generale, mentre Impostazioni con valori di spazio troppo ampi potrebbe portare a tempi troppo lunghi nel refresh dei testi principali (in caso di nuovi collegamenti, per esempio)';
...
$string['configconvertformat'] = 'Se sono disponibili <i>latex</i>, <i>dvips</i> and <i>convert</i>, le immagini saranno create nel formato specificato. In mancanza, verrà usato mimetTeX che creerà immagini GIF.';
...
$string['configlearnerroleid'] = 'Questo è il ruolo da usare per gli studenti in Totara.';
...
$string['configmanagerroleid'] = 'Questo è il ruolo da usare per i gestori in Totara.';
...
$string['configpasswordreuselimit'] = 'Numero di volte in cui un utente deve modificare la propria password prima di essere autorizzato a utilizzare un\'altra password.';
...
$string['coursecount'] = 'Numero di corsi in sito';
...
$string['cron_execute'] = 'Esegui';
$string['cron_execution_crashed'] = 'Arresto anomalo di cron';
$string['cron_execution_running'] = 'Cron è in esecuzione';
$string['cron_execution_status'] = 'Stato';
$string['cron_execution_stopped'] = 'Cron è interrotto';
$string['cron_execution_watch'] = 'Esecuzione di cron';
$string['cron_kill_mail_fail_notify_msg'] = 'L\'esecuzione di cron ha impiegato più del tempo massimo di esecuzione e la terminazione automatica non è riuscita. Verificare le impostazioni del server.';
$string['cron_kill_mail_fail_notify_title'] = 'Avviso: non è stato possibile eseguire la terminazione automatica di cron.';
$string['cron_kill_mail_notify_msg'] = 'L\'esecuzione di cron ha impiegato più del tempo massimo di esecuzione ed è stata terminata. Verificare le impostazioni del server.';
$string['cron_kill_mail_notify_title'] = 'Avviso: l\'esecuzione di cron è stata terminata automaticamente.';
$string['cron_max_time'] = 'Tempo di esecuzione massimo';
$string['cron_max_time_info'] = 'Specifica il tempo di esecuzione massimo autorizzato per il cron in ore. Il valore predefinito è 0, ossia non vi è un limite di tempo.';
$string['cron_max_time_kill'] = 'Termina il cron automaticamente.';
$string['cron_max_time_kill_info'] = 'Se selezionato, il processo di controllo terminerà il cron una volta scaduto nell\'esecuzione configurata. Per far ciò, occorre impostare la sentinella di cron.';
$string['cron_max_time_mail_notify'] = 'Notifica dell\'amministratore';
$string['cron_max_time_mail_notify_info'] = 'Se selezionato, il sistema invierà un\'e-mail di notifica all\'amministratore qualora l\'esecuzione di cron superi il tempo massimo stabilito. Per far ciò, occorre impostare la sentinella di cron.';
$string['cron_max_time_mail_notify_msg'] = 'L\'esecuzione di cron sta richiedendo più del tempo specificato. Verificare le impostazioni del server.';
$string['cron_max_time_mail_notify_title'] = 'Avviso: esecuzione del cron scaduta.';
$string['cron_refresh'] = 'Aggiorna stato';
$string['cron_settings'] = 'Cron';
$string['cron_status_info'] = 'Stato di esecuzione di cron';
$string['cron_terminate'] = 'Termina';
$string['cron_watcher_info'] = 'Sentinella di cron';
...
$string['deletefilterfiles'] = 'Tutti i dati associati al filtro \'$a->filter\' sono stati eliminati dal database. Per completare l\'eliminazione (ed evitare che il filtro si installi nuovamente) dovete eliminare questa cartella dal vostro server: $a->directory';
...
$string['displayerrorsset'] = 'Questo sito è configurato per visualizzare le occorrenze di errori.<br />Non si raccomanda questa impostazione sui siti di produzione. <br />Deselezionare <em>Visualizza messaggi di debug</em> nella sezione <a href=\"$a->link\">Server/Debugging</a> del blocco di impostazioni dell\'amministratore del sito.';
...
$string['helpprofilefieldlink'] = 'Crea un link dai dati utenti';
...
$string['learnerroleid'] = 'Ruolo per lo studente';
...
$string['managecourses'] = 'Gestione corsi';
...
$string['managerroleid'] = 'Ruolo per il gestore';
...
$string['moodlerelease'] = 'Identificatore rilascio Moodle';
...
$string['orgname'] = 'Nome dell\'organizzazione';
$string['orgnamehelp'] = 'Il nome della tua organizzazione.';
$string['passwordpolicy'] = 'Regole Password';
$string['passwordreuselimit'] = 'Limite di rotazione della password';
...
$string['purgecachesfinished'] = 'Tutte le cache sono state eliminate.';
$string['qtypedeletefiles'] = 'Tutti i dati associati al tipo di domanda \'$a->qtype\' sono stati eliminati dal database. Per completare l\'eliminazione (ed evitare che il tipo di domanda si installi nuovamente) dovete eliminare questa cartella dal vostro server: $a->directory';
...
$string['registrationdisabled'] = 'Disabilitato';
$string['registrationenabled'] = 'Abilitato';
$string['registrationinformation'] = 'Informazioni di registrazione da inviare';
$string['registrationisdisabled'] = 'La registrazione è disabilitata. Si raccomanda di configurare il sito per registrare le informazioni di base in Totara e assistere alla risoluzione di problemi futuri.<br />
E\' possibile abilitare la registrazione dalla <a href=\"$a\">pagina di configurazione della registrazione</a>';
$string['registrationisenabled'] = 'Registrazione abilitata.';
$string['registrationoutofdate'] = 'Le informazioni di registrazione non sono state aggiornate per un lungo periodo di tempo. Le informazioni di registrazione devono essere aggiornate per assistere nella risoluzione di possibili problemi futuri. Verificare che il server Web abbia un accesso illimitato per fare richieste https a register.totaralms.com';
...
$string['sitefullname'] = 'Nome completo del sito';
$string['sitehasntregistered'] = 'Questo sito non è ancora stato registrato in Totara. Si raccomanda di registrare le informazioni di base in Totara per assistere la risoluzione di  problemi futuri che potrebbero verificarsi. Accertarsi che il server Web possa effettuare richieste https a register.totaralms.com e che il Moodle cron sia abilitato. E\' possibile eseguire il cron manualmente <a href=\"$a\">facendo clic qui</a>';
$string['siteidentifier'] = 'Identificatore del sito';
...
$string['techsupportemail'] = 'E-mail del supporto tecnico';
$string['techsupportemailhelp'] = 'Indirizzo e-mail del personale che gestisce i problemi tecnici relativi all\'hosting del sito';
$string['techsupportphone'] = 'Numero di telefono del supporto tecnico';
$string['techsupportphonehelp'] = 'Numero di telefono del personale che gestisce i problemi tecnici relativi all\'hosting del sito (includere il codice del paese)';
...
$string['totarabuild'] = 'Numero di build di Totara';
$string['totarapre11'] = 'Totara (pre-versione 1.1)';
$string['totararegistration'] = 'Registrazione di Totara';
$string['totararegistrationinfo'] = '<p>In questa pagina sono configurati gli aggiornamenti di registrazione che sono inviati a totaralms.com.
Tali aggiornamenti permettono a Totara di conoscere le versioni di Totaralms e supportare il software eseguito dall\'utente. 
Permettono inoltre di esaminare e risolvere in dettaglio i problemi di supporto che potrebbero verificarsi in futuro.</p>
<p>Queste informazioni saranno trasmesse in modalità protetta e ne verrà mantenuta la riservatezza.</p>';
$string['totararelease'] = 'Identificatore della versione di Totara';
$string['totaraversion'] = 'Numero di versione di Totara';
...
$string['usercount'] = 'Numero di utenti del sito';
...
$string['webserversoftware'] = 'Identificatore del software del server Web';
...
$string['wwwroot'] = 'Root www del sito';
