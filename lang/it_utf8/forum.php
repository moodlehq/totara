<?PHP // $Id$ 
      // forum.php - created with Moodle 1.9.14 (Build: 20111010) (2007101591.06)
...
$string['confirmsubscribe'] = 'Si desidera effettuare l\'iscrizione al forum \'{$a}\'?';
$string['confirmunsubscribe'] = 'Si desidera annullare l\'iscrizione dal forum \'{$a}\'?';
...
$string['alreadyfirstpost'] = 'Questo è già il primo intervento della discussione'; // ORPHANED
$string['attachmentnopost'] = 'Non puoi esportare allegati senza specificare l\'id dell\'intervento'; // ORPHANED
$string['attachments'] = 'Allegati'; // ORPHANED
$string['blogforum'] = 'Forum standard visualizzato in stile blog'; // ORPHANED
$string['cannotadd'] = 'La discussione non può essere aggiunta in questo forum'; // ORPHANED
$string['cannotaddsubscriber'] = 'Non è stato attivare la sottoscrizione al forum per l\'utente con id $a!'; // ORPHANED
$string['cannotaddteacherforumto'] = 'Non è stato possibile aggiungere il forum teacher con il tipo già cambiato nella sezione 0 del corso'; // ORPHANED
$string['cannotcreatediscussion'] = 'Non è stato possibile creare una nuova discussione'; // ORPHANED
$string['cannotcreateinstanceforteacher'] = 'Non è stato possibile creare una nuova istanza del forum docenti'; // ORPHANED
$string['cannotdeleteforummodule'] = 'Il modulo di attività forum non può essere eliminato.'; // ORPHANED
$string['cannoteditposts'] = 'Interventi di altri non possono essere modificati!'; // ORPHANED
$string['cannotfinddiscussion'] = 'Non è stato possibile trovare la discussione in questo forum'; // ORPHANED
$string['cannotfindfirstpost'] = 'Non è stato possibile trovare il primo intervento di questo forum'; // ORPHANED
$string['cannotfindorcreateforum'] = 'Non è stato possibile trovare o creare un forum news per il sito'; // ORPHANED
$string['cannotfindparentpost'] = 'Non è stato possibile trovare l\'intervento iniziale associato all\'intervento $a'; // ORPHANED
$string['cannotmovefromsingleforum'] = 'Una discussione non può essere spostata da un forum a singola discussione semplice'; // ORPHANED
$string['cannotmovenotvisible'] = 'Forum non visibile'; // ORPHANED
$string['cannotmovetonotexist'] = 'Non possono essere effettuati spostamenti verso questo forum - non esiste!'; // ORPHANED
$string['cannotmovetonotfound'] = 'Il forum di destinazione non è stato trovato in questo corso.'; // ORPHANED
$string['cannotpurgecachedrss'] = 'Non è stato possibile ripulire i feed RSS presenti in cache per i forum sorgente e/o destinazione - verificate i vostri permessi sui file'; // ORPHANED
$string['cannotremovesubscriber'] = 'Non è stato possibile rimuovere da questo forum l\'utente con id $a !'; // ORPHANED
$string['cannotreply'] = 'Non puoi rispondere a questo intervento'; // ORPHANED
$string['cannotsplit'] = 'Le discussioni non possono essere spostate da questo forum'; // ORPHANED
$string['cannotsubscribe'] = 'Spiacente, devi appartenere ad un gruppo per poterti sottoscrivere.'; // ORPHANED
$string['cannottrack'] = 'Non è stato possibile interrompere la visualizzazione dei messaggi non letti'; // ORPHANED
$string['cannotunsubscribe'] = 'Non è stato possibile rimuoverti dal  forum'; // ORPHANED
$string['cannotupdatepost'] = 'Non puoi modificare questo intervento'; // ORPHANED
$string['configmaxattachments'] = 'Valore di default del numero massimo di allegati consentiti per ogni intervento.'; // ORPHANED
$string['errorwhiledelete'] = 'Si è verificato un errore durante l\'eliminazione del record.'; // ORPHANED
$string['forum:exportdiscussion'] = 'Esporta intera discussione'; // ORPHANED
$string['forum:exportownpost'] = 'Esporta propri interventi'; // ORPHANED
$string['forum:exportpost'] = 'Esporta intervento'; // ORPHANED
$string['forumadministration'] = 'Gestione Forum'; // ORPHANED
$string['introblog'] = 'I post di questo forum sono stati copiati automaticamente dai blog degli utenti iscritti al corso poiché tali interventi blog non sono più disponibili'; // ORPHANED
$string['invalidaccess'] = 'Questa pagina non è stata acceduta correttamente.'; // ORPHANED
$string['invaliddiscussionid'] = 'L\'ID della discussione è errata'; // ORPHANED
$string['invalidforumid'] = 'L\'ID del forum è errata'; // ORPHANED
$string['invalidparentpostid'] = 'L\'ID dell\'intervento superiore è errato'; // ORPHANED
$string['invalidpostid'] = 'ID dell\'intervento non valida - $a'; // ORPHANED
$string['maxattachments'] = 'Numero massimo allegati'; // ORPHANED
$string['messageprovider:digests'] = 'Raccolte forum sottoscritte'; // ORPHANED
$string['messageprovider:posts'] = 'Interventi forum sottoscritti'; // ORPHANED
$string['mustprovidediscussionorpost'] = 'Per esportare un argomento di discussione devi indicare l\'id della discussione o dell\'intervento.'; // ORPHANED
$string['noattachments'] = 'Questo intervento non ha allegati'; // ORPHANED
$string['noguestrate'] = 'Gli ospiti non hanno il permesso di effettuare valutazioni.'; // ORPHANED
$string['nopermissiontosubscribe'] = 'Non hai il permesso per vedere i sottoscrittori'; // ORPHANED
$string['nopermissiontoview'] = 'Non hai il permesso per vedere questo intervento'; // ORPHANED
$string['norate'] = 'La valutazione degli interventi non è permessa!'; // ORPHANED
$string['noresult'] = 'Nessuna valutazione per questo intervento: $a'; // ORPHANED
$string['notexists'] = 'La discussione non esiste più'; // ORPHANED
$string['notinstalled'] = 'Il modulo forum non è installato'; // ORPHANED
$string['notpartofdiscussion'] = 'Questo intervento non appartiene ad alcuna discussione!'; // ORPHANED
$string['noviewanyrate'] = 'Puoi visualizzare solamente i risultati relativi ai tuoi interventi'; // ORPHANED
$string['noviewrate'] = 'Non sei autorizzato a visualizzare le valutazioni date agli interventi'; // ORPHANED
$string['viewalldiscussions'] = 'Visualizza tutti gli argomenti'; // ORPHANED
