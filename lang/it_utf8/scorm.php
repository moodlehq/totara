...
$string['aicchacpkeepsessiondata'] = 'Dati di sessione AICC HACP';
$string['aicchacpkeepsessiondata_desc'] = 'La durata di tempo in giorni durante i quali mantenere i dati di sessione AICC HACP (un\'impostazione completa la tabella con i dati precedenti ma può essere utile quando si esegue il debug)';
$string['aicchacptimeout'] = 'Timeout AICC HACP';
$string['aicchacptimeout_desc'] = 'Durata di tempo in minuti in cui una sessione AICC HACP può rimanere aperta';
$string['allowapidebug'] = 'Attiva l\'API di debug e tracking (Imposta la capture mask con apidebugmasjk)';
$string['allowtypeaicchacp'] = 'Abiltia AICC HACP esterno';
$string['allowtypeaicchacp_desc'] = 'Se abilitato consente alla comunicazione esterna AICC HACP senza richiedere il login utente per le richieste dal pacchetto AICC esterno';
...
$string['direct'] = 'URL diretto';
$string['directories'] = 'Visualizza collegamenti';
$string['directview'] = 'Avvio diretto dal corso';
$string['display'] = 'Visualizzazione pacchetto';
$string['displayattemptstatus'] = 'Mostra lo stato dei tentativi';
$string['displayattemptstatusdesc'] = 'Questa preferenza imposta il valore di default per la visualizzazione dello stato dei tentativi';
$string['displaycoursestructure'] = 'Mostra la struttura del corso';
$string['displaycoursestructuredesc'] = 'Questa preferenza imposta il valore di default per la visualizzazione della struttura del corso';
...
$string['forcecompleteddesc'] = 'Questa preferenza imposta il valore di default per l\'obbligo al completamento';
$string['forcenewattempt'] = 'Forza un nuovo tentativo';
$string['forcenewattemptdesc'] = 'Questa preferenza imposta il valore di default per l\'obbligo ad un nuovo tentativo';
...
$string['invalidurl'] = 'URL specificato non valido per l\'attività di URL diretto';
...
$string['lastattemptlockdesc'] = 'Questa preferenza imposta il valore di default per il blocco dopo il tentativo finale';
...
$string['popupblocked'] = 'Se la finestra non compare, $a';
$string['popupblockedlinkname'] = 'fate click qui per lanciare l\'attività';
...
$string['type'] = 'Tipo';
$string['typeexternal'] = 'Manifest SOCRM esterno';
$string['typeimsrepository'] = 'Content repository IMS locale';
$string['typelocal'] = 'Pacchetto caricato';
$string['typelocalsync'] = 'Pacchetto scaricato';
$string['unpackmethod'] = 'Metodo di spacchettamento';
...
$string['updatetime'] = 'Sincronizzazione';
$string['url'] = 'URL';
