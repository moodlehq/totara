...
$string['configenableavailability'] = 'Le attività condizionate consentono di subordinare l\'accesso ad un attività in base a condizioni quali date, valutazioni e stato di completamento di altre attività.';
$string['enableavailability'] = 'Abilita attività condizionate';
$string['grade_atleast'] = 'deve essere &ge;';
$string['grade_upto'] = 'e &lt;';
$string['gradecondition'] = 'Valutazione da ottenere';
$string['help_conditiondates'] = 'date di disponibilità';
$string['help_showavailability'] = 'visualizzazione delle attività non disponibili';
$string['none'] = '(non in uso)';
...
$string['showavailability'] = 'Finché l\'attività non è disponibile';
$string['showavailability_hide'] = 'Non mostrare l\'attività';
$string['showavailability_show'] = 'Mostra l\'attività in grigio assieme alle condizioni per l\'accesso';
$string['userrestriction_hidden'] = 'Attività condizionata (invisibile, senza messaggi): &lsquo;$a&rsquo;';
$string['userrestriction_visible'] = 'Attività condizionata: &lsquo;$a&rsquo;';
