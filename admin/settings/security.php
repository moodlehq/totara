...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configcheckbox('forcelogin', get_string('forcelogin', 'admin'), get_string('configforcelogintotara', 'admin'), 1));
    ...
    $temp->add(new admin_setting_configcheckbox('preventmultiplelogins', get_string('preventmultiplelogins', 'admin'), get_string('preventmultiplelogins_help', 'admin'), 0));
