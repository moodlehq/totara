...
$ADMIN->add('root', new admin_category('positions', get_string('positions','admin')));
$ADMIN->add('root', new admin_category('competencies', get_string('competencies', 'competencies')));
