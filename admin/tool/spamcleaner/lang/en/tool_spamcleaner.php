...
$string['spamcleanerintro'] = 'This script allows you to search all user profiles for certain strings and then delete those accounts which are obviously created by spammers.  You can search for multiple keywords using commas (eg casino, porn)<br /><br />The documentation has more information about <a href="http://docs.moodle.org/en/Reducing_spam_in_Moodle">Reducing spam</a>.';
