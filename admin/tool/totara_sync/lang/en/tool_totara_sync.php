...
$string['cannotfindappraiserxforusery'] = 'cannot find appraiser {$a->appraiseridnumber} for user {$a->idnumber}';
$string['cannotcreatemanagerxforusery'] = 'cannot create manager {$a->manageridnumber} for user {$a->idnumber}';
$string['cannotcreateappraiserxforusery'] = 'cannot create appraiser {$a->appraiseridnumber} for user {$a->idnumber}';
...
$string['appraiserxnotexist'] = 'appraiser {$a} does not exist';
