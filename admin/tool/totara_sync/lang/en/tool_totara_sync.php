...
$string['orgxnotexist'] = 'org {$a->orgidnumber} does not exist. Skipped user {$a->idnumber}';
$string['posxnotexist'] = 'pos {$a->posidnumber} does not exist. Skipped user {$a->idnumber}';
