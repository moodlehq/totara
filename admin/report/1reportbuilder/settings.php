...
// add links to report builder reports
   ...
   $ADMIN->add('reportbuilder', new admin_externalpage('globalreportsettings', get_string('globalsettings','local'), "$CFG->wwwroot/local/reportbuilder/globalsettings.php"));
