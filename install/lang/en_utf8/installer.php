...
///
/// If you find some missing string in Totara installation, please,
/// keep us informed using http://community.totaralms.com Thanks!
///
...
$string['moodledocslink'] = 'Totara Docs for this page';
...
$string['mysql416required'] = 'MySQL 4.1.16 is the minimum version required for Totara 1.6 in order to guarantee that all data can be converted to UTF-8 in the future.';
$string['mysql5025required'] = 'MySQL 5.0.25 is the minimum version required for Totara in order to guarantee that all functionality will work correctly.';
...
$string['php516restricted'] = 'PHP 5.1.6 is required for Totara to function correctly, please upgrade your PHP version';
...
and to leave empty the Database, User and Password fields. More information on <a href=\"http://docs.moodle.org/en/Installing_Postgres_for_PHP\">Totara Docs</a>';
