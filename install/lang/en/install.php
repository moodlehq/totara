...
(usually \'nobody\', \'apache\' or \'www-data\' on Linux platforms. Or the IUSR_computername account on Windows platforms), but it must not be accessible directly via the web. The installer will try to create it if doesn\'t exist.';
