...
// Update form state custom event
Y.use('event', function(Y){
    Y.publish('form:updateState', {emitFacade: true, broadcast: 2});
});
    ...
    M.form.dependencyManager = M.form.dependencyManager || (function(){
        ...
        dependencyManager.prototype = {
            ...
            initializer : function(config) {
                var i = 0, nodeName;
                this._nameCollections = []; // Clean elements cache to support form AJAX reload
            ...
            checkDependencies : function(e) {
                ...
                Y.fire('form:updateState', formid);
                return true;
            },
            /**
