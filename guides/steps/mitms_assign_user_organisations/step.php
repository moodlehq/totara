...
class guide_mitms_assign_user_organisations_step extends guide_default_step {
    ...
    function content_step_active () {
        return 'This is the mitms_assign_user_organisations step.<br /> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis nowus.';
    }

    # Return content the step should display when it is not active, and is not complete:
    function content_step_pending () {
        return 'This is the mitms_assign_user_organisations step.<br /> This step is pending.  Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Dous soonish.';
    }

    # Return content the step should display when it is not active, and is complete:
    function content_step_complete () {
        return 'This is the mitms_assign_user_organisations step. <br /> This step is now complete: Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur? Donus maximus.';
    }
