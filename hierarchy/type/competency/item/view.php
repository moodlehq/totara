...
if ($can_edit_item || $can_delete_item || $can_add_depth || $can_edit_depth) {
    $options = array('type' => 'competency', 'id' => $item->id);
...
<form action="<?php echo $CFG->wwwroot ?>/hierarchy/type/competency/evidence/edit.php" method="get">
<div>
...
$options = array('type' => $hierarchy->prefix, 'frameworkid' => $framework->id);
print_single_button(
