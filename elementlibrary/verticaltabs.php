...
$url = new moodle_url('/elementlibrary/verticaltabs.php', array('tab' => $currenttab));
...
echo $OUTPUT->box('In Totara 2.5 we added a new UI element, vertical tab bars. These work pretty much the same as regular tabs but the tabs appear stacked to the side of the main content. Useful in cases where there are too many tabs or the tab names are too long to fit horizontally.');
...
echo "Content for right panel when using vertical tabs. In this case the text is quite short vertically but the container should be at least as tall as the tab stack.";
...
echo $OUTPUT->container(print_tabs($tabs, $currenttab, $inactive,
    ...
    array('class' => 'verticaltabtree'));
echo $OUTPUT->container_start('verticaltabtree-content');
echo "Content for right panel when using vertical tabs.<p>In this case the text is taller than the tabs</p><p>In this case the text is taller than the tabs</p><p>In this case the text is taller than the tabs</p><p>In this case the text is taller than the tabs</p><p>In this case the text is taller than the tabs</p>";
echo $OUTPUT->container_end();
echo $OUTPUT->container_end();
