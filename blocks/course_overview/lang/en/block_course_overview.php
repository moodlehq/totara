...
$string['course_overview:myaddinstance'] = 'Add a new course overview block to the My Learning page';
...
$string['here'] = 'here';
$string['showingxofycourses'] = 'Currently showing {$a->showing} of {$a->total} assigned courses. See the rest {$a->link}.';
