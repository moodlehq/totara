...
// Add text
    ...
    cert_printtext(58, 230, 'C', 'Helvetica', 'B', 20, utf8_decode(get_string("introportrait", "certificate")));
    ...
    cert_printtext(58, 540, 'C', 'Helvetica', '', 10, utf8_decode($grade));
    cert_printtext(58, 551, 'C', 'Helvetica', '', 10, utf8_decode($outcome));
    cert_printtext(58, 562, 'C', 'Helvetica', '', 10, utf8_decode($credithours));
    cert_printtext(58, 720, 'C', 'Helvetica', '', 10, utf8_decode($code));
    $i = 0 ;
    ...
    if ($teachers = get_users_by_capability($context, 'mod/certificate:printteacher')) {
		foreach ($teachers as $teacher) {
			$i++;
	cert_printtext(98, 590+($i *12) , 'L', 'Helvetica', '', 12, utf8_decode(fullname($teacher)));
}}}
