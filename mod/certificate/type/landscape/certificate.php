...
// Add text
    ...
    cert_printtext(170, 180, 'C', 'Helvetica', 'B', 20, utf8_decode(get_string('introlandscape', 'certificate')));
    ...
    cert_printtext(170, 420, 'C', 'Helvetica', '', 10, utf8_decode($grade));
    cert_printtext(170, 431, 'C', 'Helvetica', '', 10, utf8_decode($outcome));
    cert_printtext(170, 442, 'C', 'Helvetica', '', 10, utf8_decode($credithours));
    cert_printtext(170, 500, 'C', 'Helvetica', '', 10, utf8_decode($code));
    $i = 0 ;
    ...
    if ($teachers = get_users_by_capability($context, 'mod/certificate:printteacher', '', $sort='u.lastname ASC')) {
		foreach ($teachers as $teacher) {
			$i++;
	cert_printtext(130, 440+($i *12) , 'L', 'Helvetica', '', 12, utf8_decode(fullname($teacher)));
}}}

    cert_printtext(150, 420, '', '', '', '', '');
