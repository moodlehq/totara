...
$string['emailteachermail'] = '$a->Recebeu seu certificado: \'$a->certificate\'
para o curso de $a->course.

Você pode revisar este certificado em:

    $a->url';
$string['emailteachermailhtml'] = '$a->Recebeu seu certificado: \'<i>$a->certificate</i>\'
para o curso de $a->course.
...
$string['entercode'] = 'Entre com o código do certificado para verificar:';
...
$string['field1'] = 'Instituição';
$string['field2'] = 'Sou um(a)';
$string['field3'] = 'Estou treinando como';
...
$string['printerfriendly'] = 'Página pronta para impressão';
...
$string['titledefault'] = 'CERTIFICADO DE CONCLUSÃO';
...
$string['viewtranscript'] = 'Visualizar Certificados';
