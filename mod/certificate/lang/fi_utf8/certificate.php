...
$string['activitydependencies'] = 'Toisistaan riippuvaiset aktiviteetit';
$string['activitylocklabel'] = 'Linkitetty aktiviteetti/vähimmäisarvosana %%';
...
$string['certificatetitle'] = 'Kurssitodistuksen otsikko';
$string['certificatetype'] = 'Kurssitodistuksen tyyppi';
$string['course'] = 'Käyttäjälle';
$string['coursetime'] = 'Vaadittu kurssiaika';
$string['coursetimedependency'] = 'Minimiminuuttimäärä kurssilla';
...
$string['errorlockgrade'] = 'Nykyinen arvosanasi kohteesta $a->mod ($a->current%%) ei riitä vaadittuun arvosnaan ($a->needed%%), josta kurssitodistus myönnetään.';
$string['errorlockgradecourse'] = 'Nykyinen arvosanasi ($a->current%%) ei riitä vaadittuun arvosnaan ($a->needed%%), josta kurssitodistus myönnetään.';
$string['errorlockmod'] = 'Sinun tulee täyttää kaikki kurssiaktiivisuuden arvosanan kriteerit saadaksesi kurssitodistuksen.';
$string['errorlocksurvey'] = 'Sinun tulee täyttää kaikki kurssikyselyt ennenkuin saat kurssitodistuksen.';
$string['errorlocktime'] = 'Sinun tulee täyttää kurssin osallistumisaikakriteerit ennenkuin saat kurssitodistuksen.';
$string['getcertificate'] = 'Hanki kurssitodistus';
$string['grade'] = 'Arvosana';
$string['gradedate'] = 'Arvosnana päivämäärä';
$string['gradeformat'] = 'Arvosnana muoto';
...
$string['introlandscape'] = 'Tämä kurssitodistus todistaa, että';
$string['introletterlandscape'] = 'Tämä kurssitodistus todistaa, että';
$string['introletterportrait'] = 'Tämä kurssitodistus todistaa, että';
$string['introportrait'] = 'Tämä kurssitodistus todistaa, että';
$string['issued'] = 'Myönnetty';
$string['issueoptions'] = 'Myöntämisen valinnat';
$string['linkedactivity'] = 'Linkitetty aktiivisuus';
$string['lockgrade'] = 'Lukitse arvosanan mukaan';
$string['lockingoptions'] = 'Lukitsemisvalinnat';
$string['minimumgrade'] = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vaadittu arvosana';
...
$string['ondayportrait'] = 'tänä päivänä';
...
$string['reportcertificate'] = 'Kurssitodistukset raporteista';
$string['reviewcertificate'] = 'Tarkastele kurssitodistustasi';
$string['savecertificate'] = 'Tallenna kurssitodistukset';
$string['titledefault'] = 'KURSSITODISTUS SAAVUTUKSESTA';
