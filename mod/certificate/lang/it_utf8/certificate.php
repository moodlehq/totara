...
$string['activitydependencies'] = 'Attività dipendenti';
$string['activitylocklabel'] = 'Attività collegata/%% di grado minimo';
...
$string['certificatecoursename'] = 'Nome di corso';
...
$string['certificatetitle'] = 'Titolo di certificato';
$string['certificatetype'] = 'Tipo di certificato';
$string['code'] = 'Codice';
$string['course'] = 'Per';
$string['courseenddate'] = 'Data di fine del corso (da impostare)';
$string['coursegrade'] = 'Grado del corso';
$string['coursename'] = 'Corso';
$string['coursetime'] = 'Tempo richiesto del corso';
$string['coursetimedependency'] = 'Minuti minimi richiesti del corso';
$string['credithours'] = 'Ore di credito';
$string['customtext'] = 'Testo personalizzato';
$string['date'] = 'Il';
$string['dateformat'] = 'Formato di data';
$string['datehelp'] = 'Data';
$string['deliver'] = 'Fornitura';
...
$string['errorlockgrade'] = 'Il grado corrente su $a->mod ($a->current%%) è inferiore al grado richiesto ($a->needed%%) per ricevere il certificato.';
$string['errorlockgradecourse'] = 'Il grado di corso corrente ($a->current%%) è inferiore al grado richiesto ($a->needed%%) per ricevere il certificato.';
$string['errorlockmod'] = 'Occorre soddisfare tutti i requisiti del grado di attività del corso prima di ricevere il certificato';
$string['errorlocksurvey'] = 'Occorre completare tutti i sondaggi del corso prima di ricevere il certificato';
$string['errorlocktime'] = 'Occorre soddisfare il requisito di tempo di studio durante il corso prima di ricevere il certificato';
$string['field1'] = 'Istituto';
$string['field2'] = 'Sono';
$string['field3'] = 'Mi sto formando in';
$string['getcertificate'] = 'Ottieni il certificato';
$string['grade'] = 'Grado';
$string['gradedate'] = 'Data di grado';
$string['gradeformat'] = 'Formato di grado';
...
$string['introlandscape'] = 'Il presente documento attesta che';
$string['introletterlandscape'] = 'Il presente documento attesta che';
$string['introletterportrait'] = 'Il presente documento attesta che';
$string['introportrait'] = 'Il presente documento attesta che';
$string['issued'] = 'Emesso';
$string['issueoptions'] = 'Opzioni di emissione';
$string['linkedactivity'] = 'Attività collegata';
$string['lockgrade'] = 'BLocca per grado';
$string['lockingoptions'] = 'Opzioni di blocco';
$string['minimumgrade'] = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grado richiesto';
...
$string['printcode'] = 'Stampa codice';
...
$string['reportcertificate'] = 'Certificati di report';
$string['requiredgrade'] = 'Grado di corso richiesto';
$string['reviewcertificate'] = 'Rivedi il certificato';
$string['savecertificate'] = 'Salva certificati';
...
$string['titledefault'] = 'ATTESTATO DI FORMAZIONE';
$string['to'] = 'Rilasciato il';
$string['typelandscape'] = 'Orizzontale';
$string['typeletter_landscape'] = 'Orizzontale (lettera)';
$string['typeletter_portrait'] = 'Verticale (lettera)';
$string['typeportrait'] = 'Verticale';
$string['typeunicode_landscape'] = 'Unicode (orizzontale)';
$string['typeunicode_portrait'] = 'Unicode (verticale)';
