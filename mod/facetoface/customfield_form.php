...
class mod_facetoface_customfield_form extends moodleform {
    ...
    function definition()
    {
        ...
        $mform->addElement('text', 'name', get_string('name'), 'maxlenght="255" size="50"');
        ...
        $options = array(0 => get_string('field:text', 'facetoface'),
                         1 => get_string('field:select', 'facetoface'),
                         2 => get_string('field:multiselect', 'facetoface'),
                         );
        $mform->addElement('select', 'type', get_string('setting:type', 'facetoface'), $options);
        $mform->addRule('type', null, 'required', null, 'client');
        $mform->setDefault('type', 0);

        $mform->addElement('text', 'defaultvalue', get_string('setting:defaultvalue', 'facetoface'), 'maxlenght="255" size="30"');
