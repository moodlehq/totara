...
$string['addmanageremailinstruction'] = 'Adres e-mail kierownika nie został wcześniej wprowadzony. Podaj go, aby zarejestrować się na tę sesję.';
$string['addnewfield'] = 'Dodaj nowe pole niestandardowe';
$string['addnewfieldlink'] = 'Utwórz nowe pole niestandardowe';
$string['addnewnotice'] = 'Dodaj nową notatkę witryny';
$string['addnewnoticelink'] = 'Utwórz nową notatkę witryny';
$string['addremoveattendees'] = 'Dodaj/usuń uczestników';
$string['addsession'] = 'Dodaj nową sesję';
...
$string['attendance'] = 'Obecność';
$string['attendanceinstructions'] = 'Wybierz użytkowników, którzy uczestniczyli w sesji:';
$string['attendedsession'] = 'Obecność na sesji';
$string['attendees'] = 'Uczestnicy';
$string['attendeestablesummary'] = 'Osoby, które zaplanowały lub uczestniczyły w tej sesji.';
$string['booked'] = 'Zarezerwowane';
$string['bookedforsession'] = 'Zarezerwowano na sesję {$a}';
$string['bookingcancelled'] = 'Twoje rezerwacje zostały anulowane.';
$string['bookingcompleted'] = 'Twoje rezerwacje zostały ukończone.';
$string['bookingfull'] = 'Zarezerwowano wszystkie miejsca';
$string['bookingopen'] = 'Otwarto rezerwacje';
$string['bookingstatus'] = 'Masz rezerwacje na następujące sesje';
$string['calendareventdescriptionbooking'] = 'Masz rezerwację na tę <a href="{$a}">sesję bezpośrednią</a>.';
$string['calendareventdescriptionsession'] = 'Utworzono tę <a href="{$a}">sesję bezpośrednią</a>.';
$string['calendaroptions'] = 'Opcje kalendarza';
...
$string['cancellationstablesummary'] = 'Lista osób, które anulowały rejestracje na sesję.';
$string['cancelledforsession'] = 'Anulowano dla sesji';
$string['cancelreason'] = 'Przyczyna';
$string['cancelusersession'] = 'Anulowano dla sesji {$a->usermsg} {$a->url}';
...
$string['conditionsexplanation'] = 'Wszystkie te kryteria muszą zostać spełnione, aby notatka została wyświetlona w kalendarzu szkolenia:';
...
$string['confirmmanageremailaddressquestion'] = 'Czy <b>{$a}</b> jest nadal adresem e-mail Twojego kierownika?';
$string['confirmmanageremailinstruction1'] = 'Poprzednio, jako adres e-mail kierownika, podano następujące dane:';
$string['confirmmanageremailinstruction2'] = 'Czy jest to nadal adres e-mail Twojego kierownika?';
$string['copy'] = 'Kopiuj';
$string['copyingsession'] = 'Kopiowanie jako nowej sesji w {$a}';
$string['copysession'] = 'Kopiuj sesję';
$string['cost'] = 'Koszt';
$string['costheading'] = 'Koszt sesji';
$string['currentstatus'] = 'Bieżący stan';
$string['customfieldsheading'] = 'Niestandardowe pola sesji';
$string['date'] = 'Data';
$string['dateadd'] = 'Dodaj nową datę';
$string['dateremove'] = 'Usuń tę datę';
$string['datetext'] = 'Masz rejestrację na dzień';
$string['decidelater'] = 'Zdecyduj później';
...
$string['email:instrmngr'] = 'Notatka dla kierownika';
...
$string['error:addattendee'] = 'Nie można dodać {$a} do sesji.';
$string['error:cancelbooking'] = 'Wystąpił problem z anulowaniem rezerwacji.';
$string['error:cannotemailmanager'] = 'Wysłano wiadomość e-mail z przypomnieniem dla id przesłania {$a->submissionid} do użytkownika {$a->userid}, ale nie można wysłać wiadomości na adres e-mail kierownika użytkownika ({$a->manageremail}).';
$string['error:cannotemailuser'] = 'Nie można wysłać wiadomości e-mail dla id przesłania {$a->submissionid} do użytkownika {$a->userid} ({$a->useremail}).';
$string['error:cannotsendconfirmationmanager'] = 'Wiadomość potwierdzająca została wysłana na Twoje konto e-mail, ale wystąpił problem z wysłaniem wiadomości potwierdzającej na adres e-mail Twojego kierownika.';
$string['error:cannotsendconfirmationthirdparty'] = 'Wiadomość potwierdzająca została wysłana na Twoje konto e-mail i na konto e-mail Twojego kierownika, ale wystąpił problem z wysłaniem wiadomości potwierdzającej na adres e-mail innej osoby.';
$string['error:cannotsendconfirmationuser'] = 'Wystąpił problem z wysłaniem wiadomości potwierdzającej na Twoje konto e-mail.';
$string['error:cannotsendconfirmationusermanager'] = 'Wiadomości potwierdzającej nie można wysłać na Twój adres e-mail ani na adres e-mail Twojego kierownika.';
$string['error:cannotsendrequestmanager'] = 'Wystąpił problem podczas wysyłania wiadomości ze zgłoszeniem rejestracyjnym na konto e-mail Twojego kierownika.';
$string['error:cannotsendrequestuser'] = 'Wystąpił problem podczas wysyłania wiadomości ze zgłoszeniem rejestracyjnym na Twoje konto e-mail.';
$string['error:canttakeattendanceforunstartedsession'] = 'Nie można uczestniczyć w sesji, która dopiero ma się rozpocząć.';
$string['error:couldnotaddfield'] = 'Nie można dodać pola niestandardowego sesji.';
$string['error:couldnotaddnotice'] = 'Nie można dodać notatki do witryny.';
$string['error:couldnotaddsession'] = 'Nie można dodać sesji';
$string['error:couldnotcopysession'] = 'Nie można skopiować sesji';
$string['error:couldnotdeletefield'] = 'Nie można usunąć niestandardowego pola sesji';
$string['error:couldnotdeletenotice'] = 'Nie można usunąć notatki do witryny';
$string['error:couldnotdeletesession'] = 'Nie można usunąć sesji';
$string['error:couldnotfindsession'] = 'Nie można znaleźć nowo wstawionej sesji';
$string['error:couldnotsavecustomfield'] = 'Nie można zapisać pola niestandardowego';
$string['error:couldnotupdatecalendar'] = 'Nie można zaktualizować zdarzenia sesji w kalendarzu.';
$string['error:couldnotupdatef2frecord'] = 'Nie można zaktualizować rekord rejestracji bezpośredniej w bazie danych.';
$string['error:couldnotupdatefield'] = 'Nie można zaktualizować niestandardowego pola sesji.';
$string['error:couldnotupdatemanageremail'] = 'Nie można zaktualizować adresu e-mail kierownika.';
$string['error:couldnotupdatenotice'] = 'Nie można zaktualizować notatki do witryny.';
$string['error:couldnotupdatesession'] = 'Nie można zaktualizować sesji';
$string['error:coursemisconfigured'] = 'Kurs jest niepoprawnie skonfigurowany';
$string['error:cronprefix'] = 'Błąd: bezpośredni demon cron:';
$string['error:emptylocation'] = 'Lokalizacja była pusta.';
$string['error:emptymanageremail'] = 'Pusty adres e-mail kierownika.';
$string['error:emptyvenue'] = 'Miejsce było puste.';
$string['error:enrolmentfailed'] = 'Nie można zapisać {$a} na kurs.';
$string['error:eventoccurred'] = 'Nie możesz anulować zdarzenia, które już wystąpiło.';
$string['error:f2ffailedupdatestatus'] = 'Funkcja bezpośrednia nie mogła zaktualizować stanu użytkownika';
$string['error:incorrectcoursemodule'] = 'Moduł kursu jest niepoprawny';
$string['error:incorrectcoursemoduleid'] = 'ID modułu kursu jest niepoprawny';
$string['error:incorrectcoursemodulesession'] = 'Sesja bezpośrednia modułu kursu była niepoprawna';
$string['error:incorrectfacetofaceid'] = 'ID bezpośredni był niepoprawny';
$string['error:incorrectnotificationtype'] = 'Podano niepoprawny typ powiadomienia';
$string['error:invaliduserid'] = 'Niepoprawny ID użytkownika';
$string['error:manageremailaddressmissing'] = 'Nie masz teraz przypisania do kierownika w systemie. Skontaktuj się z administratorem systemu.';
$string['error:mustspecifycoursemodulefacetoface'] = 'Należy podać modułu kursu lub ID bezpośredniego';
$string['error:nomanageremail'] = 'Nie został podany adres e-mail Twojego kierownika';
$string['error:nomanagersemailset'] = 'Nie ustawiono adresu e-mail kierownika';
$string['error:nopermissiontosignup'] = 'Nie masz uprawnień do rejestracji na tę sesję bezpośrednią.';
$string['error:problemsigningup'] = 'Wystąpił problem podczas rejestracji.';
$string['error:removeattendee'] = 'Nie można usunąć {$a} z sesji.';
$string['error:sessionstartafterend'] = 'Data/godzina rozpoczęcia sesji jest ustawiona po jej zakończeniu.';
$string['error:shortnametaken'] = 'Pole niestandardowe o tej nazwie skróconej już istnieje.';
$string['error:signedupinothersession'] = 'Masz już rejestrację na inną sesję w tej czynności. Można się zapisać tylko na jedną sesję dla jednej czynności bezpośredniej.';
$string['error:unknownbuttonclicked'] = 'Brak działania powiązanego z klikniętym przyciskiem';
$string['excelformat'] = 'Excel';
$string['export'] = 'Eksportuj';
$string['exportattendance'] = 'Eksportuj uczestnictwo';
$string['exporttofile'] = 'Eksportuj do pliku';
$string['facetoface'] = 'Bezpośrednio';
$string['facetoface:addattendees'] = 'Dodaj uczestników do sesji bezpośredniej';
$string['facetoface:editsessions'] = 'Dodawaj, edytuj i usuwaj sesje bezpośrednie';
$string['facetoface:overbook'] = 'Zarejestruj się na pełnych sesjach.';
$string['facetoface:removeattendees'] = 'Usuń uczestników z sesji bezpośredniej';
$string['facetoface:signup'] = 'Zapisz się na sesję';
$string['facetoface:takeattendance'] = 'Weź udział';
$string['facetoface:view'] = 'Wyświetl czynności i sesje bezpośrednie';
$string['facetoface:viewattendees'] = 'Wyświetl listę obecności i uczesników';
$string['facetoface:viewcancellations'] = 'Wyświetl anulowania';
$string['facetoface:viewemptyactivities'] = 'Wyświetl puste czynności bezpośrednie';
$string['facetofacebooking'] = 'Rezerwacje bezpośrednie';
$string['facetofacename'] = 'Nazwa bezpośrednia';
$string['facetofacesession'] = 'Sesja bezpośrednia';
$string['feedback'] = 'Opinia';
$string['feedbackupdated'] = 'Zaktualizowano opinię dla {$a} osób';
$string['field:multiselect'] = 'Wielokrotny wybór';
$string['field:select'] = 'Menu wyboru';
$string['field:text'] = 'Tekst';
$string['fielddeleteconfirm'] = 'Usunąć pole \'{$a}\' i wszystkie dane sesji z nim związane?';
$string['floor'] = 'Podłoga';
$string['format'] = 'Format';
$string['full'] = 'Data jest całkowicie zajęta';
$string['goback'] = 'Wróć';
$string['guestsno'] = 'Goście niestety nie mogą zapisywać się na sesje.';
$string['icalendarheading'] = 'Załączniki iCalendar';
...
$string['manageremail'] = 'Adres e-mail kierownika';
$string['manageremailaddress'] = 'Adres e-mail kierownika';
$string['manageremailformat'] = 'Adres e-mail musi mieć format \'{$a}\', aby można go było zaakceptować.';
$string['manageremailheading'] = 'Adresy e-mail kierownika';
$string['manageremailinstruction'] = 'Aby zapisać się na sesję szkoleniową, wiadomość e-mail z potwierdzeniem musi zostać wysłana na Twój adres e-mail z kopią na adres e-mail Twojego kierownika.';
$string['manageremailinstructionconfirm'] = 'Potwierdź, że jest to adres e-mail Twojego kierownika:';
$string['managername'] = 'Nazwisko kierownika';
$string['managerupdated'] = 'Adres e-mail kierownika został zaktualizowany.';
$string['maximumpoints'] = 'Maksymalna liczba punktów';
$string['maximumsize'] = 'Maksymalna liczba uczestników';
$string['message'] = 'Zmiana rezerwacji na kurs {$a->coursename}!
...
$string['multiday'] = 'wielodniowy';
$string['newmanageremailaddress'] = 'Adres e-mail kierownika';
$string['noactionableunapprovedrequests'] = 'Brak niezatwierdzonych zgłoszeń wymagających działania';
$string['nocustomfields'] = '<p>Nie zdefiniowano pól niestandardowych.</p>';
$string['nofacetofaces'] = 'Nie ma czynności bezpośrednich';
$string['none'] = 'brak';
...
$string['note'] = 'Uwaga';
$string['notefull'] = 'Nadal możesz się zarejestrować, nawet jeśli sesja jest całkowicie zarezerwowana. Znajdziesz się w kolejce (zaznaczonej na czerwono). Jeśli ktoś się wyrejestruje, pierwszy uczestnik z listy zostanie przeniesiony do zarejestrowanych uczestników i dostanie pocztą powiadomienie.';
$string['noticedeleteconfirm'] = 'Usunąć notatkę dla witryny \'{$a->name}\'?<br/><blockquote>{$a->tekst}</blockquote>';
$string['noticetext'] = 'Tekst notatki';
$string['notificationboth'] = 'Powiadomienie w wiadomości e-mail i spotkanie iCalendar';
...
$string['odsformat'] = 'Otwórz dokument';
$string['onehour'] = '1 godzina';
$string['oneminute'] = '1 minuta';
$string['options'] = 'Opcje';
$string['or'] = 'lub';
$string['order'] = 'Kolejność';
$string['place'] = 'Pomieszczenie';
...
$string['pointsplural'] = 'Punkty';
$string['previoussessions'] = 'Poprzednie sesje';
$string['previoussessionslist'] = 'Lista wcześniejszych sesji dla tej czynności bezpośredniej';
$string['printversionid'] = 'Wersja wydruku: bez nazwy';
$string['printversionname'] = 'Wersja wydruku: z nazwą';
$string['really'] = 'Czy na pewno chcesz usunąć wszystkie wyniki dla tego zdarzenia bezpośredniego?';
$string['registeredon'] = 'Zarejestrowano dnia';
...
$string['scheduledsessions'] = 'Zaplanowane sesje';
$string['seatsavailable'] = 'Dostępne miejsca';
$string['seeattendees'] = 'Zobacz uczestników';
...
$string['sessionover'] = 'sesja zakończona';
$string['sessionrequiresmanagerapproval'] = 'Rezerwacja na tę sesję wymaga zatwierdzenia przez kierownika.';
$string['sessionroles'] = 'Role sesji';
...
$string['setting:addchangemanageremail'] = 'Poproś użytkowników o adresy e-mail ich kierowników.';
$string['setting:addchangemanageremail_caption'] = 'Adres e-mail kierownika:';
...
Miejsce: [session:venue]
Pomieszczenie: [session:room]';
$string['setting:defaultcancellationsubject'] = 'Domyślny wiersz tematu dla wiadomości e-mail o anulowaniu.';
$string['setting:defaultcancellationsubject_caption'] = 'Temat anulowania';
...
***Prosimy o przybycie na dziesięć minut przed rozpoczęciem kursu***

Aby zmienić daty lub anulować rezerwację
Aby zmienić daty rezerwacji musisz anulować tę rezerwację, a następnie zarezerwować nową sesję. Aby anulować rezerwację, wróć do witryny, a następnie do strony tego kursu, po czym wybierz opcję Anuluj na ekranie informacji o rezerwacji.

[details]

Otrzymasz przypomnienie na [reminderperiod] dni roboczych przed tym kursem.';
$string['setting:defaultconfirmationsubject'] = 'Domyślny wiersz tematu dla wiadomości e-mail o potwierdzeniu.';
$string['setting:defaultconfirmationsubject_caption'] = 'Temat potwierdzenia';
...
Miejsce: [session:venue]
Pomieszczenie: [session:room]';
$string['setting:defaultrequestsubjectdefault'] = 'Żądanie rezerwacji kursu: [facetofacename], [starttime]-[finishtime]';
$string['setting:defaultvalue'] = 'Wartość domyślna';
$string['setting:defaultwaitlistedmessage'] = 'Domyślna wiadomość o liście oczekujących wysłana do użytkowników.';
$string['setting:defaultwaitlistedmessage_caption'] = 'Wiadomość o liście oczekujących';
$string['setting:defaultwaitlistedmessagedefault'] = 'Informujemy, że masz miejsce na liście oczekujących na:

Kurs: [facetofacename]
Lokalizacja: [session:location]
Uczestnik: [firstname] [lastname]

***Pamiętaj, że nie jest to potwierdzenie rezerwacji kursu***

Dzięki liście oczekujących zostało zarejestrowane Twoje zainteresowanie tym kursem i skontaktujemy się bezpośrednio, gdy sesja będzie dostępna.

Aby usnąć się z listy oczekujących, wróć do tego kursu i kliknij przycisk Anuluj rezerwację. Pamiętaj, że nie ma wiadomości e-mail potwierdzającej usunięcie z listy oczekujących.';
$string['setting:defaultwaitlistedsubject'] = 'Domyślny wiersz tematu dla wiadomości e-mail o liście oczkujących.';
$string['setting:defaultwaitlistedsubject_caption'] = 'Temat listy oczekujących';
$string['setting:defaultwaitlistedsubjectdefault'] = 'Informacja o liście oczekujących dla [facetofacename]';
$string['setting:disableicalcancel'] = 'Wyłącz wiadomości e-mail o anulowaniu z załącznikiem iCalendar.';
$string['setting:disableicalcancel_caption'] = 'Wyłącz anulowania iCalendar:';
$string['setting:fromaddress'] = 'Co znajdzie się w polu Od wiadomości e-mail z przypomnieniem wysłanej przez ten moduł.';
$string['setting:fromaddress_caption'] = 'Adres nadawcy:';
$string['setting:fromaddressdefault'] = 'moodle@example.com';
$string['setting:hidecost'] = 'Ukryj pola kosztu i kodu zniżki.';
$string['setting:hidecost_caption'] = 'Ukryj koszt i zniżkę:';
$string['setting:hidediscount'] = 'Ukryj tylko pole kodu zniżki.';
$string['setting:hidediscount_caption'] = 'Ukryj zniżkę:';
$string['setting:isfilter'] = 'Wyświetl jako filtr';
$string['setting:manageraddressformat'] = 'Sufiks, który musi występować w adresie e-mail kierownika, aby był uważany za poprawny.';
$string['setting:manageraddressformat_caption'] = 'Wymagany sufiks:';
$string['setting:manageraddressformatreadable'] = 'Krótki opis ograniczeń dla adresu e-mail kierownika. to ustawienie nie wpływa na nic, jeśli poprzednie nie zostało ustawione.';
$string['setting:manageraddressformatreadable_caption'] = 'Przykład formatu:';
$string['setting:manageraddressformatreadabledefault'] = 'imie.nazwisko@firma.com';
$string['setting:oneemailperday'] = 'Wyślij wiele wiadomości e-mail z potwierdzeniem dla zdarzeń wielodniowych.';
$string['setting:oneemailperday_caption'] = 'Jedna wiadomość dziennie:';
$string['setting:possiblevalues'] = 'Lista możliwych wartości';
$string['setting:sessionroles'] = 'Użytkownicy przypisani do wybranych ról na kursie mogą być śledzeni na każdej sesji bezpośredniej';
...
$string['signupforsession'] = 'Zapisz się na dostępną nadchodzącą sesję';
$string['signupforthissession'] = 'Zapisz się na tę sesję bezpośrednią';
$string['signups'] = 'Rejestracje';
$string['sitenoticesheading'] = 'Notatki do witryny';
$string['status'] = 'Stan';
$string['status_approved'] = 'Zatwierdzone';
$string['status_booked'] = 'Zarezerwowane';
$string['status_declined'] = 'Odrzucone';
$string['status_fully_attended'] = 'Pełne uczestnictwo';
$string['status_no_show'] = 'Nieobecność';
$string['status_partially_attended'] = 'Częściowe uczestnictwo';
$string['status_requested'] = 'Żądane';
$string['status_session_cancelled'] = 'Anulowano sesję';
$string['status_user_cancelled'] = 'Anulowano użytkownika';
$string['status_waitlisted'] = 'Lista oczekujących';
$string['subject'] = 'Zmiana rezerwacji na kurs {$a->coursename} ({$a->duedate})';
...
$string['upcomingsessions'] = 'Nadchodzące sesje';
$string['upcomingsessionslist'] = 'Lista wszystkich nadchodzących sesji dla tej czynności bezpośredniej';
$string['usercancelledon'] = 'Anulowano użytkownika dla {$a}';
$string['usernotsignedup'] = 'Stan: brak rejestracji';
$string['usersignedup'] = 'Stan: zarejestrowano';
$string['usersignedupon'] = 'Użytkownik zarejestrowany na {$a}';
