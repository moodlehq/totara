...
$string['addmanageremailinstruction'] = 'Et ole antanut esimiehesi sähköpostiosoitetta. Anna se ennen ilmoittautumistasi tähän tapaamiseen.';
$string['addnewfield'] = 'Lisää uusi lisäkenttä';
$string['addnewfieldlink'] = 'Luo uusi lisäkenttä';
$string['addnewnotice'] = 'Lisää uusi tiedonanto';
$string['addnewnoticelink'] = 'Luo uusi tiedonanto';
$string['addremoveattendees'] = 'Lisää/poista osallistujia';
$string['addsession'] = 'Lisää uusi tapaaminen';
...
$string['attendanceinstructions'] = 'Valitse käyttäjät, jotka ottivat osaa tapaamiseen:';
$string['attendedsession'] = 'Ottivat osaa tapaamiseen';
$string['attendees'] = 'Osallistujat';
$string['attendeestablesummary'] = 'Ihmiset, jotka suunnittelivat osallistuvansa tai osallistuivat tapamiseen';
$string['booked'] = 'Varattu';
$string['bookedforsession'] = 'Varaus tehty koulutukseen {$a}';
$string['bookingcancelled'] = 'Varauksesi on peruttu.';
$string['bookingcompleted'] = 'Varauksesi on tehty.';
$string['bookingfull'] = 'Varauksia on enimmäismäärä';
$string['bookingopen'] = 'Varaus mahdollinen';
$string['bookingstatus'] = 'Sinulle on tehty varaus seuraavaan tapaamiseen';
$string['calendareventdescriptionbooking'] = 'Sinulle on tehty varaus tähän <a href="{$a}">lähikoulutustapaamiseen</a>.';
$string['calendareventdescriptionsession'] = 'Olet luonut tämän <a href="{$a}">lähikoulutustapaamiseen</a>.';
$string['calendaroptions'] = 'Kalenterin asetukset';
$string['cancelbooking'] = 'Peruuta varaus';
...
$string['cancellationstablesummary'] = 'Lista ihmisistä, jotka ovar peruuttaneet ilmoittautumisensa tähän tapaamiseen.';
$string['cancelledforsession'] = 'Peruutettu tälle koulutukselle';
$string['cancelreason'] = 'Syy';
$string['cancelusersession'] = 'Peruutettu tälle {$a->usermsg} koulutukselle {$a->url}';
...
$string['conditions'] = 'Ehdot';
$string['conditionsexplanation'] = 'Kaikkien näiden kriteerien tulee täyttyä, jotta koulutuskalanterissa näkyy tiedonanto:';
...
$string['confirmmanageremailaddressquestion'] = 'Onko <b>{$a}</b> edelleen esimiehesi sähköpostiosoite?';
$string['confirmmanageremailinstruction1'] = 'Olet ilmoittanut tämän esimiehesi sähköpostiosoitteeksi:';
$string['confirmmanageremailinstruction2'] = 'Onko tämä edelleen esimiehesi sähköpostiosoite?';
$string['copy'] = 'Kopioi';
$string['copyingsession'] = 'Kopioidaan uutena tapaamisena täällä: {$a}';
$string['copysession'] = 'Kopioi tapaaminen';
$string['cost'] = 'Hinta';
$string['costheading'] = 'Tapaamisen hinta';
$string['currentstatus'] = 'Nykyinen tila';
$string['customfieldsheading'] = 'Tapaamisen lisäkentät';
$string['date'] = 'Päivämäärä';
$string['dateadd'] = 'Lisää uusi päivämäärä';
$string['dateremove'] = 'Poista tämä päivämäärä';
$string['datetext'] = 'Olet ilmoittautuneena tälle päivälle:';
$string['decidelater'] = 'Päätä myöhemmin';
$string['decline'] = 'Kieltäydy';
$string['deleteall'] = 'Poista kaikki';
$string['deletesession'] = 'Poista tapaaminen';
...
$string['editsession'] = 'Muokkaa tapaamista';
$string['email:instrmngr'] = 'Tiedonanto esimiehelle';
...
$string['error:addattendee'] = 'Käyttäjää {$a} ei voitu lisätä tapaamiseen.';
$string['error:cancelbooking'] = 'Ilmoittautumistasi peruutettaessa tapahtui virhe';
$string['error:cannotemailmanager'] = 'Muistutusviesti palautustunnuksesta {$a->submissionid} lähetettiin käyttäjälle {$a->userid} mutta viestiä ei voitu lähettää käyttäjän esimiehen sähköpostiosoitteeseen ({$a->manageremail}).';
$string['error:cannotemailuser'] = 'Muistutusviestiä palautustunnuksesta {$a->submissionid} ei voitu lähettää käyttäjälle {$a->userid} ({$a->useremail}).';
$string['error:cannotsendconfirmationmanager'] = 'Vahvistusviesti lähetettiin sähköpostiisi mutta vahvistusviestin lähetyksessä esimiehellesi tapahtui virhe.';
$string['error:cannotsendconfirmationthirdparty'] = 'Vahvistusviesti lähetettiin sekä sinun että esimiehesi sähköpostiin mutta viestin lähettämisessä kolmannen osapuolen sähköpostiin tapahtui virhe.';
$string['error:cannotsendconfirmationuser'] = 'Vahvistusviestin lähetyksessä sähköpostiisi tapahtui virhe.';
$string['error:cannotsendconfirmationusermanager'] = 'Vahvistusviestiä ei voitu lähettää sinun eikä esimiehesi sähköpostiin.';
$string['error:cannotsendrequestmanager'] = 'Ilmoittautumisanomusta ei voitu lähettää esimiehesi sähköpostiin.';
$string['error:cannotsendrequestuser'] = 'Ilmoittautumisanomusta ei voitu lähettää sähköpostiisi.';
$string['error:canttakeattendanceforunstartedsession'] = 'Tapaaminen ei ole alkanut, joten sen osallistujia ei voi tarkastella.';
$string['error:couldnotaddfield'] = 'Tapaamisen lisäkenttää ei voitu lisätä.';
$string['error:couldnotaddnotice'] = 'Tiedonantoa ei voitu lisätä sivulle.';
$string['error:couldnotaddsession'] = 'Tapaamista ei voitu lisätä';
$string['error:couldnotcopysession'] = 'Tapaamista ei voitu kopioida';
$string['error:couldnotdeletefield'] = 'Tapaamisen lisäkenttää ei voitu poistaa';
$string['error:couldnotdeletenotice'] = 'Tiedonanto ei voitu poistaa sivulta';
$string['error:couldnotdeletesession'] = 'Tapaamista ei voitu poistaa';
$string['error:couldnotfindsession'] = 'Juuri luotua tapaamista ei löytynyt';
$string['error:couldnotsavecustomfield'] = 'Lisäkenttää ei voitu tallentaa';
$string['error:couldnotupdatecalendar'] = 'Tapaamista ei voitu päivittää kalenterissa.';
$string['error:couldnotupdatef2frecord'] = 'Lähikoulutuksen ilmoittautumisrekisteriä ei voitu päivittää tietokantaan';
$string['error:couldnotupdatefield'] = 'Tapaamisen lisäkenttää ei voitu päivittää';
$string['error:couldnotupdatemanageremail'] = 'Esimiehen sähköpostiosoitetta ei voitu päivittää';
$string['error:couldnotupdatenotice'] = 'Tiedonantoa ei voitu päivittää';
$string['error:couldnotupdatesession'] = 'Tapaamista ei voitu päivittää';
$string['error:coursemisconfigured'] = 'Kurssi on väärin konfiguroitu';
$string['error:cronprefix'] = 'Virhe: lähikoulutus cron:';
$string['error:emptylocation'] = 'Toimipaikka-kenttä oli tyhjä.';
$string['error:emptymanageremail'] = 'Esimiehen sähköposti -kenttä oli tyhjä';
$string['error:emptyvenue'] = 'Pitopaikka-kenttä oli tyhjä';
$string['error:enrolmentfailed'] = 'Käyttäjää {$a} ei voitu lisätä kurssille.';
$string['error:eventoccurred'] = 'Et voi peruuttaa tapahtumaa, joka on jo mennyt';
$string['error:f2ffailedupdatestatus'] = 'Tapaamisaktiviteetti ei voinut päivittää käyttäjän tilaa';
$string['error:incorrectcoursemodule'] = 'Kurssimoduuli on väärä';
$string['error:incorrectcoursemoduleid'] = 'Kurssimoduulin id oli väärä';
$string['error:incorrectcoursemodulesession'] = 'Lähikoulutustapaaminen oli väärä kurssimoduuli';
$string['error:incorrectfacetofaceid'] = 'Lähikoulutuksen id oli väärä';
$string['error:incorrectnotificationtype'] = 'Väärä ilmoitustyyppi';
$string['error:invaliduserid'] = 'Virheellinen käyttäjä-id';
$string['error:manageremailaddressmissing'] = 'Sinulla ei ole tällä hetkellä määriteltynä esimiestä. Ota yhteyttä sivuston hallinnoijaan.';
$string['error:mustspecifycoursemodulefacetoface'] = 'Kurssimoduuli tai lähikoulutuksen id on määriteltävä';
$string['error:nomanageremail'] = 'Et syöttänyt sähköpostiosoitetta esimiehellesi';
$string['error:nomanagersemailset'] = 'Esimiehen sähköpostiosoitetta ei ole määritelty';
$string['error:nopermissiontosignup'] = 'Sinulla ei ole lupaa ilmoittautua tähän lähikoulutustapaamiseen.';
$string['error:problemsigningup'] = 'Ilmoittautumisessasi ilmeni ongelma.';
$string['error:removeattendee'] = 'Käyttäjää {$a} ei voitu poistaa tästä tapaamisesta.';
$string['error:sessionstartafterend'] = 'Tapaamisen alkamispäivämäärä/aika on loppumisjankohdan jälkeen.';
$string['error:shortnametaken'] = 'Lisäkenttä, jolla on tämä lyhenne, on jo olemassa.';
$string['error:signedupinothersession'] = 'Olet ilmoittautuneena toiseen tapaamiseen tässä aktiviteetissa. Voit ilmoittautua vain yhteen tapaamisen per lähikoulutusaktiviteetti.';
$string['error:unknownbuttonclicked'] = 'Tässä painikkeessa ei ole toiminnallisuutta';
$string['excelformat'] = 'Excel';
$string['export'] = 'Vie';
$string['exportattendance'] = 'Vie osallistumistiedot';
$string['exporttofile'] = 'Vie tiedostoon';
$string['facetoface'] = 'Lähikoulutus';
$string['facetoface:addattendees'] = 'Lisää osallistujia lähikoulutustapaamiseen';
$string['facetoface:editsessions'] = 'Lisää, muokkaa, kopioi ja poista lähikoulutustapaamisia';
$string['facetoface:overbook'] = 'Ilmoittautuminen täysiin tapaamisiin';
$string['facetoface:removeattendees'] = 'Poista osallistujia lähikoulutustapaamisesta';
$string['facetoface:signup'] = 'Ilmoittaudu tapaamiseen';
$string['facetoface:takeattendance'] = 'Tarkista osallistujamäärä';
$string['facetoface:view'] = 'Tarkastele lähikoulutusaktiviteetteja ja tapaamisia';
$string['facetoface:viewattendees'] = 'Tarkastele osallistumislistaa ja osallistujia';
$string['facetoface:viewcancellations'] = 'Tarkastele peruutuksia';
$string['facetoface:viewemptyactivities'] = 'Tarkastele tyhjiä lähikoulutusaktiviteetteja';
$string['facetofacebooking'] = 'Lähikoulutusvaraus';
$string['facetofacename'] = 'Lähikoulutuksen nimi';
$string['facetofacesession'] = 'Lähikoulutustapaaminen';
$string['feedback'] = 'Palaute';
$string['feedbackupdated'] = 'Palaute päivitetty käyttäjille {$a}';
$string['field:multiselect'] = 'Monivalinta';
$string['field:select'] = 'Vaihtoehdot';
$string['field:text'] = 'Teksti';
$string['fielddeleteconfirm'] = 'Poista kenttä \'{$a}\' ja kaikki siihen liittyvä tapaamisen sisältö?';
$string['floor'] = 'Puheenvuoro';
$string['format'] = 'Muoto';
$string['full'] = 'Tämä tapaaminen on täynnä';
$string['goback'] = 'Mene takaisin';
$string['guestsno'] = 'Tähän tapaamiseen ei voi ilmoittautua vieraana.';
$string['icaldescription'] = 'Tämä kalenteritapahtuma liittyy {$a->name} lähikoulutukseen, johon olet ilmoittautunut.';
$string['icalendarheading'] = 'iCalendar-liitteet';
$string['import'] = 'Importoi';
$string['info'] = 'Tietoja';
...
$string['manageremail'] = 'Esimiehen sähköposti';
$string['manageremailaddress'] = 'Esimiehen sähköpostiosoite';
$string['manageremailformat'] = 'Sähköpostiosoitteen tulee olla';
$string['manageremailheading'] = 'Esimiehen sähköpostiosoitteet';
$string['manageremailinstruction'] = 'Jotta voit ilmoittautua koulutustapaamiseen, vahvistussähköposti tulee lähettää sähköpostiisi ja kopio siitä esimiehesi sähköpostiin.';
$string['manageremailinstructionconfirm'] = 'Vahvista, että tämä on esimiehesi sähköpostiosoite:';
$string['managername'] = 'Esimiehen nimi';
$string['managerupdated'] = 'Esimiehesi sähköpostiosoite on päivitetty.';
$string['maximumpoints'] = 'Maksimipistemäärä';
$string['maximumsize'] = 'Osallistujien maksimimäärä';
$string['message'] = 'Muutos kurssin {$a->coursename} varaustiedoissa!
...
$string['multiday'] = 'monipäiväinen';
$string['newmanageremailaddress'] = 'Esimiehen sähköpostiosoite';
$string['noactionableunapprovedrequests'] = 'Ei hyväksyntää odottavia anomuksia';
$string['nocustomfields'] = '<p>Lisäkenttiä ei ole määritelty.</p>';
$string['nofacetofaces'] = 'Ei lähiopetusaktiviteetteja';
...
$string['note'] = 'Huomaa';
$string['notefull'] = 'Vaikka tapaaminen on täynnä, voit silti ilmoittautua. Pääset varasijalle (punaisella). Jos joku peruu ilmoittautumisensa, ensimmäinen varasijalla oleva oppija siirtyy ilmoittautuneeksi ja hänelle ilmoitetaan asiasta sähköpostitse.';
$string['noticedeleteconfirm'] = 'Poista tiedonanto \'{$a->name}\'?<br/><blockquote>{$a->text}</blockquote>';
$string['noticetext'] = 'Tiedoksiannon teksti';
$string['notificationboth'] = 'Sähköposti-ilmoitus ja iCalendar-tapaaminen';
...
$string['onehour'] = '1 tunti';
$string['oneminute'] = '1 minuutti';
...
$string['pointsplural'] = 'Pisteet';
$string['previoussessions'] = 'Aiemmat tapaamiset';
$string['previoussessionslist'] = 'Lista kaikista tämän lähiopetusaktiviteetin tapaamisista';
$string['printversionid'] = 'Tulostusversio: nimetön';
$string['printversionname'] = 'Tulostusversio: nimetty';
$string['really'] = 'Oletko varma, että haluat poistaa kaikki tämän lähiopetuksen tulokset?';
$string['registeredon'] = 'Ilmoittautui';
...
$string['scheduledsessions'] = 'Sovitut tapaamiset';
$string['seatsavailable'] = 'Vapaita paikkoja yhteensä';
$string['seeattendees'] = 'Lista osallistujista';
...
$string['sessionover'] = 'Tapaaminen ohi';
$string['sessionrequiresmanagerapproval'] = 'Tähän tapaamiseen ilmoittautuminen vaatii esimiehen hyväksynnän.';
$string['sessionroles'] = 'Tapaamisen roolit';
...
$string['setting:addchangemanageremail'] = 'Kysy käyttäjiltä heidän esimiehensä sähköpostiosoitetta.';
$string['setting:addchangemanageremail_caption'] = 'Esimihen sähköpostiosoite:';
...
Toimipaikka: [session:location]
Pitopaikka: [session:venue]
Huone: [session:room]';
$string['setting:defaultcancellationsubject'] = 'Oletusotsikko peruutusviestille';
$string['setting:defaultcancellationsubject_caption'] = 'Peruutusviestin otsikko';
...
***Ole hyvä ja saavu 10 minuuttia ennen kurssin alkua***

Osallistumisajankohdan vaihtaminen tai osallistumisen peruuttaminen

Vaihtaaksesi osallistumisajankohtaasi sinun tulee ensin peruuttaa tämä ilmoittautuminen ja sen jälkeen ilmoittautua uuteen tapaamiseen. Halutessasi peruuttaa ilmoittautumisesi, mene kurssin sivustolle ja valitse "Peruuta" ilmoittautumisvalikossa.

[details]

Saat muistutusviestin [reminderperiod] arkipäivää ennen kurssin alkamista.';
$string['setting:defaultconfirmationsubject'] = 'Oletusotsikko vahvistusviesteille.';
$string['setting:defaultconfirmationsubject_caption'] = 'Vahvistusviestin otsikko';
...
Pitopaikka: [session:venue]
Huone: [session:room]';
$string['setting:defaultrequestsubjectdefault'] = 'Kurssi-ilmoittautumisanomus: [facetofacename], [starttime]-[finishtime]';
$string['setting:defaultvalue'] = 'Oletusvalinta';
$string['setting:defaultwaitlistedmessage'] = 'Oletusviesti, joka lähetetään varasijoille jääneille käyttäjille.';
$string['setting:defaultwaitlistedmessage_caption'] = 'Varasijaviesti';
$string['setting:defaultwaitlistedmessagedefault'] = 'Tämä on ilmoitus siitä, että sinut on lisätty varasijalle seuraavalle kurssille:

Kurssi: [facetofacename]
Toimipaikka: [session:location]
Osallistuja: [firstname] [lastname]

***Huomioi, että tämä ei ole ilmoittautumisilmoitus kyseiselle kurssille***

Ilmoittautumalla varasijalle olet ilmaissut kiinnostuksesi tähän kurssiin ja sinuun otetaan yhteyttä kun tapaamisiin mahtuu.

Mikäli haluat poistaa itsesi tältä varasijalta, mene kurssin sivulle ja valitse \'Peruuta ilmoittautuminen\'. Huomaa, että varasijalta poistumisesta ei tule vahvistusviestiä.';
$string['setting:defaultwaitlistedsubject'] = 'Oletusotsikko varasijaviesteille.';
$string['setting:defaultwaitlistedsubject_caption'] = 'Varasijaviestien otsikko';
$string['setting:defaultwaitlistedsubjectdefault'] = 'Varasijatietoa lähikoulutuksesta [facetofacename]';
$string['setting:disableicalcancel'] = 'Ota peruutusviestit pois käytöstä iCalendar-liitteellä';
$string['setting:disableicalcancel_caption'] = 'Ota iCalendar-peruutukset pois käytöstä:';
$string['setting:fromaddress'] = 'Tämän moduulin muistutuksien Lähettäjä-kentässä näkyvä teksti';
$string['setting:fromaddress_caption'] = 'Lähettäjän osoite:';
$string['setting:fromaddressdefault'] = 'moodle@example.com';
$string['setting:hidecost'] = 'Piilota hinta- ja alennuskoodikentät';
$string['setting:hidecost_caption'] = 'Piilota hinta ja alennus:';
$string['setting:hidediscount'] = 'Piilota vain alennuskoodikenttä.';
$string['setting:hidediscount_caption'] = 'Piilota alennus:';
$string['setting:isfilter'] = 'Käytä suotimena';
$string['setting:manageraddressformat'] = 'Pääte, joka täytyy esiintyä esimiehen sähköpostissa, jotta se katsotaan paikkaansa pitäväksi';
$string['setting:manageraddressformat_caption'] = 'Vaadittu pääte:';
$string['setting:manageraddressformatreadable'] = 'Lyhyt kuvaus esimiehen sähköpostiosoitteen rajoituksista. Tällä asetuksella ei ole vaikutusta, mikäli edellinen asetus on määritelty.';
$string['setting:manageraddressformatreadable_caption'] = 'Formaatin esimerkki:';
$string['setting:manageraddressformatreadabledefault'] = 'etunimi.sukunimi@yritys.com';
$string['setting:oneemailperday'] = 'Lähetä monta vahvistusilmoitusta monipäiväisistä tapahtumista.';
$string['setting:oneemailperday_caption'] = 'Yksi ilmoitus per päivä:';
$string['setting:possiblevalues'] = 'Lista mahdollisista vaihtoehdoista';
$string['setting:sessionroles'] = 'Käyttäjiä, joilla on kurssilla jokin valituista rooleista, voidaan seurata lähikoulutustapaamisilla';
...
$string['signupforsession'] = 'Ilmoittaudu tulevaan tapaamiseen';
$string['signupforthissession'] = 'Ilmoittaudu tähän lähikoulutustapaamiseen';
$string['signups'] = 'Ilmoittautumiset';
$string['sitenoticesheading'] = 'Tiedonannot';
$string['status'] = 'Tila';
$string['status_approved'] = 'Hyväksytty';
$string['status_booked'] = 'Ilmoittautuneena';
$string['status_declined'] = 'Hylätty';
$string['status_fully_attended'] = 'Osallistui';
$string['status_no_show'] = 'Ei paikalla';
$string['status_partially_attended'] = 'Osallistui osaksi';
$string['status_requested'] = 'Anottu';
$string['status_session_cancelled'] = 'Tapaaminen peruttu';
$string['status_user_cancelled'] = 'Käyttäjän osallistuminen peruttu';
$string['status_waitlisted'] = 'Varasijalla';
$string['subject'] = 'Muutos kurssin varaustiedoissa: {$a->coursename} ({$a->duedate})';
...
$string['upcomingsessions'] = 'Tulevat tapaamiset';
$string['upcomingsessionslist'] = 'Kaikki tämän lähikoulutuksen tulevat tapaamiset';
$string['usercancelledon'] = 'Käyttäjä perui ilmoittautumisen ({$a})';
$string['usernotsignedup'] = 'Tila: ei ole ilmoittautunut';
$string['usersignedup'] = 'Tila: ilmoittautunut';
$string['usersignedupon'] = 'Käyttäjä ilmoittautui ({$a})';
