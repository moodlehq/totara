...
$string['addnewfield'] = 'הוסף שדה חדש בהתאמה אישית';
$string['addnewfieldlink'] = 'צור שדה חדש בהתאמה אישית';
$string['addnewnotice'] = 'הוסף הודעת אתר חדשה';
$string['addnewnoticelink'] = 'צור הודעת אתר חדשה';
$string['addremoveattendees'] = 'הוסף/מחק משתתפים';
$string['addsession'] = 'הוסף מחזור';
$string['addstudent'] = 'הוסף משתתף';
$string['alllocations'] = 'כל המיקומים';
$string['allowoverbook'] = 'התר הרשמת יתר';
$string['allsessionsin'] = 'כל המחזורים ב- {$a}';
$string['alreadysignedup'] = 'נרשמת כבר לפעילות פנים-אל-פנים זו';
$string['answer'] = 'היכנס';
...
$string['calendareventdescriptionbooking'] = 'אתה רשום <a href="{$a}">למחזור פנים-אל-פנים זה</a>.';
$string['calendareventdescriptionsession'] = 'אתה פתחת <a href="{$a}">מחזור פנים-אל-פנים זה</a>.';
...
$string['changemanageremailinstruction'] = 'אנא הקלד את כתובת הדוא"ל של הנמהל שלך';
$string['clearall'] = 'נקה טופס';
$string['closed'] = 'סגור';
...
$string['confirmationsent'] = 'המערכת שלחה לך הודעת אישור בדואר אלקטרוני';
$string['confirmationsentmgr'] = 'המערכת שלחה לך ולמנהל שלך הודעת אישור בדואר אלקטרוני';
...
$string['emptylocation'] = 'חסרים פרטי מיקום';
$string['enrolled'] = 'רשום';
$string['error:addalreadysignedupattendee'] = '{$a} כבר רשום למחזור פנים-אל-פנים בקורס זה.';
$string['error:addattendee'] = 'לא הייתה אפשרות להוסיף את {$a} למחזור.';
$string['error:cancelbooking'] = 'הייתה בעיה בביטול הרשמתך';
$string['error:cannotemailmanager'] = 'נשלחה הודעת תזכורת {$a->submissionid} t למשתמש {$a->userid}, אך לא הצלחתי לשלוח הודעה לדוא"ל של המנהל ({$a->manageremail}).';
$string['error:cannotemailuser'] = 'לא ניתן לשלוח מייל בקשה מספר {$a->submissionid} למשתמש {$a->userid} ({$a->useremail}).';
$string['error:cannotsendconfirmationmanager'] = 'הודעת אישור נשלחה אליך, אך הייתה בעייה בשליחת הודעת אישור למנהל שלך.';
$string['error:cannotsendconfirmationthirdparty'] = 'הודעת אישור נשלחה אליך ולמנהלך, אך הייתה בעייה בשליחת הודעת אישור לגורם המרכז את המחזור.';
$string['error:cannotsendconfirmationuser'] = 'הייתה בעייה בשליחת הודעת אישור למייל שלך.';
...
$string['error:coursemisconfigured'] = 'יש בעייה בהגדרות של הקורס';
...
$string['error:incorrectfacetofaceid'] = 'קוד זיהוי של הדרכה פנים-אל-פנים אינו תקין';
...
$string['error:mustspecifycoursemodulefacetoface'] = 'חובה לציין רכיב קורס או קוד מחזור פנים-אל-פנים';
$string['error:nomanageremail'] = 'לא עדכנת דואר אלקטרוני של מנהלך';
$string['error:nomanagersemailset'] = 'לא הוגדר דוא"ל מנהל';
$string['error:nopermissiontosignup'] = 'אין לך הרשאה להירשם למחזור פנים-אל-פנים זה.';
...
$string['facetoface:takeattendance'] = 'השתתף';
$string['facetoface:view'] = 'צפה בהדרכות פנים-אל-פנים ובמחזורים';
$string['facetoface:viewattendees'] = 'צפה ברשימת נוכחות ובמשתתפים';
$string['facetoface:viewcancellations'] = 'צפה בביטולים';
$string['facetoface:viewemptyactivities'] = 'צפה במחזורי הדרכה ריקים';
$string['facetofacebooking'] = 'רישום להדרכה פנים-אל-פנים';
$string['facetofacename'] = 'שם ההדרכה';
...
$string['field:text'] = 'טקסט';
$string['fielddeleteconfirm'] = 'למחוק שדה \'{$a}\' וכל הנתונים הקשורים בו?';
$string['floor'] = 'קומה';
$string['format'] = 'פורמט';
$string['full'] = 'התאריך מלא';
$string['goback'] = 'חזור';
$string['guestsno'] = 'מצטערים, אורחים אינם מורשים להירשם למחזורים.';
$string['icaldescription'] = 'אירוע זה בלוח השנה הוא עבור מםגש הדרכה {$a->name} אליו אתה רשום.';
...
$string['manageremailheading'] = 'כתובות דו"אל של מנהל';
$string['manageremailinstruction'] = 'כדי להירשם למחזור הדרכה, יש לשלוח מייל אישור אליך עם העתק למנהל שלך.';
...
$string['maximumpoints'] = 'מספר מרבי של נקודות.';
...
$string['modulename'] = 'הדרכה פנים-אל-פנים';
$string['modulenameplural'] = 'הדרכה פנים-אל-פנים';
$string['moreinfo'] = 'מידע נוסף';
$string['multiday'] = 'רב-יומי';
$string['newmanageremailaddress'] = 'כתובת דוא"ל של המנהל';
$string['noactionableunapprovedrequests'] = 'אין בקשות רישום הממתינות לטיפול';
$string['nocustomfields'] = '<p>לא הוגדרו שדות מותאמים אישית.</p>';
$string['nofacetofaces'] = 'אין פעילויות הדרכה פנים-אל-פנים';
$string['none'] = 'אין';
...
אם מישהו יבטל, הראשון ברשימת ההמתנה יצורף למחזור ותישלח לו הודעה.';
$string['noticedeleteconfirm'] = 'מחק הודעת אתר \'{$a->name}\'?<br/><blockquote>{$a->text}</blockquote>';
$string['noticetext'] = 'טקסט ההודעה';
...
$string['previoussessionslist'] = 'רשימת כל המחזורים הקודמים בפעילות פנים-אל-פנים זו';
$string['printversionid'] = 'גרסת הדפסה: ללא שם';
$string['printversionname'] = 'גרסת הדפסה: כולל שם';
...
*** העתק בקשת הביטול שנשלחה מופיע למטה [firstname] [lastname] ****
...
*** העתק בקשת הרישום שנשלחה לעובד מופיע למטה [firstname] [lastname] ****
...
****לתשומת לבך - הרישום הסופי מותנה במילוי טופס רישום להדרכה, החתמת מנהל וגורמים מאשרים כנדרש.****
...
כדי לבטל את הרישום, היכנס חזרה לאתר הקורסים, לעמוד של קורס זה, ובחר "בטל הרשמה" במסך המידע על ההדרכה הפרונטלית.

[details]

הודעת תזכורת תישלח אליך [reminderperiod] ימים לפני מועד פתיחת הקורס.

English Version
---------------
This is to confirm that you are now booked on the following course.
****NOTE: Your registartion depends on signing a training registration form and its approval by your manager and other approvers as required.****
...
*** הודעת התזכורת שנשלחה ל- [firstname] [lastname] ****
...
English Version
---------------
Your request to book into the following course has been sent to your manager:
...
Venue: [session:venue]
Room: [session:room]';
$string['setting:defaultrequestsubjectdefault'] = 'בקשת רישום לקורס: [facetofacename], [starttime]-[finishtime]';
$string['setting:defaultvalue'] = 'ערך ברירת מחדל';
$string['setting:defaultwaitlistedmessage'] = 'הודעת ברירת-מחדל על הוספה לרשימת המתנה';
$string['setting:defaultwaitlistedmessage_caption'] = 'הודעה לרשימת המתנה';
$string['setting:defaultwaitlistedmessagedefault'] = 'זהו אישור לצירוף שלך לרשימת המתנה ל:

קורס: [facetofacename]
מיקום: [session:location]
משתתף: [firstname] [lastname]

*** לתשומת לבך - זהו אינו אישור להשתתפותך בקורס ***

על ידי רישום לרשימת המתנה אתה מציין את התעניינותך בקורס, ואנו ניצור אתך קשר כאשר ייקבעו מחזורים להדרכה זו.

על מנת למחוק את עצמך מרשימת ההמתנה, אנא התחבר לאתר הקורסים של מחלקת הדרכה, ולחץ על "ביטול רישום" במסך פרטי ההדרכה הפרונטלית.
לתשומת לבך - לא תקבל הודעת מייל על ביטול רישום לרשימת המתנה.

English Version
---------------
This is to advise that you been added to the waitlist for:
...
$string['setting:disableicalcancel'] = 'בטל אפשרות של הודעות מייל עם צירוף פגישה ליומן Outlook.';
$string['setting:disableicalcancel_caption'] = 'בטל אפשרות ביטולים ביומן Outlook.';
$string['setting:fromaddress'] = 'מה יופיע בשדה של הטופס של הודעת התזכורת שנשלחת.';
$string['setting:fromaddress_caption'] = 'כתובת השולח:';
$string['setting:fromaddressdefault'] = 'USERNAME@example.com';
$string['setting:hidecost'] = 'הסתר שדות עלות והנחה.';
$string['setting:hidecost_caption'] = 'הסתר עלות:';
$string['setting:hidediscount'] = 'הסתר שדה הנחה וקוד הנחה בלבד.';
$string['setting:hidediscount_caption'] = 'הסתר הנחה:';
$string['setting:isfilter'] = 'הצג כמסנן';
$string['setting:manageraddressformat'] = 'סיומת החייבת להיות במייל כדי שיתקבל ככתובת מייל תקינה.';
$string['setting:manageraddressformat_caption'] = 'סיומת מייל נדרשת';
$string['setting:manageraddressformatdefault'] = '@example.com';
$string['setting:manageraddressformatreadable'] = 'תיאור קצר של המגבלות על כתובת המייל של המנהל. להגדרה זו אין כל השפעה אם ההגדרה הקודמת לא נקבעה.';
$string['setting:manageraddressformatreadable_caption'] = 'תבנית לדוגמא:';
$string['setting:manageraddressformatreadabledefault'] = 'firstname.lastname@company.com';
$string['setting:oneemailperday'] = 'שלח מספר מיילים אם יש מספר מפגשים - אחד לכל מפגש.';
$string['setting:oneemailperday_caption'] = 'הודעה אחת ליום:';
$string['setting:possiblevalues'] = 'רשימת ערכים אפשריים';
$string['setting:sessionroles'] = 'משתמשים להם מוקצים התפקידים הבאים בקורס ניתנים למעקב בכל מחזור פנים-אל-פנים';
...
$string['suppressemail'] = 'אל תשלח הודעת מייל';
$string['takeattendance'] = 'רישום נוכחות';
$string['thirdpartyemailaddress'] = 'כתובת מייל של האחראי על ההדרכה';
$string['thirdpartywaitlist'] = 'הודעה למנהל ההדרכה על רשימות ההמתנה';
$string['time'] = 'זמן';
...
$string['upcomingsessionslist'] = 'רשימת כל המחזורים הקרובים של פעילות פנים-אל-פנים';
