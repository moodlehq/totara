...
$string['bulkaddhelptext'] = 'Note: Users must be referenced by their idnumber, idnumber\'s must be delimited by a comma or newline';
$string['bulkaddsourceidnumber'] = 'ID number';
$string['bulkaddfilehelptext'] = 'Note: Users must be referenced by their ID number and appear one per line';
$string['bulkaddtexthelptext'] = 'Note: Users must be referenced by their ID number, ID number\'s must be delimited by a comma or newline';
...
$string['error:userassignedsessionconflictsameday'] = 'This user is already assigned as a \'{$a->participation}\' for {$a->session} at {$a->timestart} to {$a->timefinish} on {$a->datestart}.';
$string['error:userbookedsessionconflictsameday'] = 'This user is already booked to attend {$a->session} at {$a->timestart} to {$a->timefinish} on {$a->datestart}.';
$string['error:userassignedsessionconflictmultiday'] = 'This user is already assigned as a \'{$a->participation}\' for {$a->session} at {$a->datetimestart} to {$a->datetimefinish}.';
$string['error:userbookedsessionconflictmultiday'] = 'This user is already booked to attend {$a->session} at {$a->datetimestart} to {$a->datetimefinish}.';
...
$string['useridnumberdoesnotexist'] = 'User with ID number "{$a}" does not exist';
...
$string['xerrorsencounteredduringimport'] = '{$a} errors encountered during import.';
