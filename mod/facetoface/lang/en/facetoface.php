...
$string['error:userassignedsessionconflictsameday'] = 'This user is already assigned as a \'{$a->participation}\' for {$a->session} at {$a->timestart} to {$a->timefinish} on {$a->datestart}. Please select another user or change the session date';
...
$string['error:userassignedsessionconflictmultiday'] = 'This user is already assigned as a \'{$a->participation}\' for {$a->session} at {$a->datetimestart} to {$a->datetimefinish}. Please select another user or change the session date';
