...
$string['cannotcreatecompletedfeedback'] = 'Non è stato possibile creare il feedback completo';
...
$string['saving_failed_because_missing_items'] = 'Per favore, completa <strong>tutte</strong> le domande obbligatorie (indicate con un asterirsco).';
...
$string['select_item_type'] = 'Seleziona tipo di elemento';
