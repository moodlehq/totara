...
$string['all_old_values_will_be_deleted'] = 'Se eliminarán las preguntas actuales y las respuestas de los usuarios';
$string['all_old_values_will_be_preserved'] = 'Se guardarán todas las preguntas anteriores y sus valores asignados';
$string['all_related_values_will_be_deleted'] = 'Se borrarán también todas las respuestas de los usuarios a esta pregunta';
...
$string['are_you_sure_to_delete_this_entry'] = '¿Está seguro de que quiere eliminar esta entrada?';
$string['are_you_sure_to_delete_this_item'] = '¿Está seguro de que quiere eliminar este elemento?';
$string['are_you_sure_to_delete_this_template'] = '¿Está seguro de que quiere eliminar esta plantilla?';
$string['are_you_sure_to_use_this_template'] = '¿Está seguro de que quiere usar esta plantilla?';
$string['autonumbering'] = 'numeración automática de las preguntas';
$string['average'] = 'Promedio';
$string['bold'] = 'Negrita';
$string['cancel_moving'] = 'Cancelar movimiento';
$string['cannotcreatecompletedfeedback'] = 'No se puede crear encuesta completada';
$string['cannotcreatetmpfeedback'] = 'No se puede crear encuesta temporal';
