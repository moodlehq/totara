<?php  // $Id: lib.php,v 1.1.2.6 2010/09/03 20:15:22 agrabs Exp $
...
class feedback_item_multichoice extends feedback_item_base {
            ...
            if($info->subtype == 'c') {
                ...
                foreach($presentation as $pres){
                    foreach($values as $val) {
                        if($val == $index){
                            echo format_text($pres . '<br />', true, false, false);
                            break;
                        }
                    }
                    $index++;
                ...
                foreach($presentation as $pres){
                    if($value == $index){
                        ...
                        print_box_start('generalbox boxalign'.$align);
                        echo format_text($pres, true, false, false);
                        // print_simple_box_end();
                        print_box_end();
                        break;
                    }
    ...
    function print_item_radio($presentation, $item, $value, $info, $align) {
        ...
        ?>
                ...
                <td align="<?php echo $align;?>">
                    <label for="<?php echo $inputid;?>"><?php echo format_text($radio, true, false, false);?>&nbsp;</label>
                </td>
        <?php
            }else {
        ?>
                ...
                <td valign="top" align="<?php echo $align;?>"><input type="radio"
                        ...
                        id="<?php echo $inputid;?>"
                        value="<?php echo $index;?>" <?php echo $checked;?> />
                </td><td align="<?php echo $align;?>"><label for="<?php echo $inputid;?>"><?php echo format_text($radio, true, false, false);?>&nbsp;</label>
                </td></tr></table>
        <?php
            }
            $index++;
    ...
    function print_item_dropdown($presentation, $item, $value, $info, $align) {
        ...
        ?>
            <option value="<?php echo $index;?>" <?php echo $selected;?>><?php echo format_text($dropdown, true, false, false);?></option>
        <?php
            $index++;
        }
        ?>
